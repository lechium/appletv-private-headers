...
- (id)initWithPopBlock:(id)popBlock popInterval:(double)interval;	// 0x1801dd
- (void)_timerFired:(id)fired;	// 0x1803f5
- (void)dealloc;	// 0x180289
- (void)discard;	// 0x1802d5
- (void)wasPopped;	// 0x180381
- (void)wasPushed;	// 0x180315
@end
