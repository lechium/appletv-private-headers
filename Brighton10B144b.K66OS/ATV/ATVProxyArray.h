...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x3b2b01
- (unsigned)count;	// 0x3b2eb5
- (void)dealloc;	// 0x3b2e69
- (unsigned)indexOfObject:(id)object;	// 0x3b2f89
- (id)objectAtIndex:(unsigned)index;	// 0x3b2ee5
@end
