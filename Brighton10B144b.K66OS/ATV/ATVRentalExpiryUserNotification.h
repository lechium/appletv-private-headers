...
+ (void)postExpiryNotificationForAsset:(id)asset;	// 0x2131d1
- (id)init;	// 0x213269
- (void)_playAsset;	// 0x213ae9
- (void)_setAsset:(id)asset;	// 0x213829
- (BOOL)brEventAction:(id)action;	// 0x213599
- (void)dealloc;	// 0x213535
- (void)layoutSubcontrols;	// 0x21364d
@end
