...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x21edb5; S=0x21edc5; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x21e3dd
- (void).cxx_destruct;	// 0x21edd5
- (void)_readCurrentConfiguration;	// 0x21ee91
- (void)_saveConfiguration;	// 0x21eff1
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x21e4cd
- (void)entryComplete:(id)complete;	// 0x21e825
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x21edc5
// declared property getter: - (BOOL)showOnlyDNS;	// 0x21edb5
@end
