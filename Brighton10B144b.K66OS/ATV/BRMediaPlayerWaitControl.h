...
- (id)initWithAsset:(id)asset;	// 0x2c47e1
- (void)_addFadeAnimationToControl:(id)control;	// 0x2c5919
- (void)dealloc;	// 0x2c4cd1
- (void)layoutSubcontrols;	// 0x2c53ed
- (void)setAuthorizing;	// 0x2c532d
- (void)setBandwidthHintForPreview:(BOOL)preview;	// 0x2c4de9
- (void)setReadyForPlayInNMins:(int)nmins;	// 0x2c4fe9
- (void)setReadyToPlay;	// 0x2c5285
@end
