...
+ (void)setSingleton:(id)singleton;	// 0x3600bd
+ (id)singleton;	// 0x3600ad
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x36027d
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x3606d1
- (void)dealloc;	// 0x3600cd
- (id)populatorForAsset:(id)asset;	// 0x36020d
@end
