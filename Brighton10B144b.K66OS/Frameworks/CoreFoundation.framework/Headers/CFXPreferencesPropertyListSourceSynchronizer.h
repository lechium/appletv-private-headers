...
- (id)initWithPropertyListSource:(id)propertyListSource forLockedSynchronize:(BOOL)lockedSynchronize;	// 0x31068fed
- (unsigned char)_backingPlistChangedSinceLastSync;	// 0x310693f1
- (void *)createPlistFromDisk;	// 0x31074595
- (void)dealloc;	// 0x31069ef9
- (void)finalize;	// 0x310f2761
- (void)setValue:(void *)value forKey:(CFStringRef)key;	// 0x310f26ed
- (unsigned char)synchronize;	// 0x310691bd
- (unsigned char)synchronizeAlreadyFlocked;	// 0x310691d5
- (unsigned char)writePlistToDisk;	// 0x31069fad
@end
