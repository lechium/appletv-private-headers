...
@property(readonly, assign, nonatomic) MIDINetworkHost *host;	// G=0x3162584d; 
+ (id)connectionWithHost:(id)host;	// 0x316256f5
- (id)init;	// 0x316256a9
- (void)dealloc;	// 0x31625761
// declared property getter: - (id)host;	// 0x3162584d
@end
