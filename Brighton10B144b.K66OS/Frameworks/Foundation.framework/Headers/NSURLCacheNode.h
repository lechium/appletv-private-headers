...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x3197ac91
- (void)dealloc;	// 0x3197ae31
- (id)description;	// 0x3197addd
- (BOOL)isEqual:(id)equal;	// 0x3197ad59
@end
