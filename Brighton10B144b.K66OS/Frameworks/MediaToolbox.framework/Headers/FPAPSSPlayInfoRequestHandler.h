...
- (id)init;	// 0x31fd0285
- (void)dealloc;	// 0x31fd02d1
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x31fd037d
- (void)request:(id)request didFailWithError:(id)error;	// 0x31fd0381
- (void)requestDidFinish:(id)request;	// 0x31fd0695
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x31fd0331
- (void)setRequest:(id)request;	// 0x31fd0341
@end
