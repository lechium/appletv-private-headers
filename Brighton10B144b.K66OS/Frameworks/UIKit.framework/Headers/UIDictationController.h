...
+ (void)enableGestureHandlerIfNecessary;	// 0x32b657f5
+ (BOOL)fetchCurrentInputModeSupportsDictation;	// 0x32be37dd
+ (id)inputModeNameForDictation;	// 0x32b5a4b5
...
+ (BOOL)isRunning;	// 0x32bcba01
+ (void)keyboardDidSetDelegate;	// 0x32bdc7d5
+ (void)keyboardDidSetInputMode;	// 0x32bdb805
+ (void)keyboardDidUpdateOnScreenStatus;	// 0x32b5d4dd
+ (void)logCorrectionStatistics;	// 0x32bcba19
...
+ (BOOL)shouldEnableGestureHandler;	// 0x32b658a9
+ (void)siriPreferencesChanged;	// 0x32e95f2d
+ (void)updateLandingView;	// 0x32bd5a75
+ (void)willEndEditingInTextView:(id)textView;	// 0x32bcb99d
- (id)init;	// 0x32e94ab5
