...
@property(retain, nonatomic) NSString *inlineText;	// G=0x32e9e4a9; S=0x32e9d5d5; @synthesize=_inlineText
...
@property(retain, nonatomic) NSArray *sortedCandidates;	// G=0x32e9e489; S=0x32e9e499; @synthesize=_sortedCandidates
...
// declared property getter: - (id)inlineText;	// 0x32e9e4a9
...
// declared property setter: - (void)setSortedCandidates:(id)candidates;	// 0x32e9e499
...
// declared property getter: - (id)sortedCandidates;	// 0x32e9e489
