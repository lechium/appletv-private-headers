...
@property(retain, nonatomic) UIImage *backgroundImage;	// G=0x32d710ad; S=0x32baa279; 
@property(retain) NSArray *buttonItems;	// G=0x32d71a9d; S=0x32d71aad; converted property
@property(assign, nonatomic) id<UITabBarDelegate> delegate;	// G=0x32d71441; S=0x32b77f0d; @synthesize=_delegate
@property(copy, nonatomic) NSArray *items;	// G=0x32b7dc71; S=0x32d7036d; 
@property(assign, getter=isLocked) BOOL locked;	// G=0x32b24dfd; S=0x32b247b1; converted property
@property(retain, nonatomic) UIColor *selectedImageTintColor;	// G=0x32d713fd; S=0x32d71355; 
@property(assign, nonatomic) UITabBarItem *selectedItem;	// G=0x32ba87a5; S=0x32b7b97d; 
@property(retain, nonatomic) UIImage *selectionIndicatorImage;	// G=0x32d710f1; S=0x32baa3d1; 
@property(retain, nonatomic) UIImage *shadowImage;	// G=0x32d710d1; S=0x32baa5c5; 
@property(retain, nonatomic) UIColor *tintColor;	// G=0x32b79ad5; S=0x32d7129d; 
+ (float)_buttonGap;	// 0x32d71af1
+ (float)defaultHeightForBarSize:(int)barSize;	// 0x32d71511
- (id)initWithCoder:(id)coder;	// 0x32d6fd69
- (id)initWithFrame:(CGRect)frame;	// 0x32b7758d
- (void)_activityViewControllerIsAppearing:(id)appearing;	// 0x32c7bf75
- (void)_activityViewControllerIsDisappearing:(id)disappearing;	// 0x32c886b9
- (void)_adjustButtonSelection:(id)selection;	// 0x32c1b5a9
...
- (id)_appearanceStorage;	// 0x32b79ac1
...
- (void)_buttonDown:(id)down;	// 0x32c1b4d5
- (void)_buttonDownDelayed:(id)delayed;	// 0x32d71e51
- (void)_buttonUp:(id)up;	// 0x32c1b529
- (BOOL)_canDrawContent;	// 0x32b7765d
...
- (void)_didMoveFromWindow:(id)window toWindow:(id)window2;	// 0x32b7ed71
...
- (void)_finishSetItems:(id)items finished:(id)finished context:(void *)context;	// 0x32b25be9
...
- (CGSize)_intrinsicSizeWithinSize:(CGSize)size;	// 0x32b77ead
- (void)_invalidateDividerImages;	// 0x32baac45
...
- (void)_positionTabBarButtons:(id)buttons ignoringItem:(id)item;	// 0x32b24e99
- (void)_sendAction:(id)action withEvent:(id)event;	// 0x32c1b6d5
- (void)_setBackgroundImage:(id)image;	// 0x32d6f7e1
// declared property setter: - (void)_setBackgroundView:(id)view;	// 0x32d6f761
- (void)_setDividerImage:(id)image forLeftButtonState:(unsigned)leftButtonState rightButtonState:(unsigned)state;	// 0x32baa8f9
...
- (void)_setSelectionIndicatorImage:(id)image;	// 0x32baa3c1
// declared property setter: - (void)_setTabButtonWidth:(float)width;	// 0x32d71481
- (id)_shadowView;	// 0x32c6d0dd
- (void)_showItemsAnimated:(BOOL)animated;	// 0x32d70c59
- (BOOL)_subclassImplementsDrawRect;	// 0x32b775dd
...
- (void)_updateBackgroundImage;	// 0x32b77795
- (void)_updateDividerImagesIfNecessary;	// 0x32b259f9
...
- (id)hitTest:(CGPoint)test withEvent:(id)event;	// 0x32c1b439
- (BOOL)isCustomizing;	// 0x32c6a211
- (BOOL)isElementAccessibilityExposedToInterfaceBuilder;	// 0x32d80f8d
// converted property getter: - (BOOL)isLocked;	// 0x32b24dfd
// declared property getter: - (id)items;	// 0x32b7dc71
- (void)layoutSubviews;	// 0x32b7f2b9
- (void)removeConstraint:(id)constraint;	// 0x32d70ead
// declared property getter: - (id)selectedImageTintColor;	// 0x32d713fd
// declared property getter: - (id)selectedItem;	// 0x32ba87a5
// declared property getter: - (id)selectionIndicatorImage;	// 0x32d710f1
- (void)setAutoresizingMask:(unsigned)mask;	// 0x32b77ebd
// declared property setter: - (void)setBackgroundImage:(id)image;	// 0x32baa279
...
// declared property setter: - (void)setDelegate:(id)delegate;	// 0x32b77f0d
- (void)setFrame:(CGRect)frame;	// 0x32b776a9
// declared property setter: - (void)setItems:(id)items;	// 0x32d7036d
- (void)setItems:(id)items animated:(BOOL)animated;	// 0x32b247e9
// converted property setter: - (void)setLocked:(BOOL)locked;	// 0x32b247b1
// declared property setter: - (void)setSelectedImageTintColor:(id)color;	// 0x32d71355
// declared property setter: - (void)setSelectedItem:(id)item;	// 0x32b7b97d
// declared property setter: - (void)setSelectionIndicatorImage:(id)image;	// 0x32baa3d1
// declared property setter: - (void)setShadowImage:(id)image;	// 0x32baa5c5
...
- (CGSize)sizeThatFits:(CGSize)fits;	// 0x32b77de5
// declared property getter: - (id)tintColor;	// 0x32b79ad5
