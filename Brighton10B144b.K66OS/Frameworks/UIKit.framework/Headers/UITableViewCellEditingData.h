...
- (id)initWithTableViewCell:(id)tableViewCell editingStyle:(int)style;	// 0x32c2a9e1
- (void)dealloc;	// 0x32c2c699
- (id)deleteConfirmationControl:(BOOL)control;	// 0x32c2ae95
- (id)editControl:(BOOL)control;	// 0x32c2ab39
// declared property getter: - (BOOL)isDataRequired;	// 0x32da0d45
- (id)reorderControl:(BOOL)control;	// 0x32c2ac09
- (id)reorderSeparatorView:(BOOL)view;	// 0x32c2ac89
@end
