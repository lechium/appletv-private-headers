...
@property(retain, nonatomic) UIView *target;	// G=0x32c2c391; S=0x32dc6679; @synthesize=_target
...
+ (id)sharedCaretMagnifier;	// 0x32c2c01d
- (id)initWithDefaultFrame;	// 0x32c2c0a9
...
// declared property getter: - (id)target;	// 0x32c2c391
