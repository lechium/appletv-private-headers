...
- (id)initWithIdentifier:(id)identifier;	// 0x336bb5f9
- (id)initWithIdentifier:(id)identifier timeout:(double)timeout;	// 0x336bb3a1
- (void)dealloc;	// 0x336bb629
- (id)description;	// 0x336bb781
@end
