...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x33704341; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x3370431d; S=0x33704331; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x33704355; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x33704219
// declared property getter: - (id)dataPayload;	// 0x33704341
- (void)dealloc;	// 0x337042a5
// declared property getter: - (id)serverID;	// 0x3370431d
// declared property setter: - (void)setServerID:(id)anId;	// 0x33704331
// declared property getter: - (id)syncKey;	// 0x33704355
@end
