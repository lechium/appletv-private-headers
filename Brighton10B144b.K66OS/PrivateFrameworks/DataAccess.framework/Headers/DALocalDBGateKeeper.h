...
+ (id)sharedGateKeeper;	// 0x3396e385
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x3396e641
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x3396e449
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x3396e3cd
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x3396e541
- (id)stateString;	// 0x3396e5bd
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x3396e4c5
@end
