...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x33a704c9
- (void)dealloc;	// 0x33a705d1
- (void)finishedWithError:(id)error;	// 0x33a70661
@end
