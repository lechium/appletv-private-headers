...
@property(retain, nonatomic) NSMutableArray *formattedAddressLines;	// G=0x33f6a8f1; S=0x33f6eac9; @synthesize=_formattedAddressLines
...
// declared property setter: - (void)setFormattedAddressLines:(id)lines;	// 0x33f6eac9
...
// declared property setter: - (void)setStructuredAddress:(id)address;	// 0x33f6ead9
// declared property getter: - (id)structuredAddress;	// 0x33f71225
- (void)writeTo:(id)to;	// 0x33f6fdfd
@end
