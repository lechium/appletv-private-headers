...
@property(retain, nonatomic) GEOAddress *address;	// G=0x33f6a8c1; S=0x33f4b5a1; @synthesize=_address
@property(assign, nonatomic) int addressGeocodeAccuracy;	// G=0x33f70ff5; S=0x33f8ed19; @synthesize=_addressGeocodeAccuracy
@property(retain, nonatomic) NSMutableArray *business;	// G=0x33f70491; S=0x33f6a82d; @synthesize=_business
@property(retain, nonatomic) GEOLatLng *center;	// G=0x33f6a859; S=0x33f4b7d1; @synthesize=_center
@property(retain, nonatomic) NSMutableArray *entryPoints;	// G=0x33f9008d; S=0x33f6a83d; @synthesize=_entryPoints
@property(assign, nonatomic) long long geoId;	// G=0x33f71039; S=0x33f8ef21; @synthesize=_geoId
...
@property(retain, nonatomic) GEOMapRegion *mapRegion;	// G=0x33f6f0c5; S=0x33f4b741; @synthesize=_mapRegion
@property(retain, nonatomic) NSString *name;	// G=0x33f6a8b1; S=0x33f54a3d; @synthesize=_name
@property(retain, nonatomic) GEOAddress *phoneticAddress;	// G=0x33f9007d; S=0x33f6a81d; @synthesize=_phoneticAddress
@property(retain, nonatomic) NSString *phoneticName;	// G=0x33f9006d; S=0x33f6a80d; @synthesize=_phoneticName
...
// declared property getter: - (id)address;	// 0x33f6a8c1
- (id)addressDictionary;	// 0x33f7a7a1
// declared property getter: - (int)addressGeocodeAccuracy;	// 0x33f70ff5
// declared property getter: - (id)business;	// 0x33f70491
- (id)businessAtIndex:(unsigned)index;	// 0x33f8ecf9
- (unsigned)businessCount;	// 0x33f6a8d1
// declared property getter: - (id)center;	// 0x33f6a859
- (void)clearBusiness;	// 0x33f8ec6d
- (void)clearEntryPoints;	// 0x33f8ed75
- (void)copyTo:(id)to;	// 0x33f8f661
- (void)dealloc;	// 0x33f6a73d
...
// declared property getter: - (long long)geoId;	// 0x33f71039
...
// declared property getter: - (id)mapRegion;	// 0x33f6f0c5
// declared property getter: - (id)name;	// 0x33f6a8b1
// declared property getter: - (id)phoneticAddress;	// 0x33f9007d
// declared property getter: - (id)phoneticName;	// 0x33f9006d
- (BOOL)readFrom:(id)from;	// 0x33f6a84d
// declared property setter: - (void)setAddress:(id)address;	// 0x33f4b5a1
// declared property setter: - (void)setAddressGeocodeAccuracy:(int)accuracy;	// 0x33f8ed19
// declared property setter: - (void)setBusiness:(id)business;	// 0x33f6a82d
// declared property setter: - (void)setCenter:(id)center;	// 0x33f4b7d1
// declared property setter: - (void)setEntryPoints:(id)points;	// 0x33f6a83d
...
// declared property setter: - (void)setMapRegion:(id)region;	// 0x33f4b741
// declared property setter: - (void)setName:(id)name;	// 0x33f54a3d
// declared property setter: - (void)setPhoneticAddress:(id)address;	// 0x33f6a81d
// declared property setter: - (void)setPhoneticName:(id)name;	// 0x33f6a80d
