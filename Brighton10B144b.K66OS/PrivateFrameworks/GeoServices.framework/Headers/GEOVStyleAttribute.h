...
@property(assign, nonatomic) BOOL hasIntValue;	// G=0x33f5c291; S=0x33fefc51; 
@property(assign, nonatomic) int intValue;	// G=0x33f5c2a5; S=0x33fefc29; @synthesize=_intValue
@property(assign, nonatomic) unsigned key;	// G=0x33f5c281; S=0x33feff71; @synthesize=_key
- (void)copyTo:(id)to;	// 0x33fefe19
- (void)dealloc;	// 0x33f5ccf9
- (id)description;	// 0x33fefc6d
- (id)dictionaryRepresentation;	// 0x33fefcdd
// declared property getter: - (BOOL)hasIntValue;	// 0x33f5c291
- (unsigned)hash;	// 0x33feff19
// declared property getter: - (int)intValue;	// 0x33f5c2a5
- (BOOL)isEqual:(id)equal;	// 0x33fefe8d
// declared property getter: - (unsigned)key;	// 0x33f5c281
