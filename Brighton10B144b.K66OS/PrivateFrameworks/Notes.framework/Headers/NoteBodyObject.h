...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x347ec915; 
...
- (BOOL)containsAttachments;	// 0x347eca71
// declared property getter: - (id)contentAsPlainText;	// 0x347ec915
- (id)contentAsPlainTextPreservingNewlines;	// 0x347ec9bd
@end
