...
+ (id)autoStylingWithChart:(id)chart;	// 0x34969e0d
- (id)initWithChart:(id)chart;	// 0x34969ea5
- (void)dealloc;	// 0x34978ab5
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x349ada11
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x349a88a1
@end
