...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x3490ccd9
- (void)dealloc;	// 0x3491075d
- (bool)loadDelayedNode:(id)node;	// 0x3490d239
@end
