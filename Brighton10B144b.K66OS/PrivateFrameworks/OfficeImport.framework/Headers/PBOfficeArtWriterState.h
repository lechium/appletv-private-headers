...
- (id)initWithClient:(id)client presentationState:(id)state;	// 0x34a75015
- (void)dealloc;	// 0x34a750a1
- (id)presentationState;	// 0x34a75091
- (id)targetPlaceholders;	// 0x34a750ed
@end
