...
- (id)init;	// 0x34ad85e5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x34ad8661
- (void)dealloc;	// 0x34ad89a5
- (XXStruct_M$PztB)getFormatStruct;	// 0x34ad86d9
- (BOOL)isEqual:(id)equal;	// 0x34ad8715
@end
