...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x35465391
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x35464e09
- (void)_didFailToLaunch;	// 0x354651bd
- (void)_didLaunch;	// 0x354650d5
- (void)dealloc;	// 0x35465075
- (void)invalidate;	// 0x354652ad
@end
