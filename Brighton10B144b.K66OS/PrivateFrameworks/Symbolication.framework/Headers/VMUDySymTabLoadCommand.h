...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x35589521; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x35589531; converted property
- (id)initWithMemory:(id)memory;	// 0x35589321
// converted property getter: - (unsigned)indirectsymoff;	// 0x35589521
- (BOOL)isDySymTab;	// 0x3558951d
// converted property getter: - (unsigned)nindirectsyms;	// 0x35589531
@end
