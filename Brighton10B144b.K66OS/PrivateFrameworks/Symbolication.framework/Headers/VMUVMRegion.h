...
@property(readonly, assign) VMURange range;	// G=0x355aec4d; converted property
@property(readonly, retain) NSString *type;	// G=0x355aec81; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x355aede5
- (void)dealloc;	// 0x355aef91
- (id)description;	// 0x355aec39
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x355ae421
- (BOOL)isEqual:(id)equal;	// 0x355aeca1
- (BOOL)isSubmap;	// 0x355aec91
- (unsigned)protection;	// 0x355aec71
// converted property getter: - (VMURange)range;	// 0x355aec4d
// converted property getter: - (id)type;	// 0x355aec81
@end
