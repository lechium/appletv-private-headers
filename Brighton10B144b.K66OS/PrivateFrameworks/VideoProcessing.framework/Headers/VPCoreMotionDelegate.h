...
- (id)init;	// 0x35b333a9
- (void)dealloc;	// 0x35b33489
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x35b33859
- (void)processGyroData:(id)data withError:(id)error;	// 0x35b33529
- (void)start;	// 0x35b33769
- (void)stop;	// 0x35b33835
@end
