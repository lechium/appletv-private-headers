...
+ (void)postDistributedNotificationWithName:(id)name;	// 0x35c16b99
- (id)_notificationTypeDescription;	// 0x35c16bf9
- (void)_startObserving;	// 0x35c16b0d
- (void)_stopObserving;	// 0x35c16b5d
@end
