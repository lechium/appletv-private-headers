...
- (id)init;	// 0x35c2707d
- (void)_handleRequests;	// 0x35c273dd
- (void)_notifyRequestHandled:(id)handled;	// 0x35c27361
- (void)dealloc;	// 0x35c27101
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x35c271bd
- (void)invalidate;	// 0x35c27305
- (void)setDelegate:(id)delegate;	// 0x35c27165
@end
