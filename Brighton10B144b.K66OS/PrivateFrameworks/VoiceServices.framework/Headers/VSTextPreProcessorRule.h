...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x35c27c15
- (void)dealloc;	// 0x35c27d4d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x35c27db1
@end
