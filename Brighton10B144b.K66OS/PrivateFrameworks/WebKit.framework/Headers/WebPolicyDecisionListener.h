...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x365fa455
- (void)_invalidate;	// 0x365fa54d
- (void)_usePolicy:(int)policy;	// 0x365fa519
- (void)dealloc;	// 0x365fa4cd
- (void)download;	// 0x365fa5a9
- (void)ignore;	// 0x365fa595
- (void)use;	// 0x365fa581
@end
