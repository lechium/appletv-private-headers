...
@property(retain) ICSDate *completed;	// G=0x3683ffe1; S=0x36840019; 
...
@property(retain) ICSDate *due;	// G=0x3684010d; S=0x36840145; 
...
@property(assign) int percentComplete;	// G=0x36840039; S=0x36840091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x36840255; S=0x36840235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x36840165; S=0x368401bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x3683feed
// declared property getter: - (id)completed;	// 0x3683ffe1
// declared property getter: - (id)due;	// 0x3684010d
- (void)fixComponent;	// 0x3683ef75
// declared property getter: - (int)percentComplete;	// 0x36840039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x36840019
// declared property setter: - (void)setDue:(id)due;	// 0x36840145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x36840091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x36840235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x368401bd
- (BOOL)validate:(id *)validate;	// 0x3683fef9
// declared property getter: - (id)x_apple_activity;	// 0x36840255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x36840165
@end
