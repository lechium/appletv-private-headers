...
- (id)initWithPath:(id)path;	// 0x170479
- (void)_savePrefs;	// 0x1707b1
- (void)clearFeedResources;	// 0x170701
- (void)dealloc;	// 0x1705cd
- (void)setFeedResource:(id)resource named:(id)named;	// 0x170651
@end
