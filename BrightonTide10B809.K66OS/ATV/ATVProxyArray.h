...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x3b4cc1
- (unsigned)count;	// 0x3b5075
- (void)dealloc;	// 0x3b5029
- (unsigned)indexOfObject:(id)object;	// 0x3b5149
- (id)objectAtIndex:(unsigned)index;	// 0x3b50a5
@end
