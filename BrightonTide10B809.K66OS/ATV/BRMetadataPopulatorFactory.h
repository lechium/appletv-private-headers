...
+ (void)setSingleton:(id)singleton;	// 0x36224d
+ (id)singleton;	// 0x36223d
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x36240d
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x362861
- (void)dealloc;	// 0x36225d
- (id)populatorForAsset:(id)asset;	// 0x36239d
@end
