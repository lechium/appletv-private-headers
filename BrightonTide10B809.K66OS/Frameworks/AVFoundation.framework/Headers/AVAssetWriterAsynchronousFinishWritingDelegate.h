...
- (id)initWithHandler:(id)handler;	// 0x30273b71
- (void)_callHandlerIfNotCalled;	// 0x30273e59
- (void)dealloc;	// 0x30273c15
- (void)didReceiveFigAssetWriterNotificationWithSuccess:(BOOL)success error:(id)error;	// 0x30273ca1
- (void)finishWritingHelper:(id)helper didInitiateFinishWritingForFigAssetWriter:(OpaqueFigAssetWriter *)figAssetWriter;	// 0x30273cf5
- (void)finishWritingHelperDidCancelFinishWriting:(id)finishWritingHelper;	// 0x30273e39
- (void)finishWritingHelperDidFail:(id)finishWritingHelper;	// 0x30273e49
- (BOOL)shouldHelperPrepareInputs;	// 0x30273e91
@end
