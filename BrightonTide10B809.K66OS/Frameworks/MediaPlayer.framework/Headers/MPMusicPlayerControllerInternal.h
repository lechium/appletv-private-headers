...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x31d0aff1; S=0x31d0afcd; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x31d0acc5
- (id)_bundleIdentifier;	// 0x31d0b009
- (void)acquireProcessAssertion;	// 0x31d0af55
- (void)dealloc;	// 0x31d0ad05
- (void)didPrepareForRemoteSelectorInvocation;	// 0x31d0ae15
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x31d0aff1
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x31d0ad49
- (void)serverConnectionDied;	// 0x31d0aed5
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x31d0afcd
@end
