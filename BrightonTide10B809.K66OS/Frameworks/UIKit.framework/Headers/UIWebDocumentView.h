...
@property(assign, getter=_acceptsFirstResponder, setter=_setAcceptsFirstResponder:) BOOL _acceptsFirstResponder;	// G=0x32c58f49; S=0x32d4a451; 
...
@property(readonly, assign, nonatomic) UITextPosition *beginningOfDocument;	// G=0x32bde995; 
@property(assign) UIEdgeInsets caretInsets;	// G=0x32dbd9ed; S=0x32b6bec9; converted property
@property(assign, nonatomic) BOOL contentsIsSingleValue;	// @dynamic
@property(assign) unsigned dataDetectorTypes;	// G=0x32b6a251; S=0x32b99d35; converted property
@property(assign, nonatomic) BOOL deferBecomingResponder;
@property(assign) id delegate;	// G=0x32c15539; S=0x32b9b009; converted property
@property(assign) BOOL detectsPhoneNumbers;	// G=0x32d3e405; S=0x32d3e3ad; converted property
@property(assign, nonatomic) BOOL displaySecureTextUsingPlainText;
@property(readonly, assign) CGRect documentBounds;	// G=0x32b9b861; converted property
@property(readonly, assign) int documentType;	// G=0x32b9b84d; converted property
...
@property(readonly, assign, nonatomic) UITextPosition *endOfDocument;	// G=0x32c01a39; 
@property(assign, nonatomic) BOOL forceEnableDictation;
@property(assign, nonatomic) id<UITextInputDelegate> inputDelegate;	// G=0x32bcb6f5; S=0x32bdc8d5; 
...
@property(readonly, assign, nonatomic) UITextInteractionAssistant *interactionAssistant;	// G=0x32c153c5; 
@property(assign) id interactionDelegate;	// G=0x32d4a2d5; S=0x32b9b019; converted property
@property(assign) BOOL isStandaloneEditableView;	// G=0x32d40a09; S=0x32c41599; converted property
...
@property(assign) BOOL loadsSynchronously;	// G=0x32d3e395; S=0x32b69ca9; converted property
@property(retain) id markedText;	// G=0x32c457b9; S=0x32caa6e1; converted property
@property(readonly, assign, nonatomic) UITextRange *markedTextRange;	// G=0x32b6acfd; 
@property(copy, nonatomic) NSDictionary *markedTextStyle;	// G=0x32d4470d; S=0x32d44711; 
@property(assign, nonatomic) BOOL mediaPlaybackAllowsAirPlay;	// G=0x32c30d1d; S=0x32d406a5; 
...
@property(copy) UITextRange *selectedTextRange;	// G=0x32bd38f9; S=0x32c15ac5; 
@property(assign, nonatomic) int selectionAffinity;	// G=0x32bd3985; S=0x32d4496d; 
...
@property(assign, nonatomic) int selectionGranularity;	// G=0x32d44971; S=0x32c01da1; 
@property(retain, nonatomic) UIColor *selectionHighlightColor;	// @dynamic
@property(readonly, assign, nonatomic) int selectionState;	// G=0x32c09189; 
@property(assign, nonatomic) int shortcutConversionType;	// @dynamic
@property(assign, nonatomic) BOOL shouldIgnoreCustomViewport;	// G=0x32d3e7e1; S=0x32c4da6d; 
...
@property(assign, nonatomic) BOOL suppressesIncrementalRendering;	// G=0x32d44cc1; S=0x32c4dd21; @synthesize=_suppressesIncrementalRendering
...
@property(readonly, assign, nonatomic) id<UITextInputTokenizer> tokenizer;	// G=0x32b6acd1; 
@property(retain) id typingAttributes;	// G=0x32d3dce9; S=0x32d3de1d; converted property
@property(readonly, retain) WebThreadSafeUndoManager *undoManager;	// G=0x32bcb741; converted property
...
@property(readonly, retain) WebView *webView;	// G=0x32b69819; converted property
+ (id)_createDefaultHighlightView;	// 0x32c3bc29
+ (id)_sharedHighlightView;	// 0x32c3bbf1
+ (double)getTimestamp;	// 0x32d3d9e9
+ (BOOL)hasLandscapeOrientation;	// 0x32ba081d
+ (void)initialize;	// 0x32b546b9
+ (Class)layerClass;	// 0x32b680e9
+ (id)standardTextViewPreferences;	// 0x32b67801
- (id)initSimpleHTMLDocumentWithStyle:(id)style frame:(CGRect)frame preferences:(id)preferences groupName:(id)name;	// 0x32b67999
- (id)initWithFrame:(CGRect)frame;	// 0x32b98881
- (id)initWithWebView:(id)webView frame:(CGRect)frame;	// 0x32b67af5
- (void)_WAKViewSizeDidChange:(id)_WAKViewSize;	// 0x32c309c1
// declared property getter: - (BOOL)_acceptsFirstResponder;	// 0x32c58f49
...
- (CGRect)_adjustedLayoutRectForFixedPositionObjects;	// 0x32c3c001
- (unsigned)_applyViewportArguments:(id)arguments;	// 0x32b9c7d5
...
- (void)_cancelLongPressGestureRecognizer;	// 0x32c3be49
- (void)_cleanUpFrameStateAndLoad:(id)load;	// 0x32c30175
- (void)_cleanupSheet;	// 0x32c43335
- (void)_clearAllConsoleMessages;	// 0x32d409fd
- (void)_clearDoubleTapRect;	// 0x32b9e261
...
- (BOOL)_dataDetectionIsActivated;	// 0x32b99df1
- (void)_define:(id)define;	// 0x32d432a5
- (BOOL)_dictationPlaceholderHasBeenRemoved;	// 0x32d411e9
- (void)_didMoveFromWindow:(id)window toWindow:(id)window2;	// 0x32b6c141
- (void)_didScroll;	// 0x32c3b829
- (void)_dismissViewControllerAnimated:(BOOL)animated completion:(id)completion;	// 0x32d3dac5
- (float)_documentScale;	// 0x32c31ce5
- (id)_documentUrl;	// 0x32d44985
- (CGRect)_documentViewVisibleRect;	// 0x32b9aca5
...
- (BOOL)_isInspectorSearchingForNode;	// 0x32c32245
- (BOOL)_isSubviewOfPlugInView:(id)view;	// 0x32c56be1
- (CGRect)_lastRectForRange:(id)range;	// 0x32c533e5
- (CGRect)_layoutRectForFixedPositionObjects;	// 0x32b9aa85
...
- (void)_notifyContentHostingLayersOfScaleChange;	// 0x32b68381
- (void)_notifyPlugInViewsOfDidEndZooming;	// 0x32d3f005
- (void)_notifyPlugInViewsOfDidZoom;	// 0x32d3f119
- (void)_notifyPlugInViewsOfScaleChange;	// 0x32b9a921
...
- (void)_reachabilityManagerNotifiedIsReachable:(BOOL)reachable;	// 0x32ba0c19
- (void)_removeAdditionalSubview:(id)subview;	// 0x32d3fc21
- (void)_removeDefinitionController:(BOOL)controller;	// 0x32bd3a61
- (void)_removeShortcutController:(BOOL)controller;	// 0x32d3da41
- (void)_renderUnbufferedInContext:(CGContextRef)context;	// 0x32d40125
- (void)_resetForNewPage;	// 0x32ba00c5
- (void)_resetFormDataForFrame:(id)frame;	// 0x32d409f9
- (void)_resetInteractionWithLocation:(CGPoint)location;	// 0x32c57d81
- (void)_resetShowingTextStyle:(id)style;	// 0x32c6225d
- (void)_reshapePlugInViews;	// 0x32b6c789
- (id)_responderForBecomeFirstResponder;	// 0x32d40b45
- (void)_restoreFlattenedContentLayers;	// 0x32d442e1
- (void)_restoreScrollPointForce:(BOOL)force;	// 0x32ba0371
- (void)_restoreViewportSettingsWithSize:(CGSize)size;	// 0x32b69561
- (void)_runLoadBlock:(id)block;	// 0x32c301f9
- (void)_saveStateToHistoryItem:(id)historyItem;	// 0x32b9f1d1
...
- (void)_selectionLayoutChangedByScrolling:(BOOL)scrolling;	// 0x32c12d4d
...
- (void)_setDocumentScale:(float)scale;	// 0x32b9a5c1
- (void)_setDocumentType:(int)type;	// 0x32b99e2d
- (void)_setDocumentType:(int)type overrideCustomConfigurations:(BOOL)configurations viewportArguments:(id)arguments;	// 0x32b99e4d
- (void)_setFont:(id)font;	// 0x32d3db21
- (void)_setParentTextView:(id)view;	// 0x32b69ec9
- (void)_setSubviewCachesNeedUpdate:(BOOL)update;	// 0x32c31ccd
...
- (BOOL)_shouldResetForNewPage;	// 0x32ba0085
- (BOOL)_shouldUpdateSubviewCachesForPlugins;	// 0x32b69ad1
...
- (void)_showPendingContentLayers;	// 0x32ba0711
- (void)_showTextStyleOptions:(id)options;	// 0x32d43041
- (void)_singleTapRecognized:(id)recognized;	// 0x32c57cd1
- (id)_supportedPasteboardTypesForCurrentSelection;	// 0x32bfa8bd
- (id)_targetURL;	// 0x32d49ec1
- (id)_textSelectingContainer;	// 0x32c15de9
...
- (void)_updateFixedPositionContent;	// 0x32c3bf85
- (void)_updateFixedPositionedObjectsLayoutRectUsingWebThread:(BOOL)thread synchronize:(BOOL)synchronize;	// 0x32d3f26d
- (void)_updateFixedPositioningObjectsLayoutAfterScroll;	// 0x32ba06bd
- (void)_updateFixedPositioningObjectsLayoutAfterVisibleGeometryChange;	// 0x32b9aa6d
- (void)_updateScrollViewBoundaryZoomScales;	// 0x32b69fb5
- (void)_updateSize;	// 0x32b9e4c1
- (void)_updateSubviewCaches;	// 0x32c31cf5
- (void)_webthread_webView:(id)view attachRootLayer:(id)layer;	// 0x32c315ed
- (float)_zoomedDocumentScale;	// 0x32b9dfb5
...
- (id)approximateNodeAtViewportLocation:(CGPoint *)viewportLocation;	// 0x32c589f9
- (id)asText;	// 0x32dbed9d
- (void)assistFormNode:(id)node;	// 0x32d409e5
- (void)attemptClick:(id)click;	// 0x32c58aad
- (id)automaticallySelectedOverlay;	// 0x32c5696d
...
- (BOOL)becomeFirstResponder;	// 0x32c58dc5
...
- (void)beginSelectionChange;	// 0x32bd2875
// declared property getter: - (id)beginningOfDocument;	// 0x32bde995
- (BOOL)canBecomeFirstResponder;	// 0x32c58f31
- (BOOL)canPerformAction:(SEL)action withSender:(id)sender;	// 0x32bf9c85
- (BOOL)canResignFirstResponder;	// 0x32d40b11
- (void)cancelAutoscroll;	// 0x32dbeb0d
- (void)cancelInteraction;	// 0x32c57e01
- (void)cancelInteractionWithImmediateDisplay:(BOOL)immediateDisplay;	// 0x32c3ba01
...
- (CGRect)caretRect;	// 0x32c17029
- (CGRect)caretRectForPosition:(id)position;	// 0x32bd520d
- (CGRect)caretRectForVisiblePosition:(id)visiblePosition;	// 0x32bd54b9
- (unsigned short)characterAfterCaretSelection;	// 0x32c091ed
- (unsigned short)characterBeforeCaretSelection;	// 0x32c091bd
...
- (id)checkSpellingOfString:(id)string;	// 0x32c4fd25
- (void)clearInteractionTimer;	// 0x32c3bbb1
- (void)clearRangedSelectionInitialExtent;	// 0x32dbdb2d
- (void)clearSelection;	// 0x32dbd769
- (BOOL)clearWKFirstResponder;	// 0x32c503d9
- (CGRect)closestCaretRectInMarkedTextRangeForPoint:(CGPoint)point;	// 0x32dbd809
- (id)closestPositionToPoint:(CGPoint)point;	// 0x32c0132d
- (id)closestPositionToPoint:(CGPoint)point withinRange:(id)range;	// 0x32d44719
- (void)collapseSelection;	// 0x32dbd999
- (int)comparePosition:(id)position toPosition:(id)position2;	// 0x32c016dd
- (void)completeInteraction;	// 0x32c433c5
...
- (CGPoint)convertPointToSelectedFrameCoordinates:(CGPoint)selectedFrameCoordinates;	// 0x32c0140d
- (CGRect)convertRect:(CGRect)rect fromFrame:(id)frame;	// 0x32d3e709
- (CGRect)convertRect:(CGRect)rect toFrame:(id)frame;	// 0x32d3e6ad
- (CGRect)convertRectFromSelectedFrameCoordinates:(CGRect)selectedFrameCoordinates;	// 0x32bd55b5
...
// converted property getter: - (unsigned)dataDetectorTypes;	// 0x32b6a251
- (void)dealloc;	// 0x32c42e1d
...
// converted property getter: - (id)delegate;	// 0x32c15539
...
- (void)didMoveToSuperview;	// 0x32b69fa1
- (void)didRemovePlugInView:(id)view;	// 0x32c323f5
- (void)didRotateInteractionSheet;	// 0x32d40611
- (void)didZoom;	// 0x32d43bfd
- (void)disableClearsOnInsertion;	// 0x32c4f3e9
// converted property getter: - (CGRect)documentBounds;	// 0x32b9b861
// converted property getter: - (int)documentType;	// 0x32b9b84d
...
- (unsigned)effectiveDataDetectorTypes;	// 0x32c4deb1
- (void)enableReachability;	// 0x32b98fd5
- (id)enclosingScrollView;	// 0x32d449e9
// declared property getter: - (id)endOfDocument;	// 0x32c01a39
- (void)endPrintMode;	// 0x32d4c55d
- (void)endSelectionChange;	// 0x32bd3e65
- (void)ensureSelection;	// 0x32c4e6cd
...
- (CGRect)firstRectForRange:(id)range;	// 0x32c52dcd
- (id)fontForCaretSelection;	// 0x32c5444d
- (void)forceLayout;	// 0x32d3ed41
- (id)formElement;	// 0x32c01479
- (void)forwardInvocation:(id)invocation;	// 0x32b996d1
...
- (BOOL)gestureRecognizer:(id)recognizer canBePreventedByGestureRecognizer:(id)recognizer2;	// 0x32c57b29
- (BOOL)gestureRecognizer:(id)recognizer canPreventGestureRecognizer:(id)recognizer2;	// 0x32c579e9
- (BOOL)gestureRecognizer:(id)recognizer shouldReceiveTouch:(id)touch;	// 0x32c56b79
- (BOOL)gestureRecognizer:(id)recognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)gestureRecognizer;	// 0x32c57a5d
- (BOOL)gestureRecognizerShouldBegin:(id)gestureRecognizer;	// 0x32c576bd
- (int)getPasteboardChangeCount;	// 0x32d3f8dd
- (int)getPasteboardItemsCount;	// 0x32d3f57d
- (void)handleKeyWebEvent:(id)event;	// 0x32d42aa1
- (BOOL)hasContent;	// 0x32b6c3c9
- (BOOL)hasDrawnTiles;	// 0x32b9c555
- (BOOL)hasEditableSelection;	// 0x32bfa461
- (BOOL)hasMarkedText;	// 0x32dbd7bd
- (BOOL)hasPlugInSubviews;	// 0x32d42c75
- (BOOL)hasRangedSelection;	// 0x32d411c9
- (BOOL)hasRichlyEditableSelection;	// 0x32c09049
- (BOOL)hasSelection;	// 0x32b69939
- (BOOL)hasSimpleTextOnlyStructure;	// 0x32d4439d
- (BOOL)hasText;	// 0x32c46991
- (void)hideTapHighlight;	// 0x32d49c35
- (void)highlightApproximateNodeAndDisplayInfoSheet;	// 0x32d49c79
- (void)highlightApproximateNodeInverted:(BOOL)inverted;	// 0x32c57e1d
...
- (float)initialScale;	// 0x32b9a3f9
// declared property getter: - (id)inputDelegate;	// 0x32bcb6f5
...
- (void)insertText:(id)text;	// 0x32c450f5
- (void)installGestureRecognizers;	// 0x32b684f1
- (float)integralScaleForScale:(float)scale;	// 0x32b9a85d
- (float)integralScaleForScale:(float)scale keepingPointFixed:(CGPoint *)fixed;	// 0x32b9a875
// declared property getter: - (id)interactionAssistant;	// 0x32c153c5
...
- (BOOL)isPosition:(id)position atBoundary:(int)boundary inDirection:(int)direction;	// 0x32c0199d
- (BOOL)isPosition:(id)position withinTextUnit:(int)unit inDirection:(int)direction;	// 0x32c019d5
- (BOOL)isShowingFullScreenPlugInUI;	// 0x32ba1611
...
- (BOOL)keyboardInput:(id)input shouldInsertText:(id)text isMarkedText:(BOOL)text3;	// 0x32c4e989
- (BOOL)keyboardInput:(id)input shouldReplaceTextInRange:(NSRange)range replacementText:(id)text;	// 0x32caa381
- (BOOL)keyboardInputChanged:(id)changed;	// 0x32c198c5
- (void)keyboardInputChangedSelection:(id)selection;	// 0x32c15459
- (BOOL)keyboardInputShouldDelete:(id)keyboardInput;	// 0x32d429fd
- (void)layoutSubviews;	// 0x32b6c47d
- (void)loadData:(id)data MIMEType:(id)type textEncodingName:(id)name baseURL:(id)url;	// 0x32d3e261
- (void)loadHTMLString:(id)string baseURL:(id)url;	// 0x32c4ce15
- (void)loadRequest:(id)request;	// 0x32c3011d
...
- (BOOL)makeWKFirstResponder;	// 0x32c1566d
// converted property getter: - (id)markedText;	// 0x32c457b9
// declared property getter: - (id)markedTextRange;	// 0x32b6acfd
...
// declared property getter: - (BOOL)mediaPlaybackAllowsAirPlay;	// 0x32c30d1d
- (id)metadataDictionariesForDictationResults;	// 0x32c136d5
- (id)methodSignatureForSelector:(SEL)selector;	// 0x32b99681
- (float)minimumScale;	// 0x32b9a335
...
- (int)offsetFromPosition:(id)position toPosition:(id)position2;	// 0x32c197c1
...
- (BOOL)playsNicelyWithGestures;	// 0x32c4d029
...
- (id)positionFromPosition:(id)position offset:(int)offset;	// 0x32c16095
- (id)positionFromPosition:(id)position toBoundary:(int)boundary inDirection:(int)direction;	// 0x32bde939
...
- (id)rangeEnclosingPosition:(id)position withGranularity:(int)granularity inDirection:(int)direction;	// 0x32bde76d
...
- (BOOL)requiresKeyEvents;	// 0x32beb7c5
- (void)resetInteraction;	// 0x32c3bb79
- (void)resetTilingAfterLoadComplete;	// 0x32b9ef95
- (BOOL)resignFirstResponder;	// 0x32bcbe01
- (void)revealedSelectionByScrollingWebFrame:(id)frame;	// 0x32bd3e2d
- (void)saveStateToCurrentHistoryItem;	// 0x32b9f17d
- (id)scriptingInfoWithChildren;	// 0x32c2efb1
- (void)scrollSelectionToVisible:(BOOL)visible;	// 0x32dbeb2d
- (void)scrollViewWasRemoved;	// 0x32c3eedd
- (void)select:(id)select;	// 0x32d436e9
- (void)selectAll;	// 0x32d426b9
- (void)selectAll:(id)all;	// 0x32d43735
- (void)selectWord;	// 0x32dbd715
- (id)selectedDOMRange;	// 0x32bd3951
// declared property getter: - (id)selectedTextRange;	// 0x32bd38f9
// declared property getter: - (int)selectionAffinity;	// 0x32bd3985
- (BOOL)selectionAtDocumentStart;	// 0x32d42581
- (BOOL)selectionAtWordStart;	// 0x32d425b1
- (int)selectionBaseWritingDirection;	// 0x32c142b1
- (void)selectionChanged;	// 0x32bd2bfd
- (void)selectionChanged:(id)changed;	// 0x32bd2afd
...
- (id)selectionRectsForDOMRange:(id)domrange;	// 0x32c02451
- (id)selectionRectsForRange:(id)range;	// 0x32ca61e9
// declared property getter: - (int)selectionState;	// 0x32c09189
- (id)selectionView;	// 0x32d42ccd
- (void)sendOrientationEventForOrientation:(int)orientation;	// 0x32c30a65
- (void)sendScrollEventIfNecessary;	// 0x32d3e81d
- (void)sendScrollEventIfNecessaryWasUserScroll:(BOOL)scroll;	// 0x32c3c0e1
- (void)sendScrollWheelEvents;	// 0x32d4a06d
- (void)setAllowsDataDetectorsSheet:(BOOL)sheet;	// 0x32c909f9
- (void)setAllowsImageSheet:(BOOL)sheet;	// 0x32b9b0c9
- (void)setAllowsLinkSheet:(BOOL)sheet;	// 0x32d4a2e9
- (void)setAllowsUserScaling:(BOOL)scaling forDocumentTypes:(int)documentTypes;	// 0x32b69799
- (void)setAutoresizes:(BOOL)autoresizes;	// 0x32b99e15
...
- (void)setBaseWritingDirection:(int)direction forRange:(id)range;	// 0x32c16119
...
// converted property setter: - (void)setCaretInsets:(UIEdgeInsets)insets;	// 0x32b6bec9
- (void)setContinuousSpellCheckingEnabled:(BOOL)enabled;	// 0x32bdd699
// converted property setter: - (void)setDataDetectorTypes:(unsigned)types;	// 0x32b99d35
// converted property setter: - (void)setDelegate:(id)delegate;	// 0x32b9b009
...
- (void)setDrawsBackground:(BOOL)background;	// 0x32b69f1d
- (void)setFrame:(CGRect)frame;	// 0x32b68149
- (void)setIgnoresFocusingMouse:(BOOL)mouse;	// 0x32b69c11
- (void)setIgnoresKeyEvents:(BOOL)events;	// 0x32c4da51
- (void)setIgnoresViewportOverflowWhenAutoresizing:(BOOL)autoresizing;	// 0x32d3eb7d
- (void)setInitialScale:(float)scale forDocumentTypes:(int)documentTypes;	// 0x32b696e5
// declared property setter: - (void)setInputDelegate:(id)delegate;	// 0x32bdc8d5
- (void)setInteractionAssistantGestureRecognizers;	// 0x32d40b75
// converted property setter: - (void)setInteractionDelegate:(id)delegate;	// 0x32b9b019
// converted property setter: - (void)setIsStandaloneEditableView:(BOOL)view;	// 0x32c41599
// converted property setter: - (void)setIsWidgetEditingView:(BOOL)view;	// 0x32d40a6d
// converted property setter: - (void)setLoadsSynchronously:(BOOL)synchronously;	// 0x32b69ca9
...
- (void)setMaximumScale:(float)scale forDocumentTypes:(int)documentTypes;	// 0x32b6975d
// declared property setter: - (void)setMediaPlaybackAllowsAirPlay:(BOOL)play;	// 0x32d406a5
- (void)setMinimumScale:(float)scale forDocumentTypes:(int)documentTypes;	// 0x32b69721
- (void)setMinimumSize:(CGSize)size;	// 0x32b6953d
- (void)setMinimumSize:(CGSize)size updateCurrentViewportConfigurationSize:(BOOL)size2;	// 0x32d3eb99
- (void)setOpaque:(BOOL)opaque;	// 0x32b69ed9
- (void)setPaused:(BOOL)paused;	// 0x32d42add
- (void)setPaused:(BOOL)paused withEvents:(BOOL)events;	// 0x32ba1629
...
- (void)setSelectedDOMRange:(id)range affinityDownstream:(BOOL)downstream;	// 0x32c15b91
// declared property setter: - (void)setSelectedTextRange:(id)range;	// 0x32c15ac5
...
// declared property setter: - (void)setSelectionGranularity:(int)granularity;	// 0x32c01da1
...
// declared property setter: - (void)setShouldIgnoreCustomViewport:(BOOL)ignoreCustomViewport;	// 0x32c4da6d
...
- (void)setSmoothsFonts:(BOOL)fonts;	// 0x32b9b031
// converted property setter: - (void)setStandaloneEditingElement:(id)element;	// 0x32d40a1d
// declared property setter: - (void)setSuppressesIncrementalRendering:(BOOL)rendering;	// 0x32c4dd21
// converted property setter: - (void)setText:(id)text;	// 0x32d4270d
- (void)setTileUpdatesDisabled:(BOOL)disabled;	// 0x32b9c5d5
- (void)setTilingArea:(int)area;	// 0x32b9b341
...
- (void)setViewportSize:(CGSize)size forDocumentTypes:(int)documentTypes;	// 0x32b697d1
...
- (void)stopLoading:(id)loading;	// 0x32c4dcc1
- (id)subviews;	// 0x32b69a01
- (id)superviewForSheet;	// 0x32d4a331
- (id)supportedPasteboardTypesForCurrentSelection;	// 0x32bfa885
...
- (id)textInRange:(id)range;	// 0x32bdeaf5
- (id)textInputTraits;	// 0x32b69069
- (id)textRangeFromPosition:(id)position toPosition:(id)position2;	// 0x32bdea51
...
// declared property getter: - (id)tokenizer;	// 0x32b6acd1
// converted property getter: - (id)typingAttributes;	// 0x32d3dce9
// converted property getter: - (id)undoManager;	// 0x32bcb741
- (id)undoManagerForWebView:(id)webView;	// 0x32bcb765
- (void)unmarkText;	// 0x32c45901
...
- (void)useSelectionAssistantWithMode:(int)mode;	// 0x32b99175
- (void)validateInteractionWithLocation:(CGPoint)location;	// 0x32d48de9
- (void)viewportConfigurationsDidChange:(unsigned)viewportConfigurations;	// 0x32b99fc1
- (float)viewportHeight;	// 0x32b9af11
- (float)viewportWidth;	// 0x32b9a4cd
...
- (void)webThreadWebViewDidLayout:(id)webThreadWebView byScrolling:(BOOL)scrolling;	// 0x32b69885
// converted property getter: - (id)webView;	// 0x32b69819
- (void)webView:(id)view didChangeLocationWithinPageForFrame:(id)frame;	// 0x32d3eb29
- (void)webView:(id)view didCommitLoadForFrame:(id)frame;	// 0x32b9ce79
...
- (void)webView:(id)view didFinishLoadForFrame:(id)frame;	// 0x32b9ec3d
- (void)webView:(id)view didFirstVisuallyNonEmptyLayoutInFrame:(id)frame;	// 0x32b6982d
...
- (void)webView:(id)view didReceiveDocTypeForFrame:(id)frame;	// 0x32c308a9
- (void)webView:(id)view didReceiveViewportArguments:(id)arguments forFrame:(id)frame;	// 0x32b9c779
- (void)webView:(id)view needsScrollNotifications:(id)notifications forFrame:(id)frame;	// 0x32c3c191
- (id)webView:(id)view plugInViewWithArguments:(id)arguments fromPlugInPackage:(id)package;	// 0x32c30ad1
- (void)webView:(id)view restoreStateFromHistoryItem:(id)historyItem forFrame:(id)frame force:(BOOL)force;	// 0x32b9e009
...
- (void)webView:(id)view saveStateToHistoryItem:(id)historyItem forFrame:(id)frame;	// 0x32c30635
- (BOOL)webView:(id)view shouldScrollToPoint:(CGPoint)point forFrame:(id)frame;	// 0x32bd3ae1
- (void)webView:(id)view willAddPlugInView:(id)view2;	// 0x32c3144d
...
- (void)webViewDidCommitCompositingLayerChanges:(id)webView;	// 0x32b6c561
- (void)webViewDidDrawTiles:(id)webView;	// 0x32b6c861
...
- (CGRect)webViewFrameForUIFrame:(CGRect)uiframe;	// 0x32b67a71
- (id)webVisiblePositionForPoint:(CGPoint)point;	// 0x32c01379
- (BOOL)willInteractWithLocation:(CGPoint)location;	// 0x32d48f25
- (void)willMoveToSuperview:(id)superview;	// 0x32b69f81
