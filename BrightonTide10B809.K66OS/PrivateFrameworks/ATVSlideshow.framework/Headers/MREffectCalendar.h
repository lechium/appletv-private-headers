...
- (id)init;	// 0x332d3d55
- (void)_loadForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x332d4869
- (void)_unload;	// 0x332d4a8d
- (BOOL)isLoadedForTime:(double)time;	// 0x332d448d
- (BOOL)prerenderForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x332d4511
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x332d4559
- (void)setAttributes:(id)attributes;	// 0x332d3d81
@end
