...
+ (void)_addCategoryMethod:(objc_method *)method toClass:(Class)aClass isClass:(BOOL)aClass3;	// 0x333829ad
+ (void)initialize;	// 0x333827e1
+ (void)installCategoryOnClassNamed:(id)named;	// 0x3338282d
@end
