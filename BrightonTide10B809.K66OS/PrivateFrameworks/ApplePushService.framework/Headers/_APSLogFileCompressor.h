...
+ (id)sharedInstance;	// 0x33496351
- (id)init;	// 0x334963fd
- (void)compressPath:(id)path toPath:(id)path2;	// 0x334964ad
- (void)dealloc;	// 0x33496461
- (void)fileCopierDidFinish:(id)fileCopier;	// 0x33496591
- (void)fileCopierDidStart:(id)fileCopier;	// 0x3349658d
@end
