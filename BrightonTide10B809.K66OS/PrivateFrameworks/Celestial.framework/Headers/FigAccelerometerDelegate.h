...
- (id)init;	// 0x335f5bc1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x335f5d55
- (void)dealloc;	// 0x335f5cc9
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x335f5ba1
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x335f5e01
@end
