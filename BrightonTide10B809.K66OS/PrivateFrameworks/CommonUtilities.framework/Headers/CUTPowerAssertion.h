...
- (id)initWithIdentifier:(id)identifier;	// 0x336bc5f9
- (id)initWithIdentifier:(id)identifier timeout:(double)timeout;	// 0x336bc3a1
- (void)dealloc;	// 0x336bc629
- (id)description;	// 0x336bc781
@end
