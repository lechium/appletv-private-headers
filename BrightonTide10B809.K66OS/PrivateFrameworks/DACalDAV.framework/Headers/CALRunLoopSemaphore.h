...
- (id)init;	// 0x339a365d
- (id)initWithCFRunLoop:(CFRunLoopRef)cfrunLoop;	// 0x339a3681
- (void)awake;	// 0x339a3659
- (void)dealloc;	// 0x339a37a9
- (void)down;	// 0x339a38f1
- (void)finalize;	// 0x339a385d
- (void)up;	// 0x339a39a1
- (int)value;	// 0x339a3a0d
@end
