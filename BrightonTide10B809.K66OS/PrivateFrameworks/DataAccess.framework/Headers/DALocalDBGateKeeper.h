...
+ (id)sharedGateKeeper;	// 0x3396f385
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x3396f641
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x3396f449
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x3396f3cd
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x3396f541
- (id)stateString;	// 0x3396f5bd
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x3396f4c5
@end
