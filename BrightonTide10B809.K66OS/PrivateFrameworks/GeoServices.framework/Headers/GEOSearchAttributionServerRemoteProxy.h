...
- (id)_manifest;	// 0x34016f0d
- (void)dealloc;	// 0x34016ec1
- (void)loadAttributionInfoForIdentifier:(id)identifier version:(unsigned)version completionHandler:(id)handler errorHandler:(id)handler4;	// 0x34016f85
@end
