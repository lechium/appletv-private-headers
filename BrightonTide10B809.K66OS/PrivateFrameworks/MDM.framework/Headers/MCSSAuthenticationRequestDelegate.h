...
+ (id)instanceWithAuthenticationContext:(id)authenticationContext;	// 0x344951c1
- (void).cxx_destruct;	// 0x3449553d
- (void)authenticateRequest:(id)request didReceiveResponse:(id)response;	// 0x3449544d
- (void)startWithCompletionBlock:(id)completionBlock;	// 0x34495241
@end
