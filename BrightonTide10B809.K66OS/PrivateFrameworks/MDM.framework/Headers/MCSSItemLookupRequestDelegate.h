...
+ (id)instance;	// 0x34494f21
- (void).cxx_destruct;	// 0x344951a9
- (void)itemLookupRequest:(id)request didFindItems:(id)items;	// 0x34495101
- (void)startCompletionBlock:(id)block;	// 0x34494f89
@end
