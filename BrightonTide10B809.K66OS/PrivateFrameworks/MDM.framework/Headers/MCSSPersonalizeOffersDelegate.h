...
+ (id)instanceWithItems:(id)items;	// 0x34495861
- (void).cxx_destruct;	// 0x34495ae5
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x34495a51
- (void)startCompletionBlock:(id)block;	// 0x344958d9
@end
