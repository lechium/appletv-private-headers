...
@property(retain, nonatomic) NSArray *searchProperties;	// G=0x34714b19; S=0x34714b29; @synthesize=_searchProperties
- (id)initWithLibrary:(id)library;	// 0x346b2f4d
- (id).cxx_construct;	// 0x346b2b05
- (void).cxx_destruct;	// 0x34714b39
- (void)appendSQLToMutableString:(id)mutableString entityClass:(Class)aClass;	// 0x346b3531
- (void)dealloc;	// 0x34714a89
// declared property getter: - (id)searchProperties;	// 0x34714b19
// declared property setter: - (void)setSearchProperties:(id)properties;	// 0x34714b29
@end
