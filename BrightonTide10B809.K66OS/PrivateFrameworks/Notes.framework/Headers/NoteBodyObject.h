...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x347ee915; 
...
- (BOOL)containsAttachments;	// 0x347eea71
// declared property getter: - (id)contentAsPlainText;	// 0x347ee915
- (id)contentAsPlainTextPreservingNewlines;	// 0x347ee9bd
@end
