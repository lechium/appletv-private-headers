...
+ (id)autoStylingWithChart:(id)chart;	// 0x3496be0d
- (id)initWithChart:(id)chart;	// 0x3496bea5
- (void)dealloc;	// 0x3497aab5
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x349afa11
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x349aa8a1
@end
