...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x3490ecd9
- (void)dealloc;	// 0x3491275d
- (bool)loadDelayedNode:(id)node;	// 0x3490f239
@end
