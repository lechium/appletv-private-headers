...
- (id)init;	// 0x34ada5e5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x34ada661
- (void)dealloc;	// 0x34ada9a5
- (XXStruct_M$PztB)getFormatStruct;	// 0x34ada6d9
- (BOOL)isEqual:(id)equal;	// 0x34ada715
@end
