...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x35467391
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x35466e09
- (void)_didFailToLaunch;	// 0x354671bd
- (void)_didLaunch;	// 0x354670d5
- (void)dealloc;	// 0x35467075
- (void)invalidate;	// 0x354672ad
@end
