...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x3558b521; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x3558b531; converted property
- (id)initWithMemory:(id)memory;	// 0x3558b321
// converted property getter: - (unsigned)indirectsymoff;	// 0x3558b521
- (BOOL)isDySymTab;	// 0x3558b51d
// converted property getter: - (unsigned)nindirectsyms;	// 0x3558b531
@end
