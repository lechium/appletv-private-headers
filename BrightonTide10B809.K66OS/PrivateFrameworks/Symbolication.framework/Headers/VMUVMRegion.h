...
@property(readonly, assign) VMURange range;	// G=0x355b0c4d; converted property
@property(readonly, retain) NSString *type;	// G=0x355b0c81; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x355b0de5
- (void)dealloc;	// 0x355b0f91
- (id)description;	// 0x355b0c39
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x355b0421
- (BOOL)isEqual:(id)equal;	// 0x355b0ca1
- (BOOL)isSubmap;	// 0x355b0c91
- (unsigned)protection;	// 0x355b0c71
// converted property getter: - (VMURange)range;	// 0x355b0c4d
// converted property getter: - (id)type;	// 0x355b0c81
@end
