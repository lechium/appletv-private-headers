...
- (id)init;	// 0x35b353a9
- (void)dealloc;	// 0x35b35489
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x35b35859
- (void)processGyroData:(id)data withError:(id)error;	// 0x35b35529
- (void)start;	// 0x35b35769
- (void)stop;	// 0x35b35835
@end
