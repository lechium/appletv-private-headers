...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x35c29c15
- (void)dealloc;	// 0x35c29d4d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x35c29db1
@end
