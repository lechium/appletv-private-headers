...
@property(retain) ICSDate *completed;	// G=0x36841fe1; S=0x36842019; 
...
@property(retain) ICSDate *due;	// G=0x3684210d; S=0x36842145; 
...
@property(assign) int percentComplete;	// G=0x36842039; S=0x36842091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x36842255; S=0x36842235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x36842165; S=0x368421bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x36841eed
// declared property getter: - (id)completed;	// 0x36841fe1
// declared property getter: - (id)due;	// 0x3684210d
- (void)fixComponent;	// 0x36840f75
// declared property getter: - (int)percentComplete;	// 0x36842039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x36842019
// declared property setter: - (void)setDue:(id)due;	// 0x36842145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x36842091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x36842235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x368421bd
- (BOOL)validate:(id *)validate;	// 0x36841ef9
// declared property getter: - (id)x_apple_activity;	// 0x36842255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x36842165
@end
