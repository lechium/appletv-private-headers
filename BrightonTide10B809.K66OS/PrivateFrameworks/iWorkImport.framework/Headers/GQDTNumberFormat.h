...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x368c413d
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x368c4221
+ (const StateSpec *)stateForReading;	// 0x368c3341
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x368c4649
- (id)baseStringFromDouble:(double)aDouble;	// 0x368c4c21
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x368c4051
- (id)currencyCode;	// 0x368c521d
- (id)customNumberFormatTokens;	// 0x368c5241
- (void)dealloc;	// 0x368c334d
- (id)formatString;	// 0x368c520d
- (int)fractionAccuracy;	// 0x368c5e99
- (id)fractionStringFromDouble:(double)aDouble;	// 0x368c4a79
- (BOOL)hasValidDecimalPlaces;	// 0x368c3411
- (BOOL)isCustom;	// 0x368c5e79
- (BOOL)isTextFormat;	// 0x368c5e89
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x368c4eed
- (id)numberFormatBySettingValueType:(int)type;	// 0x368c50b9
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x368c42b9
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x368c4edd
- (BOOL)showThousandsSeparator;	// 0x368c522d
- (id)stringFromDouble:(double)aDouble;	// 0x368c3439
- (BOOL)useAccountingStyle;	// 0x368c4119
- (int)valueType;	// 0x368c4109
@end
