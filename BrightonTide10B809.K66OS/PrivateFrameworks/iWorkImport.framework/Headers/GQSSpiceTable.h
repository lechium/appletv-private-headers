...
- (id)init;	// 0x368f3101
- (void)aboutToReadCells;	// 0x368f3245
- (void)aboutToReadColumnVectors;	// 0x368f3231
- (void)aboutToReadRowVectors;	// 0x368f321d
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x368f32d5
- (void)dealloc;	// 0x368f3199
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x368f330d
@end
