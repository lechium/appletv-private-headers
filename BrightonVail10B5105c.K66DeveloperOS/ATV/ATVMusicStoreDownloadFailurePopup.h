...
+ (void)_postDialog:(id)dialog;	// 0x1f3525
+ (void)_postDialogWhenReady:(id)ready;	// 0x1f3475
+ (void)postDownloadFailurePopup:(id)popup;	// 0x1f3359
- (id)_initWithAsset:(id)asset;	// 0x1f357d
- (BOOL)brEventAction:(id)action;	// 0x1f3c5d
- (void)layoutSubcontrols;	// 0x1f3c91
- (CGSize)sizeThatFits:(CGSize)fits;	// 0x1f3b31
@end
