...
- (id)initWithPath:(id)path;	// 0x167a6d
- (void)_savePrefs;	// 0x167da5
- (void)clearFeedResources;	// 0x167cf5
- (void)dealloc;	// 0x167bc1
- (void)setFeedResource:(id)resource named:(id)named;	// 0x167c45
@end
