...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x3a4c89
- (unsigned)count;	// 0x3a503d
- (void)dealloc;	// 0x3a4ff1
- (unsigned)indexOfObject:(id)object;	// 0x3a5111
- (id)objectAtIndex:(unsigned)index;	// 0x3a506d
@end
