...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x215415; S=0x215425; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x214a3d
- (void).cxx_destruct;	// 0x215435
- (void)_readCurrentConfiguration;	// 0x2154f1
- (void)_saveConfiguration;	// 0x215651
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x214b2d
- (void)entryComplete:(id)complete;	// 0x214e85
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x215425
// declared property getter: - (BOOL)showOnlyDNS;	// 0x215415
@end
