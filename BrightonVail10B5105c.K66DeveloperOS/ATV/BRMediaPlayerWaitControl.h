...
- (id)initWithAsset:(id)asset;	// 0x2b9381
- (void)_addFadeAnimationToControl:(id)control;	// 0x2ba4b9
- (void)dealloc;	// 0x2b9871
- (void)layoutSubcontrols;	// 0x2b9f8d
- (void)setAuthorizing;	// 0x2b9ecd
- (void)setBandwidthHintForPreview:(BOOL)preview;	// 0x2b9989
- (void)setReadyForPlayInNMins:(int)nmins;	// 0x2b9b89
- (void)setReadyToPlay;	// 0x2b9e25
@end
