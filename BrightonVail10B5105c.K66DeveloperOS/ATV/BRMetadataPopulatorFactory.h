...
+ (void)setSingleton:(id)singleton;	// 0x3539c1
+ (id)singleton;	// 0x3539b1
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x353b81
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x353fd5
- (void)dealloc;	// 0x3539d1
- (id)populatorForAsset:(id)asset;	// 0x353b11
@end
