...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(XXStruct_qlg9jA)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x336031
- (void)dealloc;	// 0x3360bd
- (void)drawRect:(CGRect)rect;	// 0x336101
@end
