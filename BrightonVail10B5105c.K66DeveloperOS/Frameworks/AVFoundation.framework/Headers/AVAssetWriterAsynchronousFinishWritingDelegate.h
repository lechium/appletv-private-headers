...
- (id)initWithHandler:(id)handler;	// 0x302e02c5
- (void)_callHandlerIfNotCalled;	// 0x302e05ad
- (void)dealloc;	// 0x302e0369
- (void)didReceiveFigAssetWriterNotificationWithSuccess:(BOOL)success error:(id)error;	// 0x302e03f5
- (void)finishWritingHelper:(id)helper didInitiateFinishWritingForFigAssetWriter:(OpaqueFigAssetWriter *)figAssetWriter;	// 0x302e0449
- (void)finishWritingHelperDidCancelFinishWriting:(id)finishWritingHelper;	// 0x302e058d
- (void)finishWritingHelperDidFail:(id)finishWritingHelper;	// 0x302e059d
- (BOOL)shouldHelperPrepareInputs;	// 0x302e05e5
@end
