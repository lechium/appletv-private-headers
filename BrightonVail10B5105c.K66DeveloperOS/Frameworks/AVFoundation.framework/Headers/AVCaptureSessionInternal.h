...
@class AVCaptureVideoPreviewLayer, AVWeakReference, AVRunLoopCondition, AVCaptureFigAudioDevice, NSMutableDictionary, AVCaptureFigVideoDevice, NSString, NSError, NSMutableArray;
