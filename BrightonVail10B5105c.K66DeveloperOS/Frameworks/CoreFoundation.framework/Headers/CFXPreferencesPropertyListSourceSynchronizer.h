...
- (id)initWithPropertyListSource:(id)propertyListSource forLockedSynchronize:(BOOL)lockedSynchronize;	// 0x356a2fed
- (unsigned char)_backingPlistChangedSinceLastSync;	// 0x356a33f1
- (void *)createPlistFromDisk;	// 0x356ae595
- (void)dealloc;	// 0x356a3ef9
- (void)finalize;	// 0x3572c761
- (void)setValue:(void *)value forKey:(CFStringRef)key;	// 0x3572c6ed
- (unsigned char)synchronize;	// 0x356a31bd
- (unsigned char)synchronizeAlreadyFlocked;	// 0x356a31d5
- (unsigned char)writePlistToDisk;	// 0x356a3fad
@end
