...
@property(readonly, assign, nonatomic) MIDINetworkHost *host;	// G=0x341c184d; 
+ (id)connectionWithHost:(id)host;	// 0x341c16f5
- (id)init;	// 0x341c16a9
- (void)dealloc;	// 0x341c1761
// declared property getter: - (id)host;	// 0x341c184d
@end
