...
- (id)init;	// 0x3042f611
- (void)_notificationHandler:(id)handler;	// 0x3042ffe9
- (void)dealloc;	// 0x3042f801
- (void)notificationCallback;	// 0x3042f9d5
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x3042f759
@end
