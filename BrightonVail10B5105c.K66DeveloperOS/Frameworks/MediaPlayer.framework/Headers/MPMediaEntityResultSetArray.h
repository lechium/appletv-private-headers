...
@property(readonly, retain) MPMediaQuerySectionInfo *sectionInfo;	// G=0x3500adf5; converted property
- (id)initWithResultSet:(id)resultSet queryCriteria:(id)criteria entityType:(int)type library:(id)library;	// 0x3500a2f5
- (id)copyWithZone:(NSZone *)zone;	// 0x3500a705
- (unsigned)count;	// 0x3500a715
- (void)dealloc;	// 0x3500a5ed
- (id)objectAtIndex:(unsigned)index;	// 0x3500a735
// converted property getter: - (id)sectionInfo;	// 0x3500adf5
@end
