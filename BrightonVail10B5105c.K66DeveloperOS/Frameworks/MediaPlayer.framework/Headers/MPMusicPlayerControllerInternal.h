...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x34fd7089; S=0x34fd7065; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x34fd6d5d
- (id)_bundleIdentifier;	// 0x34fd70a1
- (void)acquireProcessAssertion;	// 0x34fd6fed
- (void)dealloc;	// 0x34fd6d9d
- (void)didPrepareForRemoteSelectorInvocation;	// 0x34fd6ead
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x34fd7089
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x34fd6de1
- (void)serverConnectionDied;	// 0x34fd6f6d
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x34fd7065
@end
