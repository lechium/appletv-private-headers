...
- (id)init;	// 0x319eecf9
- (void)dealloc;	// 0x319eee61
- (void)drawInContext:(CGContextRef)context;	// 0x319eef89
- (void)setUpGraph:(int)graph min:(float)min max:(float)max numValues:(int)values;	// 0x319eeb11
- (void)setUpGraphs:(int)graphs;	// 0x319ee9f9
- (void)updateValue:(int)value value:(float)value2;	// 0x319eec41
@end
