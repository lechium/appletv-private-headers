...
- (id)initFromCentralFileHeader:(const char *)centralFileHeader inputStream:(id)stream;	// 0x33b2ae51
- (void)copyToFile:(id)file;	// 0x33b2b46d
- (id)data;	// 0x33b2b329
- (void)dealloc;	// 0x33b2b099
- (id)inputStream;	// 0x33b2b0e5
@end
