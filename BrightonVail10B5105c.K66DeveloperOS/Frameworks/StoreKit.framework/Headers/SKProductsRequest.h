...
- (id)init;	// 0x3511df59
- (id)initWithProductIdentifiers:(id)productIdentifiers;	// 0x3511dfbd
- (void)_handleReply:(id)reply;	// 0x3511e059
- (void)_sendXPCMessage;	// 0x3511e2c1
- (void)dealloc;	// 0x3511e009
@end
