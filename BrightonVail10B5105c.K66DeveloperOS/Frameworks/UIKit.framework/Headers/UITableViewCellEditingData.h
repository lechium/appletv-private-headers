...
@property(readonly, assign, nonatomic, getter=isDataRequired) BOOL dataRequired;	// G=0x347fb00d; 
- (id)initWithTableViewCell:(id)tableViewCell editingStyle:(int)style;	// 0x34684d29
- (void)dealloc;	// 0x346869e1
- (id)deleteConfirmationControl:(BOOL)control;	// 0x346851dd
- (id)editControl:(BOOL)control;	// 0x34684e81
// declared property getter: - (BOOL)isDataRequired;	// 0x347fb00d
- (id)reorderControl:(BOOL)control;	// 0x34684f51
- (id)reorderSeparatorView:(BOOL)view;	// 0x34684fd1
@end
