...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x34685569; 
+ (void)popAnimationState;	// 0x34551419
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x34551321
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x34685569
- (void)animationDidStart:(id)animation;	// 0x345c0fb1
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x345c6c05
- (void)dealloc;	// 0x34551fc9
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x34551d5d
- (void)setAnimationAttributes:(id)attributes;	// 0x345c07f1
@end
