...
- (id)init;	// 0x35933721
- (id)initWithCoder:(id)coder;	// 0x35933b85
- (void)dealloc;	// 0x35933821
- (void)encodeWithCoder:(id)coder;	// 0x35933c81
- (id)error;	// 0x35933b75
- (void)finalize;	// 0x359339f1
- (BOOL)isSuccessful;	// 0x35933b55
- (id)result;	// 0x35933b65
@end
