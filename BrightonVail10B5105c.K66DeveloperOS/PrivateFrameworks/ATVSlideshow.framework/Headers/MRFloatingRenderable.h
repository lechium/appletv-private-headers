...
@property(retain, nonatomic) MRImage *slide;	// G=0x325ad3c9; S=0x325ad385; @synthesize
+ (void)initialize;	// 0x325ad20d
+ (XXStruct_VuPjpB *)poolInfo;	// 0x325ad1fd
- (void)dealloc;	// 0x325ad30d
- (void)purge;	// 0x325ad34d
// declared property setter: - (void)setSlide:(id)slide;	// 0x325ad385
// declared property getter: - (id)slide;	// 0x325ad3c9
@end
