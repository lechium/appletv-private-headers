...
@class NSDictionary, MRLayerEffect, NSMutableSet, NSThread, NSConditionLock, MRContext, CMMotionManager, NSString, MRRenderArguments, NSRecursiveLock, NSArray, NSMutableDictionary, MRImage, NSMutableArray;
