...
- (id)initWithTransitionID:(id)transitionID;	// 0x325bee19
- (void)cleanup;	// 0x325beedd
- (void)releaseByTransitioner:(id)transitioner;	// 0x325befb5
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x325bf8cd
- (void)setAttributes:(id)attributes;	// 0x325bf781
- (void)setFlipDirection:(int)direction;	// 0x325bf0f5
- (void)setupCubesWithLocalAspectRatio:(float)localAspectRatio;	// 0x325bf251
@end
