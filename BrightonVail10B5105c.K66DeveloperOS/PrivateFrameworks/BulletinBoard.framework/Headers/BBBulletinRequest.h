...
@property(assign, nonatomic) unsigned expirationEvents;	// G=0x370c2bc5; S=0x370c2bd5; @synthesize=_expirationEvents
...
@property(assign, nonatomic) int primaryAttachmentType;	// S=0x370c277d; @dynamic
@property(copy, nonatomic) NSString *publisherBulletinID;	// @dynamic
@property(assign, nonatomic) unsigned realertCount;	// G=0x370c2975; S=0x370c2985; 
...
@property(assign, nonatomic) BOOL showsUnreadIndicator;	// G=0x370c2b61; S=0x370c2b0d; 
...
@property(assign, nonatomic) BOOL tentative;	// G=0x370c2bad; S=0x370c2b7d; 
@property(retain, nonatomic) NSTimeZone *timeZone;	// @dynamic
@property(copy, nonatomic) NSString *title;	// @dynamic
- (void)addAlertSuppressionAppID:(id)anId;	// 0x370c2995
- (void)addAttachmentOfType:(int)type;	// 0x370c27ad
- (void)addButton:(id)button;	// 0x370c27dd
// declared property getter: - (unsigned)expirationEvents;	// 0x370c2bc5
- (void)generateBulletinID;	// 0x370c2b09
- (void)generateNewBulletinID;	// 0x370c302d
- (BOOL)hasContentModificationsRelativeTo:(id)to;	// 0x370c2be5
- (void)publish;	// 0x370c293d
- (void)publish:(BOOL)publish;	// 0x370c2929
- (id)publisherMatchID;	// 0x370c2ff9
// declared property getter: - (unsigned)realertCount;	// 0x370c2975
- (void)setContextValue:(id)value forKey:(id)key;	// 0x370c26ad
// declared property setter: - (void)setExpirationEvents:(unsigned)events;	// 0x370c2bd5
// declared property setter: - (void)setPrimaryAttachmentType:(int)type;	// 0x370c277d
// declared property setter: - (void)setRealertCount:(unsigned)count;	// 0x370c2985
// declared property setter: - (void)setShowsUnreadIndicator:(BOOL)indicator;	// 0x370c2b0d
// declared property setter: - (void)setTentative:(BOOL)tentative;	// 0x370c2b7d
- (void)setUnlockActionLabel:(id)label;	// 0x370c2965
// declared property getter: - (BOOL)showsUnreadIndicator;	// 0x370c2b61
// declared property getter: - (BOOL)tentative;	// 0x370c2bad
- (void)withdraw;	// 0x370c2951
@end
