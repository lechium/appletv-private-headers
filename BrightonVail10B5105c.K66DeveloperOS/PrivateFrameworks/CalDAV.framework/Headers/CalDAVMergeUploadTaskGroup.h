...
- (id)initWithCalendar:(id)calendar principal:(id)principal accountInfoProvider:(id)provider taskManager:(id)manager;	// 0x3423431d
- (void)cancelTaskGroup;	// 0x34235021
- (id)dataContentType;	// 0x34234421
- (void)dealloc;	// 0x34234399
- (void)startTaskGroup;	// 0x3423442d
@end
