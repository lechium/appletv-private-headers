...
- (id)init;	// 0x30be41a9
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x30be433d
- (void)dealloc;	// 0x30be42b1
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x30be4189
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x30be43e9
@end
