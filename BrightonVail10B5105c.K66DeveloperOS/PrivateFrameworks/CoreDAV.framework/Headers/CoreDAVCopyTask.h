...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x36001be1
- (void)dealloc;	// 0x36001b1d
- (id)httpMethod;	// 0x36001b11
- (BOOL)validate:(id *)validate;	// 0x36001b61
@end
