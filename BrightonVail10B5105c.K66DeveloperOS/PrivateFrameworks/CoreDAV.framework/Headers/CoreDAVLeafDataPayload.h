...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x35ff43b1; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x35ff438d; S=0x35ff43a1; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x35ff43c5; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x35ff4289
// declared property getter: - (id)dataPayload;	// 0x35ff43b1
- (void)dealloc;	// 0x35ff4315
// declared property getter: - (id)serverID;	// 0x35ff438d
// declared property setter: - (void)setServerID:(id)anId;	// 0x35ff43a1
// declared property getter: - (id)syncKey;	// 0x35ff43c5
@end
