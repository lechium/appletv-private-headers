...
+ (id)sharedGateKeeper;	// 0x35e58385
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x35e58641
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x35e58449
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x35e583cd
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x35e58541
- (id)stateString;	// 0x35e585bd
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x35e584c5
@end
