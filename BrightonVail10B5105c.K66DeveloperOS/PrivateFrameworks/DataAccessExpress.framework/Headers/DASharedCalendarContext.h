...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x338e84c9
- (void)dealloc;	// 0x338e85d1
- (void)finishedWithError:(id)error;	// 0x338e8661
@end
