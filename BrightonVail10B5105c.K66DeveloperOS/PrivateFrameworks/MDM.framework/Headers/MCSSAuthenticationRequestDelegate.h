...
+ (id)instanceWithAuthenticationContext:(id)authenticationContext;	// 0x315b71c1
- (void).cxx_destruct;	// 0x315b753d
- (void)authenticateRequest:(id)request didReceiveResponse:(id)response;	// 0x315b744d
- (void)startWithCompletionBlock:(id)completionBlock;	// 0x315b7241
@end
