...
+ (id)instanceWithItems:(id)items;	// 0x315b7861
- (void).cxx_destruct;	// 0x315b7ae5
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x315b7a51
- (void)startCompletionBlock:(id)block;	// 0x315b78d9
@end
