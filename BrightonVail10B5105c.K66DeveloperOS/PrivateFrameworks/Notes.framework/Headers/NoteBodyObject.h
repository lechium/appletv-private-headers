...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x3147d915; 
...
- (BOOL)containsAttachments;	// 0x3147da71
// declared property getter: - (id)contentAsPlainText;	// 0x3147d915
- (id)contentAsPlainTextPreservingNewlines;	// 0x3147d9bd
@end
