...
+ (id)autoStylingWithChart:(id)chart;	// 0x37a0ee0d
- (id)initWithChart:(id)chart;	// 0x37a0eea5
- (void)dealloc;	// 0x37a1dab5
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x37a52a11
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x37a4d8a1
@end
