...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x379b1cd9
- (void)dealloc;	// 0x379b575d
- (bool)loadDelayedNode:(id)node;	// 0x379b2239
@end
