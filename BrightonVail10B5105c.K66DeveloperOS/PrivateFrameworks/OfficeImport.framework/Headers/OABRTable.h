...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x37a32779
- (id).cxx_construct;	// 0x37a32775
- (void)createTargetTableContents;	// 0x37ae30fd
- (void)dealloc;	// 0x37a33541
- (void)map;	// 0x37a3280d
- (void)mapScale;	// 0x37a329c1
- (void)readAnchor;	// 0x37a32915
- (void)readCellsAndLines;	// 0x37a331e1
- (void)readCoordinates;	// 0x37a32bc1
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x37ae300d
- (void)validateTable;	// 0x37ae2ce1
@end
