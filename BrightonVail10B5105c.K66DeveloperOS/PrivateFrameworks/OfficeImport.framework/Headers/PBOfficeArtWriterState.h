...
- (id)initWithClient:(id)client presentationState:(id)state;	// 0x37b1a015
- (void)dealloc;	// 0x37b1a0a1
- (id)presentationState;	// 0x37b1a091
- (id)targetPlaceholders;	// 0x37b1a0ed
@end
