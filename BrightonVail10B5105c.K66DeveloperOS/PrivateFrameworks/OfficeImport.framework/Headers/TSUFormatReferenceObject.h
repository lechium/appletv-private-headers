...
- (id)init;	// 0x37b7d5e5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x37b7d661
- (void)dealloc;	// 0x37b7d9a5
- (XXStruct_M$PztB)getFormatStruct;	// 0x37b7d6d9
- (BOOL)isEqual:(id)equal;	// 0x37b7d715
@end
