...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x35515391
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x35514e09
- (void)_didFailToLaunch;	// 0x355151bd
- (void)_didLaunch;	// 0x355150d5
- (void)dealloc;	// 0x35515075
- (void)invalidate;	// 0x355152ad
@end
