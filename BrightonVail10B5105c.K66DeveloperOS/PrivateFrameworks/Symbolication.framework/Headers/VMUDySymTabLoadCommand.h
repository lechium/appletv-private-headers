...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x34ea2521; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x34ea2531; converted property
- (id)initWithMemory:(id)memory;	// 0x34ea2321
// converted property getter: - (unsigned)indirectsymoff;	// 0x34ea2521
- (BOOL)isDySymTab;	// 0x34ea251d
// converted property getter: - (unsigned)nindirectsyms;	// 0x34ea2531
@end
