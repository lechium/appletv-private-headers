...
@property(readonly, assign) VMURange range;	// G=0x34ec7c4d; converted property
@property(readonly, retain) NSString *type;	// G=0x34ec7c81; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x34ec7de5
- (void)dealloc;	// 0x34ec7f91
- (id)description;	// 0x34ec7c39
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x34ec7421
- (BOOL)isEqual:(id)equal;	// 0x34ec7ca1
- (BOOL)isSubmap;	// 0x34ec7c91
- (unsigned)protection;	// 0x34ec7c71
// converted property getter: - (VMURange)range;	// 0x34ec7c4d
// converted property getter: - (id)type;	// 0x34ec7c81
@end
