...
- (id)init;	// 0x32629429
- (void)dealloc;	// 0x32629509
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x326298d9
- (void)processGyroData:(id)data withError:(id)error;	// 0x326295a9
- (void)start;	// 0x326297e9
- (void)stop;	// 0x326298b5
@end
