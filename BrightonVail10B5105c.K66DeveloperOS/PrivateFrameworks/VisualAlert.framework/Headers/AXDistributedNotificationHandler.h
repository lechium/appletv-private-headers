...
+ (void)postDistributedNotificationWithName:(id)name;	// 0x37254b99
- (id)_notificationTypeDescription;	// 0x37254bf9
- (void)_startObserving;	// 0x37254b0d
- (void)_stopObserving;	// 0x37254b5d
@end
