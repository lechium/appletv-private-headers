...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x34c79c15
- (void)dealloc;	// 0x34c79d4d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x34c79db1
@end
