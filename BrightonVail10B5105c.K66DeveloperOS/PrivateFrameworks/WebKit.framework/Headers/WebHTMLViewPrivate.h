...
@class WebDataSource, NSTimer, WebEvent, NSString, NSMutableDictionary, WebPluginController, NSArray, WAKView;
...
+ (void)initialize;	// 0x33553b01
- (id).cxx_construct;	// 0x33553b09
- (void)clear;	// 0x33568025
- (void)dealloc;	// 0x335681ed
- (void)finalize;	// 0x335a2349
@end
