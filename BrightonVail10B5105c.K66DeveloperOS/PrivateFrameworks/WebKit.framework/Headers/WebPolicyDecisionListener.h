...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x335b8455
- (void)_invalidate;	// 0x335b854d
- (void)_usePolicy:(int)policy;	// 0x335b8519
- (void)dealloc;	// 0x335b84cd
- (void)download;	// 0x335b85a9
- (void)ignore;	// 0x335b8595
- (void)use;	// 0x335b8581
@end
