...
@property(retain) NSArray *freebusy;	// G=0x31b4b751; S=0x31b4b771; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x31b4b791; S=0x31b4b7d9; 
+ (id)name;	// 0x31b4b745
// declared property getter: - (id)freebusy;	// 0x31b4b751
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x31b4b771
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x31b4b7d9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x31b4b791
@end
