...
@property(retain) ICSDate *completed;	// G=0x31b45fe1; S=0x31b46019; 
...
@property(retain) ICSDate *due;	// G=0x31b4610d; S=0x31b46145; 
...
@property(assign) int percentComplete;	// G=0x31b46039; S=0x31b46091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x31b46255; S=0x31b46235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x31b46165; S=0x31b461bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x31b45eed
// declared property getter: - (id)completed;	// 0x31b45fe1
// declared property getter: - (id)due;	// 0x31b4610d
- (void)fixComponent;	// 0x31b44f75
// declared property getter: - (int)percentComplete;	// 0x31b46039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x31b46019
// declared property setter: - (void)setDue:(id)due;	// 0x31b46145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x31b46091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x31b46235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x31b461bd
- (BOOL)validate:(id *)validate;	// 0x31b45ef9
// declared property getter: - (id)x_apple_activity;	// 0x31b46255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x31b46165
@end
