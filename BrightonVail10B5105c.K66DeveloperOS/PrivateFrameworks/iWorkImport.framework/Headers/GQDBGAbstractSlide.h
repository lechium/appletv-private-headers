...
- (char *)ID;	// 0x32cd3b19
- (void)dealloc;	// 0x32cd3a15
- (BOOL)isHidden;	// 0x32cd3b09
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x32cd3b29
- (id)slideStyle;	// 0x32cd3ae9
- (id)stylesheet;	// 0x32cd3af9
@end
