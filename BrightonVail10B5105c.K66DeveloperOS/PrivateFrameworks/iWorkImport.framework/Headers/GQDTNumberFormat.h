...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x32ce713d
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x32ce7221
+ (const StateSpec *)stateForReading;	// 0x32ce6341
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x32ce7649
- (id)baseStringFromDouble:(double)aDouble;	// 0x32ce7c21
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x32ce7051
- (id)currencyCode;	// 0x32ce821d
- (id)customNumberFormatTokens;	// 0x32ce8241
- (void)dealloc;	// 0x32ce634d
- (id)formatString;	// 0x32ce820d
- (int)fractionAccuracy;	// 0x32ce8e99
- (id)fractionStringFromDouble:(double)aDouble;	// 0x32ce7a79
- (BOOL)hasValidDecimalPlaces;	// 0x32ce6411
- (BOOL)isCustom;	// 0x32ce8e79
- (BOOL)isTextFormat;	// 0x32ce8e89
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x32ce7eed
- (id)numberFormatBySettingValueType:(int)type;	// 0x32ce80b9
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x32ce72b9
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x32ce7edd
- (BOOL)showThousandsSeparator;	// 0x32ce822d
- (id)stringFromDouble:(double)aDouble;	// 0x32ce6439
- (BOOL)useAccountingStyle;	// 0x32ce7119
- (int)valueType;	// 0x32ce7109
@end
