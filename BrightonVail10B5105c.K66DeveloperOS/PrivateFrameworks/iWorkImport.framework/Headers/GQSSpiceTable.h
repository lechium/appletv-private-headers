...
- (id)init;	// 0x32d16101
- (void)aboutToReadCells;	// 0x32d16245
- (void)aboutToReadColumnVectors;	// 0x32d16231
- (void)aboutToReadRowVectors;	// 0x32d1621d
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x32d162d5
- (void)dealloc;	// 0x32d16199
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x32d1630d
@end
