...
- (id)initWithPath:(id)path;	// 0x16af19
- (void)_savePrefs;	// 0x16b251
- (void)clearFeedResources;	// 0x16b1a1
- (void)dealloc;	// 0x16b06d
- (void)setFeedResource:(id)resource named:(id)named;	// 0x16b0f1
@end
