...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x3aa539
- (unsigned)count;	// 0x3aa8ed
- (void)dealloc;	// 0x3aa8a1
- (unsigned)indexOfObject:(id)object;	// 0x3aa9c1
- (id)objectAtIndex:(unsigned)index;	// 0x3aa91d
@end
