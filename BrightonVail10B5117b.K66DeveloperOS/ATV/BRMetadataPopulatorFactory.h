...
+ (void)setSingleton:(id)singleton;	// 0x358679
+ (id)singleton;	// 0x358669
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x358839
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x358c8d
- (void)dealloc;	// 0x358689
- (id)populatorForAsset:(id)asset;	// 0x3587c9
@end
