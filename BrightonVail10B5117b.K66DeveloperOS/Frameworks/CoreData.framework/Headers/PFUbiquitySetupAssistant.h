...
@property(readonly, retain) PFUbiquityMigrationAssistant *migrationAssistant;	// G=0x3103629d; converted property
@property(readonly, assign, nonatomic) BOOL needsMetadataRecovery;	// G=0x3103b40d; @synthesize=_needsMetadataRecovery
@property(readonly, assign, nonatomic) NSDictionary *options;	// G=0x3103b3fd; @synthesize=_options
@property(readonly, assign, nonatomic) BOOL ubiquityEnabled;	// G=0x30ee7fb9; @synthesize=_ubiquityEnabled
+ (id)createDefaultLocalPeerID;	// 0x31038fbd
+ (BOOL)doBasicSanityCheckForUbiquityRootURL:(id)ubiquityRootURL withError:(id *)error;	// 0x31039039
+ (id)generateMachineUUIDString;	// 0x31038f61
+ (void)removeUbiquityMetadataFromStore:(id)store;	// 0x3103b0f1
+ (BOOL)ubiquityMetadataTablesPresentInStore:(id)store;	// 0x3103b0ad
- (id)init;	// 0x30ee70bd
- (id)initWithPersistentStoreCoordinator:(id)persistentStoreCoordinator andStoreOptions:(id)options forPersistentStoreOfType:(id)type atURL:(id)url;	// 0x30ee6ffd
- (void)_setUbiquityRootLocation:(id)location storeName:(id)name localPeerID:(id)anId andModelVersionHash:(id)hash;	// 0x3103b37d
- (BOOL)attemptMetadataRecoveryForStore:(id)store error:(id *)error;	// 0x31038a8d
- (void)dealloc;	// 0x30ef5af1
- (BOOL)doFirstMetadataConsistencyCheckWithError:(id *)error;	// 0x310397c1
- (BOOL)doSecondMetadataConsistencyCheckWithStore:(id)store error:(id *)error;	// 0x31039bcd
- (BOOL)migrateMetadataRoot:(id *)root;	// 0x310392fd
// converted property getter: - (id)migrationAssistant;	// 0x3103629d
// declared property getter: - (BOOL)needsMetadataRecovery;	// 0x3103b40d
// declared property getter: - (id)options;	// 0x3103b3fd
- (BOOL)performPostStoreSetupWithStore:(id)store error:(id *)error;	// 0x31037171
- (BOOL)performPreStoreSetupWithError:(id *)error;	// 0x31036325
// declared property getter: - (BOOL)ubiquityEnabled;	// 0x30ee7fb9
- (BOOL)validateOptionsWithError:(id *)error;	// 0x30ee7299
@end
