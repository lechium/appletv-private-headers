...
- (id)initWithQueue:(id)queue rootFileAccessNode:(id)node;	// 0x31ab3199
- (oneway void)addPublisher:(id)publisher forID:(id)anId acknowledgementAppBundleIDs:(id)ids fileURL:(id)url;	// 0x31ab3359
- (oneway void)addSubscriber:(id)subscriber forID:(id)anId appBundleID:(id)anId3 fileURL:(id)url;	// 0x31ab3899
- (void)dealloc;	// 0x31ab323d
- (void)finalize;	// 0x31ab32b5
- (BOOL)listener:(id)listener shouldAcceptNewConnection:(id)connection;	// 0x31ab32f9
- (oneway void)observePublisherForID:(id)anId value:(id)value forKey:(id)key inUserInfo:(BOOL)userInfo;	// 0x31ab3635
- (oneway void)removePublisherForID:(id)anId;	// 0x31ab377d
- (oneway void)removeSubscriberForID:(id)anId;	// 0x31ab3b51
@end
