...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x31a1a489
- (void)dealloc;	// 0x31a1a629
- (id)description;	// 0x31a1a5d5
- (BOOL)isEqual:(id)equal;	// 0x31a1a551
@end
