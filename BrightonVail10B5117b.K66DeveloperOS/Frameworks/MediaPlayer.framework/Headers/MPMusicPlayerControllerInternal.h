...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x31daa101; S=0x31daa0dd; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x31da9dd5
- (id)_bundleIdentifier;	// 0x31daa119
- (void)acquireProcessAssertion;	// 0x31daa065
- (void)dealloc;	// 0x31da9e15
- (void)didPrepareForRemoteSelectorInvocation;	// 0x31da9f25
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x31daa101
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x31da9e59
- (void)serverConnectionDied;	// 0x31da9fe5
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x31daa0dd
@end
