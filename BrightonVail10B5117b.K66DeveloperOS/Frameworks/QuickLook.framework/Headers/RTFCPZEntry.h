...
- (id)initFromCentralFileHeader:(const char *)centralFileHeader inputStream:(id)stream;	// 0x32bcfe51
- (void)copyToFile:(id)file;	// 0x32bd046d
- (id)data;	// 0x32bd0329
- (void)dealloc;	// 0x32bd0099
- (id)inputStream;	// 0x32bd00e5
@end
