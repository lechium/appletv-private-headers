...
+ (BOOL)hasActiveSessions;	// 0x32ce25fd
+ (void)startViewServiceSessionManager;	// 0x32ce0f95
- (id)init;	// 0x33087d29
- (id)_init;	// 0x32ce0fc1
- (void)_registerSessionForDefaultDeputies:(id)defaultDeputies;	// 0x33088515
- (void)_startListener;	// 0x33087ea1
- (void)dealloc;	// 0x33087df1
- (BOOL)hasActiveSessions;	// 0x32ce2621
@end
