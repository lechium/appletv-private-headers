...
+ (void)_addCategoryMethod:(objc_method *)method toClass:(Class)aClass isClass:(BOOL)aClass3;	// 0x33534a15
+ (void)initialize;	// 0x33534849
+ (void)installCategoryOnClassNamed:(id)named;	// 0x33534895
@end
