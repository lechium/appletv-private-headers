...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x3358d1e5
- (void)dealloc;	// 0x3358d20d
- (void)forwardInvocation:(id)invocation;	// 0x3358d239
- (id)methodSignatureForSelector:(SEL)selector;	// 0x3358d3a5
@end
