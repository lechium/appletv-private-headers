...
+ (id)sharedInstance;	// 0x33648351
- (id)init;	// 0x336483fd
- (void)compressPath:(id)path toPath:(id)path2;	// 0x336484ad
- (void)dealloc;	// 0x33648461
- (void)fileCopierDidFinish:(id)fileCopier;	// 0x33648591
- (void)fileCopierDidStart:(id)fileCopier;	// 0x3364858d
@end
