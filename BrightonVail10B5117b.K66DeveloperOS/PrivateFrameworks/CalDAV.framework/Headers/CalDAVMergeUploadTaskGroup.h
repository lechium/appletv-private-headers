...
- (id)initWithCalendar:(id)calendar principal:(id)principal accountInfoProvider:(id)provider taskManager:(id)manager;	// 0x3375c31d
- (void)cancelTaskGroup;	// 0x3375d021
- (id)dataContentType;	// 0x3375c421
- (void)dealloc;	// 0x3375c399
- (void)startTaskGroup;	// 0x3375c42d
@end
