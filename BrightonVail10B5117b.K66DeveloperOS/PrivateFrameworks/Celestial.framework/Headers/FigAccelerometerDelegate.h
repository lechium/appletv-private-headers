...
- (id)init;	// 0x337b61a9
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x337b633d
- (void)dealloc;	// 0x337b62b1
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x337b6189
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x337b63e9
@end
