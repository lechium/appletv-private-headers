...
- (id)initWithIdentifier:(id)identifier;	// 0x3389d5f9
- (id)initWithIdentifier:(id)identifier timeout:(double)timeout;	// 0x3389d3a1
- (void)dealloc;	// 0x3389d629
- (id)description;	// 0x3389d781
@end
