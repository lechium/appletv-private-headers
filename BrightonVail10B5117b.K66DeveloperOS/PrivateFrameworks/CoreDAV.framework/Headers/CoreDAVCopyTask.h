...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x338f3b71
- (void)dealloc;	// 0x338f3aad
- (id)httpMethod;	// 0x338f3aa1
- (BOOL)validate:(id *)validate;	// 0x338f3af1
@end
