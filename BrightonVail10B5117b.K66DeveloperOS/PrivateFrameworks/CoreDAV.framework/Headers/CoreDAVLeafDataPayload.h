...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x338e6341; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x338e631d; S=0x338e6331; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x338e6355; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x338e6219
// declared property getter: - (id)dataPayload;	// 0x338e6341
- (void)dealloc;	// 0x338e62a5
// declared property getter: - (id)serverID;	// 0x338e631d
// declared property setter: - (void)setServerID:(id)anId;	// 0x338e6331
// declared property getter: - (id)syncKey;	// 0x338e6355
@end
