...
+ (id)sharedGateKeeper;	// 0x33b50385
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x33b50641
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x33b50449
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x33b503cd
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x33b50541
- (id)stateString;	// 0x33b505bd
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x33b504c5
@end
