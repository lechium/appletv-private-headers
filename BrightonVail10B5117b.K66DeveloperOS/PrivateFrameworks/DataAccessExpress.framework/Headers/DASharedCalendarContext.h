...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x33c524c9
- (void)dealloc;	// 0x33c525d1
- (void)finishedWithError:(id)error;	// 0x33c52661
@end
