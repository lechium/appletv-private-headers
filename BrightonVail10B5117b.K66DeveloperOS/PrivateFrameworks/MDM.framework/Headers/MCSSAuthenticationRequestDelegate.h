...
+ (id)instanceWithAuthenticationContext:(id)authenticationContext;	// 0x346721c1
- (void).cxx_destruct;	// 0x3467253d
- (void)authenticateRequest:(id)request didReceiveResponse:(id)response;	// 0x3467244d
- (void)startWithCompletionBlock:(id)completionBlock;	// 0x34672241
@end
