...
@property(retain, nonatomic) NSArray *searchProperties;	// G=0x348ef249; S=0x348ef259; @synthesize=_searchProperties
- (id)initWithLibrary:(id)library;	// 0x3488f359
- (id).cxx_construct;	// 0x3488ef11
- (void).cxx_destruct;	// 0x348ef269
- (void)appendSQLToMutableString:(id)mutableString entityClass:(Class)aClass;	// 0x3488f93d
- (void)dealloc;	// 0x348ef1b9
// declared property getter: - (id)searchProperties;	// 0x348ef249
// declared property setter: - (void)setSearchProperties:(id)properties;	// 0x348ef259
@end
