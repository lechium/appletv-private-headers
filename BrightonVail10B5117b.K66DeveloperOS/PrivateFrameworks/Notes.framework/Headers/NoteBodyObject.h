...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x349c8915; 
...
- (BOOL)containsAttachments;	// 0x349c8a71
// declared property getter: - (id)contentAsPlainText;	// 0x349c8915
- (id)contentAsPlainTextPreservingNewlines;	// 0x349c89bd
@end
