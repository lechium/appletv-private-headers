...
- (id)basicAccountIdentifier;	// 0x349c88c1
- (id)collectionInfo;	// 0x349c8765
- (unsigned)maximumServerIntId;	// 0x349c841d
- (id)notesForGUIDs:(id)guids;	// 0x349c7f29
- (id)notesForIntegerIds:(id)integerIds;	// 0x349c7d79
- (id)notesForServerIds:(id)serverIds;	// 0x349c7bc9
- (id)notesForServerIntIds:(id)serverIntIds;	// 0x349c80d9
- (id)notesForServerIntIdsInRange:(NSRange)range;	// 0x349c8289
- (id)predicateForNotes;	// 0x349c872d
@end
