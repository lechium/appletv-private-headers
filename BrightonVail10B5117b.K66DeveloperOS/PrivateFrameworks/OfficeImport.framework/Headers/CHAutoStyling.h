...
+ (id)autoStylingWithChart:(id)chart;	// 0x34b45e0d
- (id)initWithChart:(id)chart;	// 0x34b45ea5
- (void)dealloc;	// 0x34b54ab5
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x34b89a11
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x34b848a1
@end
