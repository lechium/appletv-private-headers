...
- (id)init;	// 0x34cb45e5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x34cb4661
- (void)dealloc;	// 0x34cb49a5
- (XXStruct_M$PztB)getFormatStruct;	// 0x34cb46d9
- (BOOL)isEqual:(id)equal;	// 0x34cb4715
@end
