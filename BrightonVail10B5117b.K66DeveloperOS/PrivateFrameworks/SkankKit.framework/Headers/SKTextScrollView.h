...
- (id)init;	// 0x3560c59d
- (void)appendString:(id)string;	// 0x3560c84d
- (void)setFontColor:(CGColorRef)color;	// 0x3560c731
- (void)setFrame:(CGRect)frame;	// 0x3560c695
- (void)setText:(id)text;	// 0x3560c801
- (void)updateContents;	// 0x3560c751
@end
