...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x35640391
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x3563fe09
- (void)_didFailToLaunch;	// 0x356401bd
- (void)_didLaunch;	// 0x356400d5
- (void)dealloc;	// 0x35640075
- (void)invalidate;	// 0x356402ad
@end
