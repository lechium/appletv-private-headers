...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x35764521; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x35764531; converted property
- (id)initWithMemory:(id)memory;	// 0x35764321
// converted property getter: - (unsigned)indirectsymoff;	// 0x35764521
- (BOOL)isDySymTab;	// 0x3576451d
// converted property getter: - (unsigned)nindirectsyms;	// 0x35764531
@end
