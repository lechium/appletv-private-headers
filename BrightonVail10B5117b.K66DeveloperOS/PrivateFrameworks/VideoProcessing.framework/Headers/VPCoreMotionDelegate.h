...
- (id)init;	// 0x35d0e429
- (void)dealloc;	// 0x35d0e509
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x35d0e8d9
- (void)processGyroData:(id)data withError:(id)error;	// 0x35d0e5a9
- (void)start;	// 0x35d0e7e9
- (void)stop;	// 0x35d0e8b5
@end
