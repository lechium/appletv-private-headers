...
- (id)init;	// 0x35e0207d
- (void)_handleRequests;	// 0x35e023dd
- (void)_notifyRequestHandled:(id)handled;	// 0x35e02361
- (void)dealloc;	// 0x35e02101
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x35e021bd
- (void)invalidate;	// 0x35e02305
- (void)setDelegate:(id)delegate;	// 0x35e02165
@end
