...
- (id)initWithGeolocation:(Geolocation *)geolocation;	// 0x367b6851
- (id).cxx_construct;	// 0x367b6b61
- (void).cxx_destruct;	// 0x367b6b35
- (void)initializationAllowedWebView:(id)view provider:(id)provider;	// 0x367b68b9
- (void)initializationDeniedWebView:(id)view provider:(id)provider;	// 0x367b6b21
@end
