...
- (id)initWithDelegate:(id)delegate;	// 0x368eead9
- (void)dealloc;	// 0x368eeb69
- (void)didParseData;	// 0x368eed39
- (void)failWithError:(id)error;	// 0x368eeda5
- (int)parseData:(id)data;	// 0x368eecb5
- (void)requestProfileForCurrentUser;	// 0x368eebb5
- (void)requestProfileForUsername:(id)username;	// 0x368eec2d
@end
