...
- (char *)ID;	// 0x36a89b19
- (void)dealloc;	// 0x36a89a15
- (BOOL)isHidden;	// 0x36a89b09
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x36a89b29
- (id)slideStyle;	// 0x36a89ae9
- (id)stylesheet;	// 0x36a89af9
@end
