...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x36a9d13d
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x36a9d221
+ (const StateSpec *)stateForReading;	// 0x36a9c341
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x36a9d649
- (id)baseStringFromDouble:(double)aDouble;	// 0x36a9dc21
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x36a9d051
- (id)currencyCode;	// 0x36a9e21d
- (id)customNumberFormatTokens;	// 0x36a9e241
- (void)dealloc;	// 0x36a9c34d
- (id)formatString;	// 0x36a9e20d
- (int)fractionAccuracy;	// 0x36a9ee99
- (id)fractionStringFromDouble:(double)aDouble;	// 0x36a9da79
- (BOOL)hasValidDecimalPlaces;	// 0x36a9c411
- (BOOL)isCustom;	// 0x36a9ee79
- (BOOL)isTextFormat;	// 0x36a9ee89
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x36a9deed
- (id)numberFormatBySettingValueType:(int)type;	// 0x36a9e0b9
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x36a9d2b9
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x36a9dedd
- (BOOL)showThousandsSeparator;	// 0x36a9e22d
- (id)stringFromDouble:(double)aDouble;	// 0x36a9c439
- (BOOL)useAccountingStyle;	// 0x36a9d119
- (int)valueType;	// 0x36a9d109
@end
