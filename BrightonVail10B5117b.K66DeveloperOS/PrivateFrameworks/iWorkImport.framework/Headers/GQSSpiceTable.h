...
- (id)init;	// 0x36acc101
- (void)aboutToReadCells;	// 0x36acc245
- (void)aboutToReadColumnVectors;	// 0x36acc231
- (void)aboutToReadRowVectors;	// 0x36acc21d
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x36acc2d5
- (void)dealloc;	// 0x36acc199
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x36acc30d
@end
