...
- (id)initWithPath:(id)path;	// 0x16cde1
- (void)_savePrefs;	// 0x16d119
- (void)clearFeedResources;	// 0x16d069
- (void)dealloc;	// 0x16cf35
- (void)setFeedResource:(id)resource named:(id)named;	// 0x16cfb9
@end
