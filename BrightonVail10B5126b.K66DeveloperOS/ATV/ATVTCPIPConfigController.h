...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x21af3d; S=0x21af4d; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x21a565
- (void).cxx_destruct;	// 0x21af5d
- (void)_readCurrentConfiguration;	// 0x21b019
- (void)_saveConfiguration;	// 0x21b179
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x21a655
- (void)entryComplete:(id)complete;	// 0x21a9ad
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x21af4d
// declared property getter: - (BOOL)showOnlyDNS;	// 0x21af3d
@end
