...
- (id)initWithDictionary:(id)dictionary;	// 0x262429
- (id)accessibilityLabel;	// 0x262ea9
- (void)dealloc;	// 0x262991
- (void)layoutSubcontrols;	// 0x262a75
- (CGSize)sizeThatFits:(CGSize)fits;	// 0x262a45
@end
