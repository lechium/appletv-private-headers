...
- (id)initWithAsset:(id)asset;	// 0x2bfed9
- (void)_addFadeAnimationToControl:(id)control;	// 0x2c1011
- (void)dealloc;	// 0x2c03c9
- (void)layoutSubcontrols;	// 0x2c0ae5
- (void)setAuthorizing;	// 0x2c0a25
- (void)setBandwidthHintForPreview:(BOOL)preview;	// 0x2c04e1
- (void)setReadyForPlayInNMins:(int)nmins;	// 0x2c06e1
- (void)setReadyToPlay;	// 0x2c097d
@end
