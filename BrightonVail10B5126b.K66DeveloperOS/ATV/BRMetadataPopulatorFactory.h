...
+ (void)setSingleton:(id)singleton;	// 0x35b73d
+ (id)singleton;	// 0x35b72d
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x35b8fd
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x35bd51
- (void)dealloc;	// 0x35b74d
- (id)populatorForAsset:(id)asset;	// 0x35b88d
@end
