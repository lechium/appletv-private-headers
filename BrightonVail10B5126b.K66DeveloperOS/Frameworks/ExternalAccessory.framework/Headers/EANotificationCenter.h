...
- (id)init;	// 0x318a2611
- (void)_notificationHandler:(id)handler;	// 0x318a2fe9
- (void)dealloc;	// 0x318a2801
- (void)notificationCallback;	// 0x318a29d5
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x318a2759
@end
