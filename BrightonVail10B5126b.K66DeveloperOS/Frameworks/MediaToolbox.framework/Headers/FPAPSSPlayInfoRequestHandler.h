...
- (id)init;	// 0x31fd0365
- (void)dealloc;	// 0x31fd03b1
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x31fd045d
- (void)request:(id)request didFailWithError:(id)error;	// 0x31fd0461
- (void)requestDidFinish:(id)request;	// 0x31fd0775
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x31fd0411
- (void)setRequest:(id)request;	// 0x31fd0421
@end
