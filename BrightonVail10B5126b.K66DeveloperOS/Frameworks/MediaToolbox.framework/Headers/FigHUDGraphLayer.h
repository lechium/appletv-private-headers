...
- (id)init;	// 0x32019c21
- (void)dealloc;	// 0x32019d89
- (void)drawInContext:(CGContextRef)context;	// 0x32019eb1
- (void)setUpGraph:(int)graph min:(float)min max:(float)max numValues:(int)values;	// 0x32019a39
- (void)setUpGraphs:(int)graphs;	// 0x32019921
- (void)updateValue:(int)value value:(float)value2;	// 0x32019b69
@end
