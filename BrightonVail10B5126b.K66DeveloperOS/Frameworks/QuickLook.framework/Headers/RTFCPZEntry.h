...
- (id)initFromCentralFileHeader:(const char *)centralFileHeader inputStream:(id)stream;	// 0x32a29e51
- (void)copyToFile:(id)file;	// 0x32a2a46d
- (id)data;	// 0x32a2a329
- (void)dealloc;	// 0x32a2a099
- (id)inputStream;	// 0x32a2a0e5
@end
