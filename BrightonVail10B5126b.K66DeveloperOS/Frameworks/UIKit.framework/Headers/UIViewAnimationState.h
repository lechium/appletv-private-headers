...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x32c2b229; 
+ (void)popAnimationState;	// 0x32af70d9
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x32af6fe1
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x32c2b229
- (void)animationDidStart:(id)animation;	// 0x32b66c71
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x32b6c8c5
- (void)dealloc;	// 0x32af7c89
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x32af7a1d
- (void)setAnimationAttributes:(id)attributes;	// 0x32b664b1
@end
