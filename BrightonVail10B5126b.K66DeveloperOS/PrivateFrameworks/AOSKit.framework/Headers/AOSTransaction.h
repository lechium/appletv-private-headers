...
- (id)init;	// 0x330cd721
- (id)initWithCoder:(id)coder;	// 0x330cdb85
- (void)dealloc;	// 0x330cd821
- (void)encodeWithCoder:(id)coder;	// 0x330cdc81
- (id)error;	// 0x330cdb75
- (void)finalize;	// 0x330cd9f1
- (BOOL)isSuccessful;	// 0x330cdb55
- (id)result;	// 0x330cdb65
@end
