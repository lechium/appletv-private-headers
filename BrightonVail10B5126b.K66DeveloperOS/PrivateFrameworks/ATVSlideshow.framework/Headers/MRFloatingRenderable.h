...
@property(retain, nonatomic) MRImage *slide;	// G=0x332e93c9; S=0x332e9385; @synthesize
+ (void)initialize;	// 0x332e920d
+ (XXStruct_VuPjpB *)poolInfo;	// 0x332e91fd
- (void)dealloc;	// 0x332e930d
- (void)purge;	// 0x332e934d
// declared property setter: - (void)setSlide:(id)slide;	// 0x332e9385
// declared property getter: - (id)slide;	// 0x332e93c9
@end
