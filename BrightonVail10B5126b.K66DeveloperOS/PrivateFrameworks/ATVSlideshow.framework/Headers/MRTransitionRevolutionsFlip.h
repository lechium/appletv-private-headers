...
- (id)initWithTransitionID:(id)transitionID;	// 0x332fae19
- (void)cleanup;	// 0x332faedd
- (void)releaseByTransitioner:(id)transitioner;	// 0x332fafb5
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x332fb8cd
- (void)setAttributes:(id)attributes;	// 0x332fb781
- (void)setFlipDirection:(int)direction;	// 0x332fb0f5
- (void)setupCubesWithLocalAspectRatio:(float)localAspectRatio;	// 0x332fb251
@end
