...
+ (void)_addCategoryMethod:(objc_method *)method toClass:(Class)aClass isClass:(BOOL)aClass3;	// 0x33382a15
+ (void)initialize;	// 0x33382849
+ (void)installCategoryOnClassNamed:(id)named;	// 0x33382895
@end
