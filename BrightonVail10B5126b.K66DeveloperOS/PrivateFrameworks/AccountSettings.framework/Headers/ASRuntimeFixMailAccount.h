...
- (id)init;	// 0x333ab539
- (BOOL)_cleanupAccountClass:(id)aClass;	// 0x333ab7e9
- (void)accountsHaveBeenSaved:(BOOL)saved;	// 0x333ab741
- (void)dealloc;	// 0x333ab615
- (int)fixBasicAccountIfNeeded:(id)needed loggingMessage:(id)message;	// 0x333ab661
- (id)supportedAccountTypes;	// 0x333ab781
@end
