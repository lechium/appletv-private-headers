...
@property(assign, nonatomic) unsigned expirationEvents;	// G=0x33558bc5; S=0x33558bd5; @synthesize=_expirationEvents
...
@property(assign, nonatomic) int primaryAttachmentType;	// S=0x3355877d; @dynamic
@property(copy, nonatomic) NSString *publisherBulletinID;	// @dynamic
@property(assign, nonatomic) unsigned realertCount;	// G=0x33558975; S=0x33558985; 
...
@property(assign, nonatomic) BOOL showsUnreadIndicator;	// G=0x33558b61; S=0x33558b0d; 
...
@property(assign, nonatomic) BOOL tentative;	// G=0x33558bad; S=0x33558b7d; 
@property(retain, nonatomic) NSTimeZone *timeZone;	// @dynamic
@property(copy, nonatomic) NSString *title;	// @dynamic
- (void)addAlertSuppressionAppID:(id)anId;	// 0x33558995
- (void)addAttachmentOfType:(int)type;	// 0x335587ad
- (void)addButton:(id)button;	// 0x335587dd
// declared property getter: - (unsigned)expirationEvents;	// 0x33558bc5
- (void)generateBulletinID;	// 0x33558b09
- (void)generateNewBulletinID;	// 0x3355902d
- (BOOL)hasContentModificationsRelativeTo:(id)to;	// 0x33558be5
- (void)publish;	// 0x3355893d
- (void)publish:(BOOL)publish;	// 0x33558929
- (id)publisherMatchID;	// 0x33558ff9
// declared property getter: - (unsigned)realertCount;	// 0x33558975
- (void)setContextValue:(id)value forKey:(id)key;	// 0x335586ad
// declared property setter: - (void)setExpirationEvents:(unsigned)events;	// 0x33558bd5
// declared property setter: - (void)setPrimaryAttachmentType:(int)type;	// 0x3355877d
// declared property setter: - (void)setRealertCount:(unsigned)count;	// 0x33558985
// declared property setter: - (void)setShowsUnreadIndicator:(BOOL)indicator;	// 0x33558b0d
// declared property setter: - (void)setTentative:(BOOL)tentative;	// 0x33558b7d
- (void)setUnlockActionLabel:(id)label;	// 0x33558965
// declared property getter: - (BOOL)showsUnreadIndicator;	// 0x33558b61
// declared property getter: - (BOOL)tentative;	// 0x33558bad
- (void)withdraw;	// 0x33558951
@end
