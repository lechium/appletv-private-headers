...
- (id)initWithCalendar:(id)calendar principal:(id)principal accountInfoProvider:(id)provider taskManager:(id)manager;	// 0x335a631d
- (void)cancelTaskGroup;	// 0x335a7021
- (id)dataContentType;	// 0x335a6421
- (void)dealloc;	// 0x335a6399
- (void)startTaskGroup;	// 0x335a642d
@end
