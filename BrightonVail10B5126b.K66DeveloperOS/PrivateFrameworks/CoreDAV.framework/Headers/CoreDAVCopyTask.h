...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x33711b71
- (void)dealloc;	// 0x33711aad
- (id)httpMethod;	// 0x33711aa1
- (BOOL)validate:(id *)validate;	// 0x33711af1
@end
