...
@property(retain, nonatomic) GEOMapRegion *mapRegion;	// G=0x33f6f01d; S=0x33f6ea91; @synthesize=_mapRegion
@property(retain, nonatomic) NSMutableArray *placeResults;	// G=0x33f6eafd; S=0x33f6e8d5; @synthesize=_placeResults
@property(retain, nonatomic) NSMutableArray *searchs;	// G=0x33f6e5cd; S=0x33f6eaa1; @synthesize=_searchs
@property(assign, nonatomic) int status;	// G=0x33f6e5bd; S=0x33f9b879; @synthesize=_status
...
- (void)addPlaceResult:(id)result;	// 0x33f68d15
...
// declared property getter: - (id)mapRegion;	// 0x33f6f01d
- (id)placeResultAtIndex:(unsigned)index;	// 0x33f6f04d
// declared property getter: - (id)placeResults;	// 0x33f6eafd
- (unsigned)placeResultsCount;	// 0x33f6f02d
- (BOOL)readFrom:(id)from;	// 0x33f68811
- (id)searchAtIndex:(unsigned)index;	// 0x33f9af41
// declared property getter: - (id)searchs;	// 0x33f6e5cd
...
// declared property setter: - (void)setMapRegion:(id)region;	// 0x33f6ea91
// declared property setter: - (void)setPlaceResults:(id)results;	// 0x33f6e8d5
// declared property setter: - (void)setSearchs:(id)searchs;	// 0x33f6eaa1
...
// declared property getter: - (int)status;	// 0x33f6e5bd
// declared property getter: - (int)statusCodeInfo;	// 0x33f9b8a9
- (void)writeTo:(id)to;	// 0x33f6f0a1
@end
