...
@property(readonly, assign, nonatomic) GEOActiveTileGroup *activeTileGroup;	// G=0x33f4eae5; 
@property(assign) unsigned activeTileGroupIdentifier;	// G=0x33fbb909; S=0x33fbb931; converted property
@property(readonly, assign, nonatomic) BOOL hasActiveTileGroup;	// G=0x33f4ebad; 
...
+ (id)sharedManager;	// 0x33f4ca2d
+ (void)useLocalProxy;	// 0x33fba5c9
+ (void)useRemoteProxy;	// 0x33fba5b9
- (id)init;	// 0x33f4ca59
- (id)_activeTileSetForKey:(const GEOTileKey *)key;	// 0x33fba8e9
- (void)_buildResourceNamesToPaths;	// 0x33f4e965
- (id)_listenerForTileKeys:(id)tileKeys acquireLock:(BOOL)lock;	// 0x33f55a79
- (void)_localeChanged:(id)changed;	// 0x33fba7a1
// declared property getter: - (id)activeTileGroup;	// 0x33f4eae5
...
- (void)closeServerConnection;	// 0x33f55209
...
// declared property getter: - (BOOL)hasActiveTileGroup;	// 0x33f4ebad
...
- (void)loadRegionalResourcesForKeys:(id)keys allowNetwork:(BOOL)network progress:(id)progress finished:(id)finished error:(id)error;	// 0x33f558a9
...
- (void)openServerConnection;	// 0x33f71331
- (id)pathForResourceWithName:(id)name;	// 0x33f4e781
...
- (oneway void)serverProxyDidFinishLoadingForList:(id)serverProxy;	// 0x33f56f21
- (oneway void)serverProxyDidReceiveError:(id)serverProxy forList:(id)list;	// 0x33fbb429
- (oneway void)serverProxyDidReceiveResourceNames:(id)serverProxy attributions:(id)attributions forKey:(GEOTileKey)key fromList:(id)list;	// 0x33f56ca9
// converted property setter: - (void)setActiveTileGroupIdentifier:(unsigned)identifier;	// 0x33fbb931
- (BOOL)supportsTileStyle:(int)style size:(int)size scale:(int)scale;	// 0x33f4f391
