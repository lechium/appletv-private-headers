...
@property(assign, nonatomic) int actionType;	// G=0x33fdc609; S=0x33f710a5; @synthesize=_actionType
@property(assign, nonatomic) double duration;	// G=0x33fdc619; S=0x33f71071; @synthesize=_duration
...
@property(assign, nonatomic) int sequenceNumber;	// G=0x33fdc631; S=0x33f710cd; @synthesize=_sequenceNumber
...
// declared property setter: - (void)setActionType:(int)type;	// 0x33f710a5
// declared property setter: - (void)setDuration:(double)duration;	// 0x33f71071
...
// declared property setter: - (void)setSequenceNumber:(int)number;	// 0x33f710cd
