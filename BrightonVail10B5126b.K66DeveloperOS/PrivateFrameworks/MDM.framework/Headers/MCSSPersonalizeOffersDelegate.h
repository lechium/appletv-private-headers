...
+ (id)instanceWithItems:(id)items;	// 0x34493861
- (void).cxx_destruct;	// 0x34493ae5
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x34493a51
- (void)startCompletionBlock:(id)block;	// 0x344938d9
@end
