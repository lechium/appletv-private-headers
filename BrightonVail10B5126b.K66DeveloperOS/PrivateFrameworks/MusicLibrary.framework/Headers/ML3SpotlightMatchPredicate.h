...
@property(retain, nonatomic) NSArray *searchProperties;	// G=0x34711c69; S=0x34711c79; @synthesize=_searchProperties
- (id)initWithLibrary:(id)library;	// 0x346b0435
- (id).cxx_construct;	// 0x346affed
- (void).cxx_destruct;	// 0x34711c89
- (void)appendSQLToMutableString:(id)mutableString entityClass:(Class)aClass;	// 0x346b0a19
- (void)dealloc;	// 0x34711bd9
// declared property getter: - (id)searchProperties;	// 0x34711c69
// declared property setter: - (void)setSearchProperties:(id)properties;	// 0x34711c79
@end
