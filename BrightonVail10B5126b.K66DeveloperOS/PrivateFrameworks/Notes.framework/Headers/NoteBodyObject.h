...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x347eb915; 
...
- (BOOL)containsAttachments;	// 0x347eba71
// declared property getter: - (id)contentAsPlainText;	// 0x347eb915
- (id)contentAsPlainTextPreservingNewlines;	// 0x347eb9bd
@end
