...
+ (id)autoStylingWithChart:(id)chart;	// 0x34968e0d
- (id)initWithChart:(id)chart;	// 0x34968ea5
- (void)dealloc;	// 0x34977ab5
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x349aca11
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x349a78a1
@end
