...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x3490bcd9
- (void)dealloc;	// 0x3490f75d
- (bool)loadDelayedNode:(id)node;	// 0x3490c239
@end
