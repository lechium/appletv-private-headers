...
- (id)initWithClient:(id)client presentationState:(id)state;	// 0x34a74015
- (void)dealloc;	// 0x34a740a1
- (id)presentationState;	// 0x34a74091
- (id)targetPlaceholders;	// 0x34a740ed
@end
