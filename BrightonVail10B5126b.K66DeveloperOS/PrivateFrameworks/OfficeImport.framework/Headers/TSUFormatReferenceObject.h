...
- (id)init;	// 0x34ad75e5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x34ad7661
- (void)dealloc;	// 0x34ad79a5
- (XXStruct_M$PztB)getFormatStruct;	// 0x34ad76d9
- (BOOL)isEqual:(id)equal;	// 0x34ad7715
@end
