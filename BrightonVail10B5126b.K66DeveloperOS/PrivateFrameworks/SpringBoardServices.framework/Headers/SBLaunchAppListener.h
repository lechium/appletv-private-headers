...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x35464391
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x35463e09
- (void)_didFailToLaunch;	// 0x354641bd
- (void)_didLaunch;	// 0x354640d5
- (void)dealloc;	// 0x35464075
- (void)invalidate;	// 0x354642ad
@end
