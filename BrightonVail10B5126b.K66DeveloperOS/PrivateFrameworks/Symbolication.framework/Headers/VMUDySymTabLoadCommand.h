...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x35588521; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x35588531; converted property
- (id)initWithMemory:(id)memory;	// 0x35588321
// converted property getter: - (unsigned)indirectsymoff;	// 0x35588521
- (BOOL)isDySymTab;	// 0x3558851d
// converted property getter: - (unsigned)nindirectsyms;	// 0x35588531
@end
