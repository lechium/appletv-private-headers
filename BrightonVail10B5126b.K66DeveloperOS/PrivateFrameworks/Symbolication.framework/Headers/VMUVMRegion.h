...
@property(readonly, assign) VMURange range;	// G=0x355adc4d; converted property
@property(readonly, retain) NSString *type;	// G=0x355adc81; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x355adde5
- (void)dealloc;	// 0x355adf91
- (id)description;	// 0x355adc39
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x355ad421
- (BOOL)isEqual:(id)equal;	// 0x355adca1
- (BOOL)isSubmap;	// 0x355adc91
- (unsigned)protection;	// 0x355adc71
// converted property getter: - (VMURange)range;	// 0x355adc4d
// converted property getter: - (id)type;	// 0x355adc81
@end
