...
- (id)init;	// 0x35b32429
- (void)dealloc;	// 0x35b32509
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x35b328d9
- (void)processGyroData:(id)data withError:(id)error;	// 0x35b325a9
- (void)start;	// 0x35b327e9
- (void)stop;	// 0x35b328b5
@end
