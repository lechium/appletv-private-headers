...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x35c26c15
- (void)dealloc;	// 0x35c26d4d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x35c26db1
@end
