...
- (id)initWithGeolocation:(Geolocation *)geolocation;	// 0x365da851
- (id).cxx_construct;	// 0x365dab61
- (void).cxx_destruct;	// 0x365dab35
- (void)initializationAllowedWebView:(id)view provider:(id)provider;	// 0x365da8b9
- (void)initializationDeniedWebView:(id)view provider:(id)provider;	// 0x365dab21
@end
