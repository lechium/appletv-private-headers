...
@class WebDataSource, WebEvent, NSString, NSMutableDictionary, NSTimer, WebPluginController, NSArray, WAKView;
...
+ (void)initialize;	// 0x36594b01
- (id).cxx_construct;	// 0x36594b09
- (void)clear;	// 0x365a9025
- (void)dealloc;	// 0x365a91ed
- (void)finalize;	// 0x365e3349
@end
