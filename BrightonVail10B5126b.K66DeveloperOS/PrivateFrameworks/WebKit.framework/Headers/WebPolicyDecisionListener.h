...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x365f9455
- (void)_invalidate;	// 0x365f954d
- (void)_usePolicy:(int)policy;	// 0x365f9519
- (void)dealloc;	// 0x365f94cd
- (void)download;	// 0x365f95a9
- (void)ignore;	// 0x365f9595
- (void)use;	// 0x365f9581
@end
