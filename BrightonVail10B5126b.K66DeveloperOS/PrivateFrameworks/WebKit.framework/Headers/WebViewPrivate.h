...
@class NSMutableSet, WebNodeHighlight, WebFixedPositionContent, WebIndicateLayer, NSString, NSURL, WAKWindow, NSDictionary, WebPreferences, WebVideoFullscreenController, WebInspector;
...
+ (void)initialize;	// 0x36591231
- (id)init;	// 0x36591295
- (id).cxx_construct;	// 0x36591235
- (void).cxx_destruct;	// 0x36610745
- (void)dealloc;	// 0x36610579
- (void)finalize;	// 0x36610719
@end
