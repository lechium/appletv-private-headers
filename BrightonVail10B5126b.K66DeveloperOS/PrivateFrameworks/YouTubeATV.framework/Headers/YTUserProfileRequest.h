...
- (id)initWithDelegate:(id)delegate;	// 0x36712ad9
- (void)dealloc;	// 0x36712b69
- (void)didParseData;	// 0x36712d39
- (void)failWithError:(id)error;	// 0x36712da5
- (int)parseData:(id)data;	// 0x36712cb5
- (void)requestProfileForCurrentUser;	// 0x36712bb5
- (void)requestProfileForUsername:(id)username;	// 0x36712c2d
@end
