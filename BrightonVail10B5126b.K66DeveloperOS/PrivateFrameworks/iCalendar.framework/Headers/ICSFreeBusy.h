...
@property(retain) NSArray *freebusy;	// G=0x36844751; S=0x36844771; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x36844791; S=0x368447d9; 
+ (id)name;	// 0x36844745
// declared property getter: - (id)freebusy;	// 0x36844751
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x36844771
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x368447d9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x36844791
@end
