...
@property(retain) ICSDate *completed;	// G=0x3683efe1; S=0x3683f019; 
...
@property(retain) ICSDate *due;	// G=0x3683f10d; S=0x3683f145; 
...
@property(assign) int percentComplete;	// G=0x3683f039; S=0x3683f091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x3683f255; S=0x3683f235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x3683f165; S=0x3683f1bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x3683eeed
// declared property getter: - (id)completed;	// 0x3683efe1
// declared property getter: - (id)due;	// 0x3683f10d
- (void)fixComponent;	// 0x3683df75
// declared property getter: - (int)percentComplete;	// 0x3683f039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x3683f019
// declared property setter: - (void)setDue:(id)due;	// 0x3683f145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x3683f091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x3683f235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x3683f1bd
- (BOOL)validate:(id *)validate;	// 0x3683eef9
// declared property getter: - (id)x_apple_activity;	// 0x3683f255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x3683f165
@end
