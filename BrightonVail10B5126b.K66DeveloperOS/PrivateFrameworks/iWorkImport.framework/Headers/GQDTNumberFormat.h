...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x368c113d
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x368c1221
+ (const StateSpec *)stateForReading;	// 0x368c0341
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x368c1649
- (id)baseStringFromDouble:(double)aDouble;	// 0x368c1c21
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x368c1051
- (id)currencyCode;	// 0x368c221d
- (id)customNumberFormatTokens;	// 0x368c2241
- (void)dealloc;	// 0x368c034d
- (id)formatString;	// 0x368c220d
- (int)fractionAccuracy;	// 0x368c2e99
- (id)fractionStringFromDouble:(double)aDouble;	// 0x368c1a79
- (BOOL)hasValidDecimalPlaces;	// 0x368c0411
- (BOOL)isCustom;	// 0x368c2e79
- (BOOL)isTextFormat;	// 0x368c2e89
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x368c1eed
- (id)numberFormatBySettingValueType:(int)type;	// 0x368c20b9
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x368c12b9
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x368c1edd
- (BOOL)showThousandsSeparator;	// 0x368c222d
- (id)stringFromDouble:(double)aDouble;	// 0x368c0439
- (BOOL)useAccountingStyle;	// 0x368c1119
- (int)valueType;	// 0x368c1109
@end
