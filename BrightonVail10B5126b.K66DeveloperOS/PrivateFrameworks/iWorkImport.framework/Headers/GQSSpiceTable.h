...
- (id)init;	// 0x368f0101
- (void)aboutToReadCells;	// 0x368f0245
- (void)aboutToReadColumnVectors;	// 0x368f0231
- (void)aboutToReadRowVectors;	// 0x368f021d
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x368f02d5
- (void)dealloc;	// 0x368f0199
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x368f030d
@end
