...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x324bc5e5
- (void)dealloc;	// 0x324bc579
- (id)description;	// 0x324bc321
- (BOOL)isEqual:(id)equal;	// 0x324bc37d
@end
