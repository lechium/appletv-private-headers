...
+ (id)urlCacheChangedNotificationName;	// 0x30697479
+ (id)urlCacheName;	// 0x3069722d
- (id)initWithDictionary:(id)dictionary;	// 0x30697239
- (void)dealloc;	// 0x307527b5
- (BOOL)isAppleStoreURL:(id)url;	// 0x3075173d
- (int)storeURLTypeForURL:(id)url;	// 0x30697591
@end
