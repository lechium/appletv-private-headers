...
+ (void)popAnimationState;	// 0x305a5d85
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x305a53f9
- (void)animationDidStart:(id)animation;	// 0x305b617d
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x305aa66d
- (void)dealloc;	// 0x305a7455
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x305a67bd
- (void)setAnimationAttributes:(id)attributes;	// 0x305b1a49
@end
