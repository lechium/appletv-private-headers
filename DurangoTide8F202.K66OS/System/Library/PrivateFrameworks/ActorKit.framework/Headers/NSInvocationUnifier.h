...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x318a83a9
- (void)dealloc;	// 0x318a83c5
- (void)forwardInvocation:(id)invocation;	// 0x318a8569
- (id)methodSignatureForSelector:(SEL)selector;	// 0x318a8689
@end
