...
- (id)initWithCenter:(id)center messageName:(id)name userInfoData:(id)data oolKey:(id)key oolData:(id)data5 target:(id)target selector:(SEL)selector context:(void *)context makeServer:(BOOL)server;	// 0x3215bb65
- (void)_performCallout;	// 0x3215b8bd
- (void)_releaseSendingData;	// 0x3215ba45
- (void)dealloc;	// 0x3215bab5
- (void)main;	// 0x3215b92d
@end
