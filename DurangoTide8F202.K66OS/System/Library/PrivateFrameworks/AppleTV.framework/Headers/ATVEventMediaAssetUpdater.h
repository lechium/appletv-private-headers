...
@class ATVEventMediaAsset, NSMutableArray, ATVMerchant;
...
- (id)initWithEventMediaAsset:(id)eventMediaAsset;	// 0x337352ad
- (void)_timerFired:(id)fired;	// 0x33735749
- (void)dealloc;	// 0x337356dd
@end
