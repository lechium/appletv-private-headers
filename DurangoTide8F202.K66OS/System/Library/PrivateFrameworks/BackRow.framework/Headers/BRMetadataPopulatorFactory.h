...
+ (void)setSingleton:(id)singleton;	// 0x328c51c5
+ (id)singleton;	// 0x328c51b9
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x328c5231
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x328cc83d
- (void)dealloc;	// 0x32937cdd
- (id)populatorForAsset:(id)asset;	// 0x328c51d1
@end
