...
@class NSDictionary, NSURL, NSDate, NSString;
...
@class NSNumber, AVQueue, AVQueueFeeder, CALayer, AVPlaybackItem, NSRecursiveLock, NSObject, AVPlaybackQueue;
