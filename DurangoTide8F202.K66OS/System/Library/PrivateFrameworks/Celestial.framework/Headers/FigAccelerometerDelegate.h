...
- (id)init;	// 0x30f462d5
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x30f46451
- (void)dealloc;	// 0x30f463c9
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x30f462b1
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x30f464f5
@end
