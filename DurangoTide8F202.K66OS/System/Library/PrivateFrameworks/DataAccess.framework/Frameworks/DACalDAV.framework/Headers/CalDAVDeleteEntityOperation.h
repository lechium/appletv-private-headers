...
- (id)initWithFilename:(id)filename calendarURL:(id)url account:(id)account cache:(id)cache;	// 0x32cea661
- (void)dealloc;	// 0x32cea5e1
- (void)performOperation:(BOOL)operation;	// 0x32cea6f9
- (id)readableDescription;	// 0x32cea5a9
@end
