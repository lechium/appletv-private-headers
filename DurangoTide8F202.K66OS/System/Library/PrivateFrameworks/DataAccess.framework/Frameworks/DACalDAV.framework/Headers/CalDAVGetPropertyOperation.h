...
- (id)initWithSession:(id)session URI:(id)uri properties:(id)properties value:(id)value;	// 0x32cee675
- (id)initWithSession:(id)session URI:(id)uri property:(id)property value:(id)value;	// 0x32cee5c5
- (void)dealloc;	// 0x32cee535
- (void)getProperties;	// 0x32cee3fd
- (id)responses;	// 0x32cee3dd
@end
