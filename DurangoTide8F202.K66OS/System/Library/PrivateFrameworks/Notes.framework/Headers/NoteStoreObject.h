...
- (id)basicAccountIdentifier;	// 0x30bf58e1
- (id)collectionInfo;	// 0x30bf5905
- (unsigned)maximumServerIntId;	// 0x30bf5eb9
- (id)notesForGUIDs:(id)guids;	// 0x30bf5bd1
- (id)notesForIntegerIds:(id)integerIds;	// 0x30bf5cc9
- (id)notesForServerIds:(id)serverIds;	// 0x30bf5dc1
- (id)notesForServerIntIds:(id)serverIntIds;	// 0x30bf5ad9
- (id)notesForServerIntIdsInRange:(NSRange)range;	// 0x30bf59d5
- (id)predicateForNotes;	// 0x30bf59ad
@end
