...
+ (id)autoStylingWithChart:(id)chart;	// 0x31a09645
- (id)initWithChart:(id)chart;	// 0x31a096d1
- (void)dealloc;	// 0x31a1620d
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x31a24a29
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x31a57661
@end
