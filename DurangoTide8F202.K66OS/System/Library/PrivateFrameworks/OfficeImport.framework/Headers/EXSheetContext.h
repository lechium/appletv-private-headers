...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x31a4ad11
- (void)dealloc;	// 0x31a4dda1
- (bool)loadDelayedNode:(id)node;	// 0x31a4b1f1
@end
