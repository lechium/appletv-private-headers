...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x319f3f11
- (void)createTargetTableContents;	// 0x319f4b61
- (void)dealloc;	// 0x319f5711
- (void)map;	// 0x319f3f95
- (void)mapScale;	// 0x319f4111
- (void)readAnchor;	// 0x319f4069
- (void)readCellsAndLines;	// 0x319f4839
- (void)readCoordinates;	// 0x319f4325
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x319f54bd
@end
