...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x3016aaf1; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x3016ab01; converted property
- (id)initWithMemory:(id)memory;	// 0x3016ab11
// converted property getter: - (unsigned)indirectsymoff;	// 0x3016aaf1
- (BOOL)isDySymTab;	// 0x3016aaed
// converted property getter: - (unsigned)nindirectsyms;	// 0x3016ab01
@end
