...
@property(readonly, retain) NSString *type;	// G=0x3018d6f1; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x3018dd6d
- (void)dealloc;	// 0x3018e2fd
- (id)description;	// 0x3018df21
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x30191241
- (BOOL)isEqual:(id)equal;	// 0x3018df71
- (BOOL)isSubmap;	// 0x3018d701
- (unsigned)protection;	// 0x3018d6e1
// converted property getter: - (id)type;	// 0x3018d6f1
@end
