...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x32d56de1
- (void)dealloc;	// 0x32d56f01
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x32d56f5d
@end
