...
- (id)initWithChooser:(PassRefPtr<WebCore::FileChooser>)chooser;	// 0x32c3d8f5
- (void)cancel;	// 0x32c3dd81
- (void)chooseFilename:(id)filename;	// 0x32c3dc05
- (void)chooseFilenames:(id)filenames;	// 0x32c3d941
@end
