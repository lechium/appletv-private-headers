...
@property(readonly, retain, nonatomic) MIDINetworkHost *host;	// G=0x31c5c701; 
+ (id)connectionWithHost:(id)host;	// 0x31c5c711
- (id)init;	// 0x31c5ce35
- (void)dealloc;	// 0x31c5cecd
// declared property getter: - (id)host;	// 0x31c5c701
@end
