...
- (id)init;	// 0x338a9ad5
- (void)_notificationHandler:(id)handler;	// 0x338a9ea5
- (void)dealloc;	// 0x338a9c99
- (void)notificationCallback;	// 0x338aa149
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x338a9bfd
@end
