...
- (id)initWithFrame:(CGRect)frame image:(id)image slices:(XXStruct_4cr1oD)slices;	// 0x32117105
- (void)dealloc;	// 0x321170bd
- (void)rebuildTiles;	// 0x32116f41
- (void)reflowTiles;	// 0x321171d1
- (void)setFrame:(CGRect)frame;	// 0x32116e31
@end
