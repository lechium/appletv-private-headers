...
+ (id)alloc;	// 0x3222d4f5
+ (id)allocWithZone:(NSZone *)zone;	// 0x3222d4cd
- (id)init;	// 0x3222bebd
- (id)initWithCoder:(id)coder;	// 0x3222cd71
- (void)clearNonSystemProperties;	// 0x3222be7d
- (int)compareFireDates:(id)dates;	// 0x3222be79
- (id)copyWithZone:(NSZone *)zone;	// 0x3222be69
- (void)encodeWithCoder:(id)coder;	// 0x3222be65
- (BOOL)isValid;	// 0x3222be75
- (id)nextFireDateAfterDate:(id)date localTimeZone:(id)zone;	// 0x3222be71
- (id)nextFireDateForLastFireDate:(id)lastFireDate;	// 0x3222be6d
@end
