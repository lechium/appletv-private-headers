...
@property(readonly, assign, nonatomic, getter=isDataRequired) BOOL dataRequired;	// G=0x321ad9c5; 
- (id)initWithTableViewCell:(id)tableViewCell editingStyle:(int)style;	// 0x320ae35d
- (void)dealloc;	// 0x320b0551
- (id)deleteConfirmationControl:(BOOL)control;	// 0x320aee15
- (id)editControl:(BOOL)control;	// 0x320ae465
// declared property getter: - (BOOL)isDataRequired;	// 0x321ad9c5
- (id)reorderControl:(BOOL)control;	// 0x320aeb39
- (id)reorderSeparatorView:(BOOL)view;	// 0x320aebc9
@end
