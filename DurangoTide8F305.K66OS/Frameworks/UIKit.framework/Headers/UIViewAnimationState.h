...
+ (void)popAnimationState;	// 0x31f8bd85
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x31f8b3f9
- (void)animationDidStart:(id)animation;	// 0x31f9c17d
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x31f9066d
- (void)dealloc;	// 0x31f8d455
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x31f8c7bd
- (void)setAnimationAttributes:(id)attributes;	// 0x31f97a49
@end
