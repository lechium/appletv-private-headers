...
@property(retain) UIWebSelection *selection;	// G=0x321d70fd; S=0x321d7115; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x321d70ad
- (void)dealloc;	// 0x321d7071
- (void)invalidate;	// 0x321d6e49
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x321d6edd
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x321d6c25
- (int)oppositeEdge:(int)edge;	// 0x321d6c91
// declared property getter: - (id)selection;	// 0x321d70fd
// declared property setter: - (void)setSelection:(id)selection;	// 0x321d7115
@end
