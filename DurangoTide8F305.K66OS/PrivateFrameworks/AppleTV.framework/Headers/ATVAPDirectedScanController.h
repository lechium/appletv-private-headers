...
@class BRTextControl, NSString, BRHeaderControl, BRWaitSpinnerControl;
...
- (id)initWithNetworkName:(id)networkName;	// 0x307b21d1
- (void)dealloc;	// 0x307b2151
- (void)setFrame:(CGRect)frame;	// 0x307b2381
@end
