...
- (void)dealloc;	// 0x3079d6c5
- (BOOL)perform:(id)perform;	// 0x3079d631
- (void)setKeyValueStore:(id)store;	// 0x3079d68d
- (void)setLastModifiedThreshold:(double)threshold;	// 0x3079d61d
@end
