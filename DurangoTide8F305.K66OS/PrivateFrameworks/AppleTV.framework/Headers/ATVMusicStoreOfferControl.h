...
- (id)init;	// 0x30757939
- (id)accessibilityLabel;	// 0x30757ed9
- (void)dealloc;	// 0x30757895
- (void)layoutSubcontrols;	// 0x30757979
- (void)setClosedCaption:(BOOL)caption;	// 0x30757359
- (void)setDolbyDigital:(BOOL)digital;	// 0x30757421
- (void)setHasDigitalExtras:(BOOL)extras;	// 0x30757285
- (void)setWidescreen:(BOOL)widescreen andHD:(BOOL)hd;	// 0x307574e9
- (CGSize)sizeThatFits:(CGSize)fits;	// 0x30757fbd
@end
