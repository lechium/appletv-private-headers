...
- (id)initWithBuffer:(id)buffer;	// 0x307d3b68
- (void)dealloc;	// 0x307d3a8c
- (id)getAudioData;	// 0x307d3a3c
- (id)getIndexData;	// 0x307d3a78
- (id)getNetflixKeyEnvelope;	// 0x307d3a64
- (id)getPlayReady;	// 0x307d3a50
- (id)getStreamData;	// 0x307d3a14
- (id)getVideoData;	// 0x307d3a28
@end
