...
+ (void)setSingleton:(id)singleton;	// 0x32939fe5
+ (id)singleton;	// 0x32939fd9
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x3293a051
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x3294165d
- (void)dealloc;	// 0x329acbb9
- (id)populatorForAsset:(id)asset;	// 0x32939ff1
@end
