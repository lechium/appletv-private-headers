...
- (id)initWithURL:(id)url;	// 0x3387b64d
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x3387b521
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x3387b46d
- (id)httpMethod;	// 0x3387b461
- (id)requestBody;	// 0x3387b5b1
@end
