...
- (id)initWithFilename:(id)filename calendarURL:(id)url account:(id)account cache:(id)cache;	// 0x34097661
- (void)dealloc;	// 0x340975e1
- (void)performOperation:(BOOL)operation;	// 0x340976f9
- (id)readableDescription;	// 0x340975a9
@end
