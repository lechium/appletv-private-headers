...
+ (id)sharedGateKeeper;	// 0x302443dd
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x3024417d
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x30244365
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x30244275
- (id)stateString;	// 0x302441f5
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x302442ed
@end
