...
- (id)initWithNotifier:(id)notifier protocol:(id)protocol targets:(id)targets;	// 0x31ae7609
- (void)dealloc;	// 0x31ae93a9
- (void)forwardInvocation:(id)invocation;	// 0x31ae9295
- (id)methodSignatureForSelector:(SEL)selector;	// 0x31ae7599
@end
