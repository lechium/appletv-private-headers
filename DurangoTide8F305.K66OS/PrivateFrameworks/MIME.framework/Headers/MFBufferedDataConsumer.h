...
@property(readonly, retain) NSMutableData *data;	// G=0x304a0815; converted property
- (id)init;	// 0x3049f3a9
- (int)appendData:(id)data;	// 0x304a047d
// converted property getter: - (id)data;	// 0x304a0815
- (void)dealloc;	// 0x3049f2f1
- (void)done;	// 0x3049df95
@end
