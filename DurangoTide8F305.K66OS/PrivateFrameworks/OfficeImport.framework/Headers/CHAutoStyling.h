...
+ (id)autoStylingWithChart:(id)chart;	// 0x344e1645
- (id)initWithChart:(id)chart;	// 0x344e16d1
- (void)dealloc;	// 0x344ee20d
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x344fca29
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x3452f661
@end
