...
- (id)initWithRows:(id)rows fileName:(id)name columnCount:(unsigned)count archiver:(id)archiver;	// 0x34580d2d
- (void)dealloc;	// 0x34580cd1
- (void)mapAt:(id)at withState:(id)state;	// 0x34580a8d
@end
