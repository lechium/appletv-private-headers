...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x31187af1; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x31187b01; converted property
- (id)initWithMemory:(id)memory;	// 0x31187b11
// converted property getter: - (unsigned)indirectsymoff;	// 0x31187af1
- (BOOL)isDySymTab;	// 0x31187aed
// converted property getter: - (unsigned)nindirectsyms;	// 0x31187b01
@end
