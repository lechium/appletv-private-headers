...
@property(readonly, retain) NSString *type;	// G=0x311aa6f1; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x311aad6d
- (void)dealloc;	// 0x311ab2fd
- (id)description;	// 0x311aaf21
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x311ae241
- (BOOL)isEqual:(id)equal;	// 0x311aaf71
- (BOOL)isSubmap;	// 0x311aa701
- (unsigned)protection;	// 0x311aa6e1
// converted property getter: - (id)type;	// 0x311aa6f1
@end
