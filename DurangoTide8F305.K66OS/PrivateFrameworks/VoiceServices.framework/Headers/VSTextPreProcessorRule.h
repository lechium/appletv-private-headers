...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x324fbde1
- (void)dealloc;	// 0x324fbf01
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x324fbf5d
@end
