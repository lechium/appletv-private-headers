...
- (id)initWithChooser:(PassRefPtr<WebCore::FileChooser>)chooser;	// 0x33fef8f5
- (void)cancel;	// 0x33fefd81
- (void)chooseFilename:(id)filename;	// 0x33fefc05
- (void)chooseFilenames:(id)filenames;	// 0x33fef941
@end
