...
- (id)init;	// 0x33ec3959
- (id)initWithNestingLevel:(unsigned)nestingLevel;	// 0x33e28ced
- (void)dealloc;	// 0x33e2c6f1
- (id)generateSubqueryVariableAlias;	// 0x33ec3911
- (id)generateTableAlias;	// 0x33e297fd
@end
