...
@property(readonly, assign, nonatomic, getter=isDataRequired) BOOL dataRequired;	// G=0x302b09c5; 
- (id)initWithTableViewCell:(id)tableViewCell editingStyle:(int)style;	// 0x301b135d
- (void)dealloc;	// 0x301b3551
- (id)deleteConfirmationControl:(BOOL)control;	// 0x301b1e15
- (id)editControl:(BOOL)control;	// 0x301b1465
// declared property getter: - (BOOL)isDataRequired;	// 0x302b09c5
- (id)reorderControl:(BOOL)control;	// 0x301b1b39
- (id)reorderSeparatorView:(BOOL)view;	// 0x301b1bc9
@end
