...
+ (void)popAnimationState;	// 0x3008ed85
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x3008e3f9
- (void)animationDidStart:(id)animation;	// 0x3009f17d
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x3009366d
- (void)dealloc;	// 0x30090455
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x3008f7bd
- (void)setAnimationAttributes:(id)attributes;	// 0x3009aa49
@end
