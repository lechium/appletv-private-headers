...
@property(retain) UIWebSelection *selection;	// G=0x302da0fd; S=0x302da115; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x302da0ad
- (void)dealloc;	// 0x302da071
- (void)invalidate;	// 0x302d9e49
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x302d9edd
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x302d9c25
- (int)oppositeEdge:(int)edge;	// 0x302d9c91
// declared property getter: - (id)selection;	// 0x302da0fd
// declared property setter: - (void)setSelection:(id)selection;	// 0x302da115
@end
