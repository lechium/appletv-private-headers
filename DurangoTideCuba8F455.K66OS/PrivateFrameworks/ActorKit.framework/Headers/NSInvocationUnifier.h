...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x336f53a9
- (void)dealloc;	// 0x336f53c5
- (void)forwardInvocation:(id)invocation;	// 0x336f5569
- (id)methodSignatureForSelector:(SEL)selector;	// 0x336f5689
@end
