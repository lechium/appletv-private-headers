...
- (void)dealloc;	// 0x306cc3bd
- (BOOL)perform:(id)perform;	// 0x306cc329
- (void)setKeyValueStore:(id)store;	// 0x306cc385
- (void)setLastModifiedThreshold:(double)threshold;	// 0x306cc315
@end
