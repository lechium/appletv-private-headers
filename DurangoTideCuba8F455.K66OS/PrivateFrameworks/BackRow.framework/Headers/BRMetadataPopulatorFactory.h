...
+ (void)setSingleton:(id)singleton;	// 0x32f3ac75
+ (id)singleton;	// 0x32f3ac69
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x32f3ace1
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x32f42235
- (void)dealloc;	// 0x32fac65d
- (id)populatorForAsset:(id)asset;	// 0x32f3ac81
@end
