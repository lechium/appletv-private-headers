...
- (id)init;	// 0x323b52d5
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x323b5451
- (void)dealloc;	// 0x323b53c9
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x323b52b1
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x323b54f5
@end
