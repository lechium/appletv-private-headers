...
@property(readonly, assign) NSData *dataPayload;	// G=0x3317ebe5; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x3317ece5; S=0x3317ecfd; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x3317ebd5; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x3317ec61
// declared property getter: - (id)dataPayload;	// 0x3317ebe5
- (void)dealloc;	// 0x3317ebf5
// declared property getter: - (id)serverID;	// 0x3317ece5
// declared property setter: - (void)setServerID:(id)anId;	// 0x3317ecfd
// declared property getter: - (id)syncKey;	// 0x3317ebd5
@end
