...
+ (id)sharedGateKeeper;	// 0x340c63dd
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x340c617d
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x340c6365
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x340c6275
- (id)stateString;	// 0x340c61f5
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x340c62ed
@end
