...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x32c15f11
- (void)createTargetTableContents;	// 0x32c16b61
- (void)dealloc;	// 0x32c17711
- (void)map;	// 0x32c15f95
- (void)mapScale;	// 0x32c16111
- (void)readAnchor;	// 0x32c16069
- (void)readCellsAndLines;	// 0x32c16839
- (void)readCoordinates;	// 0x32c16325
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x32c174bd
@end
