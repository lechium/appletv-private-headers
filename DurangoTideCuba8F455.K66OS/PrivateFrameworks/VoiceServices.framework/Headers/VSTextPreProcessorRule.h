...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x33f3dde1
- (void)dealloc;	// 0x33f3df01
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x33f3df5d
@end
