...
- (id)initWithHistoryController:(id)historyController;	// 0x8a74d
- (void).cxx_destruct;	// 0x8a8c5
- (id)itemForIndex:(id)index;	// 0x8a7b1
- (BOOL)itemSelectedAtIndex:(id)index action:(int)action defer:(BOOL *)defer;	// 0x8a899
@end
