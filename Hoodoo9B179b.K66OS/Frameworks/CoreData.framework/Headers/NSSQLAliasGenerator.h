...
- (id)init;	// 0x32b86395
- (id)initWithNestingLevel:(unsigned)nestingLevel;	// 0x32aebc29
- (void)dealloc;	// 0x32af2519
- (id)generateSubqueryVariableAlias;	// 0x32b863a9
- (id)generateTableAlias;	// 0x32aedb4d
@end
