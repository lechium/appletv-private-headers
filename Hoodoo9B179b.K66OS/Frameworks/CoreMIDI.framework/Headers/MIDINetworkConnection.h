...
@property(readonly, retain, nonatomic) MIDINetworkHost *host;	// G=0x32eaebb5; 
+ (id)connectionWithHost:(id)host;	// 0x32eb0821
- (id)init;	// 0x32eb08e5
- (void)dealloc;	// 0x32eb088d
// declared property getter: - (id)host;	// 0x32eaebb5
@end
