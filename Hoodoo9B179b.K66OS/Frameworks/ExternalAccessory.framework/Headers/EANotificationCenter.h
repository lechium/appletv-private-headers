...
- (id)init;	// 0x3206b6c1
- (void)_notificationHandler:(id)handler;	// 0x3206c0c1
- (void)dealloc;	// 0x3206b8b5
- (void)notificationCallback;	// 0x3206ba91
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x3206b805
@end
