...
- (id)initWithQueue:(dispatch_queue_s *)queue;	// 0x31138d0d
- (void)dealloc;	// 0x31138d79
- (void)handleFSEventPath:(id)path flags:(unsigned long)flags id:(unsigned long long)anId;	// 0x31138e7d
- (void)setURL:(id)url;	// 0x31139a6d
- (void)settle;	// 0x31139bc1
- (void)startWithObserver:(id)observer;	// 0x31139b5d
- (void)stop;	// 0x31139f0d
- (void)watchItem;	// 0x3113902d
@end
