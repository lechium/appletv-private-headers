...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x310c5399
- (void)dealloc;	// 0x310c5539
- (id)description;	// 0x310c54e5
- (BOOL)isEqual:(id)equal;	// 0x310c5461
@end
