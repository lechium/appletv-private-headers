...
+ (id)alloc;	// 0x331f0ec9
+ (id)allocWithZone:(NSZone *)zone;	// 0x331f0ef5
- (id)init;	// 0x331f0f21
- (id)initWithCoder:(id)coder;	// 0x331f0ff1
- (void)clearNonSystemProperties;	// 0x331f104d
- (int)compareFireDates:(id)dates;	// 0x331f1049
- (id)copyWithZone:(NSZone *)zone;	// 0x331f1039
- (void)encodeWithCoder:(id)coder;	// 0x331f1035
- (BOOL)isValid;	// 0x331f1045
- (id)nextFireDateAfterDate:(id)date localTimeZone:(id)zone;	// 0x331f1041
- (id)nextFireDateForLastFireDate:(id)lastFireDate;	// 0x331f103d
@end
