...
@property(retain) UIWebSelection *selection;	// G=0x3319af65; S=0x3319af79; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x3319abc5
- (void)dealloc;	// 0x3319ac1d
- (void)invalidate;	// 0x3319aeb9
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x3319ad05
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x3319ac61
- (int)oppositeEdge:(int)edge;	// 0x3319ace9
// declared property getter: - (id)selection;	// 0x3319af65
// declared property setter: - (void)setSelection:(id)selection;	// 0x3319af79
@end
