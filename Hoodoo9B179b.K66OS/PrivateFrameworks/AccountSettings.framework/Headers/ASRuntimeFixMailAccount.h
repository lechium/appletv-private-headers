...
- (id)init;	// 0x31527811
- (BOOL)_cleanupAccountClass:(id)aClass;	// 0x31527ae1
- (void)accountsHaveBeenSaved:(BOOL)saved;	// 0x31527965
- (void)dealloc;	// 0x31527a95
- (int)fixBasicAccountIfNeeded:(id)needed loggingMessage:(id)message;	// 0x315279a5
- (id)supportedAccountTypes;	// 0x315278f5
@end
