...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x333d10a5
- (void)dealloc;	// 0x333d1171
- (void)forwardInvocation:(id)invocation;	// 0x333d11e5
- (id)methodSignatureForSelector:(SEL)selector;	// 0x333d119d
@end
