...
+ (id)defaultWhitelist;	// 0x3444511d
- (id)initWithDefaultPath;	// 0x344453a1
- (id)initWithPath:(id)path;	// 0x34445499
- (void)dealloc;	// 0x34445081
- (BOOL)distributionKeyIsWhitelisted:(id)whitelisted;	// 0x34445191
- (BOOL)metadataKeyIsWhitelisted:(id)whitelisted;	// 0x34445149
- (BOOL)scalarKeyIsWhitelisted:(id)whitelisted;	// 0x34445299
@end
