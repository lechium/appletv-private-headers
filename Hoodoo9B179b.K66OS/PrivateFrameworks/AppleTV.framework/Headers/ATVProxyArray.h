...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x3036e78d
- (unsigned)count;	// 0x3036ebdd
- (void)dealloc;	// 0x3036eb91
- (unsigned)indexOfObject:(id)object;	// 0x3036ecb1
- (id)objectAtIndex:(unsigned)index;	// 0x3036ec11
@end
