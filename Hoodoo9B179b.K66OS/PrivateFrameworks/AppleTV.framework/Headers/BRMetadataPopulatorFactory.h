...
+ (void)setSingleton:(id)singleton;	// 0x30313521
+ (id)singleton;	// 0x30313511
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x303136dd
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x30313cb9
- (void)dealloc;	// 0x30313531
- (id)populatorForAsset:(id)asset;	// 0x3031366d
@end
