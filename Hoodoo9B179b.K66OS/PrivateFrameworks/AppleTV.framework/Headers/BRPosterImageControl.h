...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(XXStruct_qlg9jA)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x302f898d
- (void)dealloc;	// 0x302f8a19
- (void)drawInContext:(CGContextRef)context;	// 0x302f8a5d
@end
