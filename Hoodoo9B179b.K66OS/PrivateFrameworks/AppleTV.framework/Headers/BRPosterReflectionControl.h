...
- (id)initWithImageDataSource:(id)imageDataSource reflectionHeight:(XXStruct_qlg9jA)height cornerRadius:(XXStruct_qlg9jA)radius;	// 0x302f8c6d
- (void)dealloc;	// 0x302f8cd1
- (void)drawInContext:(CGContextRef)context;	// 0x302f8cfd
@end
