...
@class NSMutableDictionary, BRImage, BRWaitSpinnerControl, NSArray;
...
@property(assign) BOOL showChapterMarks;	// G=0x302dffb1; S=0x302dff91; converted property
- (id)initWithSpinner:(BOOL)spinner;	// 0x302df5e9
- (id)_cachedImageForName:(id)name;	// 0x302e0481
- (void)_drawChapterMarkersInContext:(CGContextRef)context;	// 0x302e0e59
- (void)_drawInterstitialMarkersInContext:(CGContextRef)context;	// 0x302e11b5
- (id)_loadImageForName:(id)name;	// 0x302e04ed
- (void)_updateDynamicFrames;	// 0x302e08fd
- (void)_updateLeftEnd;	// 0x302e0345
- (void)_updateStaticFrames;	// 0x302e0569
- (void)dealloc;	// 0x302df8a1
- (void)drawInContext:(CGContextRef)context;	// 0x302dfff1
- (void)layoutSubcontrols;	// 0x302dffc1
- (CGRect)leftEndCapRenderableArea;	// 0x302dfc15
- (float)playheadPosition;	// 0x302dfde5
- (CGRect)rightEndCapFrame;	// 0x302dfb71
- (void)setChapterMarkers:(id)markers withTemporaryMarker:(float)temporaryMarker;	// 0x302dfe8d
- (void)setCurrentInterstitialIndex:(long)index;	// 0x302dff71
- (void)setDownloadedRange:(NSRange)range;	// 0x302dfb21
- (void)setDrawsBetweenLeftEdgeAndBufferEdge:(BOOL)edge;	// 0x302df9fd
- (void)setInterstitialMarkers:(id)markers;	// 0x302dff0d
- (void)setPercentComplete:(float)complete;	// 0x302df985
- (void)setPlayerStateHidden:(BOOL)hidden;	// 0x302dfa99
// converted property setter: - (void)setShowChapterMarks:(BOOL)marks;	// 0x302dff91
- (void)setState:(int)state;	// 0x302df929
- (void)setUseWideLeftEndCap:(BOOL)cap;	// 0x302dfa41
- (void)setZeroDuration:(BOOL)duration;	// 0x302dfadd
// converted property getter: - (BOOL)showChapterMarks;	// 0x302dffb1
@end
