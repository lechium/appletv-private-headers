...
- (id)init;	// 0x30ec91c1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x30ec9359
- (void)dealloc;	// 0x30ec92c5
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x30ec91a1
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x30ec9405
@end
