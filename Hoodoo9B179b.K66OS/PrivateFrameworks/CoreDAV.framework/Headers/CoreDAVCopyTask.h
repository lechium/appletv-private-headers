...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x30cb1bd5
- (void)dealloc;	// 0x30cb1b0d
- (id)httpMethod;	// 0x30cb1b01
- (BOOL)validate:(id *)validate;	// 0x30cb1b51
@end
