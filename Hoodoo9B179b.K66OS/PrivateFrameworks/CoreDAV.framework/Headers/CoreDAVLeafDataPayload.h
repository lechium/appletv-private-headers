...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x30ca46d1; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x30ca4699; S=0x30ca46ad; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x30ca46e1; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x30ca4599
// declared property getter: - (id)dataPayload;	// 0x30ca46d1
- (void)dealloc;	// 0x30ca4625
// declared property getter: - (id)serverID;	// 0x30ca4699
// declared property setter: - (void)setServerID:(id)anId;	// 0x30ca46ad
// declared property getter: - (id)syncKey;	// 0x30ca46e1
@end
