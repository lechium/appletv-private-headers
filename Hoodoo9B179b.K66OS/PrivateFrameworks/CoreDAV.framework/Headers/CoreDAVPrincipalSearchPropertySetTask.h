...
- (id)initWithURL:(id)url;	// 0x30cb2ba1
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x30cb2c99
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x30cb2d29
- (id)httpMethod;	// 0x30cb2be1
- (id)requestBody;	// 0x30cb2bed
@end
