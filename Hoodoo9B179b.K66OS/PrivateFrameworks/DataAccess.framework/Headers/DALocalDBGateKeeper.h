...
+ (id)sharedGateKeeper;	// 0x311a8621
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x311a8861
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x311a8669
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x311a8761
- (id)stateString;	// 0x311a87dd
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x311a86e5
@end
