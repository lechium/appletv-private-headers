...
+ (id)instanceWithItems:(id)items;	// 0x34e26e05
- (void)dealloc;	// 0x34e26e7d
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x34e26ec9
- (void)startCompletionBlock:(id)block;	// 0x34e26f41
@end
