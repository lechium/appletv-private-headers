...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x30fe48dd; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x30fe48dd
- (id)contentAsPlainTextPreservingNewlines;	// 0x30fe497d
@end
