...
- (id)initWithRows:(id)rows fileName:(id)name columnCount:(unsigned)count archiver:(id)archiver;	// 0x32a2dac9
- (void)dealloc;	// 0x32a2de89
- (void)mapAt:(id)at withState:(id)state;	// 0x32a2db89
- (CGSize)pageSize;	// 0x32a2dab1
@end
