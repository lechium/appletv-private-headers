...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x328da215
- (void)dealloc;	// 0x328dd6e5
- (bool)loadDelayedNode:(id)node;	// 0x328da7a1
@end
