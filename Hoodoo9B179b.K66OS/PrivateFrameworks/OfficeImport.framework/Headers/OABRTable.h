...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x328f74f1
- (void)createTargetTableContents;	// 0x329450bd
- (void)dealloc;	// 0x328f83e9
- (void)map;	// 0x328f7591
- (void)mapScale;	// 0x328f773d
- (void)readAnchor;	// 0x328f7689
- (void)readCellsAndLines;	// 0x328f800d
- (void)readCoordinates;	// 0x328f79c9
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x32945839
@end
