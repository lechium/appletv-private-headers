...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x34d0fe29; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x34d0fe39; converted property
- (id)initWithMemory:(id)memory;	// 0x34d0fe49
// converted property getter: - (unsigned)indirectsymoff;	// 0x34d0fe29
- (BOOL)isDySymTab;	// 0x34d0fe25
// converted property getter: - (unsigned)nindirectsyms;	// 0x34d0fe39
@end
