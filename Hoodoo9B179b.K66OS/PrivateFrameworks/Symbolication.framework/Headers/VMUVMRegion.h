...
@property(readonly, assign) VMURange range;	// G=0x34d35a5d; converted property
@property(readonly, retain) NSString *type;	// G=0x34d35a91; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x34d35bc1
- (void)dealloc;	// 0x34d35b61
- (id)description;	// 0x34d35e0d
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x34d35e21
- (BOOL)isEqual:(id)equal;	// 0x34d35d75
- (BOOL)isSubmap;	// 0x34d35aa1
- (unsigned)protection;	// 0x34d35a81
// converted property getter: - (VMURange)range;	// 0x34d35a5d
// converted property getter: - (id)type;	// 0x34d35a91
@end
