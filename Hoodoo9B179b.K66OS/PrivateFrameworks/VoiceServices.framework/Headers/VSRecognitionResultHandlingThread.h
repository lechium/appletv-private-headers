...
- (id)init;	// 0x311cc211
- (void)_handleRequests;	// 0x311cc299
- (void)_notifyRequestHandled:(id)handled;	// 0x311cc4b1
- (void)dealloc;	// 0x311cc731
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x311cc589
- (void)invalidate;	// 0x311cc52d
- (void)setDelegate:(id)delegate;	// 0x311cc6d1
@end
