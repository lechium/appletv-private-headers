...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x311ccdc5
- (void)dealloc;	// 0x311ccefd
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x311ccf5d
@end
