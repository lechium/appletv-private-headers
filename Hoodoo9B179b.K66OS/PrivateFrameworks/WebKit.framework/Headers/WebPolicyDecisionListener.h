...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x34575145
- (void)_invalidate;	// 0x34575205
- (void)_usePolicy:(int)policy;	// 0x34575239
- (void)dealloc;	// 0x34575275
- (void)download;	// 0x345751c9
- (void)ignore;	// 0x345751dd
- (void)use;	// 0x345751f1
@end
