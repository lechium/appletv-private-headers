...
- (id)init;	// 0x359b1ef1
- (void)aboutToReadCells;	// 0x359b20d5
- (void)aboutToReadColumnVectors;	// 0x359b1d69
- (void)aboutToReadRowVectors;	// 0x359b1d55
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x359b20a5
- (void)dealloc;	// 0x359b216d
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x359b2015
@end
