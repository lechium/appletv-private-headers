...
- (id)initWithOffset:(long long)offset end:(long long)end uncompressedSize:(unsigned long long)size crc:(unsigned long)crc input:(id)input;	// 0x359b6749
- (void)dealloc;	// 0x359b698d
- (unsigned long)readToBuffer:(char *)buffer size:(unsigned long)size;	// 0x359b69fd
- (void)readToOwnBuffer:(const char **)ownBuffer size:(unsigned *)size;	// 0x359b6c21
@end
