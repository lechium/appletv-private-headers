...
- (id)initWithQueue:(dispatch_queue_s *)queue;	// 0x31e21d0d
- (void)dealloc;	// 0x31e21d79
- (void)handleFSEventPath:(id)path flags:(unsigned long)flags id:(unsigned long long)anId;	// 0x31e21e7d
- (void)setURL:(id)url;	// 0x31e22a6d
- (void)settle;	// 0x31e22bc1
- (void)startWithObserver:(id)observer;	// 0x31e22b5d
- (void)stop;	// 0x31e22f0d
- (void)watchItem;	// 0x31e2202d
@end
