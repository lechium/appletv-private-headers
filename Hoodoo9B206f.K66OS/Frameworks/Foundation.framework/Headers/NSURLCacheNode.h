...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x31dae399
- (void)dealloc;	// 0x31dae539
- (id)description;	// 0x31dae4e5
- (BOOL)isEqual:(id)equal;	// 0x31dae461
@end
