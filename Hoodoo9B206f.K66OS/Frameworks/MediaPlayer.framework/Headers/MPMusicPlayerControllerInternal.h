...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x3038e51d; S=0x3038e4f9; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x3038e2b5
- (void)didPrepareForRemoteSelectorInvocation;	// 0x3038e3d1
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x3038e51d
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x3038e2f5
- (void)serverConnectionDied;	// 0x3038e491
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x3038e4f9
@end
