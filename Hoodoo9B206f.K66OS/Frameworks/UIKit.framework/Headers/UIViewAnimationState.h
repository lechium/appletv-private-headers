...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x3544e36d; 
+ (void)popAnimationState;	// 0x3531af4d
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x3531a2e1
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x3544e36d
- (void)animationDidStart:(id)animation;	// 0x35321205
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x353213a1
- (void)dealloc;	// 0x3531c7ad
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x3531b8d5
- (void)setAnimationAttributes:(id)attributes;	// 0x3532aeb5
@end
