...
@property(retain) UIWebSelection *selection;	// G=0x355e6e79; S=0x355e6e8d; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x355e6ad9
- (void)dealloc;	// 0x355e6b31
- (void)invalidate;	// 0x355e6dcd
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x355e6c19
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x355e6b75
- (int)oppositeEdge:(int)edge;	// 0x355e6bfd
// declared property getter: - (id)selection;	// 0x355e6e79
// declared property setter: - (void)setSelection:(id)selection;	// 0x355e6e8d
@end
