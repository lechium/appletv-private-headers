...
- (id)init;	// 0x3092e811
- (BOOL)_cleanupAccountClass:(id)aClass;	// 0x3092eae1
- (void)accountsHaveBeenSaved:(BOOL)saved;	// 0x3092e965
- (void)dealloc;	// 0x3092ea95
- (int)fixBasicAccountIfNeeded:(id)needed loggingMessage:(id)message;	// 0x3092e9a5
- (id)supportedAccountTypes;	// 0x3092e8f5
@end
