...
+ (id)defaultWhitelist;	// 0x3654611d
- (id)initWithDefaultPath;	// 0x365463a1
- (id)initWithPath:(id)path;	// 0x36546499
- (void)dealloc;	// 0x36546081
- (BOOL)distributionKeyIsWhitelisted:(id)whitelisted;	// 0x36546191
- (BOOL)metadataKeyIsWhitelisted:(id)whitelisted;	// 0x36546149
- (BOOL)scalarKeyIsWhitelisted:(id)whitelisted;	// 0x36546299
@end
