...
+ (void)setSingleton:(id)singleton;	// 0x365a6879
+ (id)singleton;	// 0x365a6869
- (id)init;	// 0x365a6889
- (void)_hidThreadLoop;	// 0x365a6bb9
- (void)_invocationHandler;	// 0x365a6d6d
- (void)dealloc;	// 0x365a6985
- (BOOL)invokeOnHIDThread:(id)thread;	// 0x365a69e5
@end
