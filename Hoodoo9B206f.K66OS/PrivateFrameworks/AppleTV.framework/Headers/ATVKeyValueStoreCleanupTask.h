...
- (void)dealloc;	// 0x365e7749
- (BOOL)perform:(id)perform;	// 0x365e77e9
- (void)setKeyValueStore:(id)store;	// 0x365e7795
- (void)setLastModifiedThreshold:(double)threshold;	// 0x365e77d5
@end
