...
- (id)initWithXPCShmem:(void *)xpcshmem;	// 0x3102668d
- (const void *)bytes;	// 0x310267e9
- (void)dealloc;	// 0x31026711
- (id)debugDescription;	// 0x31026799
- (unsigned)length;	// 0x310267f9
@end
