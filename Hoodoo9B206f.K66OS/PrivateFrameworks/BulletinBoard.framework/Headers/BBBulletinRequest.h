...
@property(assign, nonatomic) int primaryAttachmentType;	// S=0x36d195b1; @dynamic
@property(copy, nonatomic) NSString *publisherBulletinID;	// @dynamic
@property(assign, nonatomic) unsigned realertCount;	// G=0x36d197a9; S=0x36d197b9; 
...
@property(assign, nonatomic) BOOL showsUnreadIndicator;	// G=0x36d19979; S=0x36d19931; 
@property(retain, nonatomic) BBSound *sound;	// @dynamic
@property(copy, nonatomic) NSString *subtitle;	// @dynamic
@property(assign, nonatomic) BOOL tentative;	// G=0x36d199c9; S=0x36d19999; 
@property(retain, nonatomic) NSTimeZone *timeZone;	// @dynamic
@property(copy, nonatomic) NSString *title;	// @dynamic
- (void)addAlertSuppressionAppID:(id)anId;	// 0x36d197c9
- (void)addAttachmentOfType:(int)type;	// 0x36d195e1
- (void)addButton:(id)button;	// 0x36d19611
- (void)generateBulletinID;	// 0x36d1992d
- (void)generateNewBulletinID;	// 0x36d19df5
- (BOOL)hasContentModificationsRelativeTo:(id)to;	// 0x36d199e1
- (void)publish;	// 0x36d19771
- (void)publish:(BOOL)publish;	// 0x36d1975d
- (id)publisherMatchID;	// 0x36d19dc1
// declared property getter: - (unsigned)realertCount;	// 0x36d197a9
- (void)setContextValue:(id)value forKey:(id)key;	// 0x36d194e9
// declared property setter: - (void)setPrimaryAttachmentType:(int)type;	// 0x36d195b1
// declared property setter: - (void)setRealertCount:(unsigned)count;	// 0x36d197b9
// declared property setter: - (void)setShowsUnreadIndicator:(BOOL)indicator;	// 0x36d19931
// declared property setter: - (void)setTentative:(BOOL)tentative;	// 0x36d19999
- (void)setUnlockActionLabel:(id)label;	// 0x36d19799
// declared property getter: - (BOOL)showsUnreadIndicator;	// 0x36d19979
// declared property getter: - (BOOL)tentative;	// 0x36d199c9
- (void)withdraw;	// 0x36d19785
@end
