...
- (id)init;	// 0x323fc1c1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x323fc359
- (void)dealloc;	// 0x323fc2c5
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x323fc1a1
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x323fc405
@end
