...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x339ee6d1; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x339ee699; S=0x339ee6ad; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x339ee6e1; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x339ee599
// declared property getter: - (id)dataPayload;	// 0x339ee6d1
- (void)dealloc;	// 0x339ee625
// declared property getter: - (id)serverID;	// 0x339ee699
// declared property setter: - (void)setServerID:(id)anId;	// 0x339ee6ad
// declared property getter: - (id)syncKey;	// 0x339ee6e1
@end
