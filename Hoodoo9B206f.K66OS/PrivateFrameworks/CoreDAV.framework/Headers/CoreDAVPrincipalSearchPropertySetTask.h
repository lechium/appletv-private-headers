...
- (id)initWithURL:(id)url;	// 0x339fcba1
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x339fcc99
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x339fcd29
- (id)httpMethod;	// 0x339fcbe1
- (id)requestBody;	// 0x339fcbed
@end
