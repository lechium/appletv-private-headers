...
+ (id)instanceWithItems:(id)items;	// 0x33957e05
- (void)dealloc;	// 0x33957e7d
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x33957ec9
- (void)startCompletionBlock:(id)block;	// 0x33957f41
@end
