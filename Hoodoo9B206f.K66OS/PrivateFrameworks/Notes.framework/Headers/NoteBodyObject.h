...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x30f068dd; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x30f068dd
- (id)contentAsPlainTextPreservingNewlines;	// 0x30f0697d
@end
