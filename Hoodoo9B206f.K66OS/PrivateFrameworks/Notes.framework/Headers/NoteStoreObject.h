...
- (id)basicAccountIdentifier;	// 0x30f0688d
- (id)collectionInfo;	// 0x30f06751
- (unsigned)maximumServerIntId;	// 0x30f06469
- (id)notesForGUIDs:(id)guids;	// 0x30f0600d
- (id)notesForIntegerIds:(id)integerIds;	// 0x30f05ea1
- (id)notesForServerIds:(id)serverIds;	// 0x30f05d35
- (id)notesForServerIntIds:(id)serverIntIds;	// 0x30f06179
- (id)notesForServerIntIdsInRange:(NSRange)range;	// 0x30f062e5
- (id)predicateForNotes;	// 0x30f0671d
@end
