...
+ (id)autoStylingWithChart:(id)chart;	// 0x344d5ed1
- (id)initWithChart:(id)chart;	// 0x344d5f6d
- (void)dealloc;	// 0x344e5135
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x344e2bd9
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x34527a69
@end
