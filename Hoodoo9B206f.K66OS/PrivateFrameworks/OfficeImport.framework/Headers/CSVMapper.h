...
- (id)initWithRows:(id)rows fileName:(id)name columnCount:(unsigned)count archiver:(id)archiver;	// 0x3466dac9
- (void)dealloc;	// 0x3466de89
- (void)mapAt:(id)at withState:(id)state;	// 0x3466db89
- (CGSize)pageSize;	// 0x3466dab1
@end
