...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x345374f1
- (void)createTargetTableContents;	// 0x345850bd
- (void)dealloc;	// 0x345383e9
- (void)map;	// 0x34537591
- (void)mapScale;	// 0x3453773d
- (void)readAnchor;	// 0x34537689
- (void)readCellsAndLines;	// 0x3453800d
- (void)readCoordinates;	// 0x345379c9
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x34585839
@end
