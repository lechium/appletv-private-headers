...
- (id)initForScheduledWake:(BOOL)scheduledWake wakeDate:(id)date serviceIdentifier:(id)identifier uniqueIdentifier:(void *)identifier4;	// 0x33139cf9
- (void)dealloc;	// 0x33139901
- (void)main;	// 0x33139961
@end
