...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x30bb2e29; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x30bb2e39; converted property
- (id)initWithMemory:(id)memory;	// 0x30bb2e49
// converted property getter: - (unsigned)indirectsymoff;	// 0x30bb2e29
- (BOOL)isDySymTab;	// 0x30bb2e25
// converted property getter: - (unsigned)nindirectsyms;	// 0x30bb2e39
@end
