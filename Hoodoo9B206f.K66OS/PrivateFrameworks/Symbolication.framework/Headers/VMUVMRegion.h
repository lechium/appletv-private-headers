...
@property(readonly, assign) VMURange range;	// G=0x30bd8a5d; converted property
@property(readonly, retain) NSString *type;	// G=0x30bd8a91; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x30bd8bc1
- (void)dealloc;	// 0x30bd8b61
- (id)description;	// 0x30bd8e0d
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x30bd8e21
- (BOOL)isEqual:(id)equal;	// 0x30bd8d75
- (BOOL)isSubmap;	// 0x30bd8aa1
- (unsigned)protection;	// 0x30bd8a81
// converted property getter: - (VMURange)range;	// 0x30bd8a5d
// converted property getter: - (id)type;	// 0x30bd8a91
@end
