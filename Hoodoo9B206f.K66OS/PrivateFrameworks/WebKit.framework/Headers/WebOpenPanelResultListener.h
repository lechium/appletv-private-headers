...
- (id)initWithChooser:(PassRefPtr<WebCore::FileChooser>)chooser;	// 0x30d39669
- (void)cancel;	// 0x30d39aa1
- (void)chooseFilename:(id)filename;	// 0x30d39959
- (void)chooseFilenames:(id)filenames;	// 0x30d396b1
@end
