...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x30d6d145
- (void)_invalidate;	// 0x30d6d205
- (void)_usePolicy:(int)policy;	// 0x30d6d239
- (void)dealloc;	// 0x30d6d275
- (void)download;	// 0x30d6d1c9
- (void)ignore;	// 0x30d6d1dd
- (void)use;	// 0x30d6d1f1
@end
