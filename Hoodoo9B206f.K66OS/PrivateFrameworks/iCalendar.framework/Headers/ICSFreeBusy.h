...
@property(retain) NSArray *freebusy;	// G=0x352a9ae5; S=0x352a9b05; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x352a9b25; S=0x352a9b6d; 
+ (id)name;	// 0x352a9ad9
// declared property getter: - (id)freebusy;	// 0x352a9ae5
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x352a9b05
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x352a9b6d
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x352a9b25
@end
