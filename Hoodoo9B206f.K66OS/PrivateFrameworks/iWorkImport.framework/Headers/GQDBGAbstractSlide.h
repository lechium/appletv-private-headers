...
- (char *)ID;	// 0x33fbb485
- (void)dealloc;	// 0x33fbb5cd
- (BOOL)isHidden;	// 0x33fbb475
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x33fbb561
- (id)slideStyle;	// 0x33fbb455
- (id)stylesheet;	// 0x33fbb465
@end
