...
- (id)initWithOffset:(long long)offset end:(long long)end uncompressedSize:(unsigned long long)size crc:(unsigned long)crc input:(id)input;	// 0x34005749
- (void)dealloc;	// 0x3400598d
- (unsigned long)readToBuffer:(char *)buffer size:(unsigned long)size;	// 0x340059fd
- (void)readToOwnBuffer:(const char **)ownBuffer size:(unsigned *)size;	// 0x34005c21
@end
