...
@class AVCaptureVideoPreviewLayer, AVWeakReference, NSMutableArray, AVRunLoopCondition, NSError, AVCaptureFigAudioDevice, NSMutableDictionary, AVCaptureFigVideoDevice, NSString;
