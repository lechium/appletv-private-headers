...
- (id)init;	// 0x315336c1
- (void)_notificationHandler:(id)handler;	// 0x315340c1
- (void)dealloc;	// 0x315338b5
- (void)notificationCallback;	// 0x31533a91
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x31533805
@end
