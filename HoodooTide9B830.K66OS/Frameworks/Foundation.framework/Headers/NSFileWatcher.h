...
- (id)initWithQueue:(dispatch_queue_s *)queue;	// 0x316a1d0d
- (void)dealloc;	// 0x316a1d79
- (void)handleFSEventPath:(id)path flags:(unsigned long)flags id:(unsigned long long)anId;	// 0x316a1e7d
- (void)setURL:(id)url;	// 0x316a2a6d
- (void)settle;	// 0x316a2bc1
- (void)startWithObserver:(id)observer;	// 0x316a2b5d
- (void)stop;	// 0x316a2f0d
- (void)watchItem;	// 0x316a202d
@end
