...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x3162e399
- (void)dealloc;	// 0x3162e539
- (id)description;	// 0x3162e4e5
- (BOOL)isEqual:(id)equal;	// 0x3162e461
@end
