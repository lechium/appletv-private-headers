...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x3468551d; S=0x346854f9; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x346852b5
- (void)didPrepareForRemoteSelectorInvocation;	// 0x346853d1
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x3468551d
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x346852f5
- (void)serverConnectionDied;	// 0x34685491
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x346854f9
@end
