...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x3016136d; 
+ (void)popAnimationState;	// 0x3002df4d
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x3002d2e1
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x3016136d
- (void)animationDidStart:(id)animation;	// 0x30034205
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x300343a1
- (void)dealloc;	// 0x3002f7ad
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x3002e8d5
- (void)setAnimationAttributes:(id)attributes;	// 0x3003deb5
@end
