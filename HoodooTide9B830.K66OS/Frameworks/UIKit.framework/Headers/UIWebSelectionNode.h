...
@property(retain) UIWebSelection *selection;	// G=0x302f9e79; S=0x302f9e8d; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x302f9ad9
- (void)dealloc;	// 0x302f9b31
- (void)invalidate;	// 0x302f9dcd
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x302f9c19
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x302f9b75
- (int)oppositeEdge:(int)edge;	// 0x302f9bfd
// declared property getter: - (id)selection;	// 0x302f9e79
// declared property setter: - (void)setSelection:(id)selection;	// 0x302f9e8d
@end
