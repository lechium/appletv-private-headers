...
@property(retain, nonatomic) MRImage *slide;	// G=0x322068b5; S=0x32206871; @synthesize
+ (void)initialize;	// 0x32206661
+ (XXStruct_01lTDD *)poolInfo;	// 0x32206651
- (void)dealloc;	// 0x322067f5
- (void)purge;	// 0x32206835
// declared property setter: - (void)setSlide:(id)slide;	// 0x32206871
// declared property getter: - (id)slide;	// 0x322068b5
@end
