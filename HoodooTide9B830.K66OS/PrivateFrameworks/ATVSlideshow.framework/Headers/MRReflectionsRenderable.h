...
+ (XXStruct_01lTDD *)poolInfo;	// 0x320f780d
- (id)initWithSlide:(id)slide sprite:(id)sprite modelViewMatrix:(const float *)matrix position:(CGPoint)position size:(CGSize)size flipped:(BOOL)flipped isShadow:(BOOL)shadow;	// 0x320f781d
- (void)dealloc;	// 0x320f7965
- (void)purge;	// 0x320f7909
@end
