...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x30dcb0a5
- (void)dealloc;	// 0x30dcb171
- (void)forwardInvocation:(id)invocation;	// 0x30dcb1e5
- (id)methodSignatureForSelector:(SEL)selector;	// 0x30dcb19d
@end
