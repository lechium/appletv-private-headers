...
+ (id)defaultWhitelist;	// 0x348e711d
- (id)initWithDefaultPath;	// 0x348e73a1
- (id)initWithPath:(id)path;	// 0x348e7499
- (void)dealloc;	// 0x348e7081
- (BOOL)distributionKeyIsWhitelisted:(id)whitelisted;	// 0x348e7191
- (BOOL)metadataKeyIsWhitelisted:(id)whitelisted;	// 0x348e7149
- (BOOL)scalarKeyIsWhitelisted:(id)whitelisted;	// 0x348e7299
@end
