...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x32ab1b3d
- (unsigned)count;	// 0x32ab1f8d
- (void)dealloc;	// 0x32ab1f41
- (unsigned)indexOfObject:(id)object;	// 0x32ab2061
- (id)objectAtIndex:(unsigned)index;	// 0x32ab1fc1
@end
