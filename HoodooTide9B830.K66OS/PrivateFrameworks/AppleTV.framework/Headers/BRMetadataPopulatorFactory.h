...
+ (void)setSingleton:(id)singleton;	// 0x32a56295
+ (id)singleton;	// 0x32a56285
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x32a56451
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x32a56a2d
- (void)dealloc;	// 0x32a562a5
- (id)populatorForAsset:(id)asset;	// 0x32a563e1
@end
