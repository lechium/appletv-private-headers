...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(XXStruct_qlg9jA)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x32a3b701
- (void)dealloc;	// 0x32a3b78d
- (void)drawInContext:(CGContextRef)context;	// 0x32a3b7d1
@end
