...
- (id)initWithImageDataSource:(id)imageDataSource reflectionHeight:(XXStruct_qlg9jA)height cornerRadius:(XXStruct_qlg9jA)radius;	// 0x32a3b9e1
- (void)dealloc;	// 0x32a3ba45
- (void)drawInContext:(CGContextRef)context;	// 0x32a3ba71
@end
