...
@property(assign, nonatomic) int primaryAttachmentType;	// S=0x3426a5b1; @dynamic
@property(copy, nonatomic) NSString *publisherBulletinID;	// @dynamic
@property(assign, nonatomic) unsigned realertCount;	// G=0x3426a7a9; S=0x3426a7b9; 
...
@property(assign, nonatomic) BOOL showsUnreadIndicator;	// G=0x3426a979; S=0x3426a931; 
@property(retain, nonatomic) BBSound *sound;	// @dynamic
@property(copy, nonatomic) NSString *subtitle;	// @dynamic
@property(assign, nonatomic) BOOL tentative;	// G=0x3426a9c9; S=0x3426a999; 
@property(retain, nonatomic) NSTimeZone *timeZone;	// @dynamic
@property(copy, nonatomic) NSString *title;	// @dynamic
- (void)addAlertSuppressionAppID:(id)anId;	// 0x3426a7c9
- (void)addAttachmentOfType:(int)type;	// 0x3426a5e1
- (void)addButton:(id)button;	// 0x3426a611
- (void)generateBulletinID;	// 0x3426a92d
- (void)generateNewBulletinID;	// 0x3426adf5
- (BOOL)hasContentModificationsRelativeTo:(id)to;	// 0x3426a9e1
- (void)publish;	// 0x3426a771
- (void)publish:(BOOL)publish;	// 0x3426a75d
- (id)publisherMatchID;	// 0x3426adc1
// declared property getter: - (unsigned)realertCount;	// 0x3426a7a9
- (void)setContextValue:(id)value forKey:(id)key;	// 0x3426a4e9
// declared property setter: - (void)setPrimaryAttachmentType:(int)type;	// 0x3426a5b1
// declared property setter: - (void)setRealertCount:(unsigned)count;	// 0x3426a7b9
// declared property setter: - (void)setShowsUnreadIndicator:(BOOL)indicator;	// 0x3426a931
// declared property setter: - (void)setTentative:(BOOL)tentative;	// 0x3426a999
- (void)setUnlockActionLabel:(id)label;	// 0x3426a799
// declared property getter: - (BOOL)showsUnreadIndicator;	// 0x3426a979
// declared property getter: - (BOOL)tentative;	// 0x3426a9c9
- (void)withdraw;	// 0x3426a785
@end
