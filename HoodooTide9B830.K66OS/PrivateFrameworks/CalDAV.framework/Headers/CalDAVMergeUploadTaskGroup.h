...
- (id)initWithCalendar:(id)calendar principal:(id)principal accountInfoProvider:(id)provider taskManager:(id)manager;	// 0x314911e9
- (void)cancelTaskGroup;	// 0x3149126d
- (id)dataContentType;	// 0x314911dd
- (void)dealloc;	// 0x31491849
- (void)startTaskGroup;	// 0x314912b1
@end
