...
- (id)init;	// 0x306b41c1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x306b4359
- (void)dealloc;	// 0x306b42c5
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x306b41a1
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x306b4405
@end
