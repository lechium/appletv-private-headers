...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x35dd0bd5
- (void)dealloc;	// 0x35dd0b0d
- (id)httpMethod;	// 0x35dd0b01
- (BOOL)validate:(id *)validate;	// 0x35dd0b51
@end
