...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x35dc36d1; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x35dc3699; S=0x35dc36ad; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x35dc36e1; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x35dc3599
// declared property getter: - (id)dataPayload;	// 0x35dc36d1
- (void)dealloc;	// 0x35dc3625
// declared property getter: - (id)serverID;	// 0x35dc3699
// declared property setter: - (void)setServerID:(id)anId;	// 0x35dc36ad
// declared property getter: - (id)syncKey;	// 0x35dc36e1
@end
