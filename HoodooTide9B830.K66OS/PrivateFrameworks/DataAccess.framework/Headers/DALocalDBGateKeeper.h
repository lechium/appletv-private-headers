...
+ (id)sharedGateKeeper;	// 0x325a1621
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x325a1861
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x325a1669
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x325a1761
- (id)stateString;	// 0x325a17dd
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x325a16e5
@end
