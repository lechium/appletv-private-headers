...
+ (id)instanceWithItems:(id)items;	// 0x36e58e05
- (void)dealloc;	// 0x36e58e7d
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x36e58ec9
- (void)startCompletionBlock:(id)block;	// 0x36e58f41
@end
