...
@property(readonly, retain) NSMutableData *data;	// G=0x36d33825; converted property
- (id)init;	// 0x36d33535
- (int)appendData:(id)data;	// 0x36d335ad
// converted property getter: - (id)data;	// 0x36d33825
- (void)dealloc;	// 0x36d339b9
- (void)done;	// 0x36d334cd
@end
