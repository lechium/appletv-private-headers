...
- (id)init;	// 0x3636ebdd
- (void)dealloc;	// 0x3636ec29
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x3636ecd9
- (void)request:(id)request didFailWithError:(id)error;	// 0x3636ecdd
- (void)requestDidFinish:(id)request;	// 0x3636f191
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x3636ec89
- (void)setRequest:(id)request;	// 0x3636ec99
@end
