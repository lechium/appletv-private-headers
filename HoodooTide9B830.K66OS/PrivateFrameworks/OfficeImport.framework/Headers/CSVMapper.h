...
- (id)initWithRows:(id)rows fileName:(id)name columnCount:(unsigned)count archiver:(id)archiver;	// 0x313ddac9
- (void)dealloc;	// 0x313dde89
- (void)mapAt:(id)at withState:(id)state;	// 0x313ddb89
- (CGSize)pageSize;	// 0x313ddab1
@end
