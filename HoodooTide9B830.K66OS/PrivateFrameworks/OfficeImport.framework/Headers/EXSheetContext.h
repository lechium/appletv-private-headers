...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x3128a215
- (void)dealloc;	// 0x3128d6e5
- (bool)loadDelayedNode:(id)node;	// 0x3128a7a1
@end
