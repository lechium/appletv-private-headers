...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x31bbfe29; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x31bbfe39; converted property
- (id)initWithMemory:(id)memory;	// 0x31bbfe49
// converted property getter: - (unsigned)indirectsymoff;	// 0x31bbfe29
- (BOOL)isDySymTab;	// 0x31bbfe25
// converted property getter: - (unsigned)nindirectsyms;	// 0x31bbfe39
@end
