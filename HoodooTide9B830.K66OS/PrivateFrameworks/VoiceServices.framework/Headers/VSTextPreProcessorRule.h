...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x348dcdc5
- (void)dealloc;	// 0x348dcefd
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x348dcf5d
@end
