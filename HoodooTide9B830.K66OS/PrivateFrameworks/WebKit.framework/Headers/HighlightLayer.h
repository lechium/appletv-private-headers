...
- (id)initWithHighlightView:(id)highlightView webView:(id)view;	// 0x3529e601
- (id)actionForKey:(id)key;	// 0x3529e5ad
- (void)drawInContext:(CGContextRef)context;	// 0x3529e655
@end
