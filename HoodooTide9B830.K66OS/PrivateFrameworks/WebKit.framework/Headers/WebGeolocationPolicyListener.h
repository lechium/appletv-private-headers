...
- (id)initWithGeolocation:(Geolocation *)geolocation;	// 0x35270add
- (id).cxx_construct;	// 0x35270655
- (void).cxx_destruct;	// 0x35270b4d
- (void)allow;	// 0x35270b95
- (void)deny;	// 0x35270b81
- (BOOL)shouldClearCache;	// 0x35270641
@end
