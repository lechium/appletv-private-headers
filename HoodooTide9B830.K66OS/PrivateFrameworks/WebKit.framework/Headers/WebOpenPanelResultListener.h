...
- (id)initWithChooser:(PassRefPtr<WebCore::FileChooser>)chooser;	// 0x35270669
- (void)cancel;	// 0x35270aa1
- (void)chooseFilename:(id)filename;	// 0x35270959
- (void)chooseFilenames:(id)filenames;	// 0x352706b1
@end
