...
@property(retain) NSArray *freebusy;	// G=0x32800ae5; S=0x32800b05; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x32800b25; S=0x32800b6d; 
+ (id)name;	// 0x32800ad9
// declared property getter: - (id)freebusy;	// 0x32800ae5
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x32800b05
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x32800b6d
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x32800b25
@end
