...
- (char *)ID;	// 0x3179d485
- (void)dealloc;	// 0x3179d5cd
- (BOOL)isHidden;	// 0x3179d475
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x3179d561
- (id)slideStyle;	// 0x3179d455
- (id)stylesheet;	// 0x3179d465
@end
