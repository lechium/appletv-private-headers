...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x317b4da5
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x317b267d
+ (const StateSpec *)stateForReading;	// 0x317b13f1
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x317b4515
- (id)baseStringFromDouble:(double)aDouble;	// 0x317b4b11
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x317b2c31
- (id)currencyCode;	// 0x317b1461
- (id)customNumberFormatTokens;	// 0x317b18b9
- (void)dealloc;	// 0x317b395d
- (id)formatString;	// 0x317b1451
- (int)fractionAccuracy;	// 0x317b14a1
- (id)fractionStringFromDouble:(double)aDouble;	// 0x317b4925
- (BOOL)hasValidDecimalPlaces;	// 0x317b13fd
- (BOOL)isCustom;	// 0x317b1481
- (BOOL)isTextFormat;	// 0x317b1491
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x317b1595
- (id)numberFormatBySettingValueType:(int)type;	// 0x317b1765
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x317b414d
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x317b1441
- (BOOL)showThousandsSeparator;	// 0x317b1471
- (id)stringFromDouble:(double)aDouble;	// 0x317b2ce5
- (BOOL)useAccountingStyle;	// 0x317b1431
- (int)valueType;	// 0x317b1421
@end
