...
- (id)init;	// 0x317e2ef1
- (void)aboutToReadCells;	// 0x317e30d5
- (void)aboutToReadColumnVectors;	// 0x317e2d69
- (void)aboutToReadRowVectors;	// 0x317e2d55
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x317e30a5
- (void)dealloc;	// 0x317e316d
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x317e3015
@end
