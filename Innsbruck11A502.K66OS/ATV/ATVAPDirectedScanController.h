...
@class BRHeaderControl, NSString, BRTextControl, BRWaitSpinnerControl;
...
- (id)initWithNetworkName:(id)networkName;	// 0x211b09
- (void)dealloc;	// 0x211ca9
- (void)setFrame:(CGRect)frame;	// 0x211d35
@end
