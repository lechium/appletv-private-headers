...
+ (void)setSingleton:(id)singleton;	// 0x231189
+ (id)singleton;	// 0x231179
- (id)init;	// 0x231199
- (void)_hidThreadLoop;	// 0x2314dd
- (void)_invocationHandler;	// 0x2316ad
- (void)dealloc;	// 0x231291
- (BOOL)invokeOnHIDThread:(id)thread;	// 0x2312f5
@end
