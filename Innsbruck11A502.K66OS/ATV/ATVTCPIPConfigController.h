...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x215d71; S=0x215d81; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x215621
- (void).cxx_destruct;	// 0x215d91
- (void)_readCurrentConfiguration;	// 0x215e4d
- (void)_saveConfiguration;	// 0x215fad
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x215705
- (void)entryComplete:(id)complete;	// 0x2159b1
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x215d81
// declared property getter: - (BOOL)showOnlyDNS;	// 0x215d71
@end
