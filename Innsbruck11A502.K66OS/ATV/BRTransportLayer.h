...
@property(assign) BOOL showChapterMarks;	// G=0x3b0141; S=0x3b0121; converted property
@property(assign) int state;	// G=0x3af9d1; S=0x3af9e1; converted property
- (id)initWithSpinner:(BOOL)spinner;	// 0x3af679
- (id)_cachedImageForName:(id)name;	// 0x3b05e5
- (void)_drawChapterMarkersInContext:(CGContextRef)context;	// 0x3b10b5
- (void)_drawInterstitialMarkersInContext:(CGContextRef)context;	// 0x3b1429
- (id)_loadImageForName:(id)name;	// 0x3b0651
- (void)_updateDynamicFrames;	// 0x3b0ae9
- (void)_updateLeftEnd;	// 0x3b04b5
- (void)_updateStaticFrames;	// 0x3b06c5
- (void)dealloc;	// 0x3af945
- (void)drawRect:(CGRect)rect;	// 0x3b0181
- (void)layoutSubcontrols;	// 0x3b0151
- (CGRect)leftEndCapRenderableArea;	// 0x3afdb9
- (float)playheadPosition;	// 0x3aff81
- (CGRect)rightEndCapExtensionFrame;	// 0x3afd21
- (CGRect)rightEndCapFrame;	// 0x3afc8d
- (void)setChapterMarkers:(id)markers withTemporaryMarker:(float)temporaryMarker;	// 0x3b0021
- (void)setCurrentInterstitialIndex:(long)index;	// 0x3b0101
- (void)setDownloadedRange:(NSRange)range;	// 0x3afc39
- (void)setDrawsBetweenLeftEdgeAndBufferEdge:(BOOL)edge;	// 0x3afab1
- (void)setInterstitialMarkers:(id)markers;	// 0x3b009d
- (void)setPercentComplete:(float)complete;	// 0x3afa3d
- (void)setPlayerStateHidden:(BOOL)hidden;	// 0x3afba9
// converted property setter: - (void)setShowChapterMarks:(BOOL)marks;	// 0x3b0121
// converted property setter: - (void)setState:(int)state;	// 0x3af9e1
- (void)setUseWideLeftEndCap:(BOOL)cap;	// 0x3afaf9
- (void)setUseWideRightEndCap:(BOOL)cap;	// 0x3afb51
- (void)setZeroDuration:(BOOL)duration;	// 0x3afbf1
// converted property getter: - (BOOL)showChapterMarks;	// 0x3b0141
// converted property getter: - (int)state;	// 0x3af9d1
@end
