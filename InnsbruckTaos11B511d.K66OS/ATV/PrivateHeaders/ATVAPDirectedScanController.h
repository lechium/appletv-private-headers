...
@class BRWaitSpinnerControl, BRHeaderControl, NSString, BRTextControl;
...
- (id)initWithNetworkName:(id)networkName;	// 0x214f99
- (void)dealloc;	// 0x215139
- (void)setFrame:(CGRect)frame;	// 0x2151c5
@end
