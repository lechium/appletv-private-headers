...
+ (void)setSingleton:(id)singleton;	// 0x234899
+ (id)singleton;	// 0x234889
- (id)init;	// 0x2348a9
- (void)_hidThreadLoop;	// 0x234bed
- (void)_invocationHandler;	// 0x234dbd
- (void)dealloc;	// 0x2349a1
- (BOOL)invokeOnHIDThread:(id)thread;	// 0x234a05
@end
