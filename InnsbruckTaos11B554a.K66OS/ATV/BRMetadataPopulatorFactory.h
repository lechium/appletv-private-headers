...
+ (void)setSingleton:(id)singleton;	// 0x3f1ff1
+ (id)singleton;	// 0x3f1fe1
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x3f21b1
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x3f2639
- (void)dealloc;	// 0x3f2001
- (id)populatorForAsset:(id)asset;	// 0x3f2141
@end
