...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x2087e1; S=0x2087f1; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x208091
- (void).cxx_destruct;	// 0x208801
- (void)_readCurrentConfiguration;	// 0x2088bd
- (void)_saveConfiguration;	// 0x208a1d
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x208175
- (void)entryComplete:(id)complete;	// 0x208421
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x2087f1
// declared property getter: - (BOOL)showOnlyDNS;	// 0x2087e1
@end
