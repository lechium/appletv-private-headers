...
+ (void)setSingleton:(id)singleton;	// 0x3ccfcd
+ (id)singleton;	// 0x3ccfbd
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x3cd18d
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x3cd5f1
- (void)dealloc;	// 0x3ccfdd
- (id)populatorForAsset:(id)asset;	// 0x3cd11d
@end
