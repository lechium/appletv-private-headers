...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(XXStruct_qlg9jA)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x3ab11d
- (void)dealloc;	// 0x3ab1a9
- (void)drawRect:(CGRect)rect;	// 0x3ab1ed
@end
