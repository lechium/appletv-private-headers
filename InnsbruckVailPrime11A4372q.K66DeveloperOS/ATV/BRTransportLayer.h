...
@class BRWaitSpinnerControl, NSArray, NSMutableDictionary, ATVImage;
...
@property(assign) BOOL showChapterMarks;	// G=0x3907c1; S=0x3907a1; converted property
@property(assign) int state;	// G=0x390051; S=0x390061; converted property
- (id)initWithSpinner:(BOOL)spinner;	// 0x38fcf9
- (id)_cachedImageForName:(id)name;	// 0x390c65
- (void)_drawChapterMarkersInContext:(CGContextRef)context;	// 0x391735
- (void)_drawInterstitialMarkersInContext:(CGContextRef)context;	// 0x391aa9
- (id)_loadImageForName:(id)name;	// 0x390cd1
- (void)_updateDynamicFrames;	// 0x391169
- (void)_updateLeftEnd;	// 0x390b35
- (void)_updateStaticFrames;	// 0x390d45
- (void)dealloc;	// 0x38ffc5
- (void)drawRect:(CGRect)rect;	// 0x390801
- (void)layoutSubcontrols;	// 0x3907d1
- (CGRect)leftEndCapRenderableArea;	// 0x390439
- (float)playheadPosition;	// 0x390601
- (CGRect)rightEndCapExtensionFrame;	// 0x3903a1
- (CGRect)rightEndCapFrame;	// 0x39030d
- (void)setChapterMarkers:(id)markers withTemporaryMarker:(float)temporaryMarker;	// 0x3906a1
- (void)setCurrentInterstitialIndex:(long)index;	// 0x390781
- (void)setDownloadedRange:(NSRange)range;	// 0x3902b9
- (void)setDrawsBetweenLeftEdgeAndBufferEdge:(BOOL)edge;	// 0x390131
- (void)setInterstitialMarkers:(id)markers;	// 0x39071d
- (void)setPercentComplete:(float)complete;	// 0x3900bd
- (void)setPlayerStateHidden:(BOOL)hidden;	// 0x390229
// converted property setter: - (void)setShowChapterMarks:(BOOL)marks;	// 0x3907a1
// converted property setter: - (void)setState:(int)state;	// 0x390061
- (void)setUseWideLeftEndCap:(BOOL)cap;	// 0x390179
- (void)setUseWideRightEndCap:(BOOL)cap;	// 0x3901d1
- (void)setZeroDuration:(BOOL)duration;	// 0x390271
// converted property getter: - (BOOL)showChapterMarks;	// 0x3907c1
// converted property getter: - (int)state;	// 0x390051
@end
