...
- (id)initWithHistoryController:(id)historyController;	// 0x279b49
- (void).cxx_destruct;	// 0x279ca9
- (id)itemForIndex:(id)index;	// 0x279ba1
- (BOOL)itemSelectedAtIndex:(id)index action:(int)action defer:(BOOL *)defer;	// 0x279c75
@end
