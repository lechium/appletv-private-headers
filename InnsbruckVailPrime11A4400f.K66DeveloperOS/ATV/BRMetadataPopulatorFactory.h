...
+ (void)setSingleton:(id)singleton;	// 0x3b6471
+ (id)singleton;	// 0x3b6461
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x3b6631
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x3b6a95
- (void)dealloc;	// 0x3b6481
- (id)populatorForAsset:(id)asset;	// 0x3b65c1
@end
