...
typedef struct CalScheduledTaskCache CalScheduledTaskCache;
...
typedef struct CalDatabase {
	...
	CalScheduledTaskCache *_field5;
	CFDictionaryRef _field6;
	CFDictionaryRef _field7;
	...
	opaque_pthread_mutex_t _field19;
} CalDatabase;
