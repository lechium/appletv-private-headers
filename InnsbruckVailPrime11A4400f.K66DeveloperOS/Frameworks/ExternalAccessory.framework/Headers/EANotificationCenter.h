...
- (id)init;	// 0x2db4a741
- (void)_notificationHandler:(id)handler;	// 0x2db4b10d
- (void)dealloc;	// 0x2db4a939
- (void)notificationCallback;	// 0x2db4ab0d
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x2db4a889
@end
