...
struct Behavior {
	...
	Atomic _field2;
	unsigned _field3;
	Ref<CA::Render::String> _field4;
	unsigned _field5;
	unsigned _field6;
	unsigned _field7 : 8;
	unsigned _field8 : 8;
	Ref<const CA::Render::Behavior> _field9;
};
...
typedef struct _CAMLWriterAttribute *CAMLWriterAttributeRef;
typedef struct _CAMLWriterElement {
	CAMLWriterElement *_field1;
	CAMLWriterElement *_field2;
	CAMLWriterElement *_field3;
	CAMLWriterElement **_field4;
	void *_field5;
	CFStringRef _field6;
	CAMLWriterAttributeRef _field7;
	CAMLWriterAttributeRef *_field8;
	CFStringRef _field9;
	unsigned _field10;
} CAMLWriterElement;
...
struct _CAMLWriterAttribute *CAMLWriterAttributeRef;
...
typedef struct DisplayLinkItem {
	Display *_field1;
	void *_field2;
	SEL _field3;
	void *_field4;
	...
	Mutex _field6;
	Condition _field7;
	opaque_pthread_t *_field8;
	id _field9;
	Ref<CA::Display::DisplayLink> _field10;
	List<const __CFString *> *_field11;
