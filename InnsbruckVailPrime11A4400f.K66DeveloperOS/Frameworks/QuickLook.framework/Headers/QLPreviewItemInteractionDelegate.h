...
- (void)previewItem:(id)item willEnterFullScreenWithHostedWindow:(id)hostedWindow;
...
- (void)previewItemDidExitFullScreen:(id)previewItem;
- (void)previewItemDidLoad:(id)previewItem atIndex:(int)index withError:(id)error;
- (void)previewItemWillLoad:(id)previewItem;
- (void)showContentsWasTappedForPreviewItem:(id)previewItem;
- (void)viewDidUpdateForPreviewItem:(id)view;
