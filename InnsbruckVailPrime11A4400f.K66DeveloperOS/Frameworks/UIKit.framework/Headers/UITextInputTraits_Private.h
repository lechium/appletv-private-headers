...
// declared property getter: - (BOOL)enablesReturnKeyOnNonWhiteSpaceContent;
...
// declared property getter: - (BOOL)isSingleLineDocument;
...
// declared property setter: - (void)setEnablesReturnKeyOnNonWhiteSpaceContent:(BOOL)content;
...
// declared property setter: - (void)setIsSingleLineDocument:(BOOL)document;
