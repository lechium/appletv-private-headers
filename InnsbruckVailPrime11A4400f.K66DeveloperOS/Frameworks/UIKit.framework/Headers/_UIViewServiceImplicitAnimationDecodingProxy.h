...
+ (id)proxyDecodingAnimationsForTarget:(id)target;	// 0x2f904665
- (void)__animateNextInvocationOfSelector:(id)selector withAnimationAttributes:(id)animationAttributes;	// 0x2f904839
- (void)dealloc;	// 0x2f904691
- (void)forwardInvocation:(id)invocation;	// 0x2f9046dd
- (id)proxy:(id)proxy detailedSignatureForSelector:(SEL)selector;	// 0x2f904895
@end
