...
- (id)init;	// 0x2fb3471d
- (id)initWithCoder:(id)coder;	// 0x2fb34b7d
- (void)dealloc;	// 0x2fb3481d
- (void)encodeWithCoder:(id)coder;	// 0x2fb34c79
- (id)error;	// 0x2fb34b6d
- (void)finalize;	// 0x2fb349ed
- (BOOL)isSuccessful;	// 0x2fb34b4d
- (id)result;	// 0x2fb34b5d
@end
