...
- (id)init;	// 0x2fd45b41
- (void)_loadForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x2fd466d5
- (void)_unload;	// 0x2fd46929
- (BOOL)isLoadedForTime:(double)time;	// 0x2fd46301
- (BOOL)prerenderForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x2fd46385
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x2fd463cd
- (void)setAttributes:(id)attributes;	// 0x2fd45b6d
@end
