...
@property(retain, nonatomic) MRImage *slide;	// G=0x2fd5b439; S=0x2fd5b3f5; @synthesize
+ (void)initialize;	// 0x2fd5b27d
+ (XXStruct_VuPjpB *)poolInfo;	// 0x2fd5b26d
- (void)dealloc;	// 0x2fd5b37d
- (void)purge;	// 0x2fd5b3bd
// declared property setter: - (void)setSlide:(id)slide;	// 0x2fd5b3f5
// declared property getter: - (id)slide;	// 0x2fd5b439
@end
