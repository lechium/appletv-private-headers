...
@class NSURL, NSString, NSSet, NSTimeZone, NSDictionary, NSArray;
...
// declared property getter: - (BOOL)isManagedByServer;
...
// declared property getter: - (BOOL)needsResync;
...
// declared property setter: - (void)setIsManagedByServer:(BOOL)server;
...
// declared property setter: - (void)setNeedsResync:(BOOL)resync;
