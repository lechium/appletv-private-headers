...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x30494e39
- (void)dealloc;	// 0x30494d75
- (id)httpMethod;	// 0x30494d69
- (BOOL)validate:(id *)validate;	// 0x30494db9
@end
