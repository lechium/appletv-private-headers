...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x30486999; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x30486975; S=0x30486989; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x304869ad; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x30486871
// declared property getter: - (id)dataPayload;	// 0x30486999
- (void)dealloc;	// 0x304868fd
// declared property getter: - (id)serverID;	// 0x30486975
// declared property setter: - (void)setServerID:(id)anId;	// 0x30486989
// declared property getter: - (id)syncKey;	// 0x304869ad
@end
