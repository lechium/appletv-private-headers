...
- (void)MSASStateMachine:(id)machine didFindSyncedKeyValueChangesForAlbumGUIDS:(id)albumGUIDS albumChanges:(id)changes accessControlChangesForAlbumGUIDS:(id)albumGUIDS4 info:(id)info;
...
- (id)MSASStateMachineDidRequestAlbumWithGUID:(id)msasstateMachine;
...
- (void)MSASStateMachineDidUpdateServerCommunicationBackoffDate:(id)msasstateMachine;
