...
- (id)init;	// 0x31972651
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x319726cd
- (void)dealloc;	// 0x31972a51
- (XXStruct_M$PztB)getFormatStruct;	// 0x31972735
- (BOOL)isEqual:(id)equal;	// 0x31972761
@end
