...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x3276b9a1
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x3276b3c9
- (void)_didFailToLaunch;	// 0x3276b7c9
- (void)_didLaunch;	// 0x3276b6dd
- (void)dealloc;	// 0x3276b67d
- (void)invalidate;	// 0x3276b8bd
@end
