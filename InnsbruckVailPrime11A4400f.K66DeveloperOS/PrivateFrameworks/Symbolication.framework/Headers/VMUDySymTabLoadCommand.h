...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x328f9da1; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x328f9db1; converted property
- (id)initWithMemory:(id)memory;	// 0x328f9ba1
// converted property getter: - (unsigned)indirectsymoff;	// 0x328f9da1
- (BOOL)isDySymTab;	// 0x328f9d9d
// converted property getter: - (unsigned)nindirectsyms;	// 0x328f9db1
@end
