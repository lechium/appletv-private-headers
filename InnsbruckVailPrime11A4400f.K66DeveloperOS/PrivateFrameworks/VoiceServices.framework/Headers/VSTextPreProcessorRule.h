...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x32e398dd
- (void)dealloc;	// 0x32e39a15
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x32e39a79
@end
