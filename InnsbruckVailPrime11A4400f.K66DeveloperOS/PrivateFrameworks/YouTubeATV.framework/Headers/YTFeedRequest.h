...
+ (int)partialFeedType;	// 0x33ab23ad
- (id)init;	// 0x33ab2281
- (void)dealloc;	// 0x33ab2309
- (void)didParseData;	// 0x33ab2119
- (void)failWithError:(id)error;	// 0x33ab2241
- (void)loadRequest:(id)request withDelegate:(id)delegate accountAuthRequired:(BOOL)required;	// 0x33ab2355
- (int)parseData:(id)data;	// 0x33ab2129
- (void)setDelegate:(id)delegate;	// 0x33ab239d
@end
