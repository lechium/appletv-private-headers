...
@property(retain) ICSDate *completed;	// G=0x33c4ac8d; S=0x33c4acc5; 
...
@property(retain) ICSDate *due;	// G=0x33c4adb9; S=0x33c4adf1; 
...
@property(assign) int percentComplete;	// G=0x33c4ace5; S=0x33c4ad3d; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x33c4af01; S=0x33c4aee1; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x33c4ae11; S=0x33c4ae69; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x33c4ab99
// declared property getter: - (id)completed;	// 0x33c4ac8d
// declared property getter: - (id)due;	// 0x33c4adb9
- (void)fixComponent;	// 0x33c49bc5
// declared property getter: - (int)percentComplete;	// 0x33c4ace5
- (id)propertiesToIncludeForChecksumVersion:(int)checksumVersion;	// 0x33c4af21
// declared property setter: - (void)setCompleted:(id)completed;	// 0x33c4acc5
// declared property setter: - (void)setDue:(id)due;	// 0x33c4adf1
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x33c4ad3d
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x33c4aee1
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x33c4ae69
- (BOOL)validate:(id *)validate;	// 0x33c4aba5
// declared property getter: - (id)x_apple_activity;	// 0x33c4af01
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x33c4ae11
@end
