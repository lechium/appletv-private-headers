...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x33cbab05
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x33cbabe9
+ (const StateSpec *)stateForReading;	// 0x33cb9b49
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x33cbb011
- (id)baseStringFromDouble:(double)aDouble;	// 0x33cbb5f9
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x33cbaa19
- (id)currencyCode;	// 0x33cbbbb5
- (id)customNumberFormatTokens;	// 0x33cbbbd9
- (void)dealloc;	// 0x33cb9b55
- (id)formatString;	// 0x33cbbba5
- (int)fractionAccuracy;	// 0x33cbc801
- (id)fractionStringFromDouble:(double)aDouble;	// 0x33cbb441
- (BOOL)hasValidDecimalPlaces;	// 0x33cb9c19
- (BOOL)isCustom;	// 0x33cbc7e1
- (BOOL)isTextFormat;	// 0x33cbc7f1
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x33cbb885
- (id)numberFormatBySettingValueType:(int)type;	// 0x33cbba51
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x33cbac81
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x33cbb875
- (BOOL)showThousandsSeparator;	// 0x33cbbbc5
- (id)stringFromDouble:(double)aDouble;	// 0x33cb9c41
- (BOOL)useAccountingStyle;	// 0x33cbaae1
- (int)valueType;	// 0x33cbaad1
@end
