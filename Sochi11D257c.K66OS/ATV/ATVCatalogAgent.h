...
+ (void)augmentPageDictionaryWithPurchases:(id)purchases purchaseCheckResponse:(id)response addAllOffers:(BOOL)offers;
+ (BOOL)canAccessExtrasForStoreItem:(id)storeItem offerType:(id)type;
+ (id)catalogHandler;
...
+ (id)extrasPageForStoreItem:(id)storeItem ignoreParentalControls:(BOOL)controls;
