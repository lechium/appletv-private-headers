...
+ (void)setSingleton:(id)singleton;	// 0x408fa1
+ (id)singleton;	// 0x408f91
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x409161
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x4095e9
- (void)dealloc;	// 0x408fb1
- (id)populatorForAsset:(id)asset;	// 0x4090f1
@end
