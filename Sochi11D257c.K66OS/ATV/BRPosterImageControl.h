...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(XXStruct_qlg9jA)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x3e5705
- (void)dealloc;	// 0x3e5791
- (void)drawRect:(CGRect)rect;	// 0x3e57d5
@end
