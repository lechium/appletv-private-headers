...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x303ffa49
- (unsigned)count;	// 0x303ffe01
- (void)dealloc;	// 0x303ffdb5
- (unsigned)indexOfObject:(id)object;	// 0x303ffed5
- (id)objectAtIndex:(unsigned)index;	// 0x303ffe31
@end
