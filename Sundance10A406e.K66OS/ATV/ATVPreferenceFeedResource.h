...
- (id)initWithPath:(id)path;	// 0x1614bd
- (void)_savePrefs;	// 0x1617f5
- (void)clearFeedResources;	// 0x161745
- (void)dealloc;	// 0x161611
- (void)setFeedResource:(id)resource named:(id)named;	// 0x161695
@end
