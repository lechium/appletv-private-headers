...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x397021
- (unsigned)count;	// 0x3973d5
- (void)dealloc;	// 0x397389
- (unsigned)indexOfObject:(id)object;	// 0x3974a9
- (id)objectAtIndex:(unsigned)index;	// 0x397405
@end
