...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x20b63d; S=0x20b64d; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x20ac65
- (void).cxx_destruct;	// 0x20b65d
- (void)_readCurrentConfiguration;	// 0x20b719
- (void)_saveConfiguration;	// 0x20b879
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x20ad55
- (void)entryComplete:(id)complete;	// 0x20b0ad
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x20b64d
// declared property getter: - (BOOL)showOnlyDNS;	// 0x20b63d
@end
