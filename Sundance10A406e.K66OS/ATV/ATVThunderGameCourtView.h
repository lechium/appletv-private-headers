...
- (id)initWithDictionary:(id)dictionary;	// 0x250785
- (id)accessibilityLabel;	// 0x251205
- (void)dealloc;	// 0x250ced
- (void)layoutSubcontrols;	// 0x250dd1
- (CGSize)sizeThatFits:(CGSize)fits;	// 0x250da1
@end
