...
+ (void)setSingleton:(id)singleton;	// 0x3471dd
+ (id)singleton;	// 0x3471cd
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x34739d
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x3477f1
- (void)dealloc;	// 0x3471ed
- (id)populatorForAsset:(id)asset;	// 0x34732d
@end
