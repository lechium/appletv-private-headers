...
- (id)initWithHandler:(id)handler;	// 0x302d9e31
- (void)_callHandlerIfNotCalled;	// 0x302da119
- (void)dealloc;	// 0x302d9ed5
- (void)didReceiveFigAssetWriterNotificationWithSuccess:(BOOL)success error:(id)error;	// 0x302d9f61
- (void)finishWritingHelper:(id)helper didInitiateFinishWritingForFigAssetWriter:(OpaqueFigAssetWriter *)figAssetWriter;	// 0x302d9fb5
- (void)finishWritingHelperDidCancelFinishWriting:(id)finishWritingHelper;	// 0x302da0f9
- (void)finishWritingHelperDidFail:(id)finishWritingHelper;	// 0x302da109
- (BOOL)shouldHelperPrepareInputs;	// 0x302da151
@end
