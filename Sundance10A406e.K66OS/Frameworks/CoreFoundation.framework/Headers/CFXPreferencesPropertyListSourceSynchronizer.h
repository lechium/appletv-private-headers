...
- (id)initWithPropertyListSource:(id)propertyListSource forLockedSynchronize:(BOOL)lockedSynchronize;	// 0x33a61fed
- (unsigned char)_backingPlistChangedSinceLastSync;	// 0x33a623f1
- (void *)createPlistFromDisk;	// 0x33a6d595
- (void)dealloc;	// 0x33a62ef9
- (void)finalize;	// 0x33aeb761
- (void)setValue:(void *)value forKey:(CFStringRef)key;	// 0x33aeb6ed
- (unsigned char)synchronize;	// 0x33a621bd
- (unsigned char)synchronizeAlreadyFlocked;	// 0x33a621d5
- (unsigned char)writePlistToDisk;	// 0x33a62fad
@end
