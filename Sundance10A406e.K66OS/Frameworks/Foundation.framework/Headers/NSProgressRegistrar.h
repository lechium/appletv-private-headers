...
- (id)initWithQueue:(id)queue rootFileAccessNode:(id)node;	// 0x35667199
- (oneway void)addPublisher:(id)publisher forID:(id)anId acknowledgementAppBundleIDs:(id)ids fileURL:(id)url;	// 0x35667359
- (oneway void)addSubscriber:(id)subscriber forID:(id)anId appBundleID:(id)anId3 fileURL:(id)url;	// 0x35667899
- (void)dealloc;	// 0x3566723d
- (void)finalize;	// 0x356672b5
- (BOOL)listener:(id)listener shouldAcceptNewConnection:(id)connection;	// 0x356672f9
- (oneway void)observePublisherForID:(id)anId value:(id)value forKey:(id)key inUserInfo:(BOOL)userInfo;	// 0x35667635
- (oneway void)removePublisherForID:(id)anId;	// 0x3566777d
- (oneway void)removeSubscriberForID:(id)anId;	// 0x35667b51
@end
