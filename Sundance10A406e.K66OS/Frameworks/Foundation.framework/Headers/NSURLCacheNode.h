...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x355ce489
- (void)dealloc;	// 0x355ce629
- (id)description;	// 0x355ce5d5
- (BOOL)isEqual:(id)equal;	// 0x355ce551
@end
