...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x35d04109; S=0x35d040e5; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x35d03ddd
- (id)_bundleIdentifier;	// 0x35d04121
- (void)acquireProcessAssertion;	// 0x35d0406d
- (void)dealloc;	// 0x35d03e1d
- (void)didPrepareForRemoteSelectorInvocation;	// 0x35d03f2d
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x35d04109
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x35d03e61
- (void)serverConnectionDied;	// 0x35d03fed
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x35d040e5
@end
