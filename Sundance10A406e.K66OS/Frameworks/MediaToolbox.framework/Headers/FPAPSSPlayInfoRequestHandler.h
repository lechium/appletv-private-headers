...
- (id)init;	// 0x3335c1fd
- (void)dealloc;	// 0x3335c249
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x3335c2f5
- (void)request:(id)request didFailWithError:(id)error;	// 0x3335c2f9
- (void)requestDidFinish:(id)request;	// 0x3335c60d
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x3335c2a9
- (void)setRequest:(id)request;	// 0x3335c2b9
@end
