...
- (id)initFromCentralFileHeader:(const char *)centralFileHeader inputStream:(id)stream;	// 0x30e14f79
- (void)copyToFile:(id)file;	// 0x30e15595
- (id)data;	// 0x30e15451
- (void)dealloc;	// 0x30e151c1
- (id)inputStream;	// 0x30e1520d
@end
