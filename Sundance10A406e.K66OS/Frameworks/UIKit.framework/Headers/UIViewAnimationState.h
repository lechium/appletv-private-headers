...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x309f5149; 
+ (void)popAnimationState;	// 0x308c10d9
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x308c0fe1
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x309f5149
- (void)animationDidStart:(id)animation;	// 0x30930c51
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x309368a5
- (void)dealloc;	// 0x308c1c89
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x308c1a1d
- (void)setAnimationAttributes:(id)attributes;	// 0x30930499
@end
