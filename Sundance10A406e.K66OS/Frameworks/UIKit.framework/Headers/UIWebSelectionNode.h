...
@property(retain) UIWebSelection *selection;	// G=0x30b9ef4d; S=0x30b9ef61; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x30b9ebb9
- (void)dealloc;	// 0x30b9ec11
- (void)invalidate;	// 0x30b9eea1
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x30b9ecf9
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x30b9ec55
- (int)oppositeEdge:(int)edge;	// 0x30b9ecdd
// declared property getter: - (id)selection;	// 0x30b9ef4d
// declared property setter: - (void)setSelection:(id)selection;	// 0x30b9ef61
@end
