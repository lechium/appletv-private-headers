...
+ (id)requestViewController:(id)controller fromServiceWithBundleIdentifier:(id)bundleIdentifier propagateAppearanceCustomizations:(BOOL)customizations connectionHandler:(id)handler;	// 0x30ca17d5
- (void)_cancelUnconditionallyThen:(id)then;	// 0x30ca2115
- (id)_cancelWithError:(id)error;	// 0x30ca3f09
- (void)_connectToServiceViewController;	// 0x30ca39a9
- (void)_connectToTextEffectsOperator;	// 0x30ca319d
- (void)_connectToViewControllerOperator;	// 0x30ca27f5
- (void)_connectToViewService;	// 0x30ca24e9
- (void)_didFinishEstablishingConnection;	// 0x30ca3d99
- (void)_sendServiceTextEffectsRequest;	// 0x30ca35b1
- (void)_sendServiceViewControllerRequest;	// 0x30ca2c09
- (void)dealloc;	// 0x30ca1ff9
@end
