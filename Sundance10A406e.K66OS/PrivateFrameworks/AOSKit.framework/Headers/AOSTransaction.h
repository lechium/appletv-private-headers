...
- (id)init;	// 0x33bbe721
- (id)initWithCoder:(id)coder;	// 0x33bbeb85
- (void)dealloc;	// 0x33bbe821
- (void)encodeWithCoder:(id)coder;	// 0x33bbec81
- (id)error;	// 0x33bbeb75
- (void)finalize;	// 0x33bbe9f1
- (BOOL)isSuccessful;	// 0x33bbeb55
- (id)result;	// 0x33bbeb65
@end
