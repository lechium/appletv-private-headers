...
- (id)init;	// 0x361c9935
- (void)_loadForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x361ca449
- (void)_unload;	// 0x361ca66d
- (BOOL)isLoadedForTime:(double)time;	// 0x361ca06d
- (BOOL)prerenderForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x361ca0f1
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x361ca139
- (void)setAttributes:(id)attributes;	// 0x361c9961
@end
