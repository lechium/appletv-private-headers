...
@property(retain, nonatomic) MRImage *slide;	// G=0x361defa9; S=0x361def65; @synthesize
+ (void)initialize;	// 0x361deded
+ (XXStruct_VuPjpB *)poolInfo;	// 0x361deddd
- (void)dealloc;	// 0x361deeed
- (void)purge;	// 0x361def2d
// declared property setter: - (void)setSlide:(id)slide;	// 0x361def65
// declared property getter: - (id)slide;	// 0x361defa9
@end
