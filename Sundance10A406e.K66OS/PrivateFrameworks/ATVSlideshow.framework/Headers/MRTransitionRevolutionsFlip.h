...
- (id)initWithTransitionID:(id)transitionID;	// 0x361f09f9
- (void)cleanup;	// 0x361f0abd
- (void)releaseByTransitioner:(id)transitioner;	// 0x361f0b95
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x361f14ad
- (void)setAttributes:(id)attributes;	// 0x361f1361
- (void)setFlipDirection:(int)direction;	// 0x361f0cd5
- (void)setupCubesWithLocalAspectRatio:(float)localAspectRatio;	// 0x361f0e31
@end
