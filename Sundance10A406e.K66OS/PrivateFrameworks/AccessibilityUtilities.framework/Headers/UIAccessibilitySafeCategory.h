...
+ (void)_addCategoryMethod:(objc_method *)method toClass:(Class)aClass isClass:(BOOL)aClass3;	// 0x326c3e3d
+ (void)initialize;	// 0x326c3c71
+ (void)installCategoryOnClassNamed:(id)named;	// 0x326c3cbd
@end
