...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x356d11e5
- (void)dealloc;	// 0x356d120d
- (void)forwardInvocation:(id)invocation;	// 0x356d1239
- (id)methodSignatureForSelector:(SEL)selector;	// 0x356d13a5
@end
