...
- (id)initWithCalendar:(id)calendar principal:(id)principal accountInfoProvider:(id)provider taskManager:(id)manager;	// 0x32ed431d
- (void)cancelTaskGroup;	// 0x32ed5021
- (id)dataContentType;	// 0x32ed4421
- (void)dealloc;	// 0x32ed4399
- (void)startTaskGroup;	// 0x32ed442d
@end
