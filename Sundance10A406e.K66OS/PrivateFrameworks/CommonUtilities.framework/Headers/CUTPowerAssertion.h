...
- (id)initWithIdentifier:(id)identifier;	// 0x306325f9
- (id)initWithIdentifier:(id)identifier timeout:(double)timeout;	// 0x306323a1
- (void)dealloc;	// 0x30632629
- (id)description;	// 0x30632781
@end
