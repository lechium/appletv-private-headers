...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x303bb3b1; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x303bb38d; S=0x303bb3a1; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x303bb3c5; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x303bb289
// declared property getter: - (id)dataPayload;	// 0x303bb3b1
- (void)dealloc;	// 0x303bb315
// declared property getter: - (id)serverID;	// 0x303bb38d
// declared property setter: - (void)setServerID:(id)anId;	// 0x303bb3a1
// declared property getter: - (id)syncKey;	// 0x303bb3c5
@end
