...
- (id)initWithURL:(id)url;	// 0x303c9ba1
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x303c9c99
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x303c9d29
- (id)httpMethod;	// 0x303c9be1
- (id)requestBody;	// 0x303c9bed
@end
