...
+ (id)sharedGateKeeper;	// 0x307b239d
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x307b2659
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x307b2461
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x307b23e5
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x307b2559
- (id)stateString;	// 0x307b25d5
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x307b24dd
@end
