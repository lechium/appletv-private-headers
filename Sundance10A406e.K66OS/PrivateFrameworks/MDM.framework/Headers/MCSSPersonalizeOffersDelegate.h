...
+ (id)instanceWithItems:(id)items;	// 0x37878861
- (void).cxx_destruct;	// 0x37878ae5
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x37878a51
- (void)startCompletionBlock:(id)block;	// 0x378788d9
@end
