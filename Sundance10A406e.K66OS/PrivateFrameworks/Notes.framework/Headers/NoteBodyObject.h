...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x373b7915; 
...
- (BOOL)containsAttachments;	// 0x373b7a71
// declared property getter: - (id)contentAsPlainText;	// 0x373b7915
- (id)contentAsPlainTextPreservingNewlines;	// 0x373b79bd
@end
