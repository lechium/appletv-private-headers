...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x34f65cd9
- (void)dealloc;	// 0x34f6975d
- (bool)loadDelayedNode:(id)node;	// 0x34f66239
@end
