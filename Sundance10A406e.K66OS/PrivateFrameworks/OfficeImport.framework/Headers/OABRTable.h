...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x34fe6779
- (id).cxx_construct;	// 0x34fe6775
- (void)createTargetTableContents;	// 0x350970fd
- (void)dealloc;	// 0x34fe7541
- (void)map;	// 0x34fe680d
- (void)mapScale;	// 0x34fe69c1
- (void)readAnchor;	// 0x34fe6915
- (void)readCellsAndLines;	// 0x34fe71e1
- (void)readCoordinates;	// 0x34fe6bc1
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x3509700d
- (void)validateTable;	// 0x35096ce1
@end
