...
- (id)init;	// 0x351315e5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x35131661
- (void)dealloc;	// 0x351319a5
- (XXStruct_M$PztB)getFormatStruct;	// 0x351316d9
- (BOOL)isEqual:(id)equal;	// 0x35131715
@end
