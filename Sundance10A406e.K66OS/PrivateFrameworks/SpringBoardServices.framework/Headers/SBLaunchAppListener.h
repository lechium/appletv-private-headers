...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x334b3399
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x334b2e11
- (void)_didFailToLaunch;	// 0x334b31c5
- (void)_didLaunch;	// 0x334b30dd
- (void)dealloc;	// 0x334b307d
- (void)invalidate;	// 0x334b32b5
@end
