...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x36dc74f9; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x36dc7509; converted property
- (id)initWithMemory:(id)memory;	// 0x36dc72f9
// converted property getter: - (unsigned)indirectsymoff;	// 0x36dc74f9
- (BOOL)isDySymTab;	// 0x36dc74f5
// converted property getter: - (unsigned)nindirectsyms;	// 0x36dc7509
@end
