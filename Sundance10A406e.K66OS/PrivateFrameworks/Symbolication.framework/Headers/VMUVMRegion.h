...
@property(readonly, assign) VMURange range;	// G=0x36decc2d; converted property
@property(readonly, retain) NSString *type;	// G=0x36decc61; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x36decdc5
- (void)dealloc;	// 0x36decf71
- (id)description;	// 0x36decc19
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x36dec401
- (BOOL)isEqual:(id)equal;	// 0x36decc81
- (BOOL)isSubmap;	// 0x36decc71
- (unsigned)protection;	// 0x36decc51
// converted property getter: - (VMURange)range;	// 0x36decc2d
// converted property getter: - (id)type;	// 0x36decc61
@end
