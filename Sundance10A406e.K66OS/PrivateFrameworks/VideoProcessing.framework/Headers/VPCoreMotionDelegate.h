...
- (id)init;	// 0x36e14429
- (void)dealloc;	// 0x36e14509
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x36e148d9
- (void)processGyroData:(id)data withError:(id)error;	// 0x36e145a9
- (void)start;	// 0x36e147e9
- (void)stop;	// 0x36e148b5
@end
