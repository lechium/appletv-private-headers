...
- (id)init;	// 0x3347607d
- (void)_handleRequests;	// 0x334763dd
- (void)_notifyRequestHandled:(id)handled;	// 0x33476361
- (void)dealloc;	// 0x33476101
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x334761bd
- (void)invalidate;	// 0x33476305
- (void)setDelegate:(id)delegate;	// 0x33476165
@end
