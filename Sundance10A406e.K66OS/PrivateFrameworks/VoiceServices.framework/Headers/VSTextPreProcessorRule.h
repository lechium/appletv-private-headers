...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x33476c15
- (void)dealloc;	// 0x33476d4d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x33476db1
@end
