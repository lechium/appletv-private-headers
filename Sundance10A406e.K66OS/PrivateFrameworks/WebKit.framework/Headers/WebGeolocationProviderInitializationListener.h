...
- (id)initWithGeolocation:(Geolocation *)geolocation;	// 0x30826949
- (id).cxx_construct;	// 0x30826c59
- (void).cxx_destruct;	// 0x30826c2d
- (void)initializationAllowedWebView:(id)view provider:(id)provider;	// 0x308269b1
- (void)initializationDeniedWebView:(id)view provider:(id)provider;	// 0x30826c19
@end
