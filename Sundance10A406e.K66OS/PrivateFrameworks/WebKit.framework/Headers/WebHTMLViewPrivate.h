...
@class WebEvent, WebDataSource, NSString, NSTimer, NSMutableDictionary, WebPluginController, NSArray, WAKView;
...
+ (void)initialize;	// 0x307e0d49
- (id).cxx_construct;	// 0x307e0d51
- (void)clear;	// 0x307f526d
- (void)dealloc;	// 0x307f5435
- (void)finalize;	// 0x3082f451
@end
