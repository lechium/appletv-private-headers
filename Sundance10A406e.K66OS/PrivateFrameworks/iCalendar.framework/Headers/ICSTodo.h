...
@property(retain) ICSDate *completed;	// G=0x35f1cfe1; S=0x35f1d019; 
...
@property(retain) ICSDate *due;	// G=0x35f1d10d; S=0x35f1d145; 
...
@property(assign) int percentComplete;	// G=0x35f1d039; S=0x35f1d091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x35f1d255; S=0x35f1d235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x35f1d165; S=0x35f1d1bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x35f1ceed
// declared property getter: - (id)completed;	// 0x35f1cfe1
// declared property getter: - (id)due;	// 0x35f1d10d
- (void)fixComponent;	// 0x35f1bf75
// declared property getter: - (int)percentComplete;	// 0x35f1d039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x35f1d019
// declared property setter: - (void)setDue:(id)due;	// 0x35f1d145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x35f1d091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x35f1d235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x35f1d1bd
- (BOOL)validate:(id *)validate;	// 0x35f1cef9
// declared property getter: - (id)x_apple_activity;	// 0x35f1d255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x35f1d165
@end
