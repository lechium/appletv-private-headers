...
- (char *)ID;	// 0x32449b19
- (void)dealloc;	// 0x32449a15
- (BOOL)isHidden;	// 0x32449b09
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x32449b29
- (id)slideStyle;	// 0x32449ae9
- (id)stylesheet;	// 0x32449af9
@end
