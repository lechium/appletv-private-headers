...
- (id)init;	// 0x3248c101
- (void)aboutToReadCells;	// 0x3248c245
- (void)aboutToReadColumnVectors;	// 0x3248c231
- (void)aboutToReadRowVectors;	// 0x3248c21d
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x3248c2d5
- (void)dealloc;	// 0x3248c199
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x3248c30d
@end
