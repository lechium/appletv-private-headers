...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x211a75; S=0x211a85; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x21109d
- (void).cxx_destruct;	// 0x211a95
- (void)_readCurrentConfiguration;	// 0x211b51
- (void)_saveConfiguration;	// 0x211cb1
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x21118d
- (void)entryComplete:(id)complete;	// 0x2114e5
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x211a85
// declared property getter: - (BOOL)showOnlyDNS;	// 0x211a75
@end
