...
- (id)initWithAsset:(id)asset;	// 0x2b42a9
- (void)_addFadeAnimationToControl:(id)control;	// 0x2b53e1
- (void)dealloc;	// 0x2b4799
- (void)layoutSubcontrols;	// 0x2b4eb5
- (void)setAuthorizing;	// 0x2b4df5
- (void)setBandwidthHintForPreview:(BOOL)preview;	// 0x2b48b1
- (void)setReadyForPlayInNMins:(int)nmins;	// 0x2b4ab1
- (void)setReadyToPlay;	// 0x2b4d4d
@end
