...
+ (void)setSingleton:(id)singleton;	// 0x34de21
+ (id)singleton;	// 0x34de11
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x34dfe1
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x34e435
- (void)dealloc;	// 0x34de31
- (id)populatorForAsset:(id)asset;	// 0x34df71
@end
