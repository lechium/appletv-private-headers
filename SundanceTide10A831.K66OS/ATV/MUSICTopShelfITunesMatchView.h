...
- (id)init;	// 0x78369
- (void).cxx_destruct;	// 0x78ae1
- (id)_subtextAttributes;	// 0x78781
- (id)accessibilityLabel;	// 0x78a69
- (void)layoutSubcontrols;	// 0x78911
- (void)setDescriptionKey:(id)key;	// 0x786f1
- (void)setMaxDescriptionWidth:(float)width;	// 0x78761
@end
