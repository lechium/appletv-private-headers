...
@class AVCaptureVideoPreviewLayer, AVWeakReference, AVRunLoopCondition, AVCaptureFigAudioDevice, AVCaptureFigVideoDevice, NSMutableDictionary, NSString, NSError, NSMutableArray;
...
@interface AVCaptureSessionInternal : NSObject {
	...
	NSMutableDictionary *figRecorderOptions;	// 20 = 0x14
