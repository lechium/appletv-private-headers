...
- (id)init;	// 0x33dafc69
- (id)initWithNestingLevel:(unsigned)nestingLevel;	// 0x33d25b45
- (void)dealloc;	// 0x33d2b619
- (id)generateSubqueryVariableAlias;	// 0x33dafc7d
- (id)generateTableAlias;	// 0x33d276cd
@end
