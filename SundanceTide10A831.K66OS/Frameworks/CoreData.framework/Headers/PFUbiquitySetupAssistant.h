...
@property(readonly, retain) PFUbiquityMigrationAssistant *migrationAssistant;	// G=0x33e6010d; converted property
@property(readonly, assign, nonatomic) BOOL needsMetadataRecovery;	// G=0x33e64fad; @synthesize=_needsMetadataRecovery
@property(readonly, assign, nonatomic) NSDictionary *options;	// G=0x33e64f9d; @synthesize=_options
@property(readonly, assign, nonatomic) BOOL ubiquityEnabled;	// G=0x33d12ed5; @synthesize=_ubiquityEnabled
+ (id)createDefaultLocalPeerID;	// 0x33e62ddd
+ (BOOL)doBasicSanityCheckForUbiquityRootURL:(id)ubiquityRootURL withError:(id *)error;	// 0x33e62e59
+ (id)generateMachineUUIDString;	// 0x33e62d81
+ (BOOL)ubiquityMetadataTablesPresentInStore:(id)store;	// 0x33e64ed9
- (id)init;	// 0x33d11fdd
- (id)initWithPersistentStoreCoordinator:(id)persistentStoreCoordinator andStoreOptions:(id)options forPersistentStoreOfType:(id)type atURL:(id)url;	// 0x33d11f1d
- (void)_setUbiquityRootLocation:(id)location storeName:(id)name localPeerID:(id)anId andModelVersionHash:(id)hash;	// 0x33e64f1d
- (BOOL)attemptMetadataRecoveryForStore:(id)store error:(id *)error;	// 0x33e628ad
- (void)dealloc;	// 0x33d20a05
- (BOOL)doFirstMetadataConsistencyCheckWithError:(id *)error;	// 0x33e635e1
- (BOOL)doSecondMetadataConsistencyCheckWithStore:(id)store error:(id *)error;	// 0x33e639ed
- (BOOL)migrateMetadataRoot:(id *)root;	// 0x33e6311d
// converted property getter: - (id)migrationAssistant;	// 0x33e6010d
// declared property getter: - (BOOL)needsMetadataRecovery;	// 0x33e64fad
// declared property getter: - (id)options;	// 0x33e64f9d
- (BOOL)performPostStoreSetupWithStore:(id)store error:(id *)error;	// 0x33e60fd1
- (BOOL)performPreStoreSetupWithError:(id *)error;	// 0x33e60195
// declared property getter: - (BOOL)ubiquityEnabled;	// 0x33d12ed5
- (BOOL)validateOptionsWithError:(id *)error;	// 0x33d121b9
@end
