...
- (id)init;	// 0x35b6d659
- (void)_notificationHandler:(id)handler;	// 0x35b6e031
- (void)dealloc;	// 0x35b6d849
- (void)notificationCallback;	// 0x35b6da1d
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x35b6d7a1
@end
