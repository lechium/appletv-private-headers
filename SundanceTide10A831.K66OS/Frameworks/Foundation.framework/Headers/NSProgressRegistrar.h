...
- (id)initWithQueue:(id)queue rootFileAccessNode:(id)node;	// 0x32668199
- (oneway void)addPublisher:(id)publisher forID:(id)anId acknowledgementAppBundleIDs:(id)ids fileURL:(id)url;	// 0x32668359
- (oneway void)addSubscriber:(id)subscriber forID:(id)anId appBundleID:(id)anId3 fileURL:(id)url;	// 0x32668899
- (void)dealloc;	// 0x3266823d
- (void)finalize;	// 0x326682b5
- (BOOL)listener:(id)listener shouldAcceptNewConnection:(id)connection;	// 0x326682f9
- (oneway void)observePublisherForID:(id)anId value:(id)value forKey:(id)key inUserInfo:(BOOL)userInfo;	// 0x32668635
- (oneway void)removePublisherForID:(id)anId;	// 0x3266877d
- (oneway void)removeSubscriberForID:(id)anId;	// 0x32668b51
@end
