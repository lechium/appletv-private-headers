...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x325cf489
- (void)dealloc;	// 0x325cf629
- (id)description;	// 0x325cf5d5
- (BOOL)isEqual:(id)equal;	// 0x325cf551
@end
