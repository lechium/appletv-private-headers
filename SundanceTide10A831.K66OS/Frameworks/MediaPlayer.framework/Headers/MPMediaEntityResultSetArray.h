...
@property(readonly, retain) MPMediaQuerySectionInfo *sectionInfo;	// G=0x36f3e9ad; converted property
- (id)initWithResultSet:(id)resultSet queryCriteria:(id)criteria entityType:(int)type library:(id)library;	// 0x36f3dead
- (id)copyWithZone:(NSZone *)zone;	// 0x36f3e2bd
- (unsigned)count;	// 0x36f3e2cd
- (void)dealloc;	// 0x36f3e1a5
- (id)objectAtIndex:(unsigned)index;	// 0x36f3e2ed
// converted property getter: - (id)sectionInfo;	// 0x36f3e9ad
@end
