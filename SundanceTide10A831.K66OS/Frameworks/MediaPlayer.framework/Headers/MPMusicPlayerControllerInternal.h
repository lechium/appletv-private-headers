...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x36f0b9f9; S=0x36f0b9d5; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x36f0b6cd
- (id)_bundleIdentifier;	// 0x36f0ba11
- (void)acquireProcessAssertion;	// 0x36f0b95d
- (void)dealloc;	// 0x36f0b70d
- (void)didPrepareForRemoteSelectorInvocation;	// 0x36f0b81d
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x36f0b9f9
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x36f0b751
- (void)serverConnectionDied;	// 0x36f0b8dd
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x36f0b9d5
@end
