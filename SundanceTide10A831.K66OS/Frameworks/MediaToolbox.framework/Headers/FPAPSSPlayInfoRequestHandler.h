...
- (id)init;	// 0x335ce085
- (void)dealloc;	// 0x335ce0d1
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x335ce17d
- (void)request:(id)request didFailWithError:(id)error;	// 0x335ce181
- (void)requestDidFinish:(id)request;	// 0x335ce495
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x335ce131
- (void)setRequest:(id)request;	// 0x335ce141
@end
