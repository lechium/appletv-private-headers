...
- (id)initFromCentralFileHeader:(const char *)centralFileHeader inputStream:(id)stream;	// 0x332acf79
- (void)copyToFile:(id)file;	// 0x332ad595
- (id)data;	// 0x332ad451
- (void)dealloc;	// 0x332ad1c1
- (id)inputStream;	// 0x332ad20d
@end
