...
@class NSString, NSDictionary, NSDate, NSCalendar, NSTimeZone;
...
+ (id)alloc;	// 0x31f1dd55
+ (id)allocWithZone:(NSZone *)zone;	// 0x31f1dd81
- (id)init;	// 0x31f1ddad
- (id)initWithCoder:(id)coder;	// 0x31f1de81
- (void)clearNonSystemProperties;	// 0x31f1dee1
- (int)compareFireDates:(id)dates;	// 0x31f1dedd
- (id)copyWithZone:(NSZone *)zone;	// 0x31f1decd
- (void)encodeWithCoder:(id)coder;	// 0x31f1dec9
- (BOOL)isValid;	// 0x31f1ded9
- (id)nextFireDateAfterDate:(id)date localTimeZone:(id)zone;	// 0x31f1ded5
- (id)nextFireDateForLastFireDate:(id)lastFireDate;	// 0x31f1ded1
@end
