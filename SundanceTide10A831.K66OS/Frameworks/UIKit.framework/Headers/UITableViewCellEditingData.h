...
@property(readonly, assign, nonatomic, getter=isDataRequired) BOOL dataRequired;	// G=0x31e90785; 
- (id)initWithTableViewCell:(id)tableViewCell editingStyle:(int)style;	// 0x31d1a901
- (void)dealloc;	// 0x31d1c5b9
- (id)deleteConfirmationControl:(BOOL)control;	// 0x31d1adb5
- (id)editControl:(BOOL)control;	// 0x31d1aa59
// declared property getter: - (BOOL)isDataRequired;	// 0x31e90785
- (id)reorderControl:(BOOL)control;	// 0x31d1ab29
- (id)reorderSeparatorView:(BOOL)view;	// 0x31d1aba9
@end
