...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x31d1b141; 
+ (void)popAnimationState;	// 0x31be70d1
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x31be6fd9
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x31d1b141
- (void)animationDidStart:(id)animation;	// 0x31c56c49
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x31c5c89d
- (void)dealloc;	// 0x31be7c81
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x31be7a15
- (void)setAnimationAttributes:(id)attributes;	// 0x31c56491
@end
