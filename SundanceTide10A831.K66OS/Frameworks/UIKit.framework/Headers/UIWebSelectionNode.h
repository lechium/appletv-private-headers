...
@property(retain) UIWebSelection *selection;	// G=0x31ec4f4d; S=0x31ec4f61; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x31ec4bb9
- (void)dealloc;	// 0x31ec4c11
- (void)invalidate;	// 0x31ec4ea1
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x31ec4cf9
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x31ec4c55
- (int)oppositeEdge:(int)edge;	// 0x31ec4cdd
// declared property getter: - (id)selection;	// 0x31ec4f4d
// declared property setter: - (void)setSelection:(id)selection;	// 0x31ec4f61
@end
