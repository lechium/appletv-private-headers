...
+ (BOOL)hasActiveSessions;	// 0x31c2c295
+ (void)startViewServiceSessionManager;	// 0x31c2ac2d
- (id)init;	// 0x31fd0f59
- (id)_init;	// 0x31c2ac59
- (void)_registerSessionForDefaultDeputies:(id)defaultDeputies;	// 0x31fd1745
- (void)_startListener;	// 0x31fd10d1
- (void)dealloc;	// 0x31fd1021
- (BOOL)hasActiveSessions;	// 0x31c2c2b9
@end
