...
- (id)init;	// 0x32ee0721
- (id)initWithCoder:(id)coder;	// 0x32ee0b85
- (void)dealloc;	// 0x32ee0821
- (void)encodeWithCoder:(id)coder;	// 0x32ee0c81
- (id)error;	// 0x32ee0b75
- (void)finalize;	// 0x32ee09f1
- (BOOL)isSuccessful;	// 0x32ee0b55
- (id)result;	// 0x32ee0b65
@end
