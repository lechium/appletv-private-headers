...
- (id)init;	// 0x33aee935
- (void)_loadForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x33aef449
- (void)_unload;	// 0x33aef66d
- (BOOL)isLoadedForTime:(double)time;	// 0x33aef06d
- (BOOL)prerenderForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x33aef0f1
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x33aef139
- (void)setAttributes:(id)attributes;	// 0x33aee961
@end
