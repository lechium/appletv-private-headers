...
@property(retain, nonatomic) MRImage *slide;	// G=0x33b03fa9; S=0x33b03f65; @synthesize
+ (void)initialize;	// 0x33b03ded
+ (XXStruct_VuPjpB *)poolInfo;	// 0x33b03ddd
- (void)dealloc;	// 0x33b03eed
- (void)purge;	// 0x33b03f2d
// declared property setter: - (void)setSlide:(id)slide;	// 0x33b03f65
// declared property getter: - (id)slide;	// 0x33b03fa9
@end
