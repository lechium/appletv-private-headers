...
- (id)initWithTransitionID:(id)transitionID;	// 0x33b159f9
- (void)cleanup;	// 0x33b15abd
- (void)releaseByTransitioner:(id)transitioner;	// 0x33b15b95
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x33b164ad
- (void)setAttributes:(id)attributes;	// 0x33b16361
- (void)setFlipDirection:(int)direction;	// 0x33b15cd5
- (void)setupCubesWithLocalAspectRatio:(float)localAspectRatio;	// 0x33b15e31
@end
