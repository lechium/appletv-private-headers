...
- (id)init;	// 0x32eeb539
- (BOOL)_cleanupAccountClass:(id)aClass;	// 0x32eeb7e9
- (void)accountsHaveBeenSaved:(BOOL)saved;	// 0x32eeb741
- (void)dealloc;	// 0x32eeb615
- (int)fixBasicAccountIfNeeded:(id)needed loggingMessage:(id)message;	// 0x32eeb661
- (id)supportedAccountTypes;	// 0x32eeb781
@end
