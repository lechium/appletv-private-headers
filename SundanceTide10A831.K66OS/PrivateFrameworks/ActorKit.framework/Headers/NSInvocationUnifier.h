...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x330281e5
- (void)dealloc;	// 0x3302820d
- (void)forwardInvocation:(id)invocation;	// 0x33028239
- (id)methodSignatureForSelector:(SEL)selector;	// 0x330283a5
@end
