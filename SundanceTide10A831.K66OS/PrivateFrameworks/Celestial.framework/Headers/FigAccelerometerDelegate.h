...
- (id)init;	// 0x33f24d11
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x33f24ea5
- (void)dealloc;	// 0x33f24e19
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x33f24cf1
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x33f24f51
@end
