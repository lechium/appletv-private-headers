...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x33418be1
- (void)dealloc;	// 0x33418b1d
- (id)httpMethod;	// 0x33418b11
- (BOOL)validate:(id *)validate;	// 0x33418b61
@end
