...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x3340b3b1; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x3340b38d; S=0x3340b3a1; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x3340b3c5; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x3340b289
// declared property getter: - (id)dataPayload;	// 0x3340b3b1
- (void)dealloc;	// 0x3340b315
// declared property getter: - (id)serverID;	// 0x3340b38d
// declared property setter: - (void)setServerID:(id)anId;	// 0x3340b3a1
// declared property getter: - (id)syncKey;	// 0x3340b3c5
@end
