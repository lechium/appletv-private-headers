...
- (id)initWithURL:(id)url;	// 0x33419ba1
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x33419c99
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x33419d29
- (id)httpMethod;	// 0x33419be1
- (id)requestBody;	// 0x33419bed
@end
