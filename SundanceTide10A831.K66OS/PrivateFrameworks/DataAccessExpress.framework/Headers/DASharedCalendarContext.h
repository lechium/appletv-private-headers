...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x337654c5
- (void)dealloc;	// 0x337655cd
- (void)finishedWithError:(id)error;	// 0x3376565d
@end
