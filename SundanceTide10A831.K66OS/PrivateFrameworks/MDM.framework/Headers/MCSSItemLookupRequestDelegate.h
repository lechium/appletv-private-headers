...
+ (id)instance;	// 0x331fdf21
- (void).cxx_destruct;	// 0x331fe1a9
- (void)itemLookupRequest:(id)request didFindItems:(id)items;	// 0x331fe101
- (void)startCompletionBlock:(id)block;	// 0x331fdf89
@end
