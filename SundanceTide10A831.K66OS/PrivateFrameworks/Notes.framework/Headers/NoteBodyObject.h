...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x35a5d915; 
...
- (BOOL)containsAttachments;	// 0x35a5da71
// declared property getter: - (id)contentAsPlainText;	// 0x35a5d915
- (id)contentAsPlainTextPreservingNewlines;	// 0x35a5d9bd
@end
