...
- (id)basicAccountIdentifier;	// 0x35a5d8c1
- (id)collectionInfo;	// 0x35a5d765
- (unsigned)maximumServerIntId;	// 0x35a5d41d
- (id)notesForGUIDs:(id)guids;	// 0x35a5cf29
- (id)notesForIntegerIds:(id)integerIds;	// 0x35a5cd79
- (id)notesForServerIds:(id)serverIds;	// 0x35a5cbc9
- (id)notesForServerIntIds:(id)serverIntIds;	// 0x35a5d0d9
- (id)notesForServerIntIdsInRange:(NSRange)range;	// 0x35a5d289
- (id)predicateForNotes;	// 0x35a5d72d
@end
