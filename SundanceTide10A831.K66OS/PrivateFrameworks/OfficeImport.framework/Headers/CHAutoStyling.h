...
+ (id)autoStylingWithChart:(id)chart;	// 0x36b32e0d
- (id)initWithChart:(id)chart;	// 0x36b32ea5
- (void)dealloc;	// 0x36b41ab5
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x36b76a11
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x36b718a1
@end
