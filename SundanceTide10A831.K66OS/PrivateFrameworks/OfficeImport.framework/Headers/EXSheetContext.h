...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x36ad5cd9
- (void)dealloc;	// 0x36ad975d
- (bool)loadDelayedNode:(id)node;	// 0x36ad6239
@end
