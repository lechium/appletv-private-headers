...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x379b04f9; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x379b0509; converted property
- (id)initWithMemory:(id)memory;	// 0x379b02f9
// converted property getter: - (unsigned)indirectsymoff;	// 0x379b04f9
- (BOOL)isDySymTab;	// 0x379b04f5
// converted property getter: - (unsigned)nindirectsyms;	// 0x379b0509
@end
