...
@property(readonly, assign) VMURange range;	// G=0x379d5c2d; converted property
@property(readonly, retain) NSString *type;	// G=0x379d5c61; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x379d5dc5
- (void)dealloc;	// 0x379d5f71
- (id)description;	// 0x379d5c19
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x379d5401
- (BOOL)isEqual:(id)equal;	// 0x379d5c81
- (BOOL)isSubmap;	// 0x379d5c71
- (unsigned)protection;	// 0x379d5c51
// converted property getter: - (VMURange)range;	// 0x379d5c2d
// converted property getter: - (id)type;	// 0x379d5c61
@end
