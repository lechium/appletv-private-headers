...
- (id)init;	// 0x30e68429
- (void)dealloc;	// 0x30e68509
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x30e688d9
- (void)processGyroData:(id)data withError:(id)error;	// 0x30e685a9
- (void)start;	// 0x30e687e9
- (void)stop;	// 0x30e688b5
@end
