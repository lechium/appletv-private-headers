...
- (id)init;	// 0x3053207d
- (void)_handleRequests;	// 0x305323dd
- (void)_notifyRequestHandled:(id)handled;	// 0x30532361
- (void)dealloc;	// 0x30532101
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x305321bd
- (void)invalidate;	// 0x30532305
- (void)setDelegate:(id)delegate;	// 0x30532165
@end
