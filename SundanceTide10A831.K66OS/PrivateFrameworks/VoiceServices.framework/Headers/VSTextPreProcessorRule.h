...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x30532c15
- (void)dealloc;	// 0x30532d4d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x30532db1
@end
