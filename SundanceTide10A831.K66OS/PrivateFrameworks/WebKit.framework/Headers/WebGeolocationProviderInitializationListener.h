...
- (id)initWithGeolocation:(Geolocation *)geolocation;	// 0x35084949
- (id).cxx_construct;	// 0x35084c59
- (void).cxx_destruct;	// 0x35084c2d
- (void)initializationAllowedWebView:(id)view provider:(id)provider;	// 0x350849b1
- (void)initializationDeniedWebView:(id)view provider:(id)provider;	// 0x35084c19
@end
