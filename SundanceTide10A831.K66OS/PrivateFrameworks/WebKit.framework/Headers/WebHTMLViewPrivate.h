...
@class WebEvent, WebDataSource, NSString, NSMutableDictionary, WebPluginController, NSArray, WAKView, NSTimer;
...
+ (void)initialize;	// 0x3503ed41
- (id).cxx_construct;	// 0x3503ed49
- (void)clear;	// 0x35053265
- (void)dealloc;	// 0x3505342d
- (void)finalize;	// 0x3508d451
@end
