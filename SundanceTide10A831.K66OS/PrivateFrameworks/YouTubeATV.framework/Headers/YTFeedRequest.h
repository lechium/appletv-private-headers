...
+ (int)partialFeedType;	// 0x3706c3c9
- (id)init;	// 0x3706c29d
- (void)dealloc;	// 0x3706c325
- (void)didParseData;	// 0x3706c135
- (void)failWithError:(id)error;	// 0x3706c25d
- (void)loadRequest:(id)request withDelegate:(id)delegate accountAuthRequired:(BOOL)required;	// 0x3706c371
- (int)parseData:(id)data;	// 0x3706c145
- (void)setDelegate:(id)delegate;	// 0x3706c3b9
@end
