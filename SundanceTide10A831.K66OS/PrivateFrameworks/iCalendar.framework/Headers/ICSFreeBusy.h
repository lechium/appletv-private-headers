...
@property(retain) NSArray *freebusy;	// G=0x30016751; S=0x30016771; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x30016791; S=0x300167d9; 
+ (id)name;	// 0x30016745
// declared property getter: - (id)freebusy;	// 0x30016751
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x30016771
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x300167d9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x30016791
@end
