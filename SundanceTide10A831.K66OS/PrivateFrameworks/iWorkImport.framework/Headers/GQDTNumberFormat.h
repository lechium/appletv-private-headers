...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x35d0313d
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x35d03221
+ (const StateSpec *)stateForReading;	// 0x35d02341
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x35d03649
- (id)baseStringFromDouble:(double)aDouble;	// 0x35d03c21
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x35d03051
- (id)currencyCode;	// 0x35d0421d
- (id)customNumberFormatTokens;	// 0x35d04241
- (void)dealloc;	// 0x35d0234d
- (id)formatString;	// 0x35d0420d
- (int)fractionAccuracy;	// 0x35d04e99
- (id)fractionStringFromDouble:(double)aDouble;	// 0x35d03a79
- (BOOL)hasValidDecimalPlaces;	// 0x35d02411
- (BOOL)isCustom;	// 0x35d04e79
- (BOOL)isTextFormat;	// 0x35d04e89
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x35d03eed
- (id)numberFormatBySettingValueType:(int)type;	// 0x35d040b9
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x35d032b9
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x35d03edd
- (BOOL)showThousandsSeparator;	// 0x35d0422d
- (id)stringFromDouble:(double)aDouble;	// 0x35d02439
- (BOOL)useAccountingStyle;	// 0x35d03119
- (int)valueType;	// 0x35d03109
@end
