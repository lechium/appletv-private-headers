...
- (id)initWithPath:(id)path;	// 0x1433d5
- (void)_savePrefs;	// 0x14370d
- (void)clearFeedResources;	// 0x14365d
- (void)dealloc;	// 0x143529
- (void)setFeedResource:(id)resource named:(id)named;	// 0x1435ad
@end
