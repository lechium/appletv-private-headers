...
+ (void)setSingleton:(id)singleton;	// 0x321151
+ (id)singleton;	// 0x321141
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x321311
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x321765
- (void)dealloc;	// 0x321161
- (id)populatorForAsset:(id)asset;	// 0x3212a1
@end
