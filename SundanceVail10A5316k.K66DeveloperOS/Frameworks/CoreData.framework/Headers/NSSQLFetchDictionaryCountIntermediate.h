...
- (id)initWithFetchIntermediate:(id)fetchIntermediate inScope:(id)scope;	// 0x32e02b9d
- (void)dealloc;	// 0x32e02bf5
- (id)generateSQLStringInContext:(id)context;	// 0x32e02c45
@end
