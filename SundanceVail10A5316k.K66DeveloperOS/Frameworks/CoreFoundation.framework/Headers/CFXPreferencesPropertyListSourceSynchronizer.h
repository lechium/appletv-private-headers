...
- (id)initWithPropertyListSource:(id)propertyListSource forLockedSynchronize:(BOOL)lockedSynchronize;	// 0x3709217d
- (unsigned char)_backingPlistChangedSinceLastSync;	// 0x37092581
- (void *)createPlistFromDisk;	// 0x370a1a81
- (void)dealloc;	// 0x370929c1
- (void)finalize;	// 0x3711fce9
- (void)setValue:(void *)value forKey:(CFStringRef)key;	// 0x3711fc75
- (unsigned char)synchronize;	// 0x3709234d
- (unsigned char)synchronizeAlreadyFlocked;	// 0x37092365
- (unsigned char)writePlistToDisk;	// 0x37095e15
@end
