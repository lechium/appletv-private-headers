...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x31aaa589
- (void)dealloc;	// 0x31aaa729
- (id)description;	// 0x31aaa6d5
- (BOOL)isEqual:(id)equal;	// 0x31aaa651
@end
