...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x348682fd; S=0x348682d9; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x34867fd5
- (void)dealloc;	// 0x34868015
- (void)didPrepareForRemoteSelectorInvocation;	// 0x34868199
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x348682fd
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x34868059
- (void)serverConnectionDied;	// 0x34868259
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x348682d9
@end
