...
@property(retain) UIWebSelection *selection;	// G=0x303504a5; S=0x303504b9; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x30350111
- (void)dealloc;	// 0x30350169
- (void)invalidate;	// 0x303503f9
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x30350251
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x303501ad
- (int)oppositeEdge:(int)edge;	// 0x30350235
// declared property getter: - (id)selection;	// 0x303504a5
// declared property setter: - (void)setSelection:(id)selection;	// 0x303504b9
@end
