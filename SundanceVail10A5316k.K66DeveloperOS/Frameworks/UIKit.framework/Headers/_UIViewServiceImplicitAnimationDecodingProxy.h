...
+ (id)proxyDecodingAnimationsForTarget:(id)target;	// 0x304bc5e1
- (void)__animateNextInvocationOfSelector:(id)selector withAnimationAttributes:(id)animationAttributes;	// 0x304bc7b5
- (void)dealloc;	// 0x304bc60d
- (void)forwardInvocation:(id)invocation;	// 0x304bc659
- (id)proxy:(id)proxy detailedSignatureForSelector:(SEL)selector;	// 0x304bc7f5
@end
