...
+ (void)_addCategoryMethod:(objc_method *)method toClass:(Class)aClass isClass:(BOOL)aClass3;	// 0x30a6c861
+ (void)initialize;	// 0x30a6c695
+ (void)installCategoryOnClassNamed:(id)named;	// 0x30a6c6e1
@end
