...
- (id)initWithCalendar:(id)calendar principal:(id)principal accountInfoProvider:(id)provider taskManager:(id)manager;	// 0x36e67555
- (void)cancelTaskGroup;	// 0x36e68259
- (id)dataContentType;	// 0x36e67659
- (void)dealloc;	// 0x36e675d1
- (void)startTaskGroup;	// 0x36e67665
@end
