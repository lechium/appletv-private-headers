...
- (id)init;	// 0x33c41d69
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x33c41efd
- (void)dealloc;	// 0x33c41e71
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x33c41d49
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x33c41fa9
@end
