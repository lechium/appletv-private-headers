...
- (id)init;	// 0x3416c255
- (id)initWithCFRunLoop:(CFRunLoopRef)cfrunLoop;	// 0x3416c279
- (void)awake;	// 0x3416c251
- (void)dealloc;	// 0x3416c3a1
- (void)down;	// 0x3416c4e9
- (void)finalize;	// 0x3416c455
- (void)up;	// 0x3416c599
- (int)value;	// 0x3416c605
@end
