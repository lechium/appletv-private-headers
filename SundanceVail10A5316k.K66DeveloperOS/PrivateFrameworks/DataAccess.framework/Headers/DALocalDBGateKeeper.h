...
+ (id)sharedGateKeeper;	// 0x3357742d
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x335776e9
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x335774f1
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x33577475
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x335775e9
- (id)stateString;	// 0x33577665
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x3357756d
@end
