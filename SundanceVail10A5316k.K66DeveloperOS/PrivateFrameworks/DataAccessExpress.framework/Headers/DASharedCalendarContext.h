...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x372cd365
- (void)dealloc;	// 0x372cd46d
- (void)finishedWithError:(id)error;	// 0x372cd4fd
@end
