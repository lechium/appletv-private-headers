...
+ (id)instanceWithAuthenticationContext:(id)authenticationContext;	// 0x361101f1
- (void).cxx_destruct;	// 0x3611056d
- (void)authenticateRequest:(id)request didReceiveResponse:(id)response;	// 0x3611047d
- (void)startWithCompletionBlock:(id)completionBlock;	// 0x36110271
@end
