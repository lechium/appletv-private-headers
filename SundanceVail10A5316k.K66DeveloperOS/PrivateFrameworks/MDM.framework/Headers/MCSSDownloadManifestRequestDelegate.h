...
@property(assign, nonatomic) BOOL shouldHideUserPrompts;	// G=0x361107ad; S=0x36110771; 
+ (id)instanceWithURLRequest:(id)urlrequest;	// 0x36110581
- (void).cxx_destruct;	// 0x3611087d
- (void)downloadManifestRequest:(id)request didReceiveResponse:(id)response;	// 0x361107e9
// declared property setter: - (void)setShouldHideUserPrompts:(BOOL)hideUserPrompts;	// 0x36110771
// declared property getter: - (BOOL)shouldHideUserPrompts;	// 0x361107ad
- (void)startCompletionBlock:(id)block;	// 0x361105f9
@end
