...
+ (id)instance;	// 0x3610ff51
- (void).cxx_destruct;	// 0x361101d9
- (void)itemLookupRequest:(id)request didFindItems:(id)items;	// 0x36110131
- (void)startCompletionBlock:(id)block;	// 0x3610ffb9
@end
