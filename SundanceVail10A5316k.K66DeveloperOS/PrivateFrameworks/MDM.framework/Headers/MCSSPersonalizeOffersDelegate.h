...
+ (id)instanceWithItems:(id)items;	// 0x36110891
- (void).cxx_destruct;	// 0x36110b15
- (void)personalizeOffersRequest:(id)request didReceiveResponse:(id)response;	// 0x36110a81
- (void)startCompletionBlock:(id)block;	// 0x36110909
@end
