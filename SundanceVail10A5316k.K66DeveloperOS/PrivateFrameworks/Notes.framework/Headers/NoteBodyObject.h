...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x33db5abd; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x33db5abd
- (id)contentAsPlainTextPreservingNewlines;	// 0x33db5b65
@end
