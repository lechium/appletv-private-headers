...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x31110371
- (void)dealloc;	// 0x31113df5
- (bool)loadDelayedNode:(id)node;	// 0x311108d1
@end
