...
- (id)init;	// 0x312db5f5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x312db671
- (void)dealloc;	// 0x312db9b5
- (XXStruct_M$PztB)getFormatStruct;	// 0x312db6e9
- (BOOL)isEqual:(id)equal;	// 0x312db725
@end
