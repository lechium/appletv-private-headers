...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x313bd581; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x313bd591; converted property
- (id)initWithMemory:(id)memory;	// 0x313bd381
// converted property getter: - (unsigned)indirectsymoff;	// 0x313bd581
- (BOOL)isDySymTab;	// 0x313bd57d
// converted property getter: - (unsigned)nindirectsyms;	// 0x313bd591
@end
