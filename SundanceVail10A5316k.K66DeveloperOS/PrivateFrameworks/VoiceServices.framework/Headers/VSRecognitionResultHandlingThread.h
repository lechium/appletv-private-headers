...
- (id)init;	// 0x30d6c0bd
- (void)_handleRequests;	// 0x30d6c41d
- (void)_notifyRequestHandled:(id)handled;	// 0x30d6c3a1
- (void)dealloc;	// 0x30d6c141
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x30d6c1fd
- (void)invalidate;	// 0x30d6c345
- (void)setDelegate:(id)delegate;	// 0x30d6c1a5
@end
