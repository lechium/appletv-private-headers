...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x30d6cc55
- (void)dealloc;	// 0x30d6cd8d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x30d6cdf1
@end
