...
typedef struct RefPtr<WebCore::AccessibilityObject> RefPtr<WebCore::AccessibilityObject>;
template<>
...
typedef struct WebAccessibilityObjectWrapper WebAccessibilityObjectWrapper;
template<>
...
typedef struct WebCoreMediaPlayerNotificationHelper WebCoreMediaPlayerNotificationHelper;
template<>
...
typedef struct MediaPlayerPrivateIOS {
	/*function-pointer*/ void **_field1;
	MediaPlayer *_field2;
...
template<>
struct VectorBuffer<unsigned int, 0> {
	unsigned *_field1;
	unsigned _field2;
};

template<>
struct Vector<unsigned int, 0> {
	unsigned _field1;
	VectorBuffer<unsigned int, 0> _field2;
};
...
struct GraphicsLayer {
	...
	unsigned _field26;
	int _field27;
	struct Vector<WebCore::GraphicsLayer *, 0> _field28;
	struct GraphicsLayer *_field29;
	struct GraphicsLayer *_field30;
	struct GraphicsLayer *_field31;
	struct GraphicsLayer *_field32;
	struct FloatPoint _field33;
	struct IntRect _field34;
	int _field35;
};
