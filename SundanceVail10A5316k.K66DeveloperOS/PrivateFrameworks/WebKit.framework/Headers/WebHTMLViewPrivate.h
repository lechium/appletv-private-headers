...
@class NSArray, NSMutableDictionary, WebDataSource, WAKView, WebEvent, NSString, NSTimer, WebPluginController;
...
+ (void)initialize;	// 0x35004e79
- (id).cxx_construct;	// 0x3505e121
- (void)clear;	// 0x3501e8ed
- (void)dealloc;	// 0x3501eab5
- (void)finalize;	// 0x3505e0f1
@end
