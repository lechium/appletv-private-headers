...
@property(retain) NSArray *freebusy;	// G=0x33d76751; S=0x33d76771; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x33d76791; S=0x33d767d9; 
+ (id)name;	// 0x33d76745
// declared property getter: - (id)freebusy;	// 0x33d76751
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x33d76771
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x33d767d9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x33d76791
@end
