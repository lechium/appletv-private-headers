...
@property(retain) ICSDate *completed;	// G=0x33d70fe1; S=0x33d71019; 
...
@property(retain) ICSDate *due;	// G=0x33d7110d; S=0x33d71145; 
...
@property(assign) int percentComplete;	// G=0x33d71039; S=0x33d71091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x33d71255; S=0x33d71235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x33d71165; S=0x33d711bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x33d70eed
// declared property getter: - (id)completed;	// 0x33d70fe1
// declared property getter: - (id)due;	// 0x33d7110d
- (void)fixComponent;	// 0x33d6ff75
// declared property getter: - (int)percentComplete;	// 0x33d71039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x33d71019
// declared property setter: - (void)setDue:(id)due;	// 0x33d71145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x33d71091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x33d71235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x33d711bd
- (BOOL)validate:(id *)validate;	// 0x33d70ef9
// declared property getter: - (id)x_apple_activity;	// 0x33d71255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x33d71165
@end
