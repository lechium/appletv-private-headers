...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x36c55675
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x36c55759
+ (const StateSpec *)stateForReading;	// 0x36c54879
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x36c55b81
- (id)baseStringFromDouble:(double)aDouble;	// 0x36c56159
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x36c55589
- (id)currencyCode;	// 0x36c56755
- (id)customNumberFormatTokens;	// 0x36c56779
- (void)dealloc;	// 0x36c54885
- (id)formatString;	// 0x36c56745
- (int)fractionAccuracy;	// 0x36c573d1
- (id)fractionStringFromDouble:(double)aDouble;	// 0x36c55fb1
- (BOOL)hasValidDecimalPlaces;	// 0x36c54949
- (BOOL)isCustom;	// 0x36c573b1
- (BOOL)isTextFormat;	// 0x36c573c1
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x36c56425
- (id)numberFormatBySettingValueType:(int)type;	// 0x36c565f1
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x36c557f1
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x36c56415
- (BOOL)showThousandsSeparator;	// 0x36c56765
- (id)stringFromDouble:(double)aDouble;	// 0x36c54971
- (BOOL)useAccountingStyle;	// 0x36c55651
- (int)valueType;	// 0x36c55641
@end
