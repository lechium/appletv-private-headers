...
- (id)init;	// 0x36c8328d
- (void)aboutToReadCells;	// 0x36c833d1
- (void)aboutToReadColumnVectors;	// 0x36c833bd
- (void)aboutToReadRowVectors;	// 0x36c833a9
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x36c83461
- (void)dealloc;	// 0x36c83325
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x36c83499
@end
