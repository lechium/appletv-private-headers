...
+ (void)setSingleton:(id)singleton;	// 0x206409
+ (id)singleton;	// 0x2063f9
- (id)init;	// 0x206419
- (void)_hidThreadLoop;	// 0x20675d
- (void)_invocationHandler;	// 0x206929
- (void)dealloc;	// 0x206511
- (BOOL)invokeOnHIDThread:(id)thread;	// 0x206575
@end
