...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x373931
- (unsigned)count;	// 0x373ce5
- (void)dealloc;	// 0x373c99
- (unsigned)indexOfObject:(id)object;	// 0x373db9
- (id)objectAtIndex:(unsigned)index;	// 0x373d15
@end
