...
+ (void)setSingleton:(id)singleton;	// 0x326c61
+ (id)singleton;	// 0x326c51
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x326e21
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x327275
- (void)dealloc;	// 0x326c71
- (id)populatorForAsset:(id)asset;	// 0x326db1
@end
