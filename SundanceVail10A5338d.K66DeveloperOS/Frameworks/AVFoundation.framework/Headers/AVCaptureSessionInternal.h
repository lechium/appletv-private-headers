...
@class AVRunLoopCondition, AVCaptureFigAudioDevice, AVCaptureFigVideoDevice, NSString, NSMutableDictionary, NSMutableArray, AVCaptureVideoPreviewLayer, NSError, AVWeakReference;
