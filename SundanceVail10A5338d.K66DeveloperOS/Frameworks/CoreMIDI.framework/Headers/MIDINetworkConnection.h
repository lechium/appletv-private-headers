...
@property(readonly, assign, nonatomic) MIDINetworkHost *host;	// G=0x3188c855; 
+ (id)connectionWithHost:(id)host;	// 0x3188c6fd
- (id)init;	// 0x3188c6b1
- (void)dealloc;	// 0x3188c769
// declared property getter: - (id)host;	// 0x3188c855
@end
