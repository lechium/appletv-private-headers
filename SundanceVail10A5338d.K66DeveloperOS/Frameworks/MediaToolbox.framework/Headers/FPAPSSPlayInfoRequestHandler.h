...
- (id)init;	// 0x361a0acd
- (void)dealloc;	// 0x361a0b19
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x361a0bc5
- (void)request:(id)request didFailWithError:(id)error;	// 0x361a0bc9
- (void)requestDidFinish:(id)request;	// 0x361a0fbd
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x361a0b79
- (void)setRequest:(id)request;	// 0x361a0b89
@end
