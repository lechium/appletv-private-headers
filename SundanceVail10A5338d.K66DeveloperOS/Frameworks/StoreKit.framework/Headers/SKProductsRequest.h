...
- (id)init;	// 0x337f5059
- (id)initWithProductIdentifiers:(id)productIdentifiers;	// 0x337f50bd
- (void)_handleReply:(id)reply;	// 0x337f5159
- (void)_sendXPCMessage;	// 0x337f53c1
- (void)dealloc;	// 0x337f5109
@end
