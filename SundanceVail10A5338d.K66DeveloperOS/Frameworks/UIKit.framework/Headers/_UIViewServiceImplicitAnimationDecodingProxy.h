...
+ (id)proxyDecodingAnimationsForTarget:(id)target;	// 0x3104aea1
- (void)__animateNextInvocationOfSelector:(id)selector withAnimationAttributes:(id)animationAttributes;	// 0x3104b075
- (void)dealloc;	// 0x3104aecd
- (void)forwardInvocation:(id)invocation;	// 0x3104af19
- (id)proxy:(id)proxy detailedSignatureForSelector:(SEL)selector;	// 0x3104b0d1
@end
