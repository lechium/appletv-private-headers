...
@property(retain, nonatomic) MRImage *slide;	// G=0x33552ee1; S=0x33552e9d; @synthesize
+ (void)initialize;	// 0x33552d25
+ (XXStruct_raCX$B *)poolInfo;	// 0x33552d15
- (void)dealloc;	// 0x33552e25
- (void)purge;	// 0x33552e65
// declared property setter: - (void)setSlide:(id)slide;	// 0x33552e9d
// declared property getter: - (id)slide;	// 0x33552ee1
@end
