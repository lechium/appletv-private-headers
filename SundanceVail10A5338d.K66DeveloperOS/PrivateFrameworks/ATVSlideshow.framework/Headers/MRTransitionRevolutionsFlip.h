...
- (id)initWithTransitionID:(id)transitionID;	// 0x335626b9
- (void)cleanup;	// 0x3356277d
- (void)releaseByTransitioner:(id)transitioner;	// 0x33562855
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x3356316d
- (void)setAttributes:(id)attributes;	// 0x33563021
- (void)setFlipDirection:(int)direction;	// 0x33562995
- (void)setupCubesWithLocalAspectRatio:(float)localAspectRatio;	// 0x33562af1
@end
