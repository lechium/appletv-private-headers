...
+ (void)_addCategoryMethod:(objc_method *)method toClass:(Class)aClass isClass:(BOOL)aClass3;	// 0x35055b19
+ (void)initialize;	// 0x3505594d
+ (void)installCategoryOnClassNamed:(id)named;	// 0x35055999
@end
