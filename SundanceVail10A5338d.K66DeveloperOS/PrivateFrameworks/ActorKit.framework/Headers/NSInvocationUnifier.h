...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x338501e5
- (void)dealloc;	// 0x3385020d
- (void)forwardInvocation:(id)invocation;	// 0x33850239
- (id)methodSignatureForSelector:(SEL)selector;	// 0x338503a5
@end
