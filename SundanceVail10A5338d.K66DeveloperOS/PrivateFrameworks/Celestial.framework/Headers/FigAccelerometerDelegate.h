...
- (id)init;	// 0x36359089
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x3635921d
- (void)dealloc;	// 0x36359191
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x36359069
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x363592c9
@end
