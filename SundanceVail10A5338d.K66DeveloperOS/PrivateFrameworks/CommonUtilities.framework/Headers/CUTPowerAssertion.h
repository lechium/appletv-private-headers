...
- (id)initWithIdentifier:(id)identifier;	// 0x31b20db1
- (id)initWithIdentifier:(id)identifier timeout:(double)timeout;	// 0x31b20b59
- (void)dealloc;	// 0x31b20de1
- (id)description;	// 0x31b20f39
@end
