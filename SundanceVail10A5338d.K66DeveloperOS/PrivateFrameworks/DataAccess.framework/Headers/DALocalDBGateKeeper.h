...
+ (id)sharedGateKeeper;	// 0x3097e3ad
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x3097e669
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x3097e471
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x3097e3f5
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x3097e569
- (id)stateString;	// 0x3097e5e5
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x3097e4ed
@end
