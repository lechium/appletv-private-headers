...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x338c9599
- (void)dealloc;	// 0x338c96a1
- (void)finishedWithError:(id)error;	// 0x338c9731
@end
