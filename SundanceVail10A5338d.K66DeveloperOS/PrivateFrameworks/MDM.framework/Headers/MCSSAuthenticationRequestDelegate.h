...
+ (id)instanceWithAuthenticationContext:(id)authenticationContext;	// 0x351241f1
- (void).cxx_destruct;	// 0x3512456d
- (void)authenticateRequest:(id)request didReceiveResponse:(id)response;	// 0x3512447d
- (void)startWithCompletionBlock:(id)completionBlock;	// 0x35124271
@end
