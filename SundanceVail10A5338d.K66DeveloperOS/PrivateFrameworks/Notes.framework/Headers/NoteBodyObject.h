...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x3642eabd; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x3642eabd
- (id)contentAsPlainTextPreservingNewlines;	// 0x3642eb65
@end
