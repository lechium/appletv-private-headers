...
- (id)basicAccountIdentifier;	// 0x3642ea69
- (id)collectionInfo;	// 0x3642e90d
- (unsigned)maximumServerIntId;	// 0x3642e5c5
- (id)notesForGUIDs:(id)guids;	// 0x3642e0d1
- (id)notesForIntegerIds:(id)integerIds;	// 0x3642df21
- (id)notesForServerIds:(id)serverIds;	// 0x3642dd71
- (id)notesForServerIntIds:(id)serverIntIds;	// 0x3642e281
- (id)notesForServerIntIdsInRange:(NSRange)range;	// 0x3642e431
- (id)predicateForNotes;	// 0x3642e8d5
@end
