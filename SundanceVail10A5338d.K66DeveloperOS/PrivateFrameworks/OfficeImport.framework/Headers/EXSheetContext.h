...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x33a61371
- (void)dealloc;	// 0x33a64df5
- (bool)loadDelayedNode:(id)node;	// 0x33a618d1
@end
