...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x33ae1e39
- (id).cxx_construct;	// 0x33ae1e35
- (void)createTargetTableContents;	// 0x33b9272d
- (void)dealloc;	// 0x33ae2c01
- (void)map;	// 0x33ae1ecd
- (void)mapScale;	// 0x33ae2081
- (void)readAnchor;	// 0x33ae1fd5
- (void)readCellsAndLines;	// 0x33ae28a1
- (void)readCoordinates;	// 0x33ae2281
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x33b9263d
- (void)validateTable;	// 0x33b92311
@end
