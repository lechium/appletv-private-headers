...
- (id)init;	// 0x33c2c5f5
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x33c2c671
- (void)dealloc;	// 0x33c2c9b5
- (XXStruct_M$PztB)getFormatStruct;	// 0x33c2c6e9
- (BOOL)isEqual:(id)equal;	// 0x33c2c725
@end
