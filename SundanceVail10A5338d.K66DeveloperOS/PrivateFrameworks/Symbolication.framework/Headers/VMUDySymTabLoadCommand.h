...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x34c93531; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x34c93541; converted property
- (id)initWithMemory:(id)memory;	// 0x34c93331
// converted property getter: - (unsigned)indirectsymoff;	// 0x34c93531
- (BOOL)isDySymTab;	// 0x34c9352d
// converted property getter: - (unsigned)nindirectsyms;	// 0x34c93541
@end
