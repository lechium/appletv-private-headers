...
@property(readonly, assign) VMURange range;	// G=0x34cb8c2d; converted property
@property(readonly, retain) NSString *type;	// G=0x34cb8c61; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x34cb8dc5
- (void)dealloc;	// 0x34cb8f71
- (id)description;	// 0x34cb8c19
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x34cb8401
- (BOOL)isEqual:(id)equal;	// 0x34cb8c81
- (BOOL)isSubmap;	// 0x34cb8c71
- (unsigned)protection;	// 0x34cb8c51
// converted property getter: - (VMURange)range;	// 0x34cb8c2d
// converted property getter: - (id)type;	// 0x34cb8c61
@end
