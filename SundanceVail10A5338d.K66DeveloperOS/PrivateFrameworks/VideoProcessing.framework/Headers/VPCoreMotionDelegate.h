...
- (id)init;	// 0x3189cc81
- (void)dealloc;	// 0x3189cd61
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x3189d131
- (void)processGyroData:(id)data withError:(id)error;	// 0x3189ce01
- (void)start;	// 0x3189d041
- (void)stop;	// 0x3189d10d
@end
