...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x345c7c55
- (void)dealloc;	// 0x345c7d8d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x345c7df1
@end
