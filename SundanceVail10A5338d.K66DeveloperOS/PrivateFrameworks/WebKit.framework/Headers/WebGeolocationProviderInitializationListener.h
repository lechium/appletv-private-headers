...
- (id)initWithGeolocation:(Geolocation *)geolocation;	// 0x316a66cd
- (id).cxx_construct;	// 0x316a69dd
- (void).cxx_destruct;	// 0x316a69b1
- (void)initializationAllowedWebView:(id)view provider:(id)provider;	// 0x316a6735
- (void)initializationDeniedWebView:(id)view provider:(id)provider;	// 0x316a699d
@end
