...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x316c7349
- (void)_invalidate;	// 0x316c7441
- (void)_usePolicy:(int)policy;	// 0x316c740d
- (void)dealloc;	// 0x316c73c1
- (void)download;	// 0x316c749d
- (void)ignore;	// 0x316c7489
- (void)use;	// 0x316c7475
@end
