...
+ (int)partialFeedType;	// 0x33d15469
- (id)init;	// 0x33d1533d
- (void)dealloc;	// 0x33d153c5
- (void)didParseData;	// 0x33d151d5
- (void)failWithError:(id)error;	// 0x33d152fd
- (void)loadRequest:(id)request withDelegate:(id)delegate accountAuthRequired:(BOOL)required;	// 0x33d15411
- (int)parseData:(id)data;	// 0x33d151e5
- (void)setDelegate:(id)delegate;	// 0x33d15459
@end
