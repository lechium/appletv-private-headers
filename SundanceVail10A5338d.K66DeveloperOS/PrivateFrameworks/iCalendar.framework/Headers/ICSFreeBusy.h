...
@property(retain) NSArray *freebusy;	// G=0x3653e751; S=0x3653e771; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x3653e791; S=0x3653e7d9; 
+ (id)name;	// 0x3653e745
// declared property getter: - (id)freebusy;	// 0x3653e751
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x3653e771
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x3653e7d9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x3653e791
@end
