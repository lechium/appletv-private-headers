...
@property(retain) ICSDate *completed;	// G=0x36538fe1; S=0x36539019; 
...
@property(retain) ICSDate *due;	// G=0x3653910d; S=0x36539145; 
...
@property(assign) int percentComplete;	// G=0x36539039; S=0x36539091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x36539255; S=0x36539235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x36539165; S=0x365391bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x36538eed
// declared property getter: - (id)completed;	// 0x36538fe1
// declared property getter: - (id)due;	// 0x3653910d
- (void)fixComponent;	// 0x36537f75
// declared property getter: - (int)percentComplete;	// 0x36539039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x36539019
// declared property setter: - (void)setDue:(id)due;	// 0x36539145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x36539091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x36539235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x365391bd
- (BOOL)validate:(id *)validate;	// 0x36538ef9
// declared property getter: - (id)x_apple_activity;	// 0x36539255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x36539165
@end
