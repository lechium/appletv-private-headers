...
- (char *)ID;	// 0x35073f39
- (void)dealloc;	// 0x35073e35
- (BOOL)isHidden;	// 0x35073f29
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x35073f49
- (id)slideStyle;	// 0x35073f09
- (id)stylesheet;	// 0x35073f19
@end
