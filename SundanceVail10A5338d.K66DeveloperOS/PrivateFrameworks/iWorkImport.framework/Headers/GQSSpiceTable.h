...
- (id)init;	// 0x350b5159
- (void)aboutToReadCells;	// 0x350b529d
- (void)aboutToReadColumnVectors;	// 0x350b5289
- (void)aboutToReadRowVectors;	// 0x350b5275
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x350b532d
- (void)dealloc;	// 0x350b51f1
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x350b5365
@end
