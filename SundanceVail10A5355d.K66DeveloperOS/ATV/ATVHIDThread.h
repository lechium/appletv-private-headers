...
+ (void)setSingleton:(id)singleton;	// 0x20eb7d
+ (id)singleton;	// 0x20eb6d
- (id)init;	// 0x20eb8d
- (void)_hidThreadLoop;	// 0x20eed1
- (void)_invocationHandler;	// 0x20f09d
- (void)dealloc;	// 0x20ec85
- (BOOL)invokeOnHIDThread:(id)thread;	// 0x20ece9
@end
