...
- (id)initWithPopBlock:(id)popBlock popInterval:(double)interval;	// 0x15fe41
- (void)_timerFired:(id)fired;	// 0x160059
- (void)dealloc;	// 0x15feed
- (void)discard;	// 0x15ff39
- (void)wasPopped;	// 0x15ffe5
- (void)wasPushed;	// 0x15ff79
@end
