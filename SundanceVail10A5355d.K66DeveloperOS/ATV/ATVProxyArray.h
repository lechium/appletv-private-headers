...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x381191
- (unsigned)count;	// 0x381545
- (void)dealloc;	// 0x3814f9
- (unsigned)indexOfObject:(id)object;	// 0x381619
- (id)objectAtIndex:(unsigned)index;	// 0x381575
@end
