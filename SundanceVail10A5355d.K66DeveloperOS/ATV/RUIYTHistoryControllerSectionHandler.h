...
- (id)initWithHistoryController:(id)historyController;	// 0x255109
- (void).cxx_destruct;	// 0x255269
- (id)itemForIndex:(id)index;	// 0x255169
- (BOOL)itemSelectedAtIndex:(id)index action:(int)action defer:(BOOL *)defer;	// 0x25523d
@end
