...
@class AVWeakReference, AVRunLoopCondition, AVCaptureFigAudioDevice, NSMutableDictionary, AVCaptureFigVideoDevice, NSString, NSError, NSMutableArray, AVCaptureVideoPreviewLayer;
