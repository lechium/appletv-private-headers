...
@property(readonly, assign, nonatomic) MIDINetworkHost *host;	// G=0x363d1855; 
+ (id)connectionWithHost:(id)host;	// 0x363d16fd
- (id)init;	// 0x363d16b1
- (void)dealloc;	// 0x363d1769
// declared property getter: - (id)host;	// 0x363d1855
@end
