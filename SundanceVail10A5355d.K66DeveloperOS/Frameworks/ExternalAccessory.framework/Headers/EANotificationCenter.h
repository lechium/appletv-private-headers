...
- (id)init;	// 0x31f399ad
- (void)_notificationHandler:(id)handler;	// 0x31f3a385
- (void)dealloc;	// 0x31f39b9d
- (void)notificationCallback;	// 0x31f39d71
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x31f39af5
@end
