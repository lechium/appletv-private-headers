...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x34700cc9
- (void)dealloc;	// 0x34700e69
- (id)description;	// 0x34700e15
- (BOOL)isEqual:(id)equal;	// 0x34700d91
@end
