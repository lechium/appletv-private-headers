...
- (id)init;	// 0x3026dfd9
- (void)dealloc;	// 0x3026e141
- (void)drawInContext:(CGContextRef)context;	// 0x3026e269
- (void)setUpGraph:(int)graph min:(float)min max:(float)max numValues:(int)values;	// 0x3026ddf1
- (void)setUpGraphs:(int)graphs;	// 0x3026dcd9
- (void)updateValue:(int)value value:(float)value2;	// 0x3026df21
@end
