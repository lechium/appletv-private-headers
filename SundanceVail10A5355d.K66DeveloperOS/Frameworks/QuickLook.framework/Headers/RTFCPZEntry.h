...
- (id)initFromCentralFileHeader:(const char *)centralFileHeader inputStream:(id)stream;	// 0x341d4b59
- (void)copyToFile:(id)file;	// 0x341d5175
- (id)data;	// 0x341d5031
- (void)dealloc;	// 0x341d4da1
- (id)inputStream;	// 0x341d4ded
@end
