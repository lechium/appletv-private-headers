...
@class NSDictionary, NSDate, NSCalendar, NSString, NSTimeZone;
...
+ (id)alloc;	// 0x33d1ba75
+ (id)allocWithZone:(NSZone *)zone;	// 0x33d1baa1
- (id)init;	// 0x33d1bacd
- (id)initWithCoder:(id)coder;	// 0x33d1bba1
- (void)clearNonSystemProperties;	// 0x33d1bc01
- (int)compareFireDates:(id)dates;	// 0x33d1bbfd
- (id)copyWithZone:(NSZone *)zone;	// 0x33d1bbed
- (void)encodeWithCoder:(id)coder;	// 0x33d1bbe9
- (BOOL)isValid;	// 0x33d1bbf9
- (id)nextFireDateAfterDate:(id)date localTimeZone:(id)zone;	// 0x33d1bbf5
- (id)nextFireDateForLastFireDate:(id)lastFireDate;	// 0x33d1bbf1
@end
