...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x33b25371; 
+ (void)popAnimationState;	// 0x33a02b19
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x33a01da9
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x33b25371
- (void)animationDidStart:(id)animation;	// 0x33a08c81
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x33a08e35
- (void)dealloc;	// 0x33a04431
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x33a0345d
- (void)setAnimationAttributes:(id)attributes;	// 0x33a12af9
@end
