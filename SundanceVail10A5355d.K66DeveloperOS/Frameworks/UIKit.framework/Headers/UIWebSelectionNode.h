...
@property(retain) UIWebSelection *selection;	// G=0x33cbcc65; S=0x33cbcc79; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x33cbc8d1
- (void)dealloc;	// 0x33cbc929
- (void)invalidate;	// 0x33cbcbb9
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x33cbca11
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x33cbc96d
- (int)oppositeEdge:(int)edge;	// 0x33cbc9f5
// declared property getter: - (id)selection;	// 0x33cbcc65
// declared property setter: - (void)setSelection:(id)selection;	// 0x33cbcc79
@end
