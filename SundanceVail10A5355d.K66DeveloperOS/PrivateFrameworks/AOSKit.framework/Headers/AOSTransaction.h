...
- (id)init;	// 0x3568c721
- (id)initWithCoder:(id)coder;	// 0x3568cb85
- (void)dealloc;	// 0x3568c821
- (void)encodeWithCoder:(id)coder;	// 0x3568cc81
- (id)error;	// 0x3568cb75
- (void)finalize;	// 0x3568c9f1
- (BOOL)isSuccessful;	// 0x3568cb55
- (id)result;	// 0x3568cb65
@end
