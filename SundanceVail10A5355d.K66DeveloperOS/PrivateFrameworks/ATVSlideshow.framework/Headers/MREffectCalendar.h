...
- (id)init;	// 0x321ffcad
- (void)_loadForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x322007c1
- (void)_unload;	// 0x322009e5
- (BOOL)isLoadedForTime:(double)time;	// 0x322003e5
- (BOOL)prerenderForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x32200469
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x322004b1
- (void)setAttributes:(id)attributes;	// 0x321ffcd9
@end
