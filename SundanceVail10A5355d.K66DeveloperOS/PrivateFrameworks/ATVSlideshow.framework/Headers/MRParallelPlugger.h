...
@property(assign, nonatomic) unsigned char currentLayoutIndex;	// G=0x321476c1; S=0x32146879; @synthesize=mCurrentLayoutIndex
@property(assign, nonatomic) BOOL needsUpdate;	// G=0x321476d1; S=0x321476e1; @synthesize=mNeedsUpdate
@property(copy, nonatomic) MCPlugParallel *plug;	// G=0x321476ad; S=0x321466c5; @synthesize=mPlug
- (id)init;	// 0x32144bc1
- (BOOL)applyAtTime:(double)time toSublayer:(id)sublayer withArguments:(id)arguments;	// 0x32144c65
// declared property getter: - (unsigned char)currentLayoutIndex;	// 0x321476c1
- (void)dealloc;	// 0x32144c01
// declared property getter: - (BOOL)needsUpdate;	// 0x321476d1
// declared property getter: - (id)plug;	// 0x321476ad
// declared property setter: - (void)setCurrentLayoutIndex:(unsigned char)index;	// 0x32146879
// declared property setter: - (void)setNeedsUpdate:(BOOL)update;	// 0x321476e1
// declared property setter: - (void)setPlug:(id)plug;	// 0x321466c5
@end
