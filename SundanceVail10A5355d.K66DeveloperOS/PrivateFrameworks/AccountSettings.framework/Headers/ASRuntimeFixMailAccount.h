...
- (id)init;	// 0x35f7974d
- (BOOL)_cleanupAccountClass:(id)aClass;	// 0x35f799fd
- (void)accountsHaveBeenSaved:(BOOL)saved;	// 0x35f79955
- (void)dealloc;	// 0x35f79829
- (int)fixBasicAccountIfNeeded:(id)needed loggingMessage:(id)message;	// 0x35f79875
- (id)supportedAccountTypes;	// 0x35f79995
@end
