...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x358cb1e5
- (void)dealloc;	// 0x358cb20d
- (void)forwardInvocation:(id)invocation;	// 0x358cb239
- (id)methodSignatureForSelector:(SEL)selector;	// 0x358cb3a5
@end
