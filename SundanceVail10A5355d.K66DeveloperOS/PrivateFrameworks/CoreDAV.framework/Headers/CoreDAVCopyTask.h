...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x30490ccd
- (void)dealloc;	// 0x30490c09
- (id)httpMethod;	// 0x30490bfd
- (BOOL)validate:(id *)validate;	// 0x30490c4d
@end
