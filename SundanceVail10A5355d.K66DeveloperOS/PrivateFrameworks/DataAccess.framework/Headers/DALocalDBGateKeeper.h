...
+ (id)sharedGateKeeper;	// 0x336663bd
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x33666679
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x33666481
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x33666405
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x33666579
- (id)stateString;	// 0x336665f5
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x336664fd
@end
