...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x3412e4e9
- (void)dealloc;	// 0x3412e5f1
- (void)finishedWithError:(id)error;	// 0x3412e681
@end
