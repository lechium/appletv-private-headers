...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x37401a89; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x37401a89
- (id)contentAsPlainTextPreservingNewlines;	// 0x37401b31
@end
