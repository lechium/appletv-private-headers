...
+ (id)autoStylingWithChart:(id)chart;	// 0x31cecdc5
- (id)initWithChart:(id)chart;	// 0x31cece5d
- (void)dealloc;	// 0x31cfba6d
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x31d309f1
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x31d2b881
@end
