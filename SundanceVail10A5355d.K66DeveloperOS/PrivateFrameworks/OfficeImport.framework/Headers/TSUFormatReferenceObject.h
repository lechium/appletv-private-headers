...
- (id)init;	// 0x31e5b535
- (id)initWithTSUFormatFormatStruct:(XXStruct_M$PztB)tsuformatFormatStruct;	// 0x31e5b5b1
- (void)dealloc;	// 0x31e5b8f5
- (XXStruct_M$PztB)getFormatStruct;	// 0x31e5b629
- (BOOL)isEqual:(id)equal;	// 0x31e5b665
@end
