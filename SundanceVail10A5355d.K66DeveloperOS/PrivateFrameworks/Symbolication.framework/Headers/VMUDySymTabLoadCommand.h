...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x34d5c4f9; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x34d5c509; converted property
- (id)initWithMemory:(id)memory;	// 0x34d5c2f9
// converted property getter: - (unsigned)indirectsymoff;	// 0x34d5c4f9
- (BOOL)isDySymTab;	// 0x34d5c4f5
// converted property getter: - (unsigned)nindirectsyms;	// 0x34d5c509
@end
