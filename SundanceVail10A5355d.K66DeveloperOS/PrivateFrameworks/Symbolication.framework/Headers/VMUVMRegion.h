...
@interface VMUVMRegion : __objc_empty_vtable {
...
@property(readonly, assign) VMURange range;	// G=0x34d81c2d; converted property
@property(readonly, retain) NSString *type;	// G=0x34d81c61; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x34d81dc5
- (void)dealloc;	// 0x34d81f71
- (id)description;	// 0x34d81c19
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x34d81401
- (BOOL)isEqual:(id)equal;	// 0x34d81c81
- (BOOL)isSubmap;	// 0x34d81c71
- (unsigned)protection;	// 0x34d81c51
// converted property getter: - (VMURange)range;	// 0x34d81c2d
// converted property getter: - (id)type;	// 0x34d81c61
@end
