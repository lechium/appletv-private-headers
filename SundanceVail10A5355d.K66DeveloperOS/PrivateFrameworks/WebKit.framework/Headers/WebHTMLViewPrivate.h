...
@class WebDataSource, WAKView, WebEvent, NSString, NSTimer, WebPluginController, NSArray, NSMutableDictionary;
...
+ (void)initialize;	// 0x31678301
- (id).cxx_construct;	// 0x316d3569
- (void)clear;	// 0x3169201d
- (void)dealloc;	// 0x316921e5
- (void)finalize;	// 0x316d3539
@end
