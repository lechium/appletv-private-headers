...
@class WebInspector, NSMutableSet, WebNodeHighlight, WebFixedPositionContent, NSURL, WebIndicateLayer, WAKWindow, NSString, WebPreferences, WebVideoFullscreenController, NSDictionary;
...
+ (void)initialize;	// 0x316759f9
- (id)init;	// 0x31675a5d
- (id).cxx_construct;	// 0x316759fd
- (void).cxx_destruct;	// 0x31703241
- (void)dealloc;	// 0x31703075
- (void)finalize;	// 0x31703215
@end
