...
@property(retain) ICSDate *completed;	// G=0x35068fe1; S=0x35069019; 
...
@property(retain) ICSDate *due;	// G=0x3506910d; S=0x35069145; 
...
@property(assign) int percentComplete;	// G=0x35069039; S=0x35069091; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x35069255; S=0x35069235; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x35069165; S=0x350691bd; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x35068eed
// declared property getter: - (id)completed;	// 0x35068fe1
// declared property getter: - (id)due;	// 0x3506910d
- (void)fixComponent;	// 0x35067f75
// declared property getter: - (int)percentComplete;	// 0x35069039
// declared property setter: - (void)setCompleted:(id)completed;	// 0x35069019
// declared property setter: - (void)setDue:(id)due;	// 0x35069145
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x35069091
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x35069235
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x350691bd
- (BOOL)validate:(id *)validate;	// 0x35068ef9
// declared property getter: - (id)x_apple_activity;	// 0x35069255
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x35069165
@end
