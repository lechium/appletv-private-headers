...
- (char *)ID;	// 0x34bdefa1
- (void)dealloc;	// 0x34bdee9d
- (BOOL)isHidden;	// 0x34bdef91
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x34bdefb1
- (id)slideStyle;	// 0x34bdef71
- (id)stylesheet;	// 0x34bdef81
@end
