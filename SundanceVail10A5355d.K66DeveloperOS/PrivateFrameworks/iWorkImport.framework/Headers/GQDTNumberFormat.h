...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x34bf25c5
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x34bf26a9
+ (const StateSpec *)stateForReading;	// 0x34bf17c9
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x34bf2ad1
- (id)baseStringFromDouble:(double)aDouble;	// 0x34bf30a9
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x34bf24d9
- (id)currencyCode;	// 0x34bf36a5
- (id)customNumberFormatTokens;	// 0x34bf36c9
- (void)dealloc;	// 0x34bf17d5
- (id)formatString;	// 0x34bf3695
- (int)fractionAccuracy;	// 0x34bf4321
- (id)fractionStringFromDouble:(double)aDouble;	// 0x34bf2f01
- (BOOL)hasValidDecimalPlaces;	// 0x34bf1899
- (BOOL)isCustom;	// 0x34bf4301
- (BOOL)isTextFormat;	// 0x34bf4311
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x34bf3375
- (id)numberFormatBySettingValueType:(int)type;	// 0x34bf3541
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x34bf2741
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x34bf3365
- (BOOL)showThousandsSeparator;	// 0x34bf36b5
- (id)stringFromDouble:(double)aDouble;	// 0x34bf18c1
- (BOOL)useAccountingStyle;	// 0x34bf25a1
- (int)valueType;	// 0x34bf2591
@end
