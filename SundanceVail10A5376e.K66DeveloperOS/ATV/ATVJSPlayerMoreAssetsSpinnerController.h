...
- (id)initWithPopBlock:(id)popBlock popInterval:(double)interval;	// 0x168aa1
- (void)_timerFired:(id)fired;	// 0x168cb9
- (void)dealloc;	// 0x168b4d
- (void)discard;	// 0x168b99
- (void)wasPopped;	// 0x168c45
- (void)wasPushed;	// 0x168bd9
@end
