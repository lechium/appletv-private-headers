...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x38b049
- (unsigned)count;	// 0x38b3fd
- (void)dealloc;	// 0x38b3b1
- (unsigned)indexOfObject:(id)object;	// 0x38b4d1
- (id)objectAtIndex:(unsigned)index;	// 0x38b42d
@end
