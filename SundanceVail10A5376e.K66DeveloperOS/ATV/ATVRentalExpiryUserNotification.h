...
+ (void)postExpiryNotificationForAsset:(id)asset;	// 0x1f7791
- (id)init;	// 0x1f7829
- (void)_playAsset;	// 0x1f80a9
- (void)_setAsset:(id)asset;	// 0x1f7de9
- (BOOL)brEventAction:(id)action;	// 0x1f7b59
- (void)dealloc;	// 0x1f7af5
- (void)layoutSubcontrols;	// 0x1f7c0d
@end
