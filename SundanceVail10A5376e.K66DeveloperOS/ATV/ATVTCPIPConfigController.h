...
@property(assign, nonatomic) BOOL showOnlyDNS;	// G=0x202c3d; S=0x202c4d; @synthesize=_showOnlyDNS
- (id)initWithWireless:(BOOL)wireless forDNS:(BOOL)dns notifying:(id)notifying;	// 0x202265
- (void).cxx_destruct;	// 0x202c5d
- (void)_readCurrentConfiguration;	// 0x202d19
- (void)_saveConfiguration;	// 0x202e79
- (void)autoModeChosen:(BOOL)chosen forDNS:(BOOL)dns;	// 0x202355
- (void)entryComplete:(id)complete;	// 0x2026ad
// declared property setter: - (void)setShowOnlyDNS:(BOOL)dns;	// 0x202c4d
// declared property getter: - (BOOL)showOnlyDNS;	// 0x202c3d
@end
