...
- (id)initWithDictionary:(id)dictionary;	// 0x2479ad
- (id)accessibilityLabel;	// 0x24842d
- (void)dealloc;	// 0x247f15
- (void)layoutSubcontrols;	// 0x247ff9
- (CGSize)sizeThatFits:(CGSize)fits;	// 0x247fc9
@end
