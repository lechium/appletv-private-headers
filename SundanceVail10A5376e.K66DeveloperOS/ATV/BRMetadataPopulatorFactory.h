...
+ (void)setSingleton:(id)singleton;	// 0x33c05d
+ (id)singleton;	// 0x33c04d
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x33c21d
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x33c671
- (void)dealloc;	// 0x33c06d
- (id)populatorForAsset:(id)asset;	// 0x33c1ad
@end
