...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(XXStruct_qlg9jA)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x31fbe5
- (void)dealloc;	// 0x31fc71
- (void)drawRect:(CGRect)rect;	// 0x31fcb5
@end
