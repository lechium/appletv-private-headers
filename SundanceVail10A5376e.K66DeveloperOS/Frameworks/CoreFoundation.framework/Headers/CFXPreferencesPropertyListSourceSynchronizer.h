...
- (id)initWithPropertyListSource:(id)propertyListSource forLockedSynchronize:(BOOL)lockedSynchronize;	// 0x355c54ed
- (unsigned char)_backingPlistChangedSinceLastSync;	// 0x355c58f1
- (void *)createPlistFromDisk;	// 0x355d0a95
- (void)dealloc;	// 0x355c63f9
- (void)finalize;	// 0x3564eb81
- (void)setValue:(void *)value forKey:(CFStringRef)key;	// 0x3564eb0d
- (unsigned char)synchronize;	// 0x355c56bd
- (unsigned char)synchronizeAlreadyFlocked;	// 0x355c56d5
- (unsigned char)writePlistToDisk;	// 0x355c64ad
@end
