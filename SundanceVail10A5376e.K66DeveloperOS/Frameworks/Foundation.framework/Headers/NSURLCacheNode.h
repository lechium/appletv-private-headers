...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x34dfa4c9
- (void)dealloc;	// 0x34dfa669
- (id)description;	// 0x34dfa615
- (BOOL)isEqual:(id)equal;	// 0x34dfa591
@end
