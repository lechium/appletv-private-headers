...
- (id)init;	// 0x3272ca81
- (void)dealloc;	// 0x3272cbe9
- (void)drawInContext:(CGContextRef)context;	// 0x3272cd11
- (void)setUpGraph:(int)graph min:(float)min max:(float)max numValues:(int)values;	// 0x3272c899
- (void)setUpGraphs:(int)graphs;	// 0x3272c781
- (void)updateValue:(int)value value:(float)value2;	// 0x3272c9c9
@end
