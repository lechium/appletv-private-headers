...
- (id)initFromCentralFileHeader:(const char *)centralFileHeader inputStream:(id)stream;	// 0x32c50021
- (void)copyToFile:(id)file;	// 0x32c5063d
- (id)data;	// 0x32c504f9
- (void)dealloc;	// 0x32c50269
- (id)inputStream;	// 0x32c502b5
@end
