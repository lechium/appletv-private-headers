...
- (id)init;	// 0x35f94f59
- (id)initWithProductIdentifiers:(id)productIdentifiers;	// 0x35f94fbd
- (void)_handleReply:(id)reply;	// 0x35f95059
- (void)_sendXPCMessage;	// 0x35f952c1
- (void)dealloc;	// 0x35f95009
@end
