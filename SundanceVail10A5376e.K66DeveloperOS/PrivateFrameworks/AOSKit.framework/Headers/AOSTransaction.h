...
- (id)init;	// 0x3616a721
- (id)initWithCoder:(id)coder;	// 0x3616ab85
- (void)dealloc;	// 0x3616a821
- (void)encodeWithCoder:(id)coder;	// 0x3616ac81
- (id)error;	// 0x3616ab75
- (void)finalize;	// 0x3616a9f1
- (BOOL)isSuccessful;	// 0x3616ab55
- (id)result;	// 0x3616ab65
@end
