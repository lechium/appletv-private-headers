...
- (id)init;	// 0x3638a54d
- (void)_loadForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x3638b061
- (void)_unload;	// 0x3638b285
- (BOOL)isLoadedForTime:(double)time;	// 0x3638ac85
- (BOOL)prerenderForTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x3638ad09
- (void)renderAtTime:(double)time inContext:(id)context withArguments:(id)arguments;	// 0x3638ad51
- (void)setAttributes:(id)attributes;	// 0x3638a579
@end
