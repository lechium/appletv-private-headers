...
@property(retain, nonatomic) MRImage *slide;	// G=0x3639f6d1; S=0x3639f68d; @synthesize
+ (void)initialize;	// 0x3639f515
+ (XXStruct_raCX$B *)poolInfo;	// 0x3639f505
- (void)dealloc;	// 0x3639f615
- (void)purge;	// 0x3639f655
// declared property setter: - (void)setSlide:(id)slide;	// 0x3639f68d
// declared property getter: - (id)slide;	// 0x3639f6d1
@end
