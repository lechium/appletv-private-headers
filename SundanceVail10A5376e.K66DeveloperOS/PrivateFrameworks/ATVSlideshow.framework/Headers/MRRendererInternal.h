...
@class NSThread, NSDictionary, MRLayerEffect, NSMutableSet, NSConditionLock, CMMotionManager, MRContext, MRRenderArguments, NSRecursiveLock, NSString, NSArray, NSMutableDictionary, NSMutableArray, MRImage;
