...
- (id)init;	// 0x31199539
- (BOOL)_cleanupAccountClass:(id)aClass;	// 0x311997e9
- (void)accountsHaveBeenSaved:(BOOL)saved;	// 0x31199741
- (void)dealloc;	// 0x31199615
- (int)fixBasicAccountIfNeeded:(id)needed loggingMessage:(id)message;	// 0x31199661
- (id)supportedAccountTypes;	// 0x31199781
@end
