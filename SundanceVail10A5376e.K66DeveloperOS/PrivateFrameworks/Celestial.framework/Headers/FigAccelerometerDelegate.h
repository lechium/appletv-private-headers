...
- (id)init;	// 0x329bebd9
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x329bed6d
- (void)dealloc;	// 0x329bece1
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x329bebb9
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x329bee19
@end
