...
- (id)initWithIdentifier:(id)identifier;	// 0x3794f5f9
- (id)initWithIdentifier:(id)identifier timeout:(double)timeout;	// 0x3794f3a1
- (void)dealloc;	// 0x3794f629
- (id)description;	// 0x3794f781
@end
