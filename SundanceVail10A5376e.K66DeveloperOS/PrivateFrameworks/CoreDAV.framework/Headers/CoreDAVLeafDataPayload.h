...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x33a463b1; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x33a4638d; S=0x33a463a1; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x33a463c5; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x33a46289
// declared property getter: - (id)dataPayload;	// 0x33a463b1
- (void)dealloc;	// 0x33a46315
// declared property getter: - (id)serverID;	// 0x33a4638d
// declared property setter: - (void)setServerID:(id)anId;	// 0x33a463a1
// declared property getter: - (id)syncKey;	// 0x33a463c5
@end
