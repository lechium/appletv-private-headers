...
+ (id)sharedGateKeeper;	// 0x311eb3cd
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x311eb689
- (void)registerPreemptiveWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x311eb491
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x311eb415
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x311eb589
- (id)stateString;	// 0x311eb605
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x311eb50d
@end
