...
- (id)initWithCalendarID:(id)calendarID accountID:(id)anId queue:(id)queue completionBlock:(id)block;	// 0x365864e9
- (void)dealloc;	// 0x365865f1
- (void)finishedWithError:(id)error;	// 0x36586681
@end
