...
+ (id)sharedInstance;	// 0x347a9339
- (id)init;	// 0x347a9419
- (void)SetProject:(id)project;	// 0x347a9459
- (void)addContentsToMainLayer:(id)mainLayer;	// 0x347a94c9
- (void)showModuleInMainView:(id)mainView;	// 0x347a9469
@end
