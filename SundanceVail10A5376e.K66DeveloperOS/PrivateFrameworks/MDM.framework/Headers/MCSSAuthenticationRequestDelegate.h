...
+ (id)instanceWithAuthenticationContext:(id)authenticationContext;	// 0x3478f1c1
- (void).cxx_destruct;	// 0x3478f53d
- (void)authenticateRequest:(id)request didReceiveResponse:(id)response;	// 0x3478f44d
- (void)startWithCompletionBlock:(id)completionBlock;	// 0x3478f241
@end
