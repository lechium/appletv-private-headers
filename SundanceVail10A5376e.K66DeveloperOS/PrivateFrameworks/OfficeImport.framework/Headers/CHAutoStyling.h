...
+ (id)autoStylingWithChart:(id)chart;	// 0x37065e0d
- (id)initWithChart:(id)chart;	// 0x37065ea5
- (void)dealloc;	// 0x37074ab5
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x370a9a11
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x370a48a1
@end
