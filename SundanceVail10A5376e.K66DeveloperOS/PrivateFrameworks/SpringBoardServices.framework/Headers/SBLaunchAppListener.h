...
+ (BOOL)waitForLaunchThatSpringBoardKnowsAbout:(id)launchThatSpringBoardKnowsAbout timeout:(double)timeout;	// 0x366d13f1
- (id)initWithDisplayIdentifier:(id)displayIdentifier handlerBlock:(id)block;	// 0x366d0e69
- (void)_didFailToLaunch;	// 0x366d121d
- (void)_didLaunch;	// 0x366d1135
- (void)dealloc;	// 0x366d10d5
- (void)invalidate;	// 0x366d130d
@end
