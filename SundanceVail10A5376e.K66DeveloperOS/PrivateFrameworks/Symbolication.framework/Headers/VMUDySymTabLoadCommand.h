...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x3221b4f9; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x3221b509; converted property
- (id)initWithMemory:(id)memory;	// 0x3221b2f9
// converted property getter: - (unsigned)indirectsymoff;	// 0x3221b4f9
- (BOOL)isDySymTab;	// 0x3221b4f5
// converted property getter: - (unsigned)nindirectsyms;	// 0x3221b509
@end
