...
@property(readonly, assign) VMURange range;	// G=0x32240c2d; converted property
@property(readonly, retain) NSString *type;	// G=0x32240c61; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x32240dc5
- (void)dealloc;	// 0x32240f71
- (id)description;	// 0x32240c19
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x32240401
- (BOOL)isEqual:(id)equal;	// 0x32240c81
- (BOOL)isSubmap;	// 0x32240c71
- (unsigned)protection;	// 0x32240c51
// converted property getter: - (VMURange)range;	// 0x32240c2d
// converted property getter: - (id)type;	// 0x32240c61
@end
