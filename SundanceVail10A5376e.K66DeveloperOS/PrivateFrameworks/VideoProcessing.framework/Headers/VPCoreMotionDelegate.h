...
- (id)init;	// 0x3405f7f9
- (void)dealloc;	// 0x3405f8d9
- (XXStruct_N5B6hD)getQuaternionByTimestamp:(double)timestamp;	// 0x3405fca9
- (void)processGyroData:(id)data withError:(id)error;	// 0x3405f979
- (void)start;	// 0x3405fbb9
- (void)stop;	// 0x3405fc85
@end
