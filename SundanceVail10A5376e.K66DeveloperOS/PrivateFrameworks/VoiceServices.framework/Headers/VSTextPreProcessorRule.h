...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x3210fc15
- (void)dealloc;	// 0x3210fd4d
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x3210fdb1
@end
