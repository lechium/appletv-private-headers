...
- (id)initWithGeolocation:(Geolocation *)geolocation;	// 0x32346919
- (id).cxx_construct;	// 0x32346c29
- (void).cxx_destruct;	// 0x32346bfd
- (void)initializationAllowedWebView:(id)view provider:(id)provider;	// 0x32346981
- (void)initializationDeniedWebView:(id)view provider:(id)provider;	// 0x32346be9
@end
