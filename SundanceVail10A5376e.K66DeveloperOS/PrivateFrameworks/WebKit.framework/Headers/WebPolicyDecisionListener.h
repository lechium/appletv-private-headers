...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x3236552d
- (void)_invalidate;	// 0x32365625
- (void)_usePolicy:(int)policy;	// 0x323655f1
- (void)dealloc;	// 0x323655a5
- (void)download;	// 0x32365681
- (void)ignore;	// 0x3236566d
- (void)use;	// 0x32365659
@end
