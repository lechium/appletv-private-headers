...
@property(retain) NSArray *freebusy;	// G=0x35d8f751; S=0x35d8f771; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x35d8f791; S=0x35d8f7d9; 
+ (id)name;	// 0x35d8f745
// declared property getter: - (id)freebusy;	// 0x35d8f751
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x35d8f771
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x35d8f7d9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x35d8f791
@end
