...
- (char *)ID;	// 0x35806eb1
- (void)dealloc;	// 0x35806dad
- (BOOL)isHidden;	// 0x35806ea1
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x35806ec1
- (id)slideStyle;	// 0x35806e81
- (id)stylesheet;	// 0x35806e91
@end
