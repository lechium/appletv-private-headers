...
- (id)init;	// 0x35849189
- (void)aboutToReadCells;	// 0x358492cd
- (void)aboutToReadColumnVectors;	// 0x358492b9
- (void)aboutToReadRowVectors;	// 0x358492a5
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x3584935d
- (void)dealloc;	// 0x35849221
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x35849395
@end
