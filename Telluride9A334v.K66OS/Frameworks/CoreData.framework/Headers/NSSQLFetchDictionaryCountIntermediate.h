...
- (id)initWithFetchIntermediate:(id)fetchIntermediate inScope:(id)scope;	// 0x31f47d01
- (void)dealloc;	// 0x31f47ed5
- (id)generateSQLStringInContext:(id)context;	// 0x31f47d59
@end
