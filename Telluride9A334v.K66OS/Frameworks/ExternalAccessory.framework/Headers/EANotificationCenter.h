...
- (id)init;	// 0x31a4e6c1
- (void)_notificationHandler:(id)handler;	// 0x31a4f0c1
- (void)dealloc;	// 0x31a4e8b5
- (void)notificationCallback;	// 0x31a4ea91
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x31a4e805
@end
