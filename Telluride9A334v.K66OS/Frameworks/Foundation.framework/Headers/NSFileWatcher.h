...
- (id)initWithQueue:(dispatch_queue_s *)queue;	// 0x3072ed1d
- (void)dealloc;	// 0x3072ed89
- (void)handleFSEventPath:(id)path flags:(unsigned long)flags id:(unsigned long long)anId;	// 0x3072ee8d
- (void)setURL:(id)url;	// 0x3072fa7d
- (void)settle;	// 0x3072fbd1
- (void)startWithObserver:(id)observer;	// 0x3072fb6d
- (void)stop;	// 0x3072ff1d
- (void)watchItem;	// 0x3072f03d
@end
