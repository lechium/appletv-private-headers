...
@property(readonly, assign, nonatomic, getter=isDataRequired) BOOL dataRequired;	// G=0x302d7491; 
- (id)initWithTableViewCell:(id)tableViewCell editingStyle:(int)style;	// 0x301585dd
- (void)dealloc;	// 0x30159585
- (id)deleteConfirmationControl:(BOOL)control;	// 0x30159161
- (id)editControl:(BOOL)control;	// 0x30158705
// declared property getter: - (BOOL)isDataRequired;	// 0x302d7491
- (id)reorderControl:(BOOL)control;	// 0x30158ebd
- (id)reorderSeparatorView:(BOOL)view;	// 0x30158f39
@end
