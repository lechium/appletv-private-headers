...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x30171a39; 
+ (void)popAnimationState;	// 0x3003ecbd
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x3003e051
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x30171a39
- (void)animationDidStart:(id)animation;	// 0x30044de9
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x30044f85
- (void)dealloc;	// 0x3004051d
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x3003f645
- (void)setAnimationAttributes:(id)attributes;	// 0x3004e985
@end
