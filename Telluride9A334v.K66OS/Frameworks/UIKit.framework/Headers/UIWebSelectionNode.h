...
@property(retain) UIWebSelection *selection;	// G=0x30306ccd; S=0x30306ce1; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x3030692d
- (void)dealloc;	// 0x30306985
- (void)invalidate;	// 0x30306c21
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x30306a6d
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x303069c9
- (int)oppositeEdge:(int)edge;	// 0x30306a51
// declared property getter: - (id)selection;	// 0x30306ccd
// declared property setter: - (void)setSelection:(id)selection;	// 0x30306ce1
@end
