...
- (id)initWithSlide:(id)slide sprite:(id)sprite modelViewMatrix:(const float *)matrix foreColor:(const float *)color position:(CGPoint)position size:(CGSize)size isShadow:(BOOL)shadow;	// 0x32f1f19d
- (void)dealloc;	// 0x32f1f2b5
@end
