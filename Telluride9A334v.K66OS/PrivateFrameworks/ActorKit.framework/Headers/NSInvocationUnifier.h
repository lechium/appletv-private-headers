...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x329000a5
- (void)dealloc;	// 0x32900171
- (void)forwardInvocation:(id)invocation;	// 0x329001e5
- (id)methodSignatureForSelector:(SEL)selector;	// 0x3290019d
@end
