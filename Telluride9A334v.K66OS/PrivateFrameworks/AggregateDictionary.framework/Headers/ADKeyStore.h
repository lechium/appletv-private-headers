...
+ (id)defaultWhitelist;	// 0x305210d5
- (id)initWithDefaultPath;	// 0x30521359
- (id)initWithPath:(id)path;	// 0x30521451
- (void)dealloc;	// 0x30521039
- (BOOL)distributionKeyIsWhitelisted:(id)whitelisted;	// 0x30521149
- (BOOL)metadataKeyIsWhitelisted:(id)whitelisted;	// 0x30521101
- (BOOL)scalarKeyIsWhitelisted:(id)whitelisted;	// 0x30521251
@end
