...
- (id)initWithCenter:(id)center messageName:(id)name userInfoData:(id)data oolKey:(id)key oolData:(id)data5 target:(id)target selector:(SEL)selector context:(void *)context makeServer:(BOOL)server;	// 0x35b1423d
- (void)_performCallout;	// 0x35b1438d
- (void)_releaseSendingData;	// 0x35b1453d
- (void)dealloc;	// 0x35b145bd
- (void)main;	// 0x35b14405
@end
