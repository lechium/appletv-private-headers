...
- (id)initForNetwork:(id)network acceptOnlyHex:(BOOL)hex notifying:(id)notifying;	// 0x3310edcd
- (void)dealloc;	// 0x3310f019
- (void)setInitialPassword:(id)password;	// 0x3310f0cd
- (void)textDidChange:(id)text;	// 0x3310f079
- (void)textDidEndEditing:(id)text;	// 0x3310f07d
@end
