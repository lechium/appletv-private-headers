...
+ (void)setSingleton:(id)singleton;	// 0x33110aa9
+ (id)singleton;	// 0x33110a99
- (id)init;	// 0x33110ab9
- (void)_hidThreadLoop;	// 0x33110de9
- (void)_invocationHandler;	// 0x33110fb1
- (void)dealloc;	// 0x33110bb5
- (BOOL)invokeOnHIDThread:(id)thread;	// 0x33110c15
@end
