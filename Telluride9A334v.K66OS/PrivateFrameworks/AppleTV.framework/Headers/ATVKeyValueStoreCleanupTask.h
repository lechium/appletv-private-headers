...
- (void)dealloc;	// 0x3315638d
- (BOOL)perform:(id)perform;	// 0x3315642d
- (void)setKeyValueStore:(id)store;	// 0x331563d9
- (void)setLastModifiedThreshold:(double)threshold;	// 0x33156419
@end
