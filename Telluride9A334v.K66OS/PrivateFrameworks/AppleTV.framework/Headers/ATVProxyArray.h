...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x332d9381
- (unsigned)count;	// 0x332d97d1
- (void)dealloc;	// 0x332d9785
- (unsigned)indexOfObject:(id)object;	// 0x332d98a5
- (id)objectAtIndex:(unsigned)index;	// 0x332d9805
@end
