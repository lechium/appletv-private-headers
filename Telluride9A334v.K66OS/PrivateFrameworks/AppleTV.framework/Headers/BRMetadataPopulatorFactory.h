...
+ (void)setSingleton:(id)singleton;	// 0x33282155
+ (id)singleton;	// 0x33282145
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x33282311
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x332828ed
- (void)dealloc;	// 0x33282165
- (id)populatorForAsset:(id)asset;	// 0x332822a1
@end
