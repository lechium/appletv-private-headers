...
- (id)initWithImageDataSource:(id)imageDataSource reflectionHeight:(float)height cornerRadius:(float)radius;	// 0x33268315
- (void)dealloc;	// 0x3326838d
- (void)drawInContext:(CGContextRef)context;	// 0x332683b9
@end
