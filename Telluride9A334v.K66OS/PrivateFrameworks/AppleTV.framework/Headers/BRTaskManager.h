...
+ (void)setSingleton:(id)singleton;	// 0x332c2239
+ (id)singleton;	// 0x332c2229
- (id)init;	// 0x332c2249
- (void)_processTasks;	// 0x332c2649
- (void)cancelTask:(id)task;	// 0x332c24d9
- (void)dealloc;	// 0x332c22fd
- (void)scheduleTask:(id)task;	// 0x332c235d
@end
