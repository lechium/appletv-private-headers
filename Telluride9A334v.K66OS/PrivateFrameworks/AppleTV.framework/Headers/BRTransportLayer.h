...
@property(assign) BOOL showChapterMarks;	// G=0x33250069; S=0x33250049; converted property
- (id)initWithSpinner:(BOOL)spinner;	// 0x3324f6a1
- (id)_cachedImageForName:(id)name;	// 0x33250575
- (void)_drawChapterMarkersInContext:(CGContextRef)context;	// 0x33250f41
- (void)_drawInterstitialMarkersInContext:(CGContextRef)context;	// 0x3325129d
- (id)_loadImageForName:(id)name;	// 0x332505e1
- (void)_updateDynamicFrames;	// 0x332509f1
- (void)_updateLeftEnd;	// 0x332503fd
- (void)_updateStaticFrames;	// 0x3325065d
- (void)dealloc;	// 0x3324f959
- (void)drawInContext:(CGContextRef)context;	// 0x332500a9
- (void)layoutSubcontrols;	// 0x33250079
- (CGRect)leftEndCapRenderableArea;	// 0x3324fccd
- (float)playheadPosition;	// 0x3324fe9d
- (CGRect)rightEndCapFrame;	// 0x3324fc29
- (void)setChapterMarkers:(id)markers withTemporaryMarker:(float)temporaryMarker;	// 0x3324ff45
- (void)setCurrentInterstitialIndex:(long)index;	// 0x33250029
- (void)setDownloadedRange:(NSRange)range;	// 0x3324fbd9
- (void)setDrawsBetweenLeftEdgeAndBufferEdge:(BOOL)edge;	// 0x3324fab5
- (void)setInterstitialMarkers:(id)markers;	// 0x3324ffc5
- (void)setPercentComplete:(float)complete;	// 0x3324fa3d
- (void)setPlayerStateHidden:(BOOL)hidden;	// 0x3324fb51
// converted property setter: - (void)setShowChapterMarks:(BOOL)marks;	// 0x33250049
- (void)setState:(int)state;	// 0x3324f9e1
- (void)setUseWideLeftEndCap:(BOOL)cap;	// 0x3324faf9
- (void)setZeroDuration:(BOOL)duration;	// 0x3324fb95
// converted property getter: - (BOOL)showChapterMarks;	// 0x33250069
@end
