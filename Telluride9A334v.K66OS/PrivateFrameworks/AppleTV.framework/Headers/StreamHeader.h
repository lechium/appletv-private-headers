...
- (id)initWithBuffer:(id)buffer;	// 0x333d9f94
- (void)dealloc;	// 0x333da35c
- (id)getAudioData;	// 0x333d9f44
- (id)getIndexData;	// 0x333d9f80
- (id)getNetflixKeyEnvelope;	// 0x333d9f6c
- (id)getPlayReady;	// 0x333d9f58
- (id)getStreamData;	// 0x333d9f1c
- (id)getVideoData;	// 0x333d9f30
@end
