...
- (id)initWithXPCShmem:(void *)xpcshmem;	// 0x323ef5e1
- (const void *)bytes;	// 0x323ef73d
- (void)dealloc;	// 0x323ef665
- (id)debugDescription;	// 0x323ef6ed
- (unsigned)length;	// 0x323ef74d
@end
