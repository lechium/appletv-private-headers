...
- (id)initWithCalendar:(id)calendar principal:(id)principal accountInfoProvider:(id)provider taskManager:(id)manager;	// 0x35969295
- (void)cancelTaskGroup;	// 0x35969319
- (id)dataContentType;	// 0x35969289
- (void)dealloc;	// 0x359698f5
- (void)startTaskGroup;	// 0x3596935d
@end
