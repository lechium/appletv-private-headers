...
- (id)init;	// 0x3506dce1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x3506dba1
- (void)dealloc;	// 0x3506dc4d
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x3506da1d
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x3506da3d
@end
