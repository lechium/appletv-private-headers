...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x347b44c5
- (void)dealloc;	// 0x347b43fd
- (id)httpMethod;	// 0x347b43f1
- (BOOL)validate:(id *)validate;	// 0x347b4441
@end
