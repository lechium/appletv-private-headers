...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x347a7209; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x347a71d1; S=0x347a71e5; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x347a7219; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x347a70d1
// declared property getter: - (id)dataPayload;	// 0x347a7209
- (void)dealloc;	// 0x347a715d
// declared property getter: - (id)serverID;	// 0x347a71d1
// declared property setter: - (void)setServerID:(id)anId;	// 0x347a71e5
// declared property getter: - (id)syncKey;	// 0x347a7219
@end
