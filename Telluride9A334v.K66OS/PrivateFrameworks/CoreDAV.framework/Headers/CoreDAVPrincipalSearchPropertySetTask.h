...
- (id)initWithURL:(id)url;	// 0x347b5491
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x347b5589
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x347b5619
- (id)httpMethod;	// 0x347b54d1
- (id)requestBody;	// 0x347b54dd
@end
