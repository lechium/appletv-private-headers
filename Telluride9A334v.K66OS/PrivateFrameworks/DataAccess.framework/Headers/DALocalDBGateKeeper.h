...
+ (id)sharedGateKeeper;	// 0x337b6889
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x337b6ac9
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x337b68d1
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x337b69c9
- (id)stateString;	// 0x337b6a45
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x337b694d
@end
