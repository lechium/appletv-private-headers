...
@property(readonly, retain) NSMutableData *data;	// G=0x30c3b365; converted property
- (id)init;	// 0x30c3b075
- (int)appendData:(id)data;	// 0x30c3b0ed
// converted property getter: - (id)data;	// 0x30c3b365
- (void)dealloc;	// 0x30c3b4f9
- (void)done;	// 0x30c3b00d
@end
