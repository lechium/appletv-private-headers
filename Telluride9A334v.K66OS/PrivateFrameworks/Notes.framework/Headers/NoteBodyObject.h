...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x30f053a5; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x30f053a5
- (id)contentAsPlainTextPreservingNewlines;	// 0x30f05429
@end
