...
+ (id)autoStylingWithChart:(id)chart;	// 0x35642ed1
- (id)initWithChart:(id)chart;	// 0x35642f6d
- (void)dealloc;	// 0x35652135
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x3564fbd9
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x35694a69
@end
