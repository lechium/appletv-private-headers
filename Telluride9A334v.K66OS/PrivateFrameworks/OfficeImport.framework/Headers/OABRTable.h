...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x356a44f1
- (void)createTargetTableContents;	// 0x356f20bd
- (void)dealloc;	// 0x356a53e9
- (void)map;	// 0x356a4591
- (void)mapScale;	// 0x356a473d
- (void)readAnchor;	// 0x356a4689
- (void)readCellsAndLines;	// 0x356a500d
- (void)readCoordinates;	// 0x356a49c9
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x356f2839
@end
