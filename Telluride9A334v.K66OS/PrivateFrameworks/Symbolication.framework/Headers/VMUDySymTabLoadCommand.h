...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x35bcce35; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x35bcce45; converted property
- (id)initWithMemory:(id)memory;	// 0x35bcce55
// converted property getter: - (unsigned)indirectsymoff;	// 0x35bcce35
- (BOOL)isDySymTab;	// 0x35bcce31
// converted property getter: - (unsigned)nindirectsyms;	// 0x35bcce45
@end
