...
@property(readonly, assign) VMURange range;	// G=0x35bf2a5d; converted property
@property(readonly, retain) NSString *type;	// G=0x35bf2a91; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x35bf2bc1
- (void)dealloc;	// 0x35bf2b61
- (id)description;	// 0x35bf2e0d
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x35bf2e21
- (BOOL)isEqual:(id)equal;	// 0x35bf2d75
- (BOOL)isSubmap;	// 0x35bf2aa1
- (unsigned)protection;	// 0x35bf2a81
// converted property getter: - (VMURange)range;	// 0x35bf2a5d
// converted property getter: - (id)type;	// 0x35bf2a91
@end
