...
- (id)init;	// 0x3202521d
- (void)_handleRequests;	// 0x320252a5
- (void)_notifyRequestHandled:(id)handled;	// 0x320254bd
- (void)dealloc;	// 0x3202573d
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x32025595
- (void)invalidate;	// 0x32025539
- (void)setDelegate:(id)delegate;	// 0x320256dd
@end
