...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x32025dd1
- (void)dealloc;	// 0x32025f09
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x32025f69
@end
