...
- (id)initWithHighlightView:(id)highlightView webView:(id)view;	// 0x339f960d
- (id)actionForKey:(id)key;	// 0x339f95b9
- (void)drawInContext:(CGContextRef)context;	// 0x339f9661
@end
