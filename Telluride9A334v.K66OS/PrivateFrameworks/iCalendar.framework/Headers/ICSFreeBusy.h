...
@property(retain) NSArray *freebusy;	// G=0x317bbb31; S=0x317bbb51; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x317bbb71; S=0x317bbbb9; 
+ (id)name;	// 0x317bbb25
// declared property getter: - (id)freebusy;	// 0x317bbb31
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x317bbb51
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x317bbbb9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x317bbb71
@end
