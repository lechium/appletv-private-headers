...
@property(retain) ICSDate *completed;	// G=0x317b6531; S=0x317b6569; 
...
@property(retain) ICSDate *due;	// G=0x317b6659; S=0x317b6691; 
...
@property(assign) int percentComplete;	// G=0x317b6589; S=0x317b65e1; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x317b6779; S=0x317b6759; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x317b66b1; S=0x317b6709; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x317b643d
// declared property getter: - (id)completed;	// 0x317b6531
// declared property getter: - (id)due;	// 0x317b6659
- (void)fixComponent;	// 0x317b5559
// declared property getter: - (int)percentComplete;	// 0x317b6589
// declared property setter: - (void)setCompleted:(id)completed;	// 0x317b6569
// declared property setter: - (void)setDue:(id)due;	// 0x317b6691
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x317b65e1
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x317b6759
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x317b6709
- (BOOL)validate:(id *)validate;	// 0x317b6449
// declared property getter: - (id)x_apple_activity;	// 0x317b6779
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x317b66b1
@end
