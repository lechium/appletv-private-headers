...
- (char *)ID;	// 0x32bc9589
- (void)dealloc;	// 0x32bc96d1
- (BOOL)isHidden;	// 0x32bc9579
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x32bc9665
- (id)slideStyle;	// 0x32bc9559
- (id)stylesheet;	// 0x32bc9569
@end
