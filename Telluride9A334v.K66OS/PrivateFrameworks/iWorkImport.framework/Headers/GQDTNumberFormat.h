...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x32be0e0d
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x32bde6e5
+ (const StateSpec *)stateForReading;	// 0x32bdd459
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x32be057d
- (id)baseStringFromDouble:(double)aDouble;	// 0x32be0b79
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x32bdec99
- (id)currencyCode;	// 0x32bdd4c9
- (id)customNumberFormatTokens;	// 0x32bdd921
- (void)dealloc;	// 0x32bdf9c5
- (id)formatString;	// 0x32bdd4b9
- (int)fractionAccuracy;	// 0x32bdd509
- (id)fractionStringFromDouble:(double)aDouble;	// 0x32be098d
- (BOOL)hasValidDecimalPlaces;	// 0x32bdd465
- (BOOL)isCustom;	// 0x32bdd4e9
- (BOOL)isTextFormat;	// 0x32bdd4f9
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x32bdd5fd
- (id)numberFormatBySettingValueType:(int)type;	// 0x32bdd7cd
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x32be01b5
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x32bdd4a9
- (BOOL)showThousandsSeparator;	// 0x32bdd4d9
- (id)stringFromDouble:(double)aDouble;	// 0x32bded4d
- (BOOL)useAccountingStyle;	// 0x32bdd499
- (int)valueType;	// 0x32bdd489
@end
