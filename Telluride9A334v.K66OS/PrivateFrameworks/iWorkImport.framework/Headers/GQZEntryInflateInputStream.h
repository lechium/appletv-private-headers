...
- (id)initWithOffset:(long long)offset end:(long long)end uncompressedSize:(unsigned long long)size crc:(unsigned long)crc input:(id)input;	// 0x32c13745
- (void)dealloc;	// 0x32c13989
- (unsigned long)readToBuffer:(char *)buffer size:(unsigned long)size;	// 0x32c139f9
- (void)readToOwnBuffer:(const char **)ownBuffer size:(unsigned *)size;	// 0x32c13c1d
@end
