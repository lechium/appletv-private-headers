...
- (id)init;	// 0x311b86c1
- (void)_notificationHandler:(id)handler;	// 0x311b90c1
- (void)dealloc;	// 0x311b88b5
- (void)notificationCallback;	// 0x311b8a91
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x311b8805
@end
