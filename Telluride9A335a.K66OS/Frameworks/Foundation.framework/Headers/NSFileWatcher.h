...
- (id)initWithQueue:(dispatch_queue_s *)queue;	// 0x32138d1d
- (void)dealloc;	// 0x32138d89
- (void)handleFSEventPath:(id)path flags:(unsigned long)flags id:(unsigned long long)anId;	// 0x32138e8d
- (void)setURL:(id)url;	// 0x32139a7d
- (void)settle;	// 0x32139bd1
- (void)startWithObserver:(id)observer;	// 0x32139b6d
- (void)stop;	// 0x32139f1d
- (void)watchItem;	// 0x3213903d
@end
