...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x320c53a9
- (void)dealloc;	// 0x320c5549
- (id)description;	// 0x320c54f5
- (BOOL)isEqual:(id)equal;	// 0x320c5471
@end
