...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x30141ef5; S=0x30141ed1; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x30141c8d
- (void)didPrepareForRemoteSelectorInvocation;	// 0x30141da9
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x30141ef5
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x30141ccd
- (void)serverConnectionDied;	// 0x30141e69
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x30141ed1
@end
