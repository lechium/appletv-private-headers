...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x311880a5
- (void)dealloc;	// 0x31188171
- (void)forwardInvocation:(id)invocation;	// 0x311881e5
- (id)methodSignatureForSelector:(SEL)selector;	// 0x3118819d
@end
