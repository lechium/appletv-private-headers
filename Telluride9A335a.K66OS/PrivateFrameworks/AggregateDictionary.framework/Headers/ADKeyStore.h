...
+ (id)defaultWhitelist;	// 0x312c20d5
- (id)initWithDefaultPath;	// 0x312c2359
- (id)initWithPath:(id)path;	// 0x312c2451
- (void)dealloc;	// 0x312c2039
- (BOOL)distributionKeyIsWhitelisted:(id)whitelisted;	// 0x312c2149
- (BOOL)metadataKeyIsWhitelisted:(id)whitelisted;	// 0x312c2101
- (BOOL)scalarKeyIsWhitelisted:(id)whitelisted;	// 0x312c2251
@end
