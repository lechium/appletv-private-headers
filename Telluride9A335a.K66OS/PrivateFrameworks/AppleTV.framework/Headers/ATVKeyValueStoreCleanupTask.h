...
- (void)dealloc;	// 0x3413738d
- (BOOL)perform:(id)perform;	// 0x3413742d
- (void)setKeyValueStore:(id)store;	// 0x341373d9
- (void)setLastModifiedThreshold:(double)threshold;	// 0x34137419
@end
