...
- (id)initWithPath:(id)path;	// 0x3415e389
- (void)_savePrefs;	// 0x3415e6d5
- (void)clearFeedResources;	// 0x3415e625
- (void)dealloc;	// 0x3415e4f1
- (void)setFeedResource:(id)resource named:(id)named;	// 0x3415e575
@end
