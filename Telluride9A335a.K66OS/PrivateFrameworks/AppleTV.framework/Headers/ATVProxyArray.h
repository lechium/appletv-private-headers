...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x342ba381
- (unsigned)count;	// 0x342ba7d1
- (void)dealloc;	// 0x342ba785
- (unsigned)indexOfObject:(id)object;	// 0x342ba8a5
- (id)objectAtIndex:(unsigned)index;	// 0x342ba805
@end
