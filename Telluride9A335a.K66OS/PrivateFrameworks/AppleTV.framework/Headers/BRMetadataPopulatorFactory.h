...
+ (void)setSingleton:(id)singleton;	// 0x34263155
+ (id)singleton;	// 0x34263145
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x34263311
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x342638ed
- (void)dealloc;	// 0x34263165
- (id)populatorForAsset:(id)asset;	// 0x342632a1
@end
