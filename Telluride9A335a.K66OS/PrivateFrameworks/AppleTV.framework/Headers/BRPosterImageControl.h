...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(float)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x34249009
- (void)dealloc;	// 0x3424909d
- (void)drawInContext:(CGContextRef)context;	// 0x342490e1
@end
