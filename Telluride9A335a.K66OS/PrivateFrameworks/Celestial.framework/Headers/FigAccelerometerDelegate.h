...
- (id)init;	// 0x315d8ce1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x315d8ba1
- (void)dealloc;	// 0x315d8c4d
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x315d8a1d
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x315d8a3d
@end
