...
+ (id)sharedGateKeeper;	// 0x3226d889
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x3226dac9
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x3226d8d1
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x3226d9c9
- (id)stateString;	// 0x3226da45
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x3226d94d
@end
