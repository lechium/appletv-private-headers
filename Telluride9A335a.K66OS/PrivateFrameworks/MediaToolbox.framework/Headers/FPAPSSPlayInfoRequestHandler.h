...
- (id)init;	// 0x34a98b4d
- (void)dealloc;	// 0x34a98d11
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x34a98b49
- (void)request:(id)request didFailWithError:(id)error;	// 0x34a98c41
- (void)requestDidFinish:(id)request;	// 0x34a98b99
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x34a98b39
- (void)setRequest:(id)request;	// 0x34a98cd1
@end
