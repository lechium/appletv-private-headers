...
@interface NoteBodyObject : ___CFConstantStringClassReference {
}
@property(retain, nonatomic) NSString *content;	// @dynamic
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x31ff73a5; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x31ff73a5
- (id)contentAsPlainTextPreservingNewlines;	// 0x31ff7429
@end
