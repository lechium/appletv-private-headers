...
+ (id)autoStylingWithChart:(id)chart;	// 0x35287ed1
- (id)initWithChart:(id)chart;	// 0x35287f6d
- (void)dealloc;	// 0x35297135
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x35294bd9
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x352d9a69
@end
