...
- (id)initWithRows:(id)rows fileName:(id)name columnCount:(unsigned)count archiver:(id)archiver;	// 0x3541fac9
- (void)dealloc;	// 0x3541fe89
- (void)mapAt:(id)at withState:(id)state;	// 0x3541fb89
- (CGSize)pageSize;	// 0x3541fab1
@end
