...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x352cc215
- (void)dealloc;	// 0x352cf6e5
- (bool)loadDelayedNode:(id)node;	// 0x352cc7a1
@end
