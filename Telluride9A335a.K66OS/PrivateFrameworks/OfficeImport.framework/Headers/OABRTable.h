...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x352e94f1
- (void)createTargetTableContents;	// 0x353370bd
- (void)dealloc;	// 0x352ea3e9
- (void)map;	// 0x352e9591
- (void)mapScale;	// 0x352e973d
- (void)readAnchor;	// 0x352e9689
- (void)readCellsAndLines;	// 0x352ea00d
- (void)readCoordinates;	// 0x352e99c9
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x35337839
@end
