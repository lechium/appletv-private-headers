...
@property(readonly, assign) VMURange range;	// G=0x31f85a5d; converted property
@property(readonly, retain) NSString *type;	// G=0x31f85a91; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x31f85bc1
- (void)dealloc;	// 0x31f85b61
- (id)description;	// 0x31f85e0d
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x31f85e21
- (BOOL)isEqual:(id)equal;	// 0x31f85d75
- (BOOL)isSubmap;	// 0x31f85aa1
- (unsigned)protection;	// 0x31f85a81
// converted property getter: - (VMURange)range;	// 0x31f85a5d
// converted property getter: - (id)type;	// 0x31f85a91
@end
