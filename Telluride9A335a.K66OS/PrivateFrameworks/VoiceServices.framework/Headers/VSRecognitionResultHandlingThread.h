...
- (id)init;	// 0x305e021d
- (void)_handleRequests;	// 0x305e02a5
- (void)_notifyRequestHandled:(id)handled;	// 0x305e04bd
- (void)dealloc;	// 0x305e073d
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x305e0595
- (void)invalidate;	// 0x305e0539
- (void)setDelegate:(id)delegate;	// 0x305e06dd
@end
