...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x305e0dd1
- (void)dealloc;	// 0x305e0f09
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x305e0f69
@end
