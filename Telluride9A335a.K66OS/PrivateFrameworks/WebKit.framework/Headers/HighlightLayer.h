...
- (id)initWithHighlightView:(id)highlightView webView:(id)view;	// 0x347d660d
- (id)actionForKey:(id)key;	// 0x347d65b9
- (void)drawInContext:(CGContextRef)context;	// 0x347d6661
@end
