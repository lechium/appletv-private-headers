...
- (id)initWithChooser:(PassRefPtr<WebCore::FileChooser>)chooser;	// 0x347a866d
- (void)cancel;	// 0x347a8aa5
- (void)chooseFilename:(id)filename;	// 0x347a895d
- (void)chooseFilenames:(id)filenames;	// 0x347a86b5
@end
