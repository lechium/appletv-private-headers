...
- (char *)ID;	// 0x30462589
- (void)dealloc;	// 0x304626d1
- (BOOL)isHidden;	// 0x30462579
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x30462665
- (id)slideStyle;	// 0x30462559
- (id)stylesheet;	// 0x30462569
@end
