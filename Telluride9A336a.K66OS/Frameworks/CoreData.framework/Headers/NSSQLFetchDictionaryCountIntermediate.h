...
- (id)initWithFetchIntermediate:(id)fetchIntermediate inScope:(id)scope;	// 0x32404d01
- (void)dealloc;	// 0x32404ed5
- (id)generateSQLStringInContext:(id)context;	// 0x32404d59
@end
