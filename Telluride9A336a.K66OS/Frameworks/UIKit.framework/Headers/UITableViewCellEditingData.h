...
@property(readonly, assign, nonatomic, getter=isDataRequired) BOOL dataRequired;	// G=0x35362491; 
- (id)initWithTableViewCell:(id)tableViewCell editingStyle:(int)style;	// 0x351e35dd
- (void)dealloc;	// 0x351e4585
- (id)deleteConfirmationControl:(BOOL)control;	// 0x351e4161
- (id)editControl:(BOOL)control;	// 0x351e3705
// declared property getter: - (BOOL)isDataRequired;	// 0x35362491
- (id)reorderControl:(BOOL)control;	// 0x351e3ebd
- (id)reorderSeparatorView:(BOOL)view;	// 0x351e3f39
@end
