...
- (id)initWithSlide:(id)slide sprite:(id)sprite modelViewMatrix:(const float *)matrix foreColor:(const float *)color position:(CGPoint)position size:(CGSize)size isShadow:(BOOL)shadow;	// 0x3433819d
- (void)dealloc;	// 0x343382b5
@end
