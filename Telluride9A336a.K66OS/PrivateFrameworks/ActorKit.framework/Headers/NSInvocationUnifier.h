...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x346cb0a5
- (void)dealloc;	// 0x346cb171
- (void)forwardInvocation:(id)invocation;	// 0x346cb1e5
- (id)methodSignatureForSelector:(SEL)selector;	// 0x346cb19d
@end
