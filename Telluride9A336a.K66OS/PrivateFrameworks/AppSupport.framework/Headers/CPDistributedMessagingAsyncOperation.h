...
- (id)initWithCenter:(id)center messageName:(id)name userInfoData:(id)data oolKey:(id)key oolData:(id)data5 target:(id)target selector:(SEL)selector context:(void *)context makeServer:(BOOL)server;	// 0x3603e23d
- (void)_performCallout;	// 0x3603e38d
- (void)_releaseSendingData;	// 0x3603e53d
- (void)dealloc;	// 0x3603e5bd
- (void)main;	// 0x3603e405
@end
