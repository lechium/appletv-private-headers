...
- (id)initForNetwork:(id)network notifying:(id)notifying;	// 0x339940dd
- (void)_testFinished:(id)finished;	// 0x33994681
- (void)_testInternetConnection;	// 0x33994649
- (void)dealloc;	// 0x33994325
- (void)setFrame:(CGRect)frame;	// 0x339943f1
- (void)wasExhumed;	// 0x33994609
- (void)wasPushed;	// 0x339945c9
@end
