...
+ (void)setSingleton:(id)singleton;	// 0x33995aa9
+ (id)singleton;	// 0x33995a99
- (id)init;	// 0x33995ab9
- (void)_hidThreadLoop;	// 0x33995de9
- (void)_invocationHandler;	// 0x33995fb1
- (void)dealloc;	// 0x33995bb5
- (BOOL)invokeOnHIDThread:(id)thread;	// 0x33995c15
@end
