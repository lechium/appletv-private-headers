...
- (void)dealloc;	// 0x339db38d
- (BOOL)perform:(id)perform;	// 0x339db42d
- (void)setKeyValueStore:(id)store;	// 0x339db3d9
- (void)setLastModifiedThreshold:(double)threshold;	// 0x339db419
@end
