...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x33b5e381
- (unsigned)count;	// 0x33b5e7d1
- (void)dealloc;	// 0x33b5e785
- (unsigned)indexOfObject:(id)object;	// 0x33b5e8a5
- (id)objectAtIndex:(unsigned)index;	// 0x33b5e805
@end
