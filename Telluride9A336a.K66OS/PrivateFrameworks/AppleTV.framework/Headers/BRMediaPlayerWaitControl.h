...
- (id)initWithAsset:(id)asset;	// 0x33a6e7fd
- (void)_addFadeAnimationToControl:(id)control;	// 0x33a6f6fd
- (void)dealloc;	// 0x33a6ece5
- (void)layoutSubcontrols;	// 0x33a6f1e9
- (void)setAuthorizing;	// 0x33a6f12d
- (void)setReadyForPlayInNMins:(int)nmins;	// 0x33a6ede5
- (void)setReadyToPlay;	// 0x33a6f09d
@end
