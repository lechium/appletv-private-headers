...
+ (void)setSingleton:(id)singleton;	// 0x33b07155
+ (id)singleton;	// 0x33b07145
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x33b07311
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x33b078ed
- (void)dealloc;	// 0x33b07165
- (id)populatorForAsset:(id)asset;	// 0x33b072a1
@end
