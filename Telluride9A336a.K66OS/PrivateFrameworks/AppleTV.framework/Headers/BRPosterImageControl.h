...
- (id)initWithImageDataSource:(id)imageDataSource cornerRadius:(float)radius borderWidth:(float)width borderColor:(CGColorRef)color;	// 0x33aed009
- (void)dealloc;	// 0x33aed09d
- (void)drawInContext:(CGContextRef)context;	// 0x33aed0e1
@end
