...
+ (void)setSingleton:(id)singleton;	// 0x33b47239
+ (id)singleton;	// 0x33b47229
- (id)init;	// 0x33b47249
- (void)_processTasks;	// 0x33b47649
- (void)cancelTask:(id)task;	// 0x33b474d9
- (void)dealloc;	// 0x33b472fd
- (void)scheduleTask:(id)task;	// 0x33b4735d
@end
