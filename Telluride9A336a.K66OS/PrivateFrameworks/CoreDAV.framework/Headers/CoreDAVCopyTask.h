...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x32c4f4c5
- (void)dealloc;	// 0x32c4f3fd
- (id)httpMethod;	// 0x32c4f3f1
- (BOOL)validate:(id *)validate;	// 0x32c4f441
@end
