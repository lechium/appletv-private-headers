...
- (id)init;	// 0x3607f7f1
- (id)initWithCFRunLoop:(CFRunLoopRef)cfrunLoop;	// 0x3607f815
- (void)awake;	// 0x3607f7ed
- (void)dealloc;	// 0x3607f945
- (void)down;	// 0x3607fa99
- (void)finalize;	// 0x3607f9fd
- (void)up;	// 0x3607fb61
- (int)value;	// 0x3607fbd1
@end
