...
+ (id)sharedGateKeeper;	// 0x34606889
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x34606ac9
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x346068d1
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x346069c9
- (id)stateString;	// 0x34606a45
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x3460694d
@end
