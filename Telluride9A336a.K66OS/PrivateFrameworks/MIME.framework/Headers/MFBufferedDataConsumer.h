...
@property(readonly, retain) NSMutableData *data;	// G=0x3507a365; converted property
- (id)init;	// 0x3507a075
- (int)appendData:(id)data;	// 0x3507a0ed
// converted property getter: - (id)data;	// 0x3507a365
- (void)dealloc;	// 0x3507a4f9
- (void)done;	// 0x3507a00d
@end
