...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x30cb03a5; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x30cb03a5
- (id)contentAsPlainTextPreservingNewlines;	// 0x30cb0429
@end
