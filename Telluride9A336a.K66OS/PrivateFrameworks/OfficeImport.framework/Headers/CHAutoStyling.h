...
+ (id)autoStylingWithChart:(id)chart;	// 0x34cdfed1
- (id)initWithChart:(id)chart;	// 0x34cdff6d
- (void)dealloc;	// 0x34cef135
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x34cecbd9
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x34d31a69
@end
