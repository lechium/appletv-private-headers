...
- (id)initWithRows:(id)rows fileName:(id)name columnCount:(unsigned)count archiver:(id)archiver;	// 0x34e77ac9
- (void)dealloc;	// 0x34e77e89
- (void)mapAt:(id)at withState:(id)state;	// 0x34e77b89
- (CGSize)pageSize;	// 0x34e77ab1
@end
