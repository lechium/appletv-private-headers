...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x3011ae35; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x3011ae45; converted property
- (id)initWithMemory:(id)memory;	// 0x3011ae55
// converted property getter: - (unsigned)indirectsymoff;	// 0x3011ae35
- (BOOL)isDySymTab;	// 0x3011ae31
// converted property getter: - (unsigned)nindirectsyms;	// 0x3011ae45
@end
