...
@property(readonly, assign) VMURange range;	// G=0x30140a5d; converted property
@property(readonly, retain) NSString *type;	// G=0x30140a91; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x30140bc1
- (void)dealloc;	// 0x30140b61
- (id)description;	// 0x30140e0d
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x30140e21
- (BOOL)isEqual:(id)equal;	// 0x30140d75
- (BOOL)isSubmap;	// 0x30140aa1
- (unsigned)protection;	// 0x30140a81
// converted property getter: - (VMURange)range;	// 0x30140a5d
// converted property getter: - (id)type;	// 0x30140a91
@end
