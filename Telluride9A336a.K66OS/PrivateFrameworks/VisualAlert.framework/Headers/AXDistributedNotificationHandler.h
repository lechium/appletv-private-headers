...
+ (void)postDistributedNotificationWithName:(id)name;	// 0x32193b19
- (id)_notificationTypeDescription;	// 0x32193b55
- (void)_startObserving;	// 0x32193a8d
- (void)_stopObserving;	// 0x32193add
@end
