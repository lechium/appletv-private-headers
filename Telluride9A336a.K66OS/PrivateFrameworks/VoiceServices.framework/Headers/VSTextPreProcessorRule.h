...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x328e8dd1
- (void)dealloc;	// 0x328e8f09
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x328e8f69
@end
