...
- (id)initWithHighlightView:(id)highlightView webView:(id)view;	// 0x364d760d
- (id)actionForKey:(id)key;	// 0x364d75b9
- (void)drawInContext:(CGContextRef)context;	// 0x364d7661
@end
