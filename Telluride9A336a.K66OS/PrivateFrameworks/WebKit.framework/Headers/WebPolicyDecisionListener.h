...
- (id)_initWithTarget:(id)target action:(SEL)action;	// 0x364dd14d
- (void)_invalidate;	// 0x364dd20d
- (void)_usePolicy:(int)policy;	// 0x364dd241
- (void)dealloc;	// 0x364dd27d
- (void)download;	// 0x364dd1d1
- (void)ignore;	// 0x364dd1e5
- (void)use;	// 0x364dd1f9
@end
