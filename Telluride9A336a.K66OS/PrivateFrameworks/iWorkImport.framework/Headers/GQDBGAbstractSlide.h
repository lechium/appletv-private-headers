...
- (char *)ID;	// 0x3047d589
- (void)dealloc;	// 0x3047d6d1
- (BOOL)isHidden;	// 0x3047d579
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x3047d665
- (id)slideStyle;	// 0x3047d559
- (id)stylesheet;	// 0x3047d569
@end
