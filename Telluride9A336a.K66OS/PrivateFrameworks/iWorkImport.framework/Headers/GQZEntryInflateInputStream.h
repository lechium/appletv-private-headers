...
- (id)initWithOffset:(long long)offset end:(long long)end uncompressedSize:(unsigned long long)size crc:(unsigned long)crc input:(id)input;	// 0x304c7745
- (void)dealloc;	// 0x304c7989
- (unsigned long)readToBuffer:(char *)buffer size:(unsigned long)size;	// 0x304c79f9
- (void)readToOwnBuffer:(const char **)ownBuffer size:(unsigned *)size;	// 0x304c7c1d
@end
