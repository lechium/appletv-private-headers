...
- (id)initWithFetchIntermediate:(id)fetchIntermediate inScope:(id)scope;	// 0x3403fd01
- (void)dealloc;	// 0x3403fed5
- (id)generateSQLStringInContext:(id)context;	// 0x3403fd59
@end
