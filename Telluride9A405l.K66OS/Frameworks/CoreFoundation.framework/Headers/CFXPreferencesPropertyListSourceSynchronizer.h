...
- (id)initWithPropertyListSource:(id)propertyListSource forLockedSynchronize:(BOOL)lockedSynchronize;	// 0x35274289
- (unsigned char)_backingPlistChangedSinceLastSync;	// 0x35274701
- (void *)createPlistFromDisk;	// 0x352840a1
- (void)dealloc;	// 0x35274b09
- (void)finalize;	// 0x352fba19
- (void)setValue:(void *)value forKey:(CFStringRef)key;	// 0x352fb9a5
- (unsigned char)synchronize;	// 0x35274459
- (unsigned char)synchronizeAlreadyFlocked;	// 0x35274471
- (unsigned char)writePlistToDisk;	// 0x35277e5d
@end
