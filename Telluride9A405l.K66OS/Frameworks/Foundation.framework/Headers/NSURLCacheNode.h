...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x303123a9
- (void)dealloc;	// 0x30312549
- (id)description;	// 0x303124f5
- (BOOL)isEqual:(id)equal;	// 0x30312471
@end
