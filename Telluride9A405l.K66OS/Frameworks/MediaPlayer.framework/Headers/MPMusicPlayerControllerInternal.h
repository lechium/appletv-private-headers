...
@property(assign) BOOL inBlockHandlingPlaybackStateChangedMessageFromServer;	// G=0x33c01de9; S=0x33c01dc5; 
- (id)initWithMusicPlayerController:(id)musicPlayerController;	// 0x33c01b81
- (void)didPrepareForRemoteSelectorInvocation;	// 0x33c01c9d
// declared property getter: - (BOOL)inBlockHandlingPlaybackStateChangedMessageFromServer;	// 0x33c01de9
- (BOOL)prepareForRemoteSelectorInvocation;	// 0x33c01bc1
- (void)serverConnectionDied;	// 0x33c01d5d
// declared property setter: - (void)setInBlockHandlingPlaybackStateChangedMessageFromServer:(BOOL)server;	// 0x33c01dc5
@end
