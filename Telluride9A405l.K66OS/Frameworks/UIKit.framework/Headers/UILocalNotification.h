...
+ (id)alloc;	// 0x32fa6e3d
+ (id)allocWithZone:(NSZone *)zone;	// 0x32fa6e69
- (id)init;	// 0x32fa6e95
- (id)initWithCoder:(id)coder;	// 0x32fa6f65
- (void)clearNonSystemProperties;	// 0x32fa6fc1
- (int)compareFireDates:(id)dates;	// 0x32fa6fbd
- (id)copyWithZone:(NSZone *)zone;	// 0x32fa6fad
- (void)encodeWithCoder:(id)coder;	// 0x32fa6fa9
- (BOOL)isValid;	// 0x32fa6fb9
- (id)nextFireDateAfterDate:(id)date localTimeZone:(id)zone;	// 0x32fa6fb5
- (id)nextFireDateForLastFireDate:(id)lastFireDate;	// 0x32fa6fb1
@end
