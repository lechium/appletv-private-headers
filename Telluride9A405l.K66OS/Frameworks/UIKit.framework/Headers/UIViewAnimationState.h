...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x32dbda39; 
+ (void)popAnimationState;	// 0x32c8acbd
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x32c8a051
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x32dbda39
- (void)animationDidStart:(id)animation;	// 0x32c90de9
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x32c90f85
- (void)dealloc;	// 0x32c8c51d
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x32c8b645
- (void)setAnimationAttributes:(id)attributes;	// 0x32c9a985
@end
