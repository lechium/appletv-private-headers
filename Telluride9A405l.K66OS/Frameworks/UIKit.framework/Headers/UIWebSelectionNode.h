...
@property(retain) UIWebSelection *selection;	// G=0x32f52ccd; S=0x32f52ce1; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x32f5292d
- (void)dealloc;	// 0x32f52985
- (void)invalidate;	// 0x32f52c21
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x32f52a6d
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x32f529c9
- (int)oppositeEdge:(int)edge;	// 0x32f52a51
// declared property getter: - (id)selection;	// 0x32f52ccd
// declared property setter: - (void)setSelection:(id)selection;	// 0x32f52ce1
@end
