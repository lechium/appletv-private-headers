...
- (id)init;	// 0x350e5811
- (BOOL)_cleanupAccountClass:(id)aClass;	// 0x350e5ae1
- (void)accountsHaveBeenSaved:(BOOL)saved;	// 0x350e5965
- (void)dealloc;	// 0x350e5a95
- (int)fixBasicAccountIfNeeded:(id)needed loggingMessage:(id)message;	// 0x350e59a5
- (id)supportedAccountTypes;	// 0x350e58f5
@end
