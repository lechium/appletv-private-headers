...
- (id)initWithCenter:(id)center messageName:(id)name userInfoData:(id)data oolKey:(id)key oolData:(id)data5 target:(id)target selector:(SEL)selector context:(void *)context makeServer:(BOOL)server;	// 0x36f4123d
- (void)_performCallout;	// 0x36f4138d
- (void)_releaseSendingData;	// 0x36f4153d
- (void)dealloc;	// 0x36f415bd
- (void)main;	// 0x36f41405
@end
