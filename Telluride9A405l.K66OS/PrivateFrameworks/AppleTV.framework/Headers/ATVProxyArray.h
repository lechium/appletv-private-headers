...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x35ece7b9
- (unsigned)count;	// 0x35ecec09
- (void)dealloc;	// 0x35ecebbd
- (unsigned)indexOfObject:(id)object;	// 0x35ececdd
- (id)objectAtIndex:(unsigned)index;	// 0x35ecec3d
@end
