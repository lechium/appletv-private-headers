...
+ (void)setSingleton:(id)singleton;	// 0x35e74fe5
+ (id)singleton;	// 0x35e74fd5
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x35e751a1
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x35e7577d
- (void)dealloc;	// 0x35e74ff5
- (id)populatorForAsset:(id)asset;	// 0x35e75131
@end
