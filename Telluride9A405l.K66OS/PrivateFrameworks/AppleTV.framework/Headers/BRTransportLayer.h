...
@class BRWaitSpinnerControl, BRImage, NSArray, NSMutableDictionary;
...
@property(assign) BOOL showChapterMarks;	// G=0x35e42e9d; S=0x35e42e7d; converted property
- (id)initWithSpinner:(BOOL)spinner;	// 0x35e424d5
- (id)_cachedImageForName:(id)name;	// 0x35e433a9
- (void)_drawChapterMarkersInContext:(CGContextRef)context;	// 0x35e43d75
- (void)_drawInterstitialMarkersInContext:(CGContextRef)context;	// 0x35e440d1
- (id)_loadImageForName:(id)name;	// 0x35e43415
- (void)_updateDynamicFrames;	// 0x35e43825
- (void)_updateLeftEnd;	// 0x35e43231
- (void)_updateStaticFrames;	// 0x35e43491
- (void)dealloc;	// 0x35e4278d
- (void)drawInContext:(CGContextRef)context;	// 0x35e42edd
- (void)layoutSubcontrols;	// 0x35e42ead
- (CGRect)leftEndCapRenderableArea;	// 0x35e42b01
- (float)playheadPosition;	// 0x35e42cd1
- (CGRect)rightEndCapFrame;	// 0x35e42a5d
- (void)setChapterMarkers:(id)markers withTemporaryMarker:(float)temporaryMarker;	// 0x35e42d79
- (void)setCurrentInterstitialIndex:(long)index;	// 0x35e42e5d
- (void)setDownloadedRange:(NSRange)range;	// 0x35e42a0d
- (void)setDrawsBetweenLeftEdgeAndBufferEdge:(BOOL)edge;	// 0x35e428e9
- (void)setInterstitialMarkers:(id)markers;	// 0x35e42df9
- (void)setPercentComplete:(float)complete;	// 0x35e42871
- (void)setPlayerStateHidden:(BOOL)hidden;	// 0x35e42985
// converted property setter: - (void)setShowChapterMarks:(BOOL)marks;	// 0x35e42e7d
- (void)setState:(int)state;	// 0x35e42815
- (void)setUseWideLeftEndCap:(BOOL)cap;	// 0x35e4292d
- (void)setZeroDuration:(BOOL)duration;	// 0x35e429c9
// converted property getter: - (BOOL)showChapterMarks;	// 0x35e42e9d
@end
