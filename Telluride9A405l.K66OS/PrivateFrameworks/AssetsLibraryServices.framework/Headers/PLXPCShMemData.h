...
- (id)initWithXPCShmem:(void *)xpcshmem;	// 0x36e945dd
- (const void *)bytes;	// 0x36e94739
- (void)dealloc;	// 0x36e94661
- (id)debugDescription;	// 0x36e946e9
- (unsigned)length;	// 0x36e94749
@end
