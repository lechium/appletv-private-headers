...
- (id)init;	// 0x33932ce1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x33932ba1
- (void)dealloc;	// 0x33932c4d
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x33932a1d
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x33932a3d
@end
