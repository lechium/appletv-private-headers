...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x30ffa4c5
- (void)dealloc;	// 0x30ffa3fd
- (id)httpMethod;	// 0x30ffa3f1
- (BOOL)validate:(id *)validate;	// 0x30ffa441
@end
