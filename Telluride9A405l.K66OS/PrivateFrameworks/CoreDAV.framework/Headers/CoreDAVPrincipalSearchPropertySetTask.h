...
- (id)initWithURL:(id)url;	// 0x30ffb491
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x30ffb589
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x30ffb619
- (id)httpMethod;	// 0x30ffb4d1
- (id)requestBody;	// 0x30ffb4dd
@end
