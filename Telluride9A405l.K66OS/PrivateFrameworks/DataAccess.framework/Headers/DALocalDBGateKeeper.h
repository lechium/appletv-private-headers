...
+ (id)sharedGateKeeper;	// 0x36c2787d
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x36c27abd
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x36c278c5
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x36c279bd
- (id)stateString;	// 0x36c27a39
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x36c27941
@end
