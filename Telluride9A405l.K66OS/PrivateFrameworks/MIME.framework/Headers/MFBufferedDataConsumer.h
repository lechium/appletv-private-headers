...
@property(readonly, retain) NSMutableData *data;	// G=0x311de351; converted property
- (id)init;	// 0x311de061
- (int)appendData:(id)data;	// 0x311de0d9
// converted property getter: - (id)data;	// 0x311de351
- (void)dealloc;	// 0x311de4e5
- (void)done;	// 0x311ddff9
@end
