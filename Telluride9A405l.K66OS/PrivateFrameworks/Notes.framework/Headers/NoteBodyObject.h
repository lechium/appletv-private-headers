...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x3664e3a5; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x3664e3a5
- (id)contentAsPlainTextPreservingNewlines;	// 0x3664e429
@end
