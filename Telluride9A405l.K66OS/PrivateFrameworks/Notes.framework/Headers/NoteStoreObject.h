...
- (id)basicAccountIdentifier;	// 0x3664e35d
- (id)collectionInfo;	// 0x3664e259
- (unsigned)maximumServerIntId;	// 0x3664dfe1
- (id)notesForGUIDs:(id)guids;	// 0x3664dbd1
- (id)notesForIntegerIds:(id)integerIds;	// 0x3664da71
- (id)notesForServerIds:(id)serverIds;	// 0x3664d911
- (id)notesForServerIntIds:(id)serverIntIds;	// 0x3664dd31
- (id)notesForServerIntIdsInRange:(NSRange)range;	// 0x3664de91
- (id)predicateForNotes;	// 0x3664e229
@end
