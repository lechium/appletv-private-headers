...
+ (id)autoStylingWithChart:(id)chart;	// 0x30d43ed1
- (id)initWithChart:(id)chart;	// 0x30d43f6d
- (void)dealloc;	// 0x30d53135
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x30d50bd9
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x30d95a69
@end
