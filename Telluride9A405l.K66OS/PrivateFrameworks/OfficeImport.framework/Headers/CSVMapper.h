...
- (id)initWithRows:(id)rows fileName:(id)name columnCount:(unsigned)count archiver:(id)archiver;	// 0x30edbac9
- (void)dealloc;	// 0x30edbe89
- (void)mapAt:(id)at withState:(id)state;	// 0x30edbb89
- (CGSize)pageSize;	// 0x30edbab1
@end
