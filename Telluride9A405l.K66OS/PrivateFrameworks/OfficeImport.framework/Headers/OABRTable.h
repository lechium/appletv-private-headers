...
- (id)initWithSourceTable:(id)sourceTable targetTable:(id)table state:(id)state;	// 0x30da54f1
- (void)createTargetTableContents;	// 0x30df30bd
- (void)dealloc;	// 0x30da63e9
- (void)map;	// 0x30da5591
- (void)mapScale;	// 0x30da573d
- (void)readAnchor;	// 0x30da5689
- (void)readCellsAndLines;	// 0x30da600d
- (void)readCoordinates;	// 0x30da59c9
- (id)readStrokeFromShape:(EshShape *)shape;	// 0x30df3839
@end
