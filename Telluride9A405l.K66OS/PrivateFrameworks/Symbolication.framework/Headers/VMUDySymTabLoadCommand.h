...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x34f5fe35; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x34f5fe45; converted property
- (id)initWithMemory:(id)memory;	// 0x34f5fe55
// converted property getter: - (unsigned)indirectsymoff;	// 0x34f5fe35
- (BOOL)isDySymTab;	// 0x34f5fe31
// converted property getter: - (unsigned)nindirectsyms;	// 0x34f5fe45
@end
