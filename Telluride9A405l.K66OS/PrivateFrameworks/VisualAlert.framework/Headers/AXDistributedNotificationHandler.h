...
+ (void)postDistributedNotificationWithName:(id)name;	// 0x36fa0b19
- (id)_notificationTypeDescription;	// 0x36fa0b55
- (void)_startObserving;	// 0x36fa0a8d
- (void)_stopObserving;	// 0x36fa0add
@end
