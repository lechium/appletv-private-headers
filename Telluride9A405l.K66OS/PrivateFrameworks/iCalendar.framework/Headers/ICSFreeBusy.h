...
@property(retain) NSArray *freebusy;	// G=0x3388fb31; S=0x3388fb51; 
...
@property(retain) NSString *x_calendarserver_mask_uid;	// G=0x3388fb71; S=0x3388fbb9; 
+ (id)name;	// 0x3388fb25
// declared property getter: - (id)freebusy;	// 0x3388fb31
// declared property setter: - (void)setFreebusy:(id)freebusy;	// 0x3388fb51
// declared property setter: - (void)setX_calendarserver_mask_uid:(id)uid;	// 0x3388fbb9
// declared property getter: - (id)x_calendarserver_mask_uid;	// 0x3388fb71
@end
