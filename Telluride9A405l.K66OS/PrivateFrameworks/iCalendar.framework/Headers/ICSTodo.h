...
@property(retain) ICSDate *completed;	// G=0x3388a531; S=0x3388a569; 
...
@property(retain) ICSDate *due;	// G=0x3388a659; S=0x3388a691; 
...
@property(assign) int percentComplete;	// G=0x3388a589; S=0x3388a5e1; 
...
@property(retain) NSArray *x_apple_activity;	// G=0x3388a779; S=0x3388a759; 
...
@property(assign) unsigned x_apple_sort_order;	// G=0x3388a6b1; S=0x3388a709; 
@property(retain) ICSStructuredLocation *x_apple_structured_location;	// @dynamic
+ (id)name;	// 0x3388a43d
// declared property getter: - (id)completed;	// 0x3388a531
// declared property getter: - (id)due;	// 0x3388a659
- (void)fixComponent;	// 0x33889559
// declared property getter: - (int)percentComplete;	// 0x3388a589
// declared property setter: - (void)setCompleted:(id)completed;	// 0x3388a569
// declared property setter: - (void)setDue:(id)due;	// 0x3388a691
// declared property setter: - (void)setPercentComplete:(int)complete;	// 0x3388a5e1
// declared property setter: - (void)setX_apple_activity:(id)activity;	// 0x3388a759
// declared property setter: - (void)setX_apple_sort_order:(unsigned)order;	// 0x3388a709
- (BOOL)validate:(id *)validate;	// 0x3388a449
// declared property getter: - (id)x_apple_activity;	// 0x3388a779
// declared property getter: - (unsigned)x_apple_sort_order;	// 0x3388a6b1
@end
