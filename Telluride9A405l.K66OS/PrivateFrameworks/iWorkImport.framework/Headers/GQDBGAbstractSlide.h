...
- (char *)ID;	// 0x34236589
- (void)dealloc;	// 0x342366d1
- (BOOL)isHidden;	// 0x34236579
- (int)readAttributesForSlide:(xmlTextReader *)slide;	// 0x34236665
- (id)slideStyle;	// 0x34236559
- (id)stylesheet;	// 0x34236569
@end
