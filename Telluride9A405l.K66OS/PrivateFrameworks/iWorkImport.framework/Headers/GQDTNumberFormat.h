...
+ (BOOL)needToSuppressMinusSignForFormatString:(CFStringRef)formatString;	// 0x3424de0d
+ (id)numberFormatWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9;	// 0x3424b6e5
+ (const StateSpec *)stateForReading;	// 0x3424a459
- (id)initWithValueType:(int)valueType formatString:(id)string decimalPlaces:(unsigned short)places currencyCode:(id)code useAccountingStyle:(BOOL)style negativeStyle:(int)style6 showThousandsSeparator:(BOOL)separator fractionAccuracy:(int)accuracy suffixString:(CFStringRef)string9 scaleFactor:(double)factor base:(unsigned short)base basePlaces:(unsigned short)places12 baseUseMinusSign:(BOOL)sign isCustom:(BOOL)custom interstitialStrings:(id)strings interstitialStringInsertionIndexes:(id)indexes indexFromRightOfLastDigitPlaceholder:(unsigned short)lastDigitPlaceholder minimumIntegerWidth:(unsigned char)width decimalWidth:(unsigned char)width19 numberOfNonSpaceIntegerPlaceholderDigits:(unsigned char)nonSpaceIntegerPlaceholderDigits numberOfNonSpaceDecimalPlaceholderDigits:(unsigned char)nonSpaceDecimalPlaceholderDigits isTextFormat:(BOOL)format formatName:(id)name;	// 0x3424d57d
- (id)baseStringFromDouble:(double)aDouble;	// 0x3424db79
- (CFStringRef)createStringFromDouble:(double)aDouble;	// 0x3424bc99
- (id)currencyCode;	// 0x3424a4c9
- (id)customNumberFormatTokens;	// 0x3424a921
- (void)dealloc;	// 0x3424c9c5
- (id)formatString;	// 0x3424a4b9
- (int)fractionAccuracy;	// 0x3424a509
- (id)fractionStringFromDouble:(double)aDouble;	// 0x3424d98d
- (BOOL)hasValidDecimalPlaces;	// 0x3424a465
- (BOOL)isCustom;	// 0x3424a4e9
- (BOOL)isTextFormat;	// 0x3424a4f9
- (id)numberFormatBySettingNegativeStyle:(int)style;	// 0x3424a5fd
- (id)numberFormatBySettingValueType:(int)type;	// 0x3424a7cd
- (int)readAttributesFromReader:(xmlTextReader *)reader;	// 0x3424d1b5
- (void)setUseScientificFormattingAutomatically:(BOOL)automatically;	// 0x3424a4a9
- (BOOL)showThousandsSeparator;	// 0x3424a4d9
- (id)stringFromDouble:(double)aDouble;	// 0x3424bd4d
- (BOOL)useAccountingStyle;	// 0x3424a499
- (int)valueType;	// 0x3424a489
@end
