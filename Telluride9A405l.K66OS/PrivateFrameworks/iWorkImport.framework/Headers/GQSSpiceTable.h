...
- (id)init;	// 0x3427beed
- (void)aboutToReadCells;	// 0x3427c0d1
- (void)aboutToReadColumnVectors;	// 0x3427bd65
- (void)aboutToReadRowVectors;	// 0x3427bd51
- (float)alongValueForVectorUid:(const char *)vectorUid;	// 0x3427c0a1
- (void)dealloc;	// 0x3427c169
- (void)setAlongValue:(float)value forOwnedVectorUid:(char *)ownedVectorUid;	// 0x3427c011
@end
