...
- (id)initWithOffset:(long long)offset end:(long long)end uncompressedSize:(unsigned long long)size crc:(unsigned long)crc input:(id)input;	// 0x34280745
- (void)dealloc;	// 0x34280989
- (unsigned long)readToBuffer:(char *)buffer size:(unsigned long)size;	// 0x342809f9
- (void)readToOwnBuffer:(const char **)ownBuffer size:(unsigned *)size;	// 0x34280c1d
@end
