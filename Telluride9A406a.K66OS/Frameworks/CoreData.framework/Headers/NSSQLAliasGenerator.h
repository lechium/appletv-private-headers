...
- (id)init;	// 0x34809a8d
- (id)initWithNestingLevel:(unsigned)nestingLevel;	// 0x3476f7f5
- (void)dealloc;	// 0x347760e5
- (id)generateSubqueryVariableAlias;	// 0x34809aa1
- (id)generateTableAlias;	// 0x34771719
@end
