...
- (id)initWithFetchIntermediate:(id)fetchIntermediate inScope:(id)scope;	// 0x34865d01
- (void)dealloc;	// 0x34865ed5
- (id)generateSQLStringInContext:(id)context;	// 0x34865d59
@end
