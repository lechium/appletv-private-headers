...
- (id)initWithPropertyListSource:(id)propertyListSource forLockedSynchronize:(BOOL)lockedSynchronize;	// 0x34046289
- (unsigned char)_backingPlistChangedSinceLastSync;	// 0x34046701
- (void *)createPlistFromDisk;	// 0x340560a1
- (void)dealloc;	// 0x34046b09
- (void)finalize;	// 0x340cda19
- (void)setValue:(void *)value forKey:(CFStringRef)key;	// 0x340cd9a5
- (unsigned char)synchronize;	// 0x34046459
- (unsigned char)synchronizeAlreadyFlocked;	// 0x34046471
- (unsigned char)writePlistToDisk;	// 0x34049e5d
@end
