...
@property(readonly, retain, nonatomic) MIDINetworkHost *host;	// G=0x341b4bc5; 
+ (id)connectionWithHost:(id)host;	// 0x341b6831
- (id)init;	// 0x341b68f5
- (void)dealloc;	// 0x341b689d
// declared property getter: - (id)host;	// 0x341b4bc5
@end
