...
- (id)init;	// 0x33a716c1
- (void)_notificationHandler:(id)handler;	// 0x33a720c1
- (void)dealloc;	// 0x33a718b5
- (void)notificationCallback;	// 0x33a71a91
- (void)setCallback:(/*function-pointer*/ void *)callback andContext:(void *)context andRunLoop:(CFRunLoopRef)loop;	// 0x33a71805
@end
