...
- (id)initWithCachedResponse:(id)cachedResponse request:(id)request key:(id)key;	// 0x35e963a9
- (void)dealloc;	// 0x35e96549
- (id)description;	// 0x35e964f5
- (BOOL)isEqual:(id)equal;	// 0x35e96471
@end
