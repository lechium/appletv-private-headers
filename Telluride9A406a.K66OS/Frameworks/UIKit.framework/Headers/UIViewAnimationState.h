...
@property(readonly, assign, nonatomic) BOOL _allowsUserInteraction;	// G=0x357bba39; 
+ (void)popAnimationState;	// 0x35688cbd
+ (void)pushViewAnimationState:(id)state context:(void *)context;	// 0x35688051
// declared property getter: - (BOOL)_allowsUserInteraction;	// 0x357bba39
- (void)animationDidStart:(id)animation;	// 0x3568ede9
- (void)animationDidStop:(id)animation finished:(BOOL)finished;	// 0x3568ef85
- (void)dealloc;	// 0x3568a51d
- (void)sendDelegateAnimationDidStop:(id)sendDelegateAnimation finished:(BOOL)finished;	// 0x35689645
- (void)setAnimationAttributes:(id)attributes;	// 0x35698985
@end
