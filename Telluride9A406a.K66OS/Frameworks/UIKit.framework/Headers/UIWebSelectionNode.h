...
@property(retain) UIWebSelection *selection;	// G=0x35950ccd; S=0x35950ce1; @synthesize=_selection
- (id)initWithSelection:(id)selection inGraph:(id)graph;	// 0x3595092d
- (void)dealloc;	// 0x35950985
- (void)invalidate;	// 0x35950c21
- (id)nodeByMovingEdge:(int)edge outwards:(BOOL)outwards;	// 0x35950a6d
- (id *)nodeByReferenceFromEdge:(int)edge outwards:(BOOL)outwards;	// 0x359509c9
- (int)oppositeEdge:(int)edge;	// 0x35950a51
// declared property getter: - (id)selection;	// 0x35950ccd
// declared property setter: - (void)setSelection:(id)selection;	// 0x35950ce1
@end
