...
- (id)initWithSlide:(id)slide sprite:(id)sprite modelViewMatrix:(const float *)matrix foreColor:(const float *)color position:(CGPoint)position size:(CGSize)size isShadow:(BOOL)shadow;	// 0x349d419d
- (void)dealloc;	// 0x349d42b5
@end
