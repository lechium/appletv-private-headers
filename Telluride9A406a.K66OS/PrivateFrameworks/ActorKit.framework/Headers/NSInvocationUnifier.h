...
- (id)initWithInvocation:(id)invocation protocol:(id)protocol;	// 0x35fa70a5
- (void)dealloc;	// 0x35fa7171
- (void)forwardInvocation:(id)invocation;	// 0x35fa71e5
- (id)methodSignatureForSelector:(SEL)selector;	// 0x35fa719d
@end
