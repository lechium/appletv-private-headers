...
+ (id)defaultWhitelist;	// 0x33fd60d5
- (id)initWithDefaultPath;	// 0x33fd6359
- (id)initWithPath:(id)path;	// 0x33fd6451
- (void)dealloc;	// 0x33fd6039
- (BOOL)distributionKeyIsWhitelisted:(id)whitelisted;	// 0x33fd6149
- (BOOL)metadataKeyIsWhitelisted:(id)whitelisted;	// 0x33fd6101
- (BOOL)scalarKeyIsWhitelisted:(id)whitelisted;	// 0x33fd6251
@end
