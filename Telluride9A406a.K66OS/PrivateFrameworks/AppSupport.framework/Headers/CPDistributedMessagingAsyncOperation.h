...
- (id)initWithCenter:(id)center messageName:(id)name userInfoData:(id)data oolKey:(id)key oolData:(id)data5 target:(id)target selector:(SEL)selector context:(void *)context makeServer:(BOOL)server;	// 0x3472623d
- (void)_performCallout;	// 0x3472638d
- (void)_releaseSendingData;	// 0x3472653d
- (void)dealloc;	// 0x347265bd
- (void)main;	// 0x34726405
@end
