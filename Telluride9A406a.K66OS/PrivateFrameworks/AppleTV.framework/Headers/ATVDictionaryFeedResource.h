...
- (id)init;	// 0x33013af9
- (void)clearFeedResources;	// 0x33013ce9
- (void)dealloc;	// 0x33013b75
- (id)feedResourceNamed:(id)named;	// 0x33013bd5
- (void)setFeedResource:(id)resource named:(id)named;	// 0x33013c61
@end
