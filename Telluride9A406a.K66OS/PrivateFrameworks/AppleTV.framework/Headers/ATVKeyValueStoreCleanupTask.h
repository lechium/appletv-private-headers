...
- (void)dealloc;	// 0x32fc11fd
- (BOOL)perform:(id)perform;	// 0x32fc129d
- (void)setKeyValueStore:(id)store;	// 0x32fc1249
- (void)setLastModifiedThreshold:(double)threshold;	// 0x32fc1289
@end
