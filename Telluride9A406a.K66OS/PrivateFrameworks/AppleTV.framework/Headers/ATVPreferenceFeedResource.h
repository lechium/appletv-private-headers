...
- (id)initWithPath:(id)path;	// 0x32fe916d
- (void)_savePrefs;	// 0x32fe94b9
- (void)clearFeedResources;	// 0x32fe9409
- (void)dealloc;	// 0x32fe92d5
- (void)setFeedResource:(id)resource named:(id)named;	// 0x32fe9359
@end
