...
- (id)initWithOwner:(id)owner key:(id)key;	// 0x33148685
- (unsigned)count;	// 0x33148ad5
- (void)dealloc;	// 0x33148a89
- (unsigned)indexOfObject:(id)object;	// 0x33148ba9
- (id)objectAtIndex:(unsigned)index;	// 0x33148b09
@end
