...
+ (void)setSingleton:(id)singleton;	// 0x330eeeb1
+ (id)singleton;	// 0x330eeea1
- (id)_populatorForMediaAsset:(id)mediaAsset;	// 0x330ef06d
- (id)_populatorForMediaCollection:(id)mediaCollection;	// 0x330ef649
- (void)dealloc;	// 0x330eeec1
- (id)populatorForAsset:(id)asset;	// 0x330eeffd
@end
