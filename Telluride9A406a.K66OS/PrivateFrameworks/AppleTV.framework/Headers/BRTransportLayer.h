...
@property(assign) BOOL showChapterMarks;	// G=0x330bcd69; S=0x330bcd49; converted property
- (id)initWithSpinner:(BOOL)spinner;	// 0x330bc3a1
- (id)_cachedImageForName:(id)name;	// 0x330bd275
- (void)_drawChapterMarkersInContext:(CGContextRef)context;	// 0x330bdc41
- (void)_drawInterstitialMarkersInContext:(CGContextRef)context;	// 0x330bdf9d
- (id)_loadImageForName:(id)name;	// 0x330bd2e1
- (void)_updateDynamicFrames;	// 0x330bd6f1
- (void)_updateLeftEnd;	// 0x330bd0fd
- (void)_updateStaticFrames;	// 0x330bd35d
- (void)dealloc;	// 0x330bc659
- (void)drawInContext:(CGContextRef)context;	// 0x330bcda9
- (void)layoutSubcontrols;	// 0x330bcd79
- (CGRect)leftEndCapRenderableArea;	// 0x330bc9cd
- (float)playheadPosition;	// 0x330bcb9d
- (CGRect)rightEndCapFrame;	// 0x330bc929
- (void)setChapterMarkers:(id)markers withTemporaryMarker:(float)temporaryMarker;	// 0x330bcc45
- (void)setCurrentInterstitialIndex:(long)index;	// 0x330bcd29
- (void)setDownloadedRange:(NSRange)range;	// 0x330bc8d9
- (void)setDrawsBetweenLeftEdgeAndBufferEdge:(BOOL)edge;	// 0x330bc7b5
- (void)setInterstitialMarkers:(id)markers;	// 0x330bccc5
- (void)setPercentComplete:(float)complete;	// 0x330bc73d
- (void)setPlayerStateHidden:(BOOL)hidden;	// 0x330bc851
// converted property setter: - (void)setShowChapterMarks:(BOOL)marks;	// 0x330bcd49
- (void)setState:(int)state;	// 0x330bc6e1
- (void)setUseWideLeftEndCap:(BOOL)cap;	// 0x330bc7f9
- (void)setZeroDuration:(BOOL)duration;	// 0x330bc895
// converted property getter: - (BOOL)showChapterMarks;	// 0x330bcd69
@end
