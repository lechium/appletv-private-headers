...
- (id)init;	// 0x338e7ce1
- (void)accelerometer:(id)accelerometer didAccelerateWithTimeStamp:(double)timeStamp x:(float)x y:(float)y z:(float)z eventType:(int)type;	// 0x338e7ba1
- (void)dealloc;	// 0x338e7c4d
- (void)deferOnRunloop_accelerometerEventsEnable;	// 0x338e7a1d
- (void)getVector:(float *)vector :(float *)arg2 :(float *)arg3 forTimeStamp:(double)timeStamp;	// 0x338e7a3d
@end
