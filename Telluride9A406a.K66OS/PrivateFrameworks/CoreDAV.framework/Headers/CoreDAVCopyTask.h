...
- (void)_callBackToDelegateWithResponses:(id)responses error:(id)error;	// 0x31c4c4c5
- (void)dealloc;	// 0x31c4c3fd
- (id)httpMethod;	// 0x31c4c3f1
- (BOOL)validate:(id *)validate;	// 0x31c4c441
@end
