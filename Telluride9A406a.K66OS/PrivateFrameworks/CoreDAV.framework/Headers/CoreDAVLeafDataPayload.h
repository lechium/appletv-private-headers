...
@property(readonly, assign) NSArray *childrenOrder;
@property(readonly, assign) NSData *dataPayload;	// G=0x31c3f209; @synthesize=_dataPayload
@property(retain) NSURL *serverID;	// G=0x31c3f1d1; S=0x31c3f1e5; @synthesize=_serverID
@property(readonly, assign) NSString *syncKey;	// G=0x31c3f219; @synthesize=_syncKey
- (id)initWithURL:(id)url eTag:(id)tag dataPayload:(id)payload inContainerWithURL:(id)url4 withAccountInfoProvider:(id)accountInfoProvider;	// 0x31c3f0d1
// declared property getter: - (id)dataPayload;	// 0x31c3f209
- (void)dealloc;	// 0x31c3f15d
// declared property getter: - (id)serverID;	// 0x31c3f1d1
// declared property setter: - (void)setServerID:(id)anId;	// 0x31c3f1e5
// declared property getter: - (id)syncKey;	// 0x31c3f219
@end
