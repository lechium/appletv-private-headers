...
- (id)initWithURL:(id)url;	// 0x31c4d491
- (id)copyDefaultParserForContentType:(id)contentType;	// 0x31c4d589
- (void)finishCoreDAVTaskWithError:(id)error;	// 0x31c4d619
- (id)httpMethod;	// 0x31c4d4d1
- (id)requestBody;	// 0x31c4d4dd
@end
