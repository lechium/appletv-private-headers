...
+ (id)sharedGateKeeper;	// 0x3617987d
- (void)claimedOwnershipOfDataclasses:(int)dataclasses;	// 0x36179abd
- (void)registerWaiter:(id)waiter forDataclassLocks:(int)dataclassLocks completionHandler:(id)handler;	// 0x361798c5
- (void)relinquishLocksForWaiter:(id)waiter dataclasses:(int)dataclasses moreComing:(BOOL)coming;	// 0x361799bd
- (id)stateString;	// 0x36179a39
- (void)unregisterWaiterForDataclassLocks:(id)dataclassLocks;	// 0x36179941
@end
