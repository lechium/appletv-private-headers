...
- (id)init;	// 0x34f46b4d
- (void)dealloc;	// 0x34f46d11
- (void)playInfoRequest:(id)request didReceiveResponse:(id)response;	// 0x34f46b49
- (void)request:(id)request didFailWithError:(id)error;	// 0x34f46c41
- (void)requestDidFinish:(id)request;	// 0x34f46b99
- (void)setPlayer:(OpaqueFigPlayer *)player;	// 0x34f46b39
- (void)setRequest:(id)request;	// 0x34f46cd1
@end
