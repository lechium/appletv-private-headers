...
@property(readonly, assign, nonatomic) NSString *contentAsPlainText;	// G=0x3635c3a5; 
...
// declared property getter: - (id)contentAsPlainText;	// 0x3635c3a5
- (id)contentAsPlainTextPreservingNewlines;	// 0x3635c429
@end
