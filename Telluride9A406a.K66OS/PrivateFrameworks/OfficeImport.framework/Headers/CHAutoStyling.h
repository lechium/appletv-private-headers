...
+ (id)autoStylingWithChart:(id)chart;	// 0x3297eed1
- (id)initWithChart:(id)chart;	// 0x3297ef6d
- (void)dealloc;	// 0x3298e135
- (int)defaultMarkerStyleForSeriesIndex:(int)seriesIndex;	// 0x3298bbd9
- (void)replaceStrokeAndFillInEmptyMarker:(id)emptyMarker withSeriesGraphicProperties:(id)seriesGraphicProperties;	// 0x329d0a69
@end
