...
- (id)initWithSheetLocation:(id)sheetLocation sheetXmlType:(id)type state:(id)state;	// 0x329c3215
- (void)dealloc;	// 0x329c66e5
- (bool)loadDelayedNode:(id)node;	// 0x329c37a1
@end
