...
@property(readonly, assign) unsigned indirectsymoff;	// G=0x32c9ae35; converted property
@property(readonly, assign) unsigned nindirectsyms;	// G=0x32c9ae45; converted property
- (id)initWithMemory:(id)memory;	// 0x32c9ae55
// converted property getter: - (unsigned)indirectsymoff;	// 0x32c9ae35
- (BOOL)isDySymTab;	// 0x32c9ae31
// converted property getter: - (unsigned)nindirectsyms;	// 0x32c9ae45
@end
