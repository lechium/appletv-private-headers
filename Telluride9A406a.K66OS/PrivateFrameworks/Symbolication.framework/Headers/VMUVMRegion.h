...
@property(readonly, assign) VMURange range;	// G=0x32cc0a5d; converted property
@property(readonly, retain) NSString *type;	// G=0x32cc0a91; converted property
- (id)breakAtLength:(unsigned long)length;	// 0x32cc0bc1
- (void)dealloc;	// 0x32cc0b61
- (id)description;	// 0x32cc0e0d
- (id)descriptionWithOptions:(unsigned)options maximumLength:(unsigned)length;	// 0x32cc0e21
- (BOOL)isEqual:(id)equal;	// 0x32cc0d75
- (BOOL)isSubmap;	// 0x32cc0aa1
- (unsigned)protection;	// 0x32cc0a81
// converted property getter: - (VMURange)range;	// 0x32cc0a5d
// converted property getter: - (id)type;	// 0x32cc0a91
@end
