...
- (id)init;	// 0x30e4e211
- (void)_handleRequests;	// 0x30e4e299
- (void)_notifyRequestHandled:(id)handled;	// 0x30e4e4b1
- (void)dealloc;	// 0x30e4e731
- (void)handleResults:(id)results withHandler:(id)handler;	// 0x30e4e589
- (void)invalidate;	// 0x30e4e52d
- (void)setDelegate:(id)delegate;	// 0x30e4e6d1
@end
