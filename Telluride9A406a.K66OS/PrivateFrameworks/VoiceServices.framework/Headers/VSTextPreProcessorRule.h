...
- (id)initWithDictionaryRepresentation:(id)dictionaryRepresentation;	// 0x30e4edc5
- (void)dealloc;	// 0x30e4eefd
- (id)matchedString:(id)string forTokenInRange:(XXStruct_K5nmsA *)range;	// 0x30e4ef5d
@end
