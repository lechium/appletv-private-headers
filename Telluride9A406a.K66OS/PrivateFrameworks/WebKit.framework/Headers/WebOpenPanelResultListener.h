...
- (id)initWithChooser:(PassRefPtr<WebCore::FileChooser>)chooser;	// 0x302d466d
- (void)cancel;	// 0x302d4aa5
- (void)chooseFilename:(id)filename;	// 0x302d495d
- (void)chooseFilenames:(id)filenames;	// 0x302d46b5
@end
